...
@pytest.mark.usefixtures("mirror_lag_bridge_topology")
class Test_localmirror_bport():
    ...
    def test_create_delete_mirror_session(self):
        ...
        args[SAI_MIRROR_SESSION_ATTR_MONITOR_PORT] = pytest.tb.ports[pytest.top.mirror_dest]
    ...
    def __get_bport_stats(self):
        ...
        mirror_dest_stats = pytest.tb.get_egress_port_stats(pytest.tb.ports[pytest.top.mirror_dest])
...
@pytest.mark.usefixtures("mirror_lag_rif_topology")
