...
class Test_acl_custom_udk_switch_binding_rif_delete_add():
    def test_ingress_ipv4_acl_table(self):
        ...
        aclTestInstance.ingress_ipv4_acl_table_custom_udk_test(switch_binding=True, add_delete_port=True)
