...
class Test_acl_custom_l2cid_udk_bind_to_switch():
    def test_ingress_mac_fwding_v4_v6_acl_l2cid_switch_binding(self):
        '''
            L2 fwding + RTF ACL using l2,L3,L4 and l2cid fields. Both ACL match performed with v4 and v6 packets
            ACL attached to switch.
        '''
        ...
        aclTestInstance.ingress_mac_fwding_v4_v6_acl_l2cid_test(switch_binding=True)
