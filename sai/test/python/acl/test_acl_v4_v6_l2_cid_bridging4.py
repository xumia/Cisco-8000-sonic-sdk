...
class Test_acl_custom_l2cid_udk_bind_to_switch_with_port_modification():
    def test_ingress_mac_fwding_v4_v6_acl_l2cid_switch_binding_add_delete_port(self):
        '''
        ...
        aclTestInstance.ingress_mac_fwding_v4_v6_acl_l2cid_test(switch_binding=True, add_delete_port=True)
