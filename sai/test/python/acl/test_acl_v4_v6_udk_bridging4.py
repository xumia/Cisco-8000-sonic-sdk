...
class Test_acl_custom_udk_bind_to_switch_with_port_modification():
    def test_ingress_mac_fwding_v4_v6_acl_udk_switch_binding_port_delete_add(self):
        '''
        ...
        aclTestInstance.ingress_mac_fwding_v4_v6_acl_udk_test(switch_binding=True, add_delete_port=True)
