...
class Test_acl_custom_udk_bind_to_switch():
    def test_ingress_mac_fwding_v4_v6_acl_udk_switch_binding(self):
        '''
        ...
        aclTestInstance.ingress_mac_fwding_v4_v6_acl_udk_test(switch_binding=True)
