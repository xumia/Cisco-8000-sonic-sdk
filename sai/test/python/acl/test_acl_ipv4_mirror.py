...
class Test_acl_mirror():
    def test_ingress_ipv4_acl_mirror_action(self):
        ...
        aclTestInstance.ingress_ipv4_acl_table_mirror_test(mirror_oid)
...
class Test_acl_mirror_switch_attachment():
    ...
    def test_ingress_ipv4_acl_mirror_action(self):
        ...
        mirror_oid, _, _ = self.utils.create_erspan_mirror_session_and_route_inpkt_erspan_pkt()
        aclTestInstance = aclTests()
        aclTestInstance.ingress_ipv4_acl_table_mirror_test(mirror_oid, switch_binding=True)
        pytest.tb.remove_object(mirror_oid)
...
class Test_acl_mirror_switch_attachment_port_add_delete():
    ...
    def test_ingress_ipv4_acl_mirror_action(self):
        ...
        mirror_oid, _, _ = self.utils.create_erspan_mirror_session_and_route_inpkt_erspan_pkt()
        aclTestInstance = aclTests()
        aclTestInstance.ingress_ipv4_acl_table_mirror_test(mirror_oid, switch_binding=True, add_delete_port=True)
        pytest.tb.remove_object(mirror_oid)
