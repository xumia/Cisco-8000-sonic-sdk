...
class SimInjectNdpL2Test : public ::testing::Test
{
public:
...
TEST_F(SimInjectNdpL2Test, basic_route)
{

    const char ndp_packet[] = "3333ff480000c400054800008100000186dd6e00000000183aff00000000000000000000000000000000ff02000000000000"
                              "00000001ff4800008700b19600000000fe80000000000000c60005fffe480000";
    const char egress_packet[] = "3333ff480000c4000548000086dd6e00000000183aff00000000000000000000000000000000ff0200000000000000000"
                                 "001ff4800008700b19600000000fe80000000000000c60005fffe480000";
    ...
    str_to_uint8(ndp_packet, ingress_pkt_buf, 1024);
    ...
    sai_status_t status = hostif_api->send_hostif_packet(switch_id, sizeof(ndp_packet) / 2, ingress_pkt_buf, 1, attr_list);
    ASSERT_EQ(status, SAI_STATUS_SUCCESS);

    std::this_thread::sleep_for(std::chrono::milliseconds{500});

    auto output_packets = sim_ifc->get_packets();
    ASSERT_EQ(output_packets.size(), 3U);
