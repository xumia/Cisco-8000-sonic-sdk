...
class SimPuntArpTest : public ::testing::Test
{
public:
...
TEST_F(SimPuntArpTest, basic_route)
{
    ...
    const char arp_packet[] = "ffffffffffff00070daff4540806000108000604000100070daff45418a6ac0100000000000018a6ad9f0601040000000002"
                              "01000302000005010301";

    auto input_info = lane_to_slice_ifg_pif(port_5_for_bridge * 2);
    //------- arp packet
    sim_packet_info_desc punt_packet_desc
        = {.packet = arp_packet, .slice = input_info.slice, .ifg = input_info.ifg, .pif = input_info.pif};
    ...
    sai_object_id_t arp_trap;
    create_hostif_trap(arp_trap, SAI_HOSTIF_TRAP_TYPE_ARP_REQUEST, SAI_PACKET_ACTION_TRAP);
    this_thread::sleep_for(chrono::milliseconds{600});
