...
BoardInjectP4SviTest* injectp4svi_test;

void
setup_injectP4Svi()
{
    injectp4svi_test = new BoardInjectP4SviTest;
    injectp4svi_test->SetUp();
}

void
run_injectP4Svi()
{
    injectp4svi_test->basic_route();
}
