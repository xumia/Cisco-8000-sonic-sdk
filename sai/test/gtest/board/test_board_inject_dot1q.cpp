...
class BoardInjectL2GTest : public ::testing::Test
{
public:
    ...
    int port_3_for_bridge = 0;
    // int port_4_svi_router = 3;
    int port_5_for_bridge = 1;
    uint16_t VLAN_10 = 10;
};

TEST_F(BoardInjectL2GTest, basic_route)
{
    while (1) {
...
const char egress_packet[] = "00000033555500005d35a526080045000078000100007f00712652515ffa0c0a0c0a88888888888888"
        ...
        */
        ...
        status = hostif_api->send_hostif_packet(hostif_id, sizeof(ingress_packet) / 2, ingress_pkt_buf, 1, attr_list);
        ASSERT_EQ(status, SAI_STATUS_SUCCESS);

        sleep(20);

        /*
        const char ingress_packet_v10[] =
        "00000033555500005d35a5268100000a080045000078000100007f00712652515ffa0c0a0c0a88888888888888"
                                            "888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888"
                                            "888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888"
                                            "888888";
        ...
        status = hostif_api->send_hostif_packet(hostif_id, sizeof(ingress_packet_v10)/2, ingress_pkt_buf, 1, attr_list);
        ASSERT_EQ(status, SAI_STATUS_SUCCESS);
        sleep(20);
        */
    }
