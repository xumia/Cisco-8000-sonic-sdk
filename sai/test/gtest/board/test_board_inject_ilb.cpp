...
// this test is same as test_board_inject.cpp except MAC is in serdes ILB and SAI notification callback is connected.
...
class BoardInjectILBGTest : public ::testing::Test
{
public:
    static BoardInjectILBGTest* m_inst;
...
BoardInjectILBGTest* BoardInjectILBGTest::m_inst = nullptr;

TEST_F(BoardInjectILBGTest, basic_route)
{
