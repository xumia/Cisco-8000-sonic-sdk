...
private:
    ...
    la_status read_profile_map_table_line(la_slice_id_t slice, la_uint_t line, gibraltar::rx_cgm_profile_map_table_memory& out_mem);
    la_status write_profile_map_table_line(la_slice_id_t slice, la_uint_t line, gibraltar::rx_cgm_profile_map_table_memory& mem);
