...
public:
    ...
    la_status update_l3_lp_attributes(la_slice_pair_id_t slice_pair_idx,
    ...
    la_status update_l3_lp_attributes_tcam(la_slice_pair_id_t slice_pair_id,
    ...
    bool is_stack_remote_lp_queueing_enabled() const;
...
private:
    ...
    la_status configure_lp_attributes_table(la_slice_pair_id_t slice_pair_idx);
    la_status teardown_lp_attributes_table(la_slice_pair_id_t slice_pair_idx);
    ...
    // Logical Port Queueing state
    bool m_stack_remote_lp_queueing;
