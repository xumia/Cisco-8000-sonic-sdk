...
constexpr npl_counter_ptr_t NPU_COUNTER_NOP = {.update_or_read = 0, .cb_id = 0x3f, .cb_set_base = 0x0fff};

constexpr npl_counter_ptr_t NPU_COUNTER_INVALID = {.update_or_read = 0, .cb_id = 0x3f, .cb_set_base = 0x1fff};
