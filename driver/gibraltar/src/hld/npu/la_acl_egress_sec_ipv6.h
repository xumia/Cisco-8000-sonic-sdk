...
#ifndef __LA_ACL_EGRESS_SEC_IPV6_H__
#define __LA_ACL_EGRESS_SEC_IPV6_H__
...
class la_acl_egress_sec_ipv6 : public la_acl_delegate
{

    CEREAL_SUPPORT_PRIVATE_MEMBERS

public:
    explicit la_acl_egress_sec_ipv6(const la_device_impl_wptr& device, const la_acl_wptr& parent);
    ~la_acl_egress_sec_ipv6() override = default;
...
protected:
    using npl_table_t = npl_default_egress_ipv6_acl_sec_table_t;
...
private:
    la_acl_egress_sec_ipv6() = default; // For serialization purposes only.
};
}

#endif // __LA_ACL_EGRESS_SEC_IPV6_H__
