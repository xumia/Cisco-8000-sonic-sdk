...
#ifndef __GIBRALTAR_MAC_POOL_PORT_H__
#define __GIBRALTAR_MAC_POOL_PORT_H__
...
class gibraltar_mac_pool : public mac_pool_port
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit gibraltar_mac_pool(const la_device_impl_wptr& device);
    ~gibraltar_mac_pool();
    ...
    la_status post_anlt_complete(const std::unique_ptr<serdes_handler>& serdes_handler_ptr) override;
    la_status pre_tune_rx_pma_reset() override;
...
protected:
    gibraltar_mac_pool() = default; // Needed for cereal
    virtual void initialize_register_pointers() = 0;

private:
    la_status get_mac_config(mac_pool8_rx_mac_cfg0_register* rx_mac_cfg0_register,
                             mac_pool8_tx_mac_cfg0_register* tx_mac_cfg0_register) const;
    la_status set_mac_config(mac_pool8_rx_mac_cfg0_register* rx_mac_cfg0_register,
                             mac_pool8_tx_mac_cfg0_register* tx_mac_cfg0_register);
    la_status recalc_general_config(mac_pool8_tx_cfg0_register* tx_cfg_register,
                                    mac_pool8_rx_cfg0_register* rx_cfg_register,
                                    mac_pool8_am_cfg_register* am_cfg_register);
    la_status get_general_config(mac_pool8_tx_cfg0_register* tx_cfg_register,
                                 mac_pool8_rx_cfg0_register* rx_cfg_register,
                                 mac_pool8_am_cfg_register* am_cfg_register) const;
    la_status set_general_config(mac_pool8_tx_cfg0_register* tx_cfg_register,
                                 mac_pool8_rx_cfg0_register* rx_cfg_register,
                                 mac_pool8_am_cfg_register* am_cfg_register);
    la_status recalc_rs_fec_config(mac_pool8_rx_rsf_cfg0_register* rx_rsf_cfg0_register) const;
    la_status get_rs_fec_config(mac_pool8_rx_rsf_cfg0_register* rx_rsf_cfg0_register) const;
    la_status set_rs_fec_config(mac_pool8_rx_rsf_cfg0_register* rx_rsf_cfg0_register);
    la_status reset_rs_fec_config(mac_pool8_rx_rsf_cfg0_register* rx_rsf_cfg0_register);
...
protected:
    ...
    struct _mac_pool_regs_t {
        ...
        lld_register_array_scptr am_cfg;
        lld_register_array_scptr mac_lanes_loopback_register;
        lld_register_array_scptr pma_loopback_register;
        lld_register_array_scptr rsf_degraded_ser_cfg0;
        lld_register_array_scptr rx_ber_fsm_cfg;
        lld_register_array_scptr rx_cfg0;
        lld_register_array_scptr rx_high_ser_fsm_cfg;
        lld_register_array_scptr rx_krf_status;
        lld_register_array_scptr rx_krf_cfg;
        lld_register_array_scptr rx_mac_cfg0;
        lld_register_array_scptr rx_mac_cfg1;
        lld_register_array_scptr rx_pcs_test_cfg0;
        lld_register_array_scptr rx_pma_test_cfg0;
        lld_register_array_scptr rx_rsf_cfg0;
        lld_register_array_scptr rx_status_register;
        lld_register_array_scptr rx_status_lane_mapping;
        lld_register_array_scptr tx_cfg0;
        lld_register_array_scptr tx_mac_cfg0;
        lld_register_array_scptr tx_mac_ctrl_sa;
        lld_register_array_scptr tx_mac_cfg_ipg;
        lld_register_array_scptr tx_mac_fc_per_xoff_timer;
        lld_register_array_scptr tx_mac_fc_xoff_timer;
        lld_register_array_scptr tx_mac_fc_per_xon_timer;
        lld_register_array_scptr tx_mac_fc_xon_timer;
        lld_register_array_scptr tx_pcs_test_cfg0;
        lld_register_array_scptr tx_pma_test_cfg0;
        lld_register_array_scptr tx_oobi_cfg_reg;
    } m_mac_pool_regs;
    CEREAL_SUPPORT_PRIVATE_CLASS(_mac_pool_regs_t);

    // MAC pool counter registers
    struct _mac_pool_counters_t {
        lld_register_array_scptr rx_ber;
        lld_register_array_scptr rx_errored_blocks;
        lld_register_array_scptr port_mib;
        lld_register_array_scptr pcs_test;
        lld_register_array_scptr pma_read;
        lld_register_array_scptr pma_write;
        lld_register_array_scptr pma_test;
        lld_register_array_scptr krf_cor;
        lld_register_array_scptr krf_uncor;
        lld_register_array_scptr rsf_cor;
        lld_register_array_scptr rsf_uncor;
        lld_register_array_scptr rsf_debug;
        std::array<lld_register_array_scptr, RS_FEC_LANE_PER_PORT> rx_symb_err_lane_regs;
    } m_mac_pool_counters;
    ...
    struct _mac_pool_interrupt_regs_t {
        ...
        lld_register_scptr device_time_fif_ne_interrupt_register;
        ...
        lld_register_scptr device_time_fif_ne_interrupt_register_mask;
    ...
    gibraltar_tree_wcptr m_gibraltar_tree;
};
}

#endif // __GIBRALTAR_MAC_POOL_PORT_H__
