...
public:
    ...
    la_status get_fabric_port_num_in_device(la_uint_t& out_port_num) const;
...
private:
    ...
    la_status get_fabric_port_num_in_slice(la_uint_t& out_port_num_in_slice) const;
    ...
    la_status get_peer_delay_mem_entry(gibraltar::fte_peer_delay_mem_memory& out_peer_delay_mem_entry) const;
