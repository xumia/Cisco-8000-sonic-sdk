...
#ifndef __MAC_POOL8_PORT_H__
#define __MAC_POOL8_PORT_H__
...
class mac_pool8_port : public gibraltar_mac_pool
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit mac_pool8_port(const la_device_impl_wptr& device);
    ~mac_pool8_port();
...
protected:
    mac_pool8_port() = default; // Needed for cereal
