...
em_utils::get_entry_width(database_e db)
{
    ...
    case DATABASE_MAC_TERMINATION_EM:
        return 40 + 160;
    case DATABASE_RESOLUTION_STAGE0_EM:
        return 24 + 38;
    case DATABASE_RESOLUTION_STAGE1_EM:
    case DATABASE_RESOLUTION_STAGE2_EM:
        return 24 + 35;
    case DATABASE_RESOLUTION_STAGE3_EM:
        return 24 + 34;
    case DATABASE_DLP_PROFILE_EM:
        return 20 + 24;
    case DATABASE_LP_QUEUING_EM:
        return 56 + 19;
