...
private:
    ...
    gibraltar_tree::lld_memory_e get_memory_enum(const lld_block_scptr& block, const std::string& res_name);
    gibraltar_tree::lld_register_e get_register_enum(const lld_block_scptr& block, const std::string& res_name);
...
private:
    ...
    typedef std::map<std::string, gibraltar_tree::lld_memory_e> memory_desc_map_t;
    ...
    typedef std::map<std::string, gibraltar_tree::lld_register_e> register_desc_map_t;
