...
enum database_block_e {
    ...
    DATABASE_BLOCK_EXTERNAL_IDB_MACDB,
    DATABASE_BLOCK_EXTERNAL_IDB_ENCDB,
    DATABASE_BLOCK_EXTERNAL_RXPP_FWD,
    DATABASE_BLOCK_EXTERNAL_RXPP_FWD_FLC_QUEUES,
    DATABASE_BLOCK_EXTERNAL_RXPP_FWD_CDB_CACHE,
    DATABASE_BLOCK_EXTERNAL_RXPP_TERM,
    DATABASE_BLOCK_EXTERNAL_RXPP_TERM_FI_ENG,
    DATABASE_BLOCK_EXTERNAL_RXPP_TERM_FI_STAGE,
    DATABASE_BLOCK_EXTERNAL_RXPP_TERM_SNA,
    DATABASE_BLOCK_EXTERNAL_RXPP_TERM_FLC_DB,
    DATABASE_BLOCK_EXTERNAL_TXPP,
    DATABASE_BLOCK_EXTERNAL_ENE_CLUSTER,
    DATABASE_BLOCK_EXTERNAL_NPUH_HOST,
    DATABASE_BLOCK_EXTERNAL_NPUH_FI_ENG,
    DATABASE_BLOCK_EXTERNAL_PDVOQ_SLICE,
    DATABASE_BLOCK_EXTERNAL_DRAM_CGM,
...
enum database_e {
    ...
    DATABASE_RESOLUTION_STAGE0_EM,
    DATABASE_RESOLUTION_STAGE1_EM,
    DATABASE_RESOLUTION_STAGE2_EM,
    DATABASE_RESOLUTION_STAGE3_EM,
    DATABASE_RESOLUTION_STAGE0_MAP_TABLE_PBTS,
    DATABASE_RESOLUTION_STAGE1_MAP_TABLE_PBTS,
    DATABASE_RESOLUTION_STAGE2_MAP_TABLE_PBTS,
    DATABASE_RESOLUTION_STAGE3_MAP_TABLE_PBTS,
    DATABASE_DLP_PROFILE_EM,
    DATABASE_LP_QUEUING_EM,
