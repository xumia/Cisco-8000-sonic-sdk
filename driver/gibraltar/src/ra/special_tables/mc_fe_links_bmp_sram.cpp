...
{
    gibraltar_tree_scptr gb_tree = m_ll_device->get_gibraltar_tree_scptr();
    return (*gb_tree->rx_pdr_mc_db[shared_db_num]->shared_db_verifier)[shared_db_verifier_mem_num];
}
}
