...
command_callback_t arc2_command_callbacks[] = {
    // Example:
...
poll_callback_t arc2_poll_callbacks[] = {
    // Example:
...
void
set_arc2_command_callbacks(arc_context_t* ctx)
{
    ctx->command_callbacks = arc2_command_callbacks;
    ctx->command_callbacks_count = sizeof(arc2_command_callbacks) / sizeof(command_callback_t);
}

void
set_arc2_poll_callbacks(arc_context_t* ctx)
{
    ctx->poll_callbacks = arc2_poll_callbacks;
    ctx->poll_callbacks_count = sizeof(arc2_poll_callbacks) / sizeof(poll_callback_t);
