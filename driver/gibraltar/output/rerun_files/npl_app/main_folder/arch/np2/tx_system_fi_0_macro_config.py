...
def config_tables():
    ...
    table = txpp_fi_stage0_macro_config_table
    for line in table_data:
        key = txpp_fi_stage0_macro_config_table_key_t(fi_macro=line["key"])
        val = line["value"]
        conf_data = fi_macro_config_data_t(hw_logic_select=val[0],
                                           ...
                                           size_shift=val[7],
                                           size_mask=val[8])
        value = txpp_fi_stage0_macro_config_table_value_t(fi_macro_config_data=conf_data)
