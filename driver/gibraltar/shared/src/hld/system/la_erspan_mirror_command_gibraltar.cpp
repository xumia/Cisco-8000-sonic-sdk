...
la_erspan_mirror_command_gibraltar::la_erspan_mirror_command_gibraltar(const la_device_impl_wptr& device)
    : la_erspan_mirror_command_base(device)
{
}

la_erspan_mirror_command_gibraltar::~la_erspan_mirror_command_gibraltar()
{
}

la_status
la_erspan_mirror_command_gibraltar::populate_punt_encap_data(la_uint_t mirror_gid,
...
la_status
la_erspan_mirror_command_gibraltar::set_truncate(bool truncate)
{
...
la_status
la_erspan_mirror_command_gibraltar::configure_cud_entry(la_uint_t mirror_hw_id, la_uint_t mirror_gid, la_uint_t encap_ptr)
{
    return configure_mc_cud_table_entry(mirror_hw_id, mirror_gid, encap_ptr);
}

la_status
la_erspan_mirror_command_gibraltar::teardown_cud_entry(la_uint_t mirror_gid)
{
    return teardown_mc_cud_table_entry(mirror_gid);
}

la_status
la_erspan_mirror_command_gibraltar::configure_mc_cud_table_entry(la_uint_t mirror_hw_id, la_uint_t mirror_gid, la_uint_t encap_ptr)
{
...
la_status
la_erspan_mirror_command_gibraltar::teardown_mc_cud_table_entry(la_uint_t mirror_gid)
{
    npl_mc_cud_table_key_t k;
    k.cud_mapping_local_vars_exp_mc_copy_id_14_1_ = mc_copy_id_manager::get_mc_cud_table_key(mirror_gid);
...
la_status
la_erspan_mirror_command_gibraltar::configure_ibm_command_table(la_uint_t sampling_rate)
{
...
la_status
la_erspan_mirror_command_gibraltar::configure_mirror_to_dsp_in_npu_soft_header_table(uint8_t value)
{
...
la_status
la_erspan_mirror_command_gibraltar::teardown_mirror_to_dsp_in_npu_soft_header_table()
{
    const auto& table(m_device->m_tables.mirror_to_dsp_in_npu_soft_header_table);
