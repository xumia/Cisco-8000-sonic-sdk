...
#ifndef __LA_ERSPAN_MIRROR_COMMAND_GIBRALTAR_H__
#define __LA_ERSPAN_MIRROR_COMMAND_GIBRALTAR_H__
...
class la_erspan_mirror_command_gibraltar : public la_erspan_mirror_command_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_erspan_mirror_command_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_erspan_mirror_command_gibraltar(const la_device_impl_wptr& device);
    ~la_erspan_mirror_command_gibraltar() override;
...
#endif // __LA_ERSPAN_MIRROR_COMMAND_GIBRALTAR_H__
