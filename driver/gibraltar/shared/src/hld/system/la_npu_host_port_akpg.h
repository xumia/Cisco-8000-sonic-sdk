...
#ifndef __LA_NPU_HOST_PORT_AKPG_H__
#define __LA_NPU_HOST_PORT_AKPG_H__
...
class la_npu_host_port_akpg : public la_npu_host_port_base
{
public:
    explicit la_npu_host_port_akpg(const la_device_impl_wptr device);
    ~la_npu_host_port_akpg() override;
...
#endif // __LA_NPU_HOST_PORT_AKPG_H__
