...
#ifndef __DEVICE_PORT_HANDLER_PACIFIC_H__
#define __DEVICE_PORT_HANDLER_PACIFIC_H__
...
class device_port_handler_pacific : public device_port_handler_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    device_port_handler_pacific() = default; // Needed for cereal
public:
    device_port_handler_pacific(const la_device_impl_wptr& device);
    virtual ~device_port_handler_pacific();
...
#endif // __DEVICE_PORT_HANDLER_PACIFIC_H__
