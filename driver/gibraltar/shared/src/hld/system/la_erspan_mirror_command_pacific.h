...
#ifndef __LA_ERSPAN_MIRROR_COMMAND_PACIFIC_H__
#define __LA_ERSPAN_MIRROR_COMMAND_PACIFIC_H__
...
class la_erspan_mirror_command_pacific : public la_erspan_mirror_command_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_erspan_mirror_command_pacific() = default;
    //////////////////////////////
public:
    explicit la_erspan_mirror_command_pacific(const la_device_impl_wptr& device);
    ~la_erspan_mirror_command_pacific() override;

    la_status set_truncate(bool truncate) override;

protected:
    la_status populate_punt_encap_data(la_uint_t mirror_code,
...
#endif // __LA_ERSPAN_MIRROR_COMMAND_PACIFIC_H__
