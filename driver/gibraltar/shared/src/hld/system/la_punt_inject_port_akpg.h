...
#ifndef __LA_PUNT_INJECT_PORT_AKPG_H__
#define __LA_PUNT_INJECT_PORT_AKPG_H__
...
class la_punt_inject_port_akpg : public la_punt_inject_port_base
{
public:
    explicit la_punt_inject_port_akpg(const la_device_impl_wptr& device);
    ~la_punt_inject_port_akpg() override;
...
#endif // __LA_PUNT_INJECT_PORT_AKPG_H__
