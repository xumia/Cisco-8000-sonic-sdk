...
#ifndef __LA_SYSTEM_PORT_GIBRALTAR_H__
#define __LA_SYSTEM_PORT_GIBRALTAR_H__
...
class la_system_port_gibraltar : public la_system_port_pacgb
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_system_port_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_system_port_gibraltar(const la_device_impl_wptr& device);
    ~la_system_port_gibraltar() override;
    ...
    // Helper APIs.
    la_status get_delay_measurement_mapped_tc(la_traffic_class_t tc, la_traffic_class_t& out_mapped_tc);
    la_status do_read_egress_delay_and_cong_memory(la_traffic_class_t tc,
                                                   gibraltar::txpp_tod_port_max_delay_and_cong_memory& out_mem);
    la_status do_write_egress_delay_and_cong_memory(la_traffic_class_t tc, gibraltar::txpp_tod_port_max_delay_and_cong_memory& mem);
...
private:
    ...
    la_status fill_in_dsp_attr_key(npl_pif_ifg_base_t& omd_txpp, la_uint_t pif_offset);
...
#endif // __LA_SYSTEM_PORT_GIBRALTAR_H__
