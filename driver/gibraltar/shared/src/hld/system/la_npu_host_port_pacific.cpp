...
#include "la_npu_host_port_pacific.h"
...
la_npu_host_port_pacific::la_npu_host_port_pacific(const la_device_impl_wptr& device) : la_npu_host_port_base(device)
{
}

la_npu_host_port_pacific::~la_npu_host_port_pacific()
{
}

la_status
la_npu_host_port_pacific::initialize_remote(la_remote_device* remote_device,
...
la_status
la_npu_host_port_pacific::set_slice_source_pif_entry()
{
...
la_status
la_npu_host_port_pacific::erase_slice_source_pif_entry()
{
...
la_status
la_npu_host_port_pacific::initialize(la_object_id_t oid,
