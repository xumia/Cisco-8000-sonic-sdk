...
#ifndef __LA_L2_MIRROR_COMMAND_GIBRALTAR_H__
#define __LA_L2_MIRROR_COMMAND_GIBRALTAR_H__
...
class la_l2_mirror_command_gibraltar : public la_l2_mirror_command_pacgb
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_l2_mirror_command_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_l2_mirror_command_gibraltar(const la_device_impl_wptr& device);
    ~la_l2_mirror_command_gibraltar() override;
...
#endif // __LA_L2_MIRROR_COMMAND_GIBRALTAR_H__
