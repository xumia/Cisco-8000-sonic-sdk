...
#include "la_ethernet_port_pacific.h"
...
la_ethernet_port_pacific::la_ethernet_port_pacific(const la_device_impl_wptr& device) : la_ethernet_port_base(device)
{
}

la_ethernet_port_pacific::~la_ethernet_port_pacific()
{
}

la_status
la_ethernet_port_pacific::set_service_mapping_type(service_mapping_type_e type)
{
...
la_status
la_ethernet_port_pacific::set_source_pif_entry(const la_ac_profile_impl* ac_profile)
{
    ...
    if (m_spa_port != nullptr) {
        auto spa_port_pacific = m_spa_port.weak_ptr_static_cast<la_spa_port_pacific>();
...
la_ethernet_port_pacific::populate_mac_af_npp_attributes() const
{
...
la_status
la_ethernet_port_pacific::configure_security_group_policy_attributes()
{
    return LA_STATUS_SUCCESS;
}
