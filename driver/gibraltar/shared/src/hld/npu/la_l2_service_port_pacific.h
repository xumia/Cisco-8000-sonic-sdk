...
#ifndef __LEABA_LA_L2_SERVICE_PORT_PACIFIC_H__
#define __LEABA_LA_L2_SERVICE_PORT_PACIFIC_H__
...
class la_l2_service_port_pacific : public la_l2_service_port_pacgb
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_l2_service_port_pacific() = default;
    //////////////////////////////
public:
    explicit la_l2_service_port_pacific(const la_device_impl_wptr& device);
    ~la_l2_service_port_pacific() override;
    ...
    la_status get_fec_table_value(npl_native_fec_table_value_t& value) const;
...
private:
    ...
    la_status configure_native_l2_table();
    la_status teardown_native_l2_table();
    la_status configure_native_l2_table_vxlan(uint64_t ovl_nh_id);
    ...
    la_slice_id_vec_t pwe_get_slices() const;
...
private:
    ...
    struct slice_pair_data {
        /// L2 DLP table entry
        npl_l2_dlp_table_t::entry_wptr_type l2_dlp_entry;
        npl_vxlan_l2_dlp_table_t::entry_wptr_type vxlan_l2_dlp_entry;
