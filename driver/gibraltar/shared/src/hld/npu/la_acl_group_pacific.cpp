...
la_acl_group_pacific::la_acl_group_pacific(const la_device_impl_wptr& device) : la_acl_group_base(device)
{
}

la_acl_group_pacific::~la_acl_group_pacific()
{
}

npl_rtf_stage_and_type_e
la_acl_group_pacific::get_next_rtf_stage(la_acl_packet_format_e packet_format,
...
npl_rtf_stage_and_type_e
la_acl_group_pacific::get_init_eth_rtf_stage(la_acl_packet_format_e packet_format, const la_acl_wptr_vec_t& acls) const
{
    if (packet_format == la_acl_packet_format_e::ETHERNET) {
...
la_status
la_acl_group_pacific::get_post_fwd_rtf_stage(la_acl_packet_format_e packet_format,
                                             const la_acl_wptr_vec_t& acls,
