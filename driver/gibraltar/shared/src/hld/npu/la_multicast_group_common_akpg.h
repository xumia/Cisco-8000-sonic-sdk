...
#ifndef __LA_MULTICAST_GROUP_AKPG_H__
#define __LA_MULTICAST_GROUP_AKPG_H__
...
class la_multicast_group_common_akpg : public la_multicast_group_common_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit la_multicast_group_common_akpg(const la_device_impl_wptr& device);
    la_multicast_group_common_akpg() = default; // needed for cereal
    ~la_multicast_group_common_akpg() override;
...
#endif // __LA_MULTICAST_GROUP_AKPG_H__
