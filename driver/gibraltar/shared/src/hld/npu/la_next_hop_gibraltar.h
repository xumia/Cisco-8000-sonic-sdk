...
#ifndef __LA_NEXT_HOP_GIBRALTAR_H__
#define __LA_NEXT_HOP_GIBRALTAR_H__
...
class la_next_hop_gibraltar : public la_next_hop_pacgb
{
...
public:
    explicit la_next_hop_gibraltar(la_device_impl_wptr device);
    ~la_next_hop_gibraltar() override;
...
#endif // __LA_NEXT_HOP_GIBRALTAR_H__
