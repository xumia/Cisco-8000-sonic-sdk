...
#ifndef __LA_VXLAN_NEXT_HOP_PACIFIC_H__
#define __LA_VXLAN_NEXT_HOP_PACIFIC_H__
...
class la_vxlan_next_hop_pacific : public la_vxlan_next_hop_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_vxlan_next_hop_pacific() = default;
    //////////////////////////////
public:
    explicit la_vxlan_next_hop_pacific(const la_device_impl_wptr& device);
    ~la_vxlan_next_hop_pacific() override;
...
#endif // __LA_VXLAN_NEXT_HOP_PACIFIC_H__
