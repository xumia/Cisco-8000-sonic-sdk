...
#ifndef __LA_MULTICAST_GROUP_GIBRALTAR_H__
#define __LA_MULTICAST_GROUP_GIBRALTAR_H__
...
class la_multicast_group_common_gibraltar : public la_multicast_group_common_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit la_multicast_group_common_gibraltar(const la_device_impl_wptr& device);
    la_multicast_group_common_gibraltar() = default; // needed for cereal
    ~la_multicast_group_common_gibraltar() override;
...
private:
    ...
    // Egress replication helper functions
...
#endif // __LA_MULTICAST_GROUP_GIBRALTAR_H__
