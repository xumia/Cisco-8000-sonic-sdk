...
#ifndef __LA_L2_MULTICAST_GROUP_AKPG_H__
#define __LA_L2_MULTICAST_GROUP_AKPG_H__
...
#include "npu/la_multicast_group_common_akpg.h"
...
class la_l2_multicast_group_akpg : public la_l2_multicast_group_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit la_l2_multicast_group_akpg(la_device_impl_wptr device);
    ~la_l2_multicast_group_akpg() override;

private:
    la_l2_multicast_group_akpg() = default;
...
#endif // __LA_L2_MULTICAST_GROUP_AKPG_H__
