...
class test_l2_vxlan_encap_ipv4_security_group_acl_drop(vxlan_l2_single_port):
    ...
    def test_l2_vxlan_encap_ipv4_security_group_acl_drop(self):
        self.single_port_setup()
        self.set_l2_sgacl(False, True, True, True)  # monitor, drop, is_ipv4, is_encap
