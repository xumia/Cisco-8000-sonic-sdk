...
class test_l2_vxlan_decap_ipv6_security_group_acl_permit(vxlan_l2_single_port):
    ...
    def test_l2_vxlan_decap_ipv6_security_group_acl_permit(self):
        self.single_port_setup()
        self.set_l2_sgacl(False, False, False, False)  # monitor, drop, is_ipv4, is_encap
