...
class test_l3_vxlan_decap_ipv4_security_group_acl_permit(vxlan_l2_single_port):
    ...
    def test_l3_vxlan_decap_ipv4_security_group_acl_permit(self):
        self.create_recycle_ac_port()
        self.single_port_setup()
        self.sda_setup()
        self.set_l3_sgacl(False, False, True, False)  # monitor, drop, is_ipv4, is_encap
