...
class test_l3_vxlan_decap_ipv6_security_group_acl_drop(vxlan_l2_single_port):
    ...
    def test_l3_vxlan_decap_ipv6_security_group_acl_drop(self):
        self.create_recycle_ac_port()
        self.single_port_setup()
        self.sda_setup()
        self.set_l3_sgacl(False, True, False, False)  # monitor, drop, is_ipv4, is_encap
