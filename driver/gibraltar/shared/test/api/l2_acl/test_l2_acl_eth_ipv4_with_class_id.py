...
class test_l2_acl_eth_ipv4_with_class_id(test_l2_acl_ipv_base):
    ...
    def device_config_func(device, state):
        if state == sdk.la_device.init_phase_e_DEVICE:
            ...
            tcam_pool_id = 0
            test_l2_acl_eth_ipv4_with_class_id.acl_profile = device.create_acl_key_profile(
                key_type, direction, udk, tcam_pool_id)

    @classmethod
    def setUpClass(cls):
        super(test_l2_acl_eth_ipv4_with_class_id, cls).setUpClass(
            device_config_func=test_l2_acl_eth_ipv4_with_class_id.device_config_func)
    ...
    def create_class_id_acl(self):
        ...
        acl1 = self.device.create_acl(
            test_l2_acl_eth_ipv4_with_class_id.acl_profile,
        ...
        f1.val.class_id = test_l2_acl_eth_ipv4_with_class_id.CLASS_ID
