...
class ipv6_l3_ac_test(mpls_to_mpls_headend_base):
    ...
    INPUT_PACKET_BASE = \
        ...
        IPv6(src=SIP.addr_str, dst=DIP.addr_str, hlim=mpls_to_mpls_headend_base.IP_TTL)
    ...
    EXPECTED_OUTPUT_PHP_UNIFORM_PACKET_BASE = \
        ...
        IPv6(src=SIP.addr_str, dst=DIP.addr_str, hlim=mpls_to_mpls_headend_base.MPLS_TTL - 1)
    ...
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR - NP2 compound")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    @unittest.skipIf(decor.is_asic4(), "Test is not yet enabled on Asic4")
    def test_bgp_lu_dpe_ecmp_asbr_lsp_prot_group_to_mpls(self):
        self._test_bgp_lu_dpe_ecmp_asbr_lsp_prot_group_to_mpls()
