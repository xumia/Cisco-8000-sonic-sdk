...
class ipv4_svi_test(mpls_to_mpls_headend_base_disable_mpls_sr):
    ...
    INPUT_PACKET_BASE = Ether(dst=T.RX_SVI_MAC.addr_str,
                              src=mpls_to_mpls_headend_base_disable_mpls_sr.SA.addr_str,
                              type=U.Ethertype.Dot1Q.value) / Dot1Q(vlan=T.RX_L2_AC_PORT_VID1,
                                                                    type=U.Ethertype.MPLS.value) / MPLS(label=mpls_to_mpls_headend_base_disable_mpls_sr.INPUT_LABEL0.label,
                                                                                                        ttl=mpls_to_mpls_headend_base_disable_mpls_sr.MPLS_TTL) / IP(src=SIP.addr_str,
                                                                                                                                                                     dst=DIP.addr_str,
                                                                                                                                                                     ttl=mpls_to_mpls_headend_base_disable_mpls_sr.IP_TTL)
