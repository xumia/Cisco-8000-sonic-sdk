...
class test_mac_port_serdes_loopback(mac_port_loopback_base):
    def test_serdes_loopback(self):
        self.parallel_loopback_test(sdk.la_mac_port.loopback_mode_e_SERDES, do_warm_boot=True)
