...
class warm_boot_l3_ac_routing_sdk_down_kernel_module_up(sdk_test_case_base):
    ...
    def tearDown(self):
        ...
        super().tearDown()
        self.l3_port_impl_class = None
        self.l3_port_impl = None

    def test_warm_boot_ipv4_l3_ac_routing_em_sdk_down_kernel_module_up(self):
    ...
    def test_warm_boot_ipv4_l3_ac_routing_lpm_sdk_down_kernel_module_up(self):
        SIP = T.ipv4_addr('12.10.12.10')
        DIP = T.ipv4_addr('82.81.95.250')
    ...
    def test_warm_boot_ipv6_l3_ac_routing_em_sdk_down_kernel_module_up(self):
    ...
    def test_warm_boot_ipv6_l3_ac_routing_lpm_sdk_down_kernel_module_up(self):
        SIP = T.ipv6_addr('2222:0db8:0a0b:12f0:0000:0000:0000:2222')
        DIP = T.ipv6_addr('1111:0db8:0a0b:12f0:0000:0000:0000:1111')
