...
class ipv6_ingress_acl_class_id_320_base(sdk_test_case_base):
    l3_port_impl_class = T.ip_l3_ac_base
    ip_impl_class = ip_test_base.ipv6_test_base
    acl_key_profile_ipv6_320_class_id = None
    ...
    def device_config_func(device, state):
        if state == sdk.la_device.init_phase_e_DEVICE:
            ...
            udf2.type = sdk.la_acl_field_type_e_CLASS_ID
            udk.append(udf2)
            key_type = sdk.la_acl_key_type_e_IPV6
            direction = sdk.la_acl_direction_e_INGRESS
            tcam_pool_id = 0
            ipv6_ingress_acl_class_id_320_base.acl_key_profile_ipv6_320_class_id = device.create_acl_key_profile(
                key_type, direction, udk, tcam_pool_id)

    @classmethod
    def setUpClass(cls):
        super(ipv6_ingress_acl_class_id_320_base, cls).setUpClass(
            device_config_func=ipv6_ingress_acl_class_id_320_base.device_config_func)
    ...
    def create_lpm_class_id_unified_acl(self):
        ...
        acl1 = self.device.create_acl(
            ipv6_ingress_acl_class_id_320_base.acl_key_profile_ipv6_320_class_id,
        ...
        q0 = sdk.get_ipv6_addr_q0(SIP.hld_obj)
        q1 = sdk.get_ipv6_addr_q1(SIP.hld_obj)
        # Should not catch
        ...
        f2.val.class_id = ipv6_ingress_acl_class_id_320_base.CLASS_ID
    ...
    def create_host_class_id_unified_acl(self):
        ...
        f2 = sdk.la_acl_field()
        f2.type = sdk.la_acl_field_type_e_CLASS_ID
        f2.val.class_id = ipv6_ingress_acl_class_id_320_base.CLASS_ID_HOST
