...
class ipv6_ingress_acl_udk_320_base(sdk_test_case_base):
    ...
    @classmethod
    def setUpClass(cls):
        super(ipv6_ingress_acl_udk_320_base, cls).setUpClass()
    ...
    def insert_ace(self, acl, is_drop, is_punt, l3_dest):
        ...
        if (is_punt):
            action2 = sdk.la_acl_command_action()
            action2.type = sdk.la_acl_action_type_e_FORCE_PUNT
