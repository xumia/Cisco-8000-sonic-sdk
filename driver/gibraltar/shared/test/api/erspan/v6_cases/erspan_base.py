...
TUNNEL_DSCP = 46
TRAFFIC_CLASS = 0
TUNNEL_DEST = T.ipv6_addr('3222:0db8:0a0b:12f0:1234:aabb:ccdd:eeff')
TUNNEL_SOURCE = T.ipv6_addr('2111:0db8:0a0b:12f0:0000:0000:0000:0000')
...
NEW_TUNNEL_TTL = 250
NEW_TUNNEL_DSCP = 47
NEW_TUNNEL_DEST = T.ipv6_addr('3222:0db8:0a0b:2222:1234:5678:9abc:deff')
NEW_TUNNEL_SOURCE = T.ipv6_addr('2111:0db8:2222:12f0:0000:0000:0000:0000')
NEW_VOQ_OFFSET = 5
...
class erspan_base(sdk_test_case_base):
    ...
    def add_l3_acl(self, *, is_mirror=True, is_drop=False):
        ...
        acl_drop = sdk.la_acl_command_action()
        acl_drop.type = sdk.la_acl_action_type_e_DROP
        acl_drop.data.drop = is_drop
        acl_cmd.append(acl_drop)
