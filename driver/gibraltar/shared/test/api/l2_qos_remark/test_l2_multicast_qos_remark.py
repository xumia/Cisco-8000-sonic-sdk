...
OUT_IFG1 = 0
OUT_SERDES_FIRST1 = T.get_device_next_first_serdes(12)
...
class test_l2_multicast_qos_remark(sdk_test_case_base):
    ...
    def create_packets(self):
        ...
        in_packet_base = Ether(dst=DST_MAC, src=SRC_MAC, type=Ethertype.Dot1Q.value) / \
            ...
            IPvX(ipvx='v4', src=SIP.addr_str, dst=DIP.addr_str,
    ...
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_l2_multicast_qos_remarking(self):
        ...
        ingress_qos_profile.hld_obj.set_qos_tag_mapping_pcpdei(IN_PCPDEI, TAG_PCPDEI)

        # Prepare remarking of IN_PCPDEI -> OUT_PCPDEI
        encap_qos_values = sdk.encapsulating_headers_qos_values()
        egress_qos_profile.hld_obj.set_qos_tag_mapping_pcpdei(TAG_PCPDEI, OUT_PCPDEI, encap_qos_values)
        ...
        self.ac_profile.hld_obj.set_qos_mode_per_format(pvf, sdk.la_ac_profile.qos_mode_e_L2)
