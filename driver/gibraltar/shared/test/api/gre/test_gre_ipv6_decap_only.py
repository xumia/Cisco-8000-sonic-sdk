...
class test_gre_ipv6_decap_only(gre_ipv6_base):
    ...
    def test_gre_port_decap_termination_negative(self):
        self.gre_port_single_underlay_path(sdk.la_ip_tunnel_mode_e_DECAP_ONLY)
        self._test_gre_port_decap_termination_negative(sdk.la_ip_tunnel_mode_e_ENCAP_DECAP)
    ...
    def test_gre_decap_ecmp(self):
        ...
        self._test_gre_port_decap_ecmp(sdk.la_l3_protocol_e_IPV6_UC)
