...
class test_mac_port_remote_pma_loopback(mac_port_loopback_base):
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR")
    def test_remote_pma_loopback(self):
        self.parallel_loopback_test(sdk.la_mac_port.loopback_mode_e_REMOTE_PMA)
