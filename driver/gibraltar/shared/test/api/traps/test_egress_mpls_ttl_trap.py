...
class egress_mpls_ttl_trap(TrapsTest):
    IP_TTL = 128
    MPLS_TTL_1 = 1
    ...
    def setUp(self):
        ...
        self.device.set_trap_configuration(sdk.LA_EVENT_MPLS_INVALID_TTL, 0, self.stat_meter, self.punt_dest, False, False, True, 0)
    ...
    def test_egress_mpls_ttl_trap(self):
        ...
        U.run_and_compare(self, self.device,
                          self.INPUT_PACKET_TTL_1, T.RX_SLICE, T.RX_IFG, T.FIRST_SERDES,
        ...
        nhlfe = self.device.create_mpls_swap_nhlfe(nh, self.OUTPUT_LABEL)
