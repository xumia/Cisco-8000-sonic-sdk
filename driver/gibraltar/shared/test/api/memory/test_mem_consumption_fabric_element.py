...
HW_EXPECTED_MEM_CONSUMPTION = 560000
SIM_EXPECTED_MEM_CONSUMPTION = 750000
FABRIC_ELEMENT_EXPECTED_MEM_CONSUMPTION = HW_EXPECTED_MEM_CONSUMPTION if decor.is_hw_device() else SIM_EXPECTED_MEM_CONSUMPTION
...
class test_mem_consumption_fabric_element(mem_consumption_base):

    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_mode_fe(self):
        import sim_utils
        self._test_mem(sim_utils.FABRIC_ELEMENT_DEV, FABRIC_ELEMENT_EXPECTED_MEM_CONSUMPTION)
