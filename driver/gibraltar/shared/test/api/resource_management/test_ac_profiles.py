...
class ac_profiles(resource_handler_base):

    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_ac_profiles(self):
        rd = sdk.la_resource_descriptor()
        rd.m_resource_type = sdk.la_resource_descriptor.type_e_AC_PROFILE
        ...
        res = self.device.get_granularity(sdk.la_resource_descriptor.type_e_AC_PROFILE)
        self.assertEqual(res, sdk.la_resource_granularity_DEVICE)
