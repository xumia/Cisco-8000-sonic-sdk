...
class ipv4_known_unicast_routing_pkt_count(ip_routing_counters_base):
    ...
    def test_counter_route_single_nh_pkt_count(self):
        self._test_counter_route_single_nh_pkt_count()
