...
class ipv6_svi_counters_ip_routing_counters(ip_routing_counters_base):
    ...
    INPUT_PACKET_BASE = \
        ...
        S.IPv6(src=SIP.addr_str, dst=DIP.addr_str, hlim=ip_routing_counters_base.TTL, plen=40) / \
    ...
    EXPECTED_OUTPUT_PACKET_BASE = \
        ...
        S.IPv6(src=SIP.addr_str, dst=DIP.addr_str, hlim=ip_routing_counters_base.TTL - 1, plen=40) / \
        S.Raw(load=0xdeadbeefdeadbeefdeadbeefdeadbeef)
