...
#ifndef __LA_IP_OVER_IP_TUNNEL_PORT_H__
#define __LA_IP_OVER_IP_TUNNEL_PORT_H__
...
///
/// Defines API-s for managing a L3 Tunnel port object.

class la_ip_over_ip_tunnel_port : public la_ip_tunnel_port
{

public:
    /// DIP entropy mode.
    enum class la_ip_tunnel_dip_entropy_mode_e {
        IP_TUNNEL_DIP_ENTROPY_NONE, ///< DIP entropy disabled (32-bit DIP).
        IP_TUNNEL_DIP_ENTROPY_24,   ///< 8-bit DIP entropy (24-bit DIP).
        IP_TUNNEL_DIP_ENTROPY_28    ///< 4-bit DIP entropy (28-bit DIP).
    };
...
protected:
    ~la_ip_over_ip_tunnel_port() override = default;
    /// @}
};

} // namepace leaba

#endif // __LA_IP_OVER_IP_TUNNEL_PORT_H__
