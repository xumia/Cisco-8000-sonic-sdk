...
template <class Archive> void save(Archive&, const npl_ip_sgt_em_result_t_anonymous_union_result_t&);
template <class Archive> void load(Archive&, npl_ip_sgt_em_result_t_anonymous_union_result_t&);
...
template <class Archive> void save(Archive&, const npl_l2_mc_cud_narrow_t&);
template <class Archive> void load(Archive&, npl_l2_mc_cud_narrow_t&);
...
template <class Archive> void save(Archive&, const npl_l3_dlp_t&);
template <class Archive> void load(Archive&, npl_l3_dlp_t&);
...
template <class Archive> void save(Archive&, const npl_mark_color_t&);
template <class Archive> void load(Archive&, npl_mark_color_t&);
...
template <class Archive> void save(Archive&, const npl_minimal_l3_lp_attributes_t_anonymous_union_disable_mpls_or_mc_tunnel_t&);
template <class Archive> void load(Archive&, npl_minimal_l3_lp_attributes_t_anonymous_union_disable_mpls_or_mc_tunnel_t&);
...
template <class Archive> void save(Archive&, const npl_padding_or_ipv6_len_t&);
template <class Archive> void load(Archive&, npl_padding_or_ipv6_len_t&);
...
template <class Archive> void save(Archive&, const npl_punt_if_sa_or_npu_host_data_t&);
template <class Archive> void load(Archive&, npl_punt_if_sa_or_npu_host_data_t&);
...
template <class Archive> void save(Archive&, const npl_punt_padding_id_t&);
template <class Archive> void load(Archive&, npl_punt_padding_id_t&);
...
template <class Archive> void save(Archive&, const npl_resolution_stage_assoc_data_narrow_protection_record_t&);
template <class Archive> void load(Archive&, npl_resolution_stage_assoc_data_narrow_protection_record_t&);

template <class Archive> void save(Archive&, const npl_resolution_stage_assoc_data_raw_t&);
template <class Archive> void load(Archive&, npl_resolution_stage_assoc_data_raw_t&);
...
template <class Archive> void save(Archive&, const npl_rxpp_pd_forward_destination_t&);
template <class Archive> void load(Archive&, npl_rxpp_pd_forward_destination_t&);

template <class Archive> void save(Archive&, const npl_rxpp_pd_t_anonymous_union_lb_or_slb_t&);
template <class Archive> void load(Archive&, npl_rxpp_pd_t_anonymous_union_lb_or_slb_t&);

template <class Archive> void save(Archive&, const npl_rxpp_pd_t_anonymous_union_slice_mode_data_t&);
template <class Archive> void load(Archive&, npl_rxpp_pd_t_anonymous_union_slice_mode_data_t&);
...
template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_destination_vpn_inter_as_ce_ptr_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_destination_vpn_inter_as_ce_ptr_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_l3_nh_ip_tunnel_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_l3_nh_ip_tunnel_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_l3_nh_vpn_inter_as_ce_ptr_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_l3_nh_vpn_inter_as_ce_ptr_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_l3_nh_vpn_inter_as_ce_ptr_with_common_data_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_l3_nh_vpn_inter_as_ce_ptr_with_common_data_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_level2_ecmp_ip_tunnel_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_level2_ecmp_ip_tunnel_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_p_l3_nh_vpn_inter_as_ce_ptr_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_p_l3_nh_vpn_inter_as_ce_ptr_t&);

template <class Archive> void save(Archive&, const npl_stage0_ce_ptr_p_l3_nh_vpn_inter_as_ce_ptr_with_common_data_t&);
template <class Archive> void load(Archive&, npl_stage0_ce_ptr_p_l3_nh_vpn_inter_as_ce_ptr_with_common_data_t&);

template <class Archive> void save(Archive&, const npl_stage0_destination1_t&);
template <class Archive> void load(Archive&, npl_stage0_destination1_t&);

template <class Archive> void save(Archive&, const npl_stage0_ecmp_destination_t&);
template <class Archive> void load(Archive&, npl_stage0_ecmp_destination_t&);

template <class Archive> void save(Archive&, const npl_stage0_l2_dlp_destination_overlay_nh_t&);
template <class Archive> void load(Archive&, npl_stage0_l2_dlp_destination_overlay_nh_t&);

template <class Archive> void save(Archive&, const npl_stage0_l2_dlp_destination_t&);
template <class Archive> void load(Archive&, npl_stage0_l2_dlp_destination_t&);

template <class Archive> void save(Archive&, const npl_stage0_l3_nh_vpn_inter_as_ce_ptr_with_common_data1_t&);
template <class Archive> void load(Archive&, npl_stage0_l3_nh_vpn_inter_as_ce_ptr_with_common_data1_t&);

template <class Archive> void save(Archive&, const npl_stage0_narrow_raw_t&);
template <class Archive> void load(Archive&, npl_stage0_narrow_raw_t&);

template <class Archive> void save(Archive&, const npl_stage0_p_l3_nh_vpn_inter_as_ce_ptr_with_common_data1_t&);
template <class Archive> void load(Archive&, npl_stage0_p_l3_nh_vpn_inter_as_ce_ptr_with_common_data1_t&);

template <class Archive> void save(Archive&, const npl_stage1_destination1_t&);
template <class Archive> void load(Archive&, npl_stage1_destination1_t&);

template <class Archive> void save(Archive&, const npl_stage1_l3_nh_te_tunnel14b_or_asbr1_t&);
template <class Archive> void load(Archive&, npl_stage1_l3_nh_te_tunnel14b_or_asbr1_t&);

template <class Archive> void save(Archive&, const npl_stage1_l3_nh_te_tunnel14b_or_asbr2_t&);
template <class Archive> void load(Archive&, npl_stage1_l3_nh_te_tunnel14b_or_asbr2_t&);

template <class Archive> void save(Archive&, const npl_stage1_level2_ecmp_destination_t&);
template <class Archive> void load(Archive&, npl_stage1_level2_ecmp_destination_t&);

template <class Archive> void save(Archive&, const npl_stage1_level2_ecmp_l3_nh_te_tunnel14b_or_asbr_t&);
template <class Archive> void load(Archive&, npl_stage1_level2_ecmp_l3_nh_te_tunnel14b_or_asbr_t&);

template <class Archive> void save(Archive&, const npl_stage2_l3_nh_destination_l3_dlp_dlp_attr_t&);
template <class Archive> void load(Archive&, npl_stage2_l3_nh_destination_l3_dlp_dlp_attr_t&);

template <class Archive> void save(Archive&, const npl_stage2_l3_nh_destination_l3_dlp_t&);
template <class Archive> void load(Archive&, npl_stage2_l3_nh_destination_l3_dlp_t&);

template <class Archive> void save(Archive&, const npl_stage2_wide_raw_t&);
template <class Archive> void load(Archive&, npl_stage2_wide_raw_t&);

template <class Archive> void save(Archive&, const npl_stage3_dspa_destination_t&);
template <class Archive> void load(Archive&, npl_stage3_dspa_destination_t&);

template <class Archive> void save(Archive&, const npl_stage3_narrow_raw_t&);
template <class Archive> void load(Archive&, npl_stage3_narrow_raw_t&);
...
template <class Archive> void save(Archive&, const npl_svl_mc_data_t&);
template <class Archive> void load(Archive&, npl_svl_mc_data_t&);

template <class Archive> void save(Archive&, const npl_svl_uc_data_t&);
template <class Archive> void load(Archive&, npl_svl_uc_data_t&);
...
template <class Archive> void save(Archive&, const npl_wfq_weight_4p_entry_t&);
template <class Archive> void load(Archive&, npl_wfq_weight_4p_entry_t&);

template <class Archive> void save(Archive&, const npl_wfq_weight_8p_t&);
template <class Archive> void load(Archive&, npl_wfq_weight_8p_t&);

template <class Archive> void save(Archive&, const npl_wide_protection_entry_t&);
template <class Archive> void load(Archive&, npl_wide_protection_entry_t&);
...
template<>
class serializer_class<npl_resolution_stage_assoc_data_narrow_entry_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_entry_t& m) {
            archive(::cereal::make_nvp("stage0_ce_ptr_l3_nh_ip_tunnel", m.stage0_ce_ptr_l3_nh_ip_tunnel));
            archive(::cereal::make_nvp("stage0_ce_ptr_level2_ecmp_ip_tunnel", m.stage0_ce_ptr_level2_ecmp_ip_tunnel));
            archive(::cereal::make_nvp("stage0_l2_dlp_dest", m.stage0_l2_dlp_dest));
            archive(::cereal::make_nvp("stage0_ce_ptr_nh_no_tunnel", m.stage0_ce_ptr_nh_no_tunnel));
            archive(::cereal::make_nvp("stage0_ce_ptr_nh_te_he", m.stage0_ce_ptr_nh_te_he));
            archive(::cereal::make_nvp("stage0_ce_ptr_nh_ldp_over_te", m.stage0_ce_ptr_nh_ldp_over_te));
            archive(::cereal::make_nvp("stage0_ce_ptr_p_nh_no_tunnel", m.stage0_ce_ptr_p_nh_no_tunnel));
            archive(::cereal::make_nvp("stage0_ce_ptr_p_nh_te_he", m.stage0_ce_ptr_p_nh_te_he));
            archive(::cereal::make_nvp("stage0_ce_ptr_p_nh_ldp_over_te", m.stage0_ce_ptr_p_nh_ldp_over_te));
            archive(::cereal::make_nvp("stage0_ecmp_dest", m.stage0_ecmp_dest));
            archive(::cereal::make_nvp("stage0_destination_overlay_nh", m.stage0_destination_overlay_nh));
            archive(::cereal::make_nvp("stage0_dest1", m.stage0_dest1));
            archive(::cereal::make_nvp("stage0_raw", m.stage0_raw));
            archive(::cereal::make_nvp("stage1_ecmp_dest", m.stage1_ecmp_dest));
            archive(::cereal::make_nvp("stage1_ecmp_dest1", m.stage1_ecmp_dest1));
            archive(::cereal::make_nvp("stage1_ecmp_tunnel_or_asbr_he_with_tunnel_id", m.stage1_ecmp_tunnel_or_asbr_he_with_tunnel_id));
            archive(::cereal::make_nvp("stage1_ecmp_tunnel_or_asbr_ldp_over_te", m.stage1_ecmp_tunnel_or_asbr_ldp_over_te));
            archive(::cereal::make_nvp("stage1_ecmp_lsp_asbr_nh", m.stage1_ecmp_lsp_asbr_nh));
            archive(::cereal::make_nvp("stage3_dspa_dest", m.stage3_dspa_dest));
            archive(::cereal::make_nvp("stage3_raw", m.stage3_raw));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_narrow_entry_t& m) {
            archive(::cereal::make_nvp("stage0_ce_ptr_l3_nh_ip_tunnel", m.stage0_ce_ptr_l3_nh_ip_tunnel));
            archive(::cereal::make_nvp("stage0_ce_ptr_level2_ecmp_ip_tunnel", m.stage0_ce_ptr_level2_ecmp_ip_tunnel));
            archive(::cereal::make_nvp("stage0_l2_dlp_dest", m.stage0_l2_dlp_dest));
            archive(::cereal::make_nvp("stage0_ce_ptr_nh_no_tunnel", m.stage0_ce_ptr_nh_no_tunnel));
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_entry_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_entry_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_narrow_entry_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_narrow_entry_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_entry_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_narrow_entry_t&);



template<>
class serializer_class<npl_resolution_stage_assoc_data_narrow_line_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("entry", m.entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_narrow_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("entry", m.entry));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_line_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_narrow_line_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_narrow_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_line_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_narrow_line_t&);



template<>
class serializer_class<npl_resolution_stage_assoc_data_narrow_protection_line_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_protection_line_t& m) {
        uint64_t m_id = m.id;
        uint64_t m_const1 = m.const1;
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("id", m_id));
            archive(::cereal::make_nvp("const1", m_const1));
            archive(::cereal::make_nvp("record", m.record));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_narrow_protection_line_t& m) {
        uint64_t m_id;
        uint64_t m_const1;
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("id", m_id));
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_narrow_protection_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_protection_line_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_narrow_protection_line_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_narrow_protection_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_narrow_protection_line_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_narrow_protection_line_t&);



template<>
class serializer_class<npl_resolution_stage_assoc_data_wide_entry_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_wide_entry_t& m) {
            archive(::cereal::make_nvp("stage0_ce_ptr_ecmp2", m.stage0_ce_ptr_ecmp2));
            archive(::cereal::make_nvp("stage2_l3_nh_dlp_bvn_profile", m.stage2_l3_nh_dlp_bvn_profile));
            archive(::cereal::make_nvp("stage2_l3_nh_dlp", m.stage2_l3_nh_dlp));
            archive(::cereal::make_nvp("stage2_raw", m.stage2_raw));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_wide_entry_t& m) {
            archive(::cereal::make_nvp("stage0_ce_ptr_ecmp2", m.stage0_ce_ptr_ecmp2));
            archive(::cereal::make_nvp("stage2_l3_nh_dlp_bvn_profile", m.stage2_l3_nh_dlp_bvn_profile));
            archive(::cereal::make_nvp("stage2_l3_nh_dlp", m.stage2_l3_nh_dlp));
            archive(::cereal::make_nvp("stage2_raw", m.stage2_raw));
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_wide_entry_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_entry_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_wide_entry_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_wide_entry_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_entry_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_wide_entry_t&);



template<>
class serializer_class<npl_resolution_stage_assoc_data_wide_line_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_wide_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("entry", m.entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_wide_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("entry", m.entry));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_wide_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_line_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_wide_line_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_wide_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_line_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_wide_line_t&);



template<>
class serializer_class<npl_resolution_stage_assoc_data_wide_protection_record_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_wide_protection_record_t& m) {
        uint64_t m_id = m.id;
            archive(::cereal::make_nvp("id", m_id));
            archive(::cereal::make_nvp("path", m.path));
            archive(::cereal::make_nvp("primary_entry", m.primary_entry));
            archive(::cereal::make_nvp("protect_entry", m.protect_entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_wide_protection_record_t& m) {
        uint64_t m_id;
            archive(::cereal::make_nvp("id", m_id));
            archive(::cereal::make_nvp("path", m.path));
            archive(::cereal::make_nvp("primary_entry", m.primary_entry));
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_wide_protection_record_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_protection_record_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_wide_protection_record_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_wide_protection_record_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_protection_record_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_wide_protection_record_t&);



template<>
class serializer_class<npl_resolution_stage_em_table_key_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_em_table_key_t& m) {
            archive(::cereal::make_nvp("dest_map_key", m.dest_map_key));
            archive(::cereal::make_nvp("lb_key", m.lb_key));
            archive(::cereal::make_nvp("raw_key", m.raw_key));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_em_table_key_t& m) {
            archive(::cereal::make_nvp("dest_map_key", m.dest_map_key));
            archive(::cereal::make_nvp("lb_key", m.lb_key));
            archive(::cereal::make_nvp("raw_key", m.raw_key));
    }
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_em_table_key_t& m)
{
    serializer_class<npl_resolution_stage_em_table_key_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_em_table_key_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_em_table_key_t& m)
{
    serializer_class<npl_resolution_stage_em_table_key_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_em_table_key_t&);
...
template<>
class serializer_class<npl_rxpp_pd_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_rxpp_pd_t& m) {
        uint64_t m_source_if = m.source_if;
        uint64_t m_drop_flag = m.drop_flag;
        uint64_t m_in_mirror_cmd0 = m.in_mirror_cmd0;
        uint64_t m_tc = m.tc;
        uint64_t m_in_color = m.in_color;
        uint64_t m_counter_meter_ptr_0 = m.counter_meter_ptr_0;
        uint64_t m_counter_meter_comp_0 = m.counter_meter_comp_0;
        uint64_t m_counter_lm_read_only_0 = m.counter_lm_read_only_0;
        uint64_t m_ethernet_rate_limiter_type = m.ethernet_rate_limiter_type;
        uint64_t m_packet_learn_enable = m.packet_learn_enable;
        uint64_t m_snr_context = m.snr_context;
        uint64_t m_snr_psn = m.snr_psn;
        uint64_t m_snr_out_slice = m.snr_out_slice;
            archive(::cereal::make_nvp("source_if", m_source_if));
            archive(::cereal::make_nvp("drop_flag", m_drop_flag));
            archive(::cereal::make_nvp("fwd_destination", m.fwd_destination));
            archive(::cereal::make_nvp("in_mirror_cmd0", m_in_mirror_cmd0));
            archive(::cereal::make_nvp("tc", m_tc));
            archive(::cereal::make_nvp("in_color", m_in_color));
            archive(::cereal::make_nvp("counter_meter_ptr_0", m_counter_meter_ptr_0));
            archive(::cereal::make_nvp("counter_meter_comp_0", m_counter_meter_comp_0));
            archive(::cereal::make_nvp("counter_lm_read_only_0", m_counter_lm_read_only_0));
            archive(::cereal::make_nvp("ethernet_rate_limiter_type", m_ethernet_rate_limiter_type));
            archive(::cereal::make_nvp("packet_learn_enable", m_packet_learn_enable));
            archive(::cereal::make_nvp("snr_context", m_snr_context));
            archive(::cereal::make_nvp("snr_psn", m_snr_psn));
            archive(::cereal::make_nvp("snr_out_slice", m_snr_out_slice));
            archive(::cereal::make_nvp("lb_or_slb", m.lb_or_slb));
            archive(::cereal::make_nvp("slice_mode_data", m.slice_mode_data));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_rxpp_pd_t& m) {
        uint64_t m_source_if;
        uint64_t m_drop_flag;
        uint64_t m_in_mirror_cmd0;
        uint64_t m_tc;
        uint64_t m_in_color;
        uint64_t m_counter_meter_ptr_0;
        uint64_t m_counter_meter_comp_0;
        uint64_t m_counter_lm_read_only_0;
        uint64_t m_ethernet_rate_limiter_type;
        uint64_t m_packet_learn_enable;
        uint64_t m_snr_context;
        uint64_t m_snr_psn;
        uint64_t m_snr_out_slice;
            archive(::cereal::make_nvp("source_if", m_source_if));
            archive(::cereal::make_nvp("drop_flag", m_drop_flag));
            archive(::cereal::make_nvp("fwd_destination", m.fwd_destination));
            archive(::cereal::make_nvp("in_mirror_cmd0", m_in_mirror_cmd0));
            ...
            archive(::cereal::make_nvp("lb_or_slb", m.lb_or_slb));
            archive(::cereal::make_nvp("slice_mode_data", m.slice_mode_data));
        m.source_if = m_source_if;
        m.drop_flag = m_drop_flag;
        m.in_mirror_cmd0 = m_in_mirror_cmd0;
        m.tc = m_tc;
        m.in_color = m_in_color;
        m.counter_meter_ptr_0 = m_counter_meter_ptr_0;
        m.counter_meter_comp_0 = m_counter_meter_comp_0;
        m.counter_lm_read_only_0 = m_counter_lm_read_only_0;
        m.ethernet_rate_limiter_type = m_ethernet_rate_limiter_type;
        m.packet_learn_enable = m_packet_learn_enable;
        m.snr_context = m_snr_context;
        m.snr_psn = m_snr_psn;
        m.snr_out_slice = m_snr_out_slice;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_rxpp_pd_t& m)
{
    serializer_class<npl_rxpp_pd_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_rxpp_pd_t&);

template <class Archive>
void
load(Archive& archive, npl_rxpp_pd_t& m)
{
    serializer_class<npl_rxpp_pd_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_rxpp_pd_t&);
...
template<>
class serializer_class<npl_sgt_matrix_padded_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_sgt_matrix_padded_result_t& m) {
            archive(::cereal::make_nvp("sgt_matrix_em_result", m.sgt_matrix_em_result));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_sgt_matrix_padded_result_t& m) {
            archive(::cereal::make_nvp("sgt_matrix_em_result", m.sgt_matrix_em_result));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_sgt_matrix_padded_result_t& m)
{
    serializer_class<npl_sgt_matrix_padded_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_sgt_matrix_padded_result_t&);

template <class Archive>
void
load(Archive& archive, npl_sgt_matrix_padded_result_t& m)
{
    serializer_class<npl_sgt_matrix_padded_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_sgt_matrix_padded_result_t&);
...
template<>
class serializer_class<npl_svl_data_t_anonymous_union_svl_uc_mc_data_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_svl_data_t_anonymous_union_svl_uc_mc_data_t& m) {
            archive(::cereal::make_nvp("svl_uc_data", m.svl_uc_data));
            archive(::cereal::make_nvp("svl_mc_data", m.svl_mc_data));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_svl_data_t_anonymous_union_svl_uc_mc_data_t& m) {
            archive(::cereal::make_nvp("svl_uc_data", m.svl_uc_data));
            archive(::cereal::make_nvp("svl_mc_data", m.svl_mc_data));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_svl_data_t_anonymous_union_svl_uc_mc_data_t& m)
{
    serializer_class<npl_svl_data_t_anonymous_union_svl_uc_mc_data_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_svl_data_t_anonymous_union_svl_uc_mc_data_t&);

template <class Archive>
void
load(Archive& archive, npl_svl_data_t_anonymous_union_svl_uc_mc_data_t& m)
{
    serializer_class<npl_svl_data_t_anonymous_union_svl_uc_mc_data_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_svl_data_t_anonymous_union_svl_uc_mc_data_t&);
...
template<>
class serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t& m) {
        uint64_t m_mark_green_u = m.mark_green_u;
            archive(::cereal::make_nvp("mark_green", m.mark_green));
            archive(::cereal::make_nvp("mark_green_u", m_mark_green_u));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t& m) {
        uint64_t m_mark_green_u;
            archive(::cereal::make_nvp("mark_green", m.mark_green));
            archive(::cereal::make_nvp("mark_green_u", m_mark_green_u));
        m.mark_green_u = m_mark_green_u;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_g_t&);



template<>
class serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t& m) {
        uint64_t m_mark_yellow_u = m.mark_yellow_u;
            archive(::cereal::make_nvp("mark_yellow", m.mark_yellow));
            archive(::cereal::make_nvp("mark_yellow_u", m_mark_yellow_u));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t& m) {
        uint64_t m_mark_yellow_u;
            archive(::cereal::make_nvp("mark_yellow", m.mark_yellow));
            archive(::cereal::make_nvp("mark_yellow_u", m_mark_yellow_u));
        m.mark_yellow_u = m_mark_yellow_u;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t_anonymous_union_mark_y_t&);
...
template<>
class serializer_class<npl_flc_payload_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_flc_payload_t& m) {
            archive(::cereal::make_nvp("npu_header", m.npu_header));
            archive(::cereal::make_nvp("rxpp_pd", m.rxpp_pd));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_flc_payload_t& m) {
            archive(::cereal::make_nvp("npu_header", m.npu_header));
            archive(::cereal::make_nvp("rxpp_pd", m.rxpp_pd));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_flc_payload_t& m)
{
    serializer_class<npl_flc_payload_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_flc_payload_t&);

template <class Archive>
void
load(Archive& archive, npl_flc_payload_t& m)
{
    serializer_class<npl_flc_payload_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_flc_payload_t&);
...
template<>
class serializer_class<npl_ip_sgt_em_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_ip_sgt_em_result_t& m) {
            archive(::cereal::make_nvp("result_type", m.result_type));
            archive(::cereal::make_nvp("result", m.result));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_ip_sgt_em_result_t& m) {
            archive(::cereal::make_nvp("result_type", m.result_type));
            archive(::cereal::make_nvp("result", m.result));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_ip_sgt_em_result_t& m)
{
    serializer_class<npl_ip_sgt_em_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_ip_sgt_em_result_t&);

template <class Archive>
void
load(Archive& archive, npl_ip_sgt_em_result_t& m)
{
    serializer_class<npl_ip_sgt_em_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_ip_sgt_em_result_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_l3_dlp_qos_and_attributes_t& m) {
            ...
            archive(::cereal::make_nvp("qos_counter_comp", m.qos_counter_comp));
...
public:
    ...
    do_save(Archive& archive, const npl_minimal_l3_lp_attributes_t& m) {
        ...
        uint64_t m_disable_ipv6_uc = m.disable_ipv6_uc;
            ...
            archive(::cereal::make_nvp("disable_mpls_or_mc_tunnel", m.disable_mpls_or_mc_tunnel));
...
public:
    ...
    do_save(Archive& archive, const npl_nh_payload_t& m) {
        ...
        uint64_t m_eve_vid2 = m.eve_vid2;
            ...
            archive(::cereal::make_nvp("eve_vid2", m_eve_vid2));
...
template<>
class serializer_class<npl_npu_l3_mc_host_gb_dlp_encap_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_npu_l3_mc_host_gb_dlp_encap_t& m) {
            archive(::cereal::make_nvp("mc_host_gb_l3_dlp", m.mc_host_gb_l3_dlp));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_npu_l3_mc_host_gb_dlp_encap_t& m) {
            archive(::cereal::make_nvp("mc_host_gb_l3_dlp", m.mc_host_gb_l3_dlp));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_npu_l3_mc_host_gb_dlp_encap_t& m)
{
    serializer_class<npl_npu_l3_mc_host_gb_dlp_encap_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_npu_l3_mc_host_gb_dlp_encap_t&);

template <class Archive>
void
load(Archive& archive, npl_npu_l3_mc_host_gb_dlp_encap_t& m)
{
    serializer_class<npl_npu_l3_mc_host_gb_dlp_encap_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_npu_l3_mc_host_gb_dlp_encap_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_punt_eth_nw_common_encap_data_t& m) {
        uint64_t m_punt_if_sa_rewrite_idx = m.punt_if_sa_rewrite_idx;
            archive(::cereal::make_nvp("punt_host_da", m.punt_host_da));
            archive(::cereal::make_nvp("padding_or_ipv6_len", m.padding_or_ipv6_len));
            archive(::cereal::make_nvp("sa_or_npuh", m.sa_or_npuh));
            archive(::cereal::make_nvp("punt_if_sa_rewrite_idx", m_punt_if_sa_rewrite_idx));
            archive(::cereal::make_nvp("punt_eth_vid", m.punt_eth_vid));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_punt_eth_nw_common_encap_data_t& m) {
        uint64_t m_punt_if_sa_rewrite_idx;
            archive(::cereal::make_nvp("punt_host_da", m.punt_host_da));
            archive(::cereal::make_nvp("padding_or_ipv6_len", m.padding_or_ipv6_len));
            archive(::cereal::make_nvp("sa_or_npuh", m.sa_or_npuh));
            archive(::cereal::make_nvp("punt_if_sa_rewrite_idx", m_punt_if_sa_rewrite_idx));
            archive(::cereal::make_nvp("punt_eth_vid", m.punt_eth_vid));
        m.punt_if_sa_rewrite_idx = m_punt_if_sa_rewrite_idx;
    }
};
template <class Archive>
void
...
template<>
class serializer_class<npl_resolution_stage_assoc_data_wide_protection_line_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_wide_protection_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("record", m.record));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_wide_protection_line_t& m) {
            archive(::cereal::make_nvp("type", m.type));
            archive(::cereal::make_nvp("record", m.record));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_wide_protection_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_protection_line_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_wide_protection_line_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_wide_protection_line_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_wide_protection_line_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_wide_protection_line_t&);
...
template<>
class serializer_class<npl_svl_data_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_svl_data_t& m) {
            archive(::cereal::make_nvp("svl_uc_mc_data", m.svl_uc_mc_data));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_svl_data_t& m) {
            archive(::cereal::make_nvp("svl_uc_mc_data", m.svl_uc_mc_data));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_svl_data_t& m)
{
    serializer_class<npl_svl_data_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_svl_data_t&);

template <class Archive>
void
load(Archive& archive, npl_svl_data_t& m)
{
    serializer_class<npl_svl_data_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_svl_data_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_enq_results_t& m) {
            archive(::cereal::make_nvp("mark_y", m.mark_y));
            archive(::cereal::make_nvp("mark_g", m.mark_g));
...
template<>
class serializer_class<npl_app_mc_cud_narrow_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_app_mc_cud_narrow_t& m) {
            archive(::cereal::make_nvp("l2", m.l2));
            archive(::cereal::make_nvp("ip_collapsed_mc", m.ip_collapsed_mc));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_app_mc_cud_narrow_t& m) {
            archive(::cereal::make_nvp("l2", m.l2));
            archive(::cereal::make_nvp("ip_collapsed_mc", m.ip_collapsed_mc));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_app_mc_cud_narrow_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_app_mc_cud_narrow_t&);

template <class Archive>
void
load(Archive& archive, npl_app_mc_cud_narrow_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_app_mc_cud_narrow_t&);
...
template<>
class serializer_class<npl_ip_sgt_em_padded_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_ip_sgt_em_padded_result_t& m) {
            archive(::cereal::make_nvp("ip_sgt_em_result", m.ip_sgt_em_result));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_ip_sgt_em_padded_result_t& m) {
            archive(::cereal::make_nvp("ip_sgt_em_result", m.ip_sgt_em_result));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_ip_sgt_em_padded_result_t& m)
{
    serializer_class<npl_ip_sgt_em_padded_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_ip_sgt_em_padded_result_t&);

template <class Archive>
void
load(Archive& archive, npl_ip_sgt_em_padded_result_t& m)
{
    serializer_class<npl_ip_sgt_em_padded_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_ip_sgt_em_padded_result_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_npu_l3_common_encap_header_t_anonymous_union_l3_dlp_nh_encap_t& m) {
            ...
            archive(::cereal::make_nvp("npu_l3_mc_host_gb_dlp_encap", m.npu_l3_mc_host_gb_dlp_encap));
...
template<>
class serializer_class<npl_resolution_stage_assoc_data_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_stage_assoc_data_result_t& m) {
            archive(::cereal::make_nvp("raw", m.raw));
            archive(::cereal::make_nvp("narrow", m.narrow));
            archive(::cereal::make_nvp("wide", m.wide));
            archive(::cereal::make_nvp("narrow_protection", m.narrow_protection));
            archive(::cereal::make_nvp("wide_protection", m.wide_protection));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_stage_assoc_data_result_t& m) {
            archive(::cereal::make_nvp("raw", m.raw));
            archive(::cereal::make_nvp("narrow", m.narrow));
            archive(::cereal::make_nvp("wide", m.wide));
            archive(::cereal::make_nvp("narrow_protection", m.narrow_protection));
...
template <class Archive>
void
save(Archive& archive, const npl_resolution_stage_assoc_data_result_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_stage_assoc_data_result_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_stage_assoc_data_result_t& m)
{
    serializer_class<npl_resolution_stage_assoc_data_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_stage_assoc_data_result_t&);
