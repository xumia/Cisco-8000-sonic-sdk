...
template <class Archive> void save(Archive&, const npl_db_access_fwd_info_header_t_anonymous_union_macro_or_fwd_dest_t&);
template <class Archive> void load(Archive&, npl_db_access_fwd_info_header_t_anonymous_union_macro_or_fwd_dest_t&);

template <class Archive> void save(Archive&, const npl_db_access_key_selectors_header_t&);
template <class Archive> void load(Archive&, npl_db_access_key_selectors_header_t&);
...
template <class Archive> void save(Archive&, const npl_em_result_dsp_host_w_class_t_anonymous_union_dest_type_or_has_class_t&);
template <class Archive> void load(Archive&, npl_em_result_dsp_host_w_class_t_anonymous_union_dest_type_or_has_class_t&);
...
template <class Archive> void save(Archive&, const npl_ingress_qos_remark_t_anonymous_union_encap_qos_tag_u_t&);
template <class Archive> void load(Archive&, npl_ingress_qos_remark_t_anonymous_union_encap_qos_tag_u_t&);
...
template <class Archive> void save(Archive&, const npl_lpm_std_ip_em_lpm_result_destination_t_anonymous_union_union_for_padding_t&);
template <class Archive> void load(Archive&, npl_lpm_std_ip_em_lpm_result_destination_t_anonymous_union_union_for_padding_t&);
...
template <class Archive> void save(Archive&, const npl_quan_14b&);
template <class Archive> void load(Archive&, npl_quan_14b&);

template <class Archive> void save(Archive&, const npl_quan_15b&);
template <class Archive> void load(Archive&, npl_quan_15b&);

template <class Archive> void save(Archive&, const npl_quan_17b&);
template <class Archive> void load(Archive&, npl_quan_17b&);
...
template <class Archive> void save(Archive&, const npl_quan_2b&);
template <class Archive> void load(Archive&, npl_quan_2b&);

template <class Archive> void save(Archive&, const npl_quan_3b&);
template <class Archive> void load(Archive&, npl_quan_3b&);

template <class Archive> void save(Archive&, const npl_quan_4b&);
template <class Archive> void load(Archive&, npl_quan_4b&);

template <class Archive> void save(Archive&, const npl_quan_5b&);
template <class Archive> void load(Archive&, npl_quan_5b&);

template <class Archive> void save(Archive&, const npl_quan_8b&);
template <class Archive> void load(Archive&, npl_quan_8b&);
...
template <class Archive> void save(Archive&, const npl_stage0_l2_dlp_destination_l2_dlp_t&);
template <class Archive> void load(Archive&, npl_stage0_l2_dlp_destination_l2_dlp_t&);

template <class Archive> void save(Archive&, const npl_stage1_l3_nh_te_tunnel16b1_t&);
template <class Archive> void load(Archive&, npl_stage1_l3_nh_te_tunnel16b1_t&);

template <class Archive> void save(Archive&, const npl_stage1_p_l3_nh_destination_with_common_data_t&);
template <class Archive> void load(Archive&, npl_stage1_p_l3_nh_destination_with_common_data_t&);

template <class Archive> void save(Archive&, const npl_stage1_protected_raw_t&);
template <class Archive> void load(Archive&, npl_stage1_protected_raw_t&);
...
template<>
class serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_buffers_consumption_lut_for_deq_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_dram_consumption_lut_for_deq_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_drop_color_probability_selector_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_drop_color_probability_selector_results_t& m) {
            archive(::cereal::make_nvp("drop_prob", m.drop_prob));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_drop_color_probability_selector_results_t& m) {
            archive(::cereal::make_nvp("drop_prob", m.drop_prob));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_drop_color_probability_selector_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_drop_color_probability_selector_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_drop_color_probability_selector_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_drop_color_probability_selector_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_drop_color_probability_selector_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_drop_color_probability_selector_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t& m) {
        uint64_t m_drop_yellow = m.drop_yellow;
        uint64_t m_drop_green = m.drop_green;
            archive(::cereal::make_nvp("drop_yellow", m_drop_yellow));
            archive(::cereal::make_nvp("drop_green", m_drop_green));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t& m) {
        uint64_t m_drop_yellow;
        uint64_t m_drop_green;
            archive(::cereal::make_nvp("drop_yellow", m_drop_yellow));
            archive(::cereal::make_nvp("drop_green", m_drop_green));
        m.drop_yellow = m_drop_yellow;
        m.drop_green = m_drop_green;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t& m)
{
    serializer_class<npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t& m)
{
    serializer_class<npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_result_t&);



template<>
class serializer_class<npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t& m) {
        uint64_t m_drop_on_eviction = m.drop_on_eviction;
        uint64_t m_eviction_ok = m.eviction_ok;
            archive(::cereal::make_nvp("drop_on_eviction", m_drop_on_eviction));
            archive(::cereal::make_nvp("eviction_ok", m_eviction_ok));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t& m) {
        uint64_t m_drop_on_eviction;
        uint64_t m_eviction_ok;
            archive(::cereal::make_nvp("drop_on_eviction", m_drop_on_eviction));
            archive(::cereal::make_nvp("eviction_ok", m_eviction_ok));
        m.drop_on_eviction = m_drop_on_eviction;
        m.eviction_ok = m_eviction_ok;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_mark_color_probability_selector_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_mark_color_probability_selector_results_t& m) {
            archive(::cereal::make_nvp("mark_yellow_prob", m.mark_yellow_prob));
            archive(::cereal::make_nvp("mark_green_prob", m.mark_green_prob));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_mark_color_probability_selector_results_t& m) {
            archive(::cereal::make_nvp("mark_yellow_prob", m.mark_yellow_prob));
            archive(::cereal::make_nvp("mark_green_prob", m.mark_green_prob));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_mark_color_probability_selector_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_mark_color_probability_selector_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_mark_color_probability_selector_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_mark_color_probability_selector_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_mark_color_probability_selector_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_mark_color_probability_selector_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t& m) {
            archive(::cereal::make_nvp("congestion_level", m.congestion_level));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_pd_consumption_lut_for_deq_results_t&);



template<>
class serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t& m) {
            archive(::cereal::make_nvp("mark_yellow", m.mark_yellow));
            archive(::cereal::make_nvp("mark_green", m.mark_green));
            archive(::cereal::make_nvp("evict_to_dram", m.evict_to_dram));
            archive(::cereal::make_nvp("drop_yellow", m.drop_yellow));
...
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t& m)
{
    serializer_class<npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_slice_pd_consumption_lut_for_enq_results_t&);
...
template<>
class serializer_class<npl_voq_cgm_wred_probability_region_id_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_wred_probability_region_id_t& m) {
        uint64_t m_region_id = m.region_id;
            archive(::cereal::make_nvp("region_id", m_region_id));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_wred_probability_region_id_t& m) {
...
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_wred_probability_region_id_t& m)
{
    serializer_class<npl_voq_cgm_wred_probability_region_id_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_wred_probability_region_id_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_wred_probability_region_id_t& m)
{
    serializer_class<npl_voq_cgm_wred_probability_region_id_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_wred_probability_region_id_t&);



template<>
class serializer_class<npl_voq_cgm_wred_probability_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_voq_cgm_wred_probability_results_t& m) {
            archive(::cereal::make_nvp("probability", m.probability));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_voq_cgm_wred_probability_results_t& m) {
            archive(::cereal::make_nvp("probability", m.probability));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_voq_cgm_wred_probability_results_t& m)
{
    serializer_class<npl_voq_cgm_wred_probability_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_voq_cgm_wred_probability_results_t&);

template <class Archive>
void
load(Archive& archive, npl_voq_cgm_wred_probability_results_t& m)
{
    serializer_class<npl_voq_cgm_wred_probability_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_voq_cgm_wred_probability_results_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_vxlan_dlp_specific_t& m) {
        uint64_t m_group_policy_encap = m.group_policy_encap;
        ...
        uint64_t m_ttl = m.ttl;
            archive(::cereal::make_nvp("group_policy_encap", m_group_policy_encap));
    ...
    do_load(Archive& archive, npl_vxlan_dlp_specific_t& m) {
        ...
        uint64_t m_ttl;
            ...
            archive(::cereal::make_nvp("dip", m.dip));
            archive(::cereal::make_nvp("ttl", m_ttl));
        m.group_policy_encap = m_group_policy_encap;
...
public:
    ...
    do_save(Archive& archive, const npl_vxlan_encap_data_t& m) {
        uint64_t m_group_policy_id = m.group_policy_id;
        uint64_t m_vni = m.vni;
            archive(::cereal::make_nvp("group_policy_id", m_group_policy_id));
            archive(::cereal::make_nvp("vni", m_vni));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_vxlan_encap_data_t& m) {
        uint64_t m_group_policy_id;
        uint64_t m_vni;
            archive(::cereal::make_nvp("group_policy_id", m_group_policy_id));
            archive(::cereal::make_nvp("vni", m_vni));
        m.group_policy_id = m_group_policy_id;
        m.vni = m_vni;
    }
};
template <class Archive>
...
template<>
class serializer_class<npl_wide_protection_entry_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_wide_protection_entry_t& m) {
            archive(::cereal::make_nvp("stage0_l2_dlp_dest_l2_dlp", m.stage0_l2_dlp_dest_l2_dlp));
            archive(::cereal::make_nvp("stage1_nh_dest", m.stage1_nh_dest));
            archive(::cereal::make_nvp("stage1_te_tunnel", m.stage1_te_tunnel));
            archive(::cereal::make_nvp("stage1_raw", m.stage1_raw));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_wide_protection_entry_t& m) {
            archive(::cereal::make_nvp("stage0_l2_dlp_dest_l2_dlp", m.stage0_l2_dlp_dest_l2_dlp));
            archive(::cereal::make_nvp("stage1_nh_dest", m.stage1_nh_dest));
            archive(::cereal::make_nvp("stage1_te_tunnel", m.stage1_te_tunnel));
            archive(::cereal::make_nvp("stage1_raw", m.stage1_raw));
...
template <class Archive>
void
save(Archive& archive, const npl_wide_protection_entry_t& m)
{
    serializer_class<npl_wide_protection_entry_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_wide_protection_entry_t&);

template <class Archive>
void
load(Archive& archive, npl_wide_protection_entry_t& m)
{
    serializer_class<npl_wide_protection_entry_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_wide_protection_entry_t&);
...
template<>
class serializer_class<npl_db_access_fwd_info_header_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_db_access_fwd_info_header_t& m) {
            archive(::cereal::make_nvp("macro_or_fwd_dest", m.macro_or_fwd_dest));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_db_access_fwd_info_header_t& m) {
            archive(::cereal::make_nvp("macro_or_fwd_dest", m.macro_or_fwd_dest));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_db_access_fwd_info_header_t& m)
{
    serializer_class<npl_db_access_fwd_info_header_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_db_access_fwd_info_header_t&);

template <class Archive>
void
load(Archive& archive, npl_db_access_fwd_info_header_t& m)
{
    serializer_class<npl_db_access_fwd_info_header_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_db_access_fwd_info_header_t&);



template<>
class serializer_class<npl_db_access_fwd_macro_dests_header_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_db_access_fwd_macro_dests_header_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_db_access_fwd_macro_dests_header_t& m) {
            archive(::cereal::make_nvp("bucket_a_lu_dest", m.bucket_a_lu_dest));
            archive(::cereal::make_nvp("bucket_b_lu_dest", m.bucket_b_lu_dest));
            archive(::cereal::make_nvp("bucket_c_lu_dest", m.bucket_c_lu_dest));
            archive(::cereal::make_nvp("bucket_d_lu_dest", m.bucket_d_lu_dest));
...
template <class Archive>
void
save(Archive& archive, const npl_db_access_fwd_macro_dests_header_t& m)
{
    serializer_class<npl_db_access_fwd_macro_dests_header_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_db_access_fwd_macro_dests_header_t&);

template <class Archive>
void
load(Archive& archive, npl_db_access_fwd_macro_dests_header_t& m)
{
    serializer_class<npl_db_access_fwd_macro_dests_header_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_db_access_fwd_macro_dests_header_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_dsp_attr_common_t& m) {
        ...
        uint64_t m_svl_vpc_prune_port = m.svl_vpc_prune_port;
            ...
            archive(::cereal::make_nvp("svl_vpc_prune_port", m_svl_vpc_prune_port));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_dsp_attr_common_t& m) {
        ...
        m.dsp = m_dsp;
        m.svl_vpc_prune_port = m_svl_vpc_prune_port;
    }
};
template <class Archive>
void
...
template<>
class serializer_class<npl_em_result_dsp_host_w_class_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_em_result_dsp_host_w_class_t& m) {
        ...
        uint64_t m_host_mac_lsb = m.host_mac_lsb;
            archive(::cereal::make_nvp("dest_type_or_has_class", m.dest_type_or_has_class));
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_em_result_dsp_host_w_class_t& m) {
        uint64_t m_class_id;
        uint64_t m_dest;
...
template <class Archive>
void
save(Archive& archive, const npl_em_result_dsp_host_w_class_t& m)
{
    serializer_class<npl_em_result_dsp_host_w_class_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_em_result_dsp_host_w_class_t&);

template <class Archive>
void
load(Archive& archive, npl_em_result_dsp_host_w_class_t& m)
{
    serializer_class<npl_em_result_dsp_host_w_class_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_em_result_dsp_host_w_class_t&);
...
template<>
class serializer_class<npl_flc_header_types_array_data_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_flc_header_types_array_data_t& m) {
        uint64_t m_range_comp_vld_3 = m.range_comp_vld_3;
        uint64_t m_range_comp_vld_2 = m.range_comp_vld_2;
        uint64_t m_range_comp_vld_1 = m.range_comp_vld_1;
        uint64_t m_range_comp_vld_0 = m.range_comp_vld_0;
        uint64_t m_use_cache = m.use_cache;
            archive(::cereal::make_nvp("range_comp_sel_3", m.range_comp_sel_3));
            archive(::cereal::make_nvp("range_comp_sel_2", m.range_comp_sel_2));
            archive(::cereal::make_nvp("range_comp_sel_1", m.range_comp_sel_1));
            archive(::cereal::make_nvp("range_comp_sel_0", m.range_comp_sel_0));
            archive(::cereal::make_nvp("range_comp_vld_3", m_range_comp_vld_3));
            archive(::cereal::make_nvp("range_comp_vld_2", m_range_comp_vld_2));
            archive(::cereal::make_nvp("range_comp_vld_1", m_range_comp_vld_1));
            archive(::cereal::make_nvp("range_comp_vld_0", m_range_comp_vld_0));
            archive(::cereal::make_nvp("use_cache", m_use_cache));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_flc_header_types_array_data_t& m) {
        uint64_t m_range_comp_vld_3;
        uint64_t m_range_comp_vld_2;
        uint64_t m_range_comp_vld_1;
        uint64_t m_range_comp_vld_0;
        uint64_t m_use_cache;
            archive(::cereal::make_nvp("range_comp_sel_3", m.range_comp_sel_3));
            archive(::cereal::make_nvp("range_comp_sel_2", m.range_comp_sel_2));
            archive(::cereal::make_nvp("range_comp_sel_1", m.range_comp_sel_1));
            archive(::cereal::make_nvp("range_comp_sel_0", m.range_comp_sel_0));
            ...
            archive(::cereal::make_nvp("range_comp_vld_0", m_range_comp_vld_0));
            archive(::cereal::make_nvp("use_cache", m_use_cache));
        m.range_comp_vld_3 = m_range_comp_vld_3;
        m.range_comp_vld_2 = m_range_comp_vld_2;
        m.range_comp_vld_1 = m_range_comp_vld_1;
        m.range_comp_vld_0 = m_range_comp_vld_0;
        m.use_cache = m_use_cache;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_flc_header_types_array_data_t& m)
{
    serializer_class<npl_flc_header_types_array_data_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_flc_header_types_array_data_t&);

template <class Archive>
void
load(Archive& archive, npl_flc_header_types_array_data_t& m)
{
    serializer_class<npl_flc_header_types_array_data_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_flc_header_types_array_data_t&);
...
template<>
class serializer_class<npl_gb_std_ip_em_lpm_result_destination_with_default_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_gb_std_ip_em_lpm_result_destination_with_default_t& m) {
            archive(::cereal::make_nvp("destination_with_default", m.destination_with_default));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_gb_std_ip_em_lpm_result_destination_with_default_t& m) {
            archive(::cereal::make_nvp("destination_with_default", m.destination_with_default));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_gb_std_ip_em_lpm_result_destination_with_default_t& m)
{
    serializer_class<npl_gb_std_ip_em_lpm_result_destination_with_default_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_gb_std_ip_em_lpm_result_destination_with_default_t&);

template <class Archive>
void
load(Archive& archive, npl_gb_std_ip_em_lpm_result_destination_with_default_t& m)
{
    serializer_class<npl_gb_std_ip_em_lpm_result_destination_with_default_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_gb_std_ip_em_lpm_result_destination_with_default_t&);
...
template<>
class serializer_class<npl_ingress_qos_remark_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_ingress_qos_remark_t& m) {
        uint64_t m_qos_group = m.qos_group;
        uint64_t m_fwd_qos_tag = m.fwd_qos_tag;
            archive(::cereal::make_nvp("encap_qos_tag_u", m.encap_qos_tag_u));
            archive(::cereal::make_nvp("qos_group", m_qos_group));
            archive(::cereal::make_nvp("fwd_qos_tag", m_fwd_qos_tag));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_ingress_qos_remark_t& m) {
...
template <class Archive>
void
save(Archive& archive, const npl_ingress_qos_remark_t& m)
{
    serializer_class<npl_ingress_qos_remark_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_ingress_qos_remark_t&);

template <class Archive>
void
load(Archive& archive, npl_ingress_qos_remark_t& m)
{
    serializer_class<npl_ingress_qos_remark_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_ingress_qos_remark_t&);
...
template<>
class serializer_class<npl_ip_sgt_em_result_t_anonymous_union_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_ip_sgt_em_result_t_anonymous_union_result_t& m) {
            archive(::cereal::make_nvp("sgt_data", m.sgt_data));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_ip_sgt_em_result_t_anonymous_union_result_t& m) {
            archive(::cereal::make_nvp("sgt_data", m.sgt_data));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_ip_sgt_em_result_t_anonymous_union_result_t& m)
{
    serializer_class<npl_ip_sgt_em_result_t_anonymous_union_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_ip_sgt_em_result_t_anonymous_union_result_t&);

template <class Archive>
void
load(Archive& archive, npl_ip_sgt_em_result_t_anonymous_union_result_t& m)
{
    serializer_class<npl_ip_sgt_em_result_t_anonymous_union_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_ip_sgt_em_result_t_anonymous_union_result_t&);



template<>
class serializer_class<npl_ip_sgt_lpm_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_ip_sgt_lpm_result_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_ip_sgt_lpm_result_t& m) {
        uint64_t m_rtype;
        uint64_t m_no_hbm_access;
        uint64_t m_is_default_unused;
            archive(::cereal::make_nvp("sgt_data", m.sgt_data));
...
template <class Archive>
void
save(Archive& archive, const npl_ip_sgt_lpm_result_t& m)
{
    serializer_class<npl_ip_sgt_lpm_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_ip_sgt_lpm_result_t&);

template <class Archive>
void
load(Archive& archive, npl_ip_sgt_lpm_result_t& m)
{
    serializer_class<npl_ip_sgt_lpm_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_ip_sgt_lpm_result_t&);
...
template<>
class serializer_class<npl_l2_mc_cud_narrow_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_l2_mc_cud_narrow_t& m) {
            archive(::cereal::make_nvp("l2_encapsulation_type", m.l2_encapsulation_type));
            archive(::cereal::make_nvp("l2_ac_encdap", m.l2_ac_encdap));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_l2_mc_cud_narrow_t& m) {
            archive(::cereal::make_nvp("l2_encapsulation_type", m.l2_encapsulation_type));
            archive(::cereal::make_nvp("l2_ac_encdap", m.l2_ac_encdap));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_l2_mc_cud_narrow_t& m)
{
    serializer_class<npl_l2_mc_cud_narrow_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_l2_mc_cud_narrow_t&);

template <class Archive>
void
load(Archive& archive, npl_l2_mc_cud_narrow_t& m)
{
    serializer_class<npl_l2_mc_cud_narrow_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_l2_mc_cud_narrow_t&);
...
template<>
class serializer_class<npl_lpm_std_ip_em_lpm_result_destination_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_lpm_std_ip_em_lpm_result_destination_t& m) {
            archive(::cereal::make_nvp("union_for_padding", m.union_for_padding));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_lpm_std_ip_em_lpm_result_destination_t& m) {
            archive(::cereal::make_nvp("union_for_padding", m.union_for_padding));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_lpm_std_ip_em_lpm_result_destination_t& m)
{
    serializer_class<npl_lpm_std_ip_em_lpm_result_destination_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_lpm_std_ip_em_lpm_result_destination_t&);

template <class Archive>
void
load(Archive& archive, npl_lpm_std_ip_em_lpm_result_destination_t& m)
{
    serializer_class<npl_lpm_std_ip_em_lpm_result_destination_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_lpm_std_ip_em_lpm_result_destination_t&);
...
template<>
class serializer_class<npl_mark_color_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_mark_color_t& m) {
            archive(::cereal::make_nvp("mark_color", m.mark_color));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_mark_color_t& m) {
            archive(::cereal::make_nvp("mark_color", m.mark_color));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_mark_color_t& m)
{
    serializer_class<npl_mark_color_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_mark_color_t&);

template <class Archive>
void
load(Archive& archive, npl_mark_color_t& m)
{
    serializer_class<npl_mark_color_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_mark_color_t&);
...
template<>
class serializer_class<npl_npu_base_header_leaba_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_npu_base_header_leaba_t& m) {
        uint64_t m_slp_qos_id = m.slp_qos_id;
        uint64_t m_issu_codespace = m.issu_codespace;
        uint64_t m_fwd_offset = m.fwd_offset;
            archive(::cereal::make_nvp("rx_nw_app_or_lb_key", m.rx_nw_app_or_lb_key));
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_npu_base_header_leaba_t& m) {
...
template <class Archive>
void
save(Archive& archive, const npl_npu_base_header_leaba_t& m)
{
    serializer_class<npl_npu_base_header_leaba_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_npu_base_header_leaba_t&);

template <class Archive>
void
load(Archive& archive, npl_npu_base_header_leaba_t& m)
{
    serializer_class<npl_npu_base_header_leaba_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_npu_base_header_leaba_t&);



template<>
class serializer_class<npl_npu_base_leaba_dont_overwrite_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_npu_base_leaba_dont_overwrite_t& m) {
        uint64_t m_base_type = m.base_type;
        uint64_t m_receive_time = m.receive_time;
        uint64_t m_meter_color = m.meter_color;
        uint64_t m_l2_flood_mc_pruning = m.l2_flood_mc_pruning;
            archive(::cereal::make_nvp("base_type", m_base_type));
            archive(::cereal::make_nvp("receive_time", m_receive_time));
            archive(::cereal::make_nvp("meter_color", m_meter_color));
            archive(::cereal::make_nvp("l2_flood_mc_pruning", m_l2_flood_mc_pruning));
            archive(::cereal::make_nvp("ingress_qos_remark", m.ingress_qos_remark));
            archive(::cereal::make_nvp("fwd_header_type", m.fwd_header_type));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_npu_base_leaba_dont_overwrite_t& m) {
        uint64_t m_base_type;
        uint64_t m_receive_time;
        uint64_t m_meter_color;
        uint64_t m_l2_flood_mc_pruning;
            archive(::cereal::make_nvp("base_type", m_base_type));
            archive(::cereal::make_nvp("receive_time", m_receive_time));
            archive(::cereal::make_nvp("meter_color", m_meter_color));
            archive(::cereal::make_nvp("l2_flood_mc_pruning", m_l2_flood_mc_pruning));
            archive(::cereal::make_nvp("ingress_qos_remark", m.ingress_qos_remark));
            archive(::cereal::make_nvp("fwd_header_type", m.fwd_header_type));
        m.base_type = m_base_type;
        m.receive_time = m_receive_time;
        m.meter_color = m_meter_color;
        m.l2_flood_mc_pruning = m_l2_flood_mc_pruning;
    }
};
template <class Archive>
void
save(Archive& archive, const npl_npu_base_leaba_dont_overwrite_t& m)
{
    serializer_class<npl_npu_base_leaba_dont_overwrite_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_npu_base_leaba_dont_overwrite_t&);

template <class Archive>
void
load(Archive& archive, npl_npu_base_leaba_dont_overwrite_t& m)
{
    serializer_class<npl_npu_base_leaba_dont_overwrite_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_npu_base_leaba_dont_overwrite_t&);
...
template<>
class serializer_class<npl_pdvoq_slice_dram_wred_lut_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_pdvoq_slice_dram_wred_lut_result_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_pdvoq_slice_dram_wred_lut_result_t& m) {
            archive(::cereal::make_nvp("mark_y", m.mark_y));
            archive(::cereal::make_nvp("mark_g", m.mark_g));
            archive(::cereal::make_nvp("drop_y", m.drop_y));
            archive(::cereal::make_nvp("drop_g", m.drop_g));
...
template <class Archive>
void
save(Archive& archive, const npl_pdvoq_slice_dram_wred_lut_result_t& m)
{
    serializer_class<npl_pdvoq_slice_dram_wred_lut_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_pdvoq_slice_dram_wred_lut_result_t&);

template <class Archive>
void
load(Archive& archive, npl_pdvoq_slice_dram_wred_lut_result_t& m)
{
    serializer_class<npl_pdvoq_slice_dram_wred_lut_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_pdvoq_slice_dram_wred_lut_result_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_punt_if_sa_or_npu_host_data_t& m) {
        uint64_t m_punt_if_sa_lsb = m.punt_if_sa_lsb;
            archive(::cereal::make_nvp("punt_if_sa_lsb", m_punt_if_sa_lsb));
    ...
    do_load(Archive& archive, npl_punt_if_sa_or_npu_host_data_t& m) {
        uint64_t m_punt_if_sa_lsb;
            archive(::cereal::make_nvp("punt_if_sa_lsb", m_punt_if_sa_lsb));
            archive(::cereal::make_nvp("punt_npu_host_data", m.punt_npu_host_data));
        m.punt_if_sa_lsb = m_punt_if_sa_lsb;
    }
};
template <class Archive>
void
