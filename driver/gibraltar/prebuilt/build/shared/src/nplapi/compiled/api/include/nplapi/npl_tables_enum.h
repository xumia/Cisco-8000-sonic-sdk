...
typedef enum {
    ...
    NPL_TABLES_CONG_LEVEL_ECN_REMAP_MAP_TABLE,
    ...
    NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C,
    NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_D,
    NPL_TABLES_DB_ACCESS_PER_PORT_DESTINATION_TABLE,
    NPL_TABLES_DB_ACCESS_TRANSMIT_PER_DEST_PORT_NPU_HOST_MACRO_STAMPING_TABLE,
    NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_C_RES_C,
    NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C,
    ...
    NPL_TABLES_DEST_TYPE_DECODING_TABLE,
    NPL_TABLES_DEVICE_MODE_TABLE,
    NPL_TABLES_DLP0_KEY_LSB_MAPPING_TABLE,
    NPL_TABLES_DLP1_KEY_LSB_MAPPING_TABLE,
    NPL_TABLES_DRAM_CGM_CGM_DEQ_LUT_TABLE,
    NPL_TABLES_DRAM_CGM_CGM_LUT_TABLE,
    NPL_TABLES_DSP_DEST_MSBS_FOR_ECN_TABLE,
    NPL_TABLES_DSP_GROUP_POLICY_TABLE,
    ...
    NPL_TABLES_ETH_TYPE_STATIC_TABLE,
    NPL_TABLES_EVE_DROP_MAPPING_HW_TABLE,
    NPL_TABLES_EVE_DROP_VLAN_ID_HW_TABLE,
    NPL_TABLES_EVE_INTERRUPT_MAPPING_HW_TABLE,
    ...
    NPL_TABLES_FC_DB_PERFORMANCE_VLAN_MEMBERSHIP_TABLE,
    ...
    NPL_TABLES_FEC_TABLE,
    NPL_TABLES_FEC_TYPE_DECODING_TABLE,
    ...
    NPL_TABLES_FIXUP_DESTINATION_FOR_RESOLUTION_STATIC_TABLE,
    NPL_TABLES_FLC_CACHE_RANGE_COMP_PROFILE_TABLE,
    NPL_TABLES_FLC_DATA_TABLE,
    NPL_TABLES_FLC_DB_TABLE,
    NPL_TABLES_FLC_FBM_TABLE,
    NPL_TABLES_FLC_HEADER_TYPES_ARRAY_TABLE,
    NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_ID_TABLE,
    NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_L_TABLE,
    NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_M_TABLE,
    NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_S_TABLE,
    NPL_TABLES_FLC_Q_RANGE_COMP_PROFILE_TABLE,
    NPL_TABLES_FLC_RANGE_COMP_RANGES_TABLE,
    NPL_TABLES_FRM_DB_FABRIC_ROUTING_TABLE,
    NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_A_OFFSET_TABLE,
    NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_B_OFFSET_TABLE,
    NPL_TABLES_FWD_BUCKET_A_LU_DATA_SELECTOR,
    NPL_TABLES_FWD_BUCKET_B_LU_DATA_SELECTOR,
    NPL_TABLES_FWD_BUCKET_C_LU_DATA_SELECTOR,
    NPL_TABLES_FWD_BUCKET_D_LU_DATA_SELECTOR,
    ...
    NPL_TABLES_IPV4_IP_TUNNEL_TERMINATION_DIP_TT0_TABLE,
    ...
    NPL_TABLES_IPV4_SGT_EM_TABLE,
    NPL_TABLES_IPV4_SGT_LPM_TABLE,
    ...
    NPL_TABLES_IPV6_SGT_EM_TABLE,
    NPL_TABLES_IPV6_SGT_LPM_TABLE,
    ...
    NPL_TABLES_L3_LP_PROFILE_FILTER_TABLE,
    ...
    NPL_TABLES_LARGE_EM_KEY_LSB_MAPPING_TABLE,
    ...
    NPL_TABLES_LINK_RELAY_ID_STATIC_TABLE,
    NPL_TABLES_LINK_UP_VECTOR,
    NPL_TABLES_LOCAL_MC_FWD_NEXT_MACRO_STATIC_TABLE,
    ...
    NPL_TABLES_MAC_FORWARDING_W_METADATA_TABLE,
    ...
    NPL_TABLES_MIRROR_CODE_2_HW_TABLE,
    ...
    NPL_TABLES_NPP_SGT_ATTRIBUTES_TABLE,
    ...
    NPL_TABLES_PBTS_MAP_TABLE_STAGE0,
    NPL_TABLES_PBTS_MAP_TABLE_STAGE1,
    NPL_TABLES_PBTS_MAP_TABLE_STAGE2,
    NPL_TABLES_PBTS_MAP_TABLE_STAGE3,
    NPL_TABLES_PDOQ_OQ_IFC_MAPPING,
    NPL_TABLES_PDVOQ_BANK_PAIR_OFFSET_TABLE,
    NPL_TABLES_PDVOQ_SLICE_DRAM_WRED_LUT_TABLE,
    ...
    NPL_TABLES_POST_FWD_RTF_NEXT_MACRO_STATIC_TABLE,
    NPL_TABLES_PROBE_MARKER_1_STATIC_TABLE,
    NPL_TABLES_PROBE_MARKER_2_STATIC_TABLE,
    ...
    NPL_TABLES_RX_COUNTERS_BANK_ID_MAP_CONFIG,
    ...
    NPL_TABLES_RX_METER_BANK_OFFSET_MAP,
    ...
    NPL_TABLES_RXPDR_FE_RLB_UC_TX_FB_LINK_TO_OQ_TABLE,
    NPL_TABLES_SCH_OQSE_CFG,
    NPL_TABLES_SDA_FABRIC_ENABLE_TABLE,
    NPL_TABLES_SECOND_ENE_STATIC_TABLE,
    NPL_TABLES_SELECT_INJECT_NEXT_MACRO_STATIC_TABLE,
    NPL_TABLES_SELECT_MAC_FORWARDING_STATIC_TABLE,
    NPL_TABLES_SERVICE_LP_ATTRIBUTES_TABLE,
    NPL_TABLES_SERVICE_MAPPING0_KEY_LSB_MAPPING_TABLE,
    NPL_TABLES_SERVICE_MAPPING1_KEY_LSB_MAPPING_TABLE,
    ...
    NPL_TABLES_SERVICE_MAPPING_TCAM_KEY_LSB_MAPPING_TABLE,
    NPL_TABLES_SERVICE_MAPPING_TCAM_PWE_TAG_TABLE,
    NPL_TABLES_SERVICE_RELAY_ATTRIBUTES_TABLE,
    NPL_TABLES_SERVICE_RELAY_ID_STATIC_TABLE,
    NPL_TABLES_SET_ENE_MACRO_AND_BYTES_TO_REMOVE_TABLE,
    NPL_TABLES_SGACL_COUNTER_BANK_TABLE,
    NPL_TABLES_SGACL_IP_FRAGMENT_CHECK_TABLE,
    NPL_TABLES_SGACL_L4_PROTOCOL_SELECT_TABLE,
    NPL_TABLES_SGACL_NEXT_MACRO_STATIC_TABLE,
    NPL_TABLES_SGACL_TABLE,
    NPL_TABLES_SGT_DERIVATION_MACRO_STATIC_TABLE,
    NPL_TABLES_SGT_MATRIX_TABLE,
    NPL_TABLES_SGT_VXLAN_TERMINATION_TABLE,
    NPL_TABLES_SIP_INDEX_TABLE,
    NPL_TABLES_SLICE_MODES_TABLE,
    NPL_TABLES_SLP_BASED_FORWARDING_TABLE,
    NPL_TABLES_SMALL_EM_KEY_LSB_MAPPING_TABLE,
    ...
    NPL_TABLES_SOURCE_PORT_TO_LINK_TABLE,
    NPL_TABLES_SPLITTER_LU_B_KEY_SELECTOR,
    NPL_TABLES_SPLITTER_LU_D_KEY_SELECTOR,
    NPL_TABLES_STAGE0_ASSOC_DATA_TABLE,
    NPL_TABLES_STAGE0_EM_TABLE,
    NPL_TABLES_STAGE0_GROUP_SIZE_TABLE,
    NPL_TABLES_STAGE0_PROTECTION_TABLE,
    NPL_TABLES_STAGE0_TYPE_DECODING_TABLE,
    NPL_TABLES_STAGE1_ASSOC_DATA_TABLE,
    NPL_TABLES_STAGE1_EM_TABLE,
    NPL_TABLES_STAGE1_GROUP_SIZE_TABLE,
    NPL_TABLES_STAGE1_PROTECTION_TABLE,
    NPL_TABLES_STAGE1_TYPE_DECODING_TABLE,
    NPL_TABLES_STAGE2_ASSOC_DATA_TABLE,
    NPL_TABLES_STAGE2_EM_TABLE,
    NPL_TABLES_STAGE2_GROUP_SIZE_TABLE,
    NPL_TABLES_STAGE2_PROTECTION_TABLE,
    NPL_TABLES_STAGE2_TYPE_DECODING_TABLE,
    NPL_TABLES_STAGE3_ASSOC_DATA_TABLE,
    NPL_TABLES_STAGE3_EM_TABLE,
    NPL_TABLES_STAGE3_GROUP_SIZE_TABLE,
    NPL_TABLES_STAGE3_PROTECTION_TABLE,
    NPL_TABLES_STAGE3_TYPE_DECODING_TABLE,
    NPL_TABLES_SVL_DSPA_TABLE,
    NPL_TABLES_SVL_IS_DSP_REMOTE,
    NPL_TABLES_SVL_MIRROR_CMD_REMOTE_DSP_TABLE,
    NPL_TABLES_SVL_MODE_TABLE,
    NPL_TABLES_SVL_NEXT_MACRO_STATIC_TABLE,
    NPL_TABLES_SVL_SGACL_ENABLE_STATIC_TABLE,
    NPL_TABLES_SVL_SGACL_NEXT_MACRO_STATIC_TABLE,
    NPL_TABLES_TE_HEADEND_LSP_COUNTER_OFFSET_TABLE,
    NPL_TABLES_TERM_BUCKET_A_LU_DATA_SELECTOR,
    NPL_TABLES_TERM_BUCKET_B_LU_DATA_SELECTOR,
    NPL_TABLES_TERM_BUCKET_C_LU_DATA_SELECTOR,
    NPL_TABLES_TERM_BUCKET_D_LU_DATA_SELECTOR,
    NPL_TABLES_TERM_TO_FWD_HDR_SHIFT_TABLE,
    NPL_TABLES_TERMINATION_TO_FORWARDING_FI_HARDWIRED_TABLE,
    NPL_TABLES_TM_IBM_CMD_TO_DESTINATION,
    NPL_TABLES_TRANSMIT_BUCKET_A_LU_DATA_SELECTOR,
    NPL_TABLES_TRANSMIT_BUCKET_B_LU_DATA_SELECTOR,
    NPL_TABLES_TRANSMIT_BUCKET_C_LU_DATA_SELECTOR,
    NPL_TABLES_TRANSMIT_BUCKET_D_LU_DATA_SELECTOR,
    NPL_TABLES_TS_CMD_HW_STATIC_TABLE,
    NPL_TABLES_TUNNEL_DLP_P_COUNTER_OFFSET_TABLE,
    NPL_TABLES_TUNNEL_QOS_STATIC_TABLE,
    NPL_TABLES_TX_COUNTERS_BANK_ID_MAP_CONFIG,
    ...
    NPL_TABLES_TXPP_DLP_PROFILE_KEY_CONSTRUCT_PARAMETERS_TABLE,
    NPL_TABLES_TXPP_EM_DLP_PROFILE_MAPPING_TABLE,
    ...
    NPL_TABLES_UDP_FI_CORE_TCAM_TABLE,
    NPL_TABLES_URPF_IPSA_DEST_IS_LPTS_STATIC_TABLE,
    NPL_TABLES_VLAN0_FI_CORE_TCAM_TABLE,
    NPL_TABLES_VLAN1_FI_CORE_TCAM_TABLE,
    NPL_TABLES_VLAN_EDIT_TPID1_PROFILE_HW_TABLE,
    NPL_TABLES_VLAN_EDIT_TPID2_PROFILE_HW_TABLE,
    NPL_TABLES_VLAN_FORMAT_TABLE,
    NPL_TABLES_VLAN_PE_FI_CORE_TCAM_TABLE,
    NPL_TABLES_VNI_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_BUFFERS_CONSUMPTION_LUT_FOR_DEQ_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_BUFFERS_CONSUMPTION_LUT_FOR_ENQ_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_DROP_GREEN_PROBABILITY_SELECTOR_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_DROP_YELLOW_PROBABILITY_SELECTOR_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_EVICTED_BUFFERS_CONSUMPTION_LUT_FOR_ENQ_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_EVICTION_OK_LUT_FOR_ENQ_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_MARK_PROBABILITY_SELECTOR_TABLE,
    NPL_TABLES_VOQ_CGM_SLICE_PD_CONSUMPTION_LUT_FOR_DEQ_TABLE,
    ...
    NPL_TABLES_VOQ_CGM_WRED_PROBABILITY_TABLE,
