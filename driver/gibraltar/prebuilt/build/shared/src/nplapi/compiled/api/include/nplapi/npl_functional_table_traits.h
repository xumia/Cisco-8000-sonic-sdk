...
namespace silicon_one {
    ...
    struct npl_cong_level_ecn_remap_map_table_functional_traits_t {
        typedef npl_cong_level_ecn_remap_map_table_key_t key_type;
        typedef npl_cong_level_ecn_remap_map_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_CONG_LEVEL_ECN_REMAP_MAP_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("cong_level_ecn_remap_map_table");
            return table_name;
        }
    };
    ...
    struct npl_db_access_ingress_vlan_membership_table_lu_d_res_c_functional_traits_t {
        typedef npl_db_access_ingress_vlan_membership_table_lu_d_res_c_key_t key_type;
        typedef npl_db_access_ingress_vlan_membership_table_lu_d_res_c_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_ingress_vlan_membership_table_lu_d_res_c");
            return table_name;
        }
    };
    
    struct npl_db_access_ingress_vlan_membership_table_lu_d_res_d_functional_traits_t {
        typedef npl_db_access_ingress_vlan_membership_table_lu_d_res_d_key_t key_type;
        typedef npl_db_access_ingress_vlan_membership_table_lu_d_res_d_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_D;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_ingress_vlan_membership_table_lu_d_res_d");
            return table_name;
        }
    };
    
    struct npl_db_access_per_port_destination_table_functional_traits_t {
        typedef npl_db_access_per_port_destination_table_key_t key_type;
        typedef npl_db_access_per_port_destination_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_PER_PORT_DESTINATION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_per_port_destination_table");
            return table_name;
        }
    };
    
    struct npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_functional_traits_t {
        typedef npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_key_t key_type;
        typedef npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_TRANSMIT_PER_DEST_PORT_NPU_HOST_MACRO_STAMPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_transmit_per_dest_port_npu_host_macro_stamping_table");
            return table_name;
        }
    };
    
    struct npl_db_access_vlan_membership_table_lu_c_res_c_functional_traits_t {
        typedef npl_db_access_vlan_membership_table_lu_c_res_c_key_t key_type;
        typedef npl_db_access_vlan_membership_table_lu_c_res_c_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_C_RES_C;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_vlan_membership_table_lu_c_res_c");
            return table_name;
        }
    };
    
    struct npl_db_access_vlan_membership_table_lu_d_res_c_functional_traits_t {
        typedef npl_db_access_vlan_membership_table_lu_d_res_c_key_t key_type;
        typedef npl_db_access_vlan_membership_table_lu_d_res_c_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C;
        static const std::string& get_table_name() {
            static const std::string table_name("db_access_vlan_membership_table_lu_d_res_c");
            return table_name;
        }
    };
    ...
    struct npl_dest_type_decoding_table_functional_traits_t {
        typedef npl_dest_type_decoding_table_key_t key_type;
        typedef npl_dest_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DEST_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dest_type_decoding_table");
            return table_name;
        }
    };
    ...
    struct npl_dlp0_key_lsb_mapping_table_functional_traits_t {
        typedef npl_dlp0_key_lsb_mapping_table_key_t key_type;
        typedef npl_dlp0_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_DLP0_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dlp0_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 4;
        static bool key_match(const npl_dlp0_key_lsb_mapping_table_key_t& lookup_key, const npl_dlp0_key_lsb_mapping_table_key_t& table_key, const npl_dlp0_key_lsb_mapping_table_key_t& table_mask);
    };
    
    struct npl_dlp1_key_lsb_mapping_table_functional_traits_t {
        typedef npl_dlp1_key_lsb_mapping_table_key_t key_type;
        typedef npl_dlp1_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_DLP1_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dlp1_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 4;
        static bool key_match(const npl_dlp1_key_lsb_mapping_table_key_t& lookup_key, const npl_dlp1_key_lsb_mapping_table_key_t& table_key, const npl_dlp1_key_lsb_mapping_table_key_t& table_mask);
    };
    
    struct npl_dram_cgm_cgm_deq_lut_table_functional_traits_t {
        typedef npl_dram_cgm_cgm_deq_lut_table_key_t key_type;
        typedef npl_dram_cgm_cgm_deq_lut_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DRAM_CGM_CGM_DEQ_LUT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dram_cgm_cgm_deq_lut_table");
            return table_name;
        }
    };
    
    struct npl_dram_cgm_cgm_lut_table_functional_traits_t {
        typedef npl_dram_cgm_cgm_lut_table_key_t key_type;
        typedef npl_dram_cgm_cgm_lut_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DRAM_CGM_CGM_LUT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dram_cgm_cgm_lut_table");
            return table_name;
        }
    };
    
    struct npl_dsp_dest_msbs_for_ecn_table_functional_traits_t {
        typedef npl_dsp_dest_msbs_for_ecn_table_key_t key_type;
        typedef npl_dsp_dest_msbs_for_ecn_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_DSP_DEST_MSBS_FOR_ECN_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dsp_dest_msbs_for_ecn_table");
            return table_name;
        }
        static const size_t table_size = 4;
        static bool key_match(const npl_dsp_dest_msbs_for_ecn_table_key_t& lookup_key, const npl_dsp_dest_msbs_for_ecn_table_key_t& table_key, const npl_dsp_dest_msbs_for_ecn_table_key_t& table_mask);
    };
    
    struct npl_dsp_group_policy_table_functional_traits_t {
        typedef npl_dsp_group_policy_table_key_t key_type;
        typedef npl_dsp_group_policy_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_DSP_GROUP_POLICY_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("dsp_group_policy_table");
            return table_name;
        }
    };
    ...
    struct npl_encap_data_source_select_table_functional_traits_t {
        typedef npl_encap_data_source_select_table_key_t key_type;
        typedef npl_encap_data_source_select_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_ENCAP_DATA_SOURCE_SELECT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("encap_data_source_select_table");
            return table_name;
        }
    };
    ...
    struct npl_ene_rewrite_punt_sa_prefix_index_table_functional_traits_t {
        typedef npl_ene_rewrite_punt_sa_prefix_index_table_key_t key_type;
        typedef npl_ene_rewrite_punt_sa_prefix_index_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_ENE_REWRITE_PUNT_SA_PREFIX_INDEX_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ene_rewrite_punt_sa_prefix_index_table");
            return table_name;
        }
    };
    
    struct npl_ene_rewrite_sa_prefix_index_table_functional_traits_t {
        typedef npl_ene_rewrite_sa_prefix_index_table_key_t key_type;
        typedef npl_ene_rewrite_sa_prefix_index_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_ENE_REWRITE_SA_PREFIX_INDEX_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ene_rewrite_sa_prefix_index_table");
            return table_name;
        }
    };
    ...
    struct npl_eth_fi_core_tcam_table_functional_traits_t {
        typedef npl_eth_fi_core_tcam_table_key_t key_type;
        typedef npl_eth_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_ETH_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("eth_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_eth_fi_core_tcam_table_key_t& lookup_key, const npl_eth_fi_core_tcam_table_key_t& table_key, const npl_eth_fi_core_tcam_table_key_t& table_mask);
    };
    ...
    struct npl_eth_type_static_table_functional_traits_t {
        typedef npl_eth_type_static_table_key_t key_type;
        typedef npl_eth_type_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_ETH_TYPE_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("eth_type_static_table");
            return table_name;
        }
    };
    
    struct npl_eve_drop_mapping_hw_table_functional_traits_t {
        typedef npl_eve_drop_mapping_hw_table_key_t key_type;
        typedef npl_eve_drop_mapping_hw_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_EVE_DROP_MAPPING_HW_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("eve_drop_mapping_hw_table");
            return table_name;
        }
    };
    
    struct npl_eve_drop_vlan_id_hw_table_functional_traits_t {
        typedef npl_eve_drop_vlan_id_hw_table_key_t key_type;
        typedef npl_eve_drop_vlan_id_hw_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_EVE_DROP_VLAN_ID_HW_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("eve_drop_vlan_id_hw_table");
            return table_name;
        }
    };
    
    struct npl_eve_interrupt_mapping_hw_table_functional_traits_t {
        typedef npl_eve_interrupt_mapping_hw_table_key_t key_type;
        typedef npl_eve_interrupt_mapping_hw_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_EVE_INTERRUPT_MAPPING_HW_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("eve_interrupt_mapping_hw_table");
            return table_name;
        }
    };
    ...
    struct npl_fc_db_performance_vlan_membership_table_functional_traits_t {
        typedef npl_fc_db_performance_vlan_membership_table_key_t key_type;
        typedef npl_fc_db_performance_vlan_membership_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FC_DB_PERFORMANCE_VLAN_MEMBERSHIP_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fc_db_performance_vlan_membership_table");
            return table_name;
        }
    };
    ...
    struct npl_fec_table_functional_traits_t {
        typedef npl_fec_table_key_t key_type;
        typedef npl_fec_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FEC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fec_table");
            return table_name;
        }
    };
    
    struct npl_fec_type_decoding_table_functional_traits_t {
        typedef npl_fec_type_decoding_table_key_t key_type;
        typedef npl_fec_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FEC_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fec_type_decoding_table");
            return table_name;
        }
    };
    ...
    struct npl_fixup_destination_for_resolution_static_table_functional_traits_t {
        typedef npl_fixup_destination_for_resolution_static_table_key_t key_type;
        typedef npl_fixup_destination_for_resolution_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_FIXUP_DESTINATION_FOR_RESOLUTION_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fixup_destination_for_resolution_static_table");
            return table_name;
        }
        static const size_t table_size = 11;
        static bool key_match(const npl_fixup_destination_for_resolution_static_table_key_t& lookup_key, const npl_fixup_destination_for_resolution_static_table_key_t& table_key, const npl_fixup_destination_for_resolution_static_table_key_t& table_mask);
    };
    
    struct npl_flc_cache_range_comp_profile_table_functional_traits_t {
        typedef npl_flc_cache_range_comp_profile_table_key_t key_type;
        typedef npl_flc_cache_range_comp_profile_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_CACHE_RANGE_COMP_PROFILE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_cache_range_comp_profile_table");
            return table_name;
        }
    };
    
    struct npl_flc_data_table_functional_traits_t {
        typedef npl_flc_data_table_key_t key_type;
        typedef npl_flc_data_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_DATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_data_table");
            return table_name;
        }
    };
    
    struct npl_flc_db_table_functional_traits_t {
        typedef npl_flc_db_table_key_t key_type;
        typedef npl_flc_db_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_FLC_DB_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_db_table");
            return table_name;
        }
    };
    
    struct npl_flc_fbm_table_functional_traits_t {
        typedef npl_flc_fbm_table_key_t key_type;
        typedef npl_flc_fbm_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_FBM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_fbm_table");
            return table_name;
        }
    };
    
    struct npl_flc_header_types_array_table_functional_traits_t {
        typedef npl_flc_header_types_array_table_key_t key_type;
        typedef npl_flc_header_types_array_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_FLC_HEADER_TYPES_ARRAY_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_header_types_array_table");
            return table_name;
        }
        static const size_t table_size = 256;
        static bool key_match(const npl_flc_header_types_array_table_key_t& lookup_key, const npl_flc_header_types_array_table_key_t& table_key, const npl_flc_header_types_array_table_key_t& table_mask);
    };
    
    struct npl_flc_map_header_type_mask_id_table_functional_traits_t {
        typedef npl_flc_map_header_type_mask_id_table_key_t key_type;
        typedef npl_flc_map_header_type_mask_id_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_ID_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_map_header_type_mask_id_table");
            return table_name;
        }
    };
    
    struct npl_flc_map_header_type_mask_l_table_functional_traits_t {
        typedef npl_flc_map_header_type_mask_l_table_key_t key_type;
        typedef npl_flc_map_header_type_mask_l_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_L_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_map_header_type_mask_l_table");
            return table_name;
        }
    };
    
    struct npl_flc_map_header_type_mask_m_table_functional_traits_t {
        typedef npl_flc_map_header_type_mask_m_table_key_t key_type;
        typedef npl_flc_map_header_type_mask_m_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_M_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_map_header_type_mask_m_table");
            return table_name;
        }
    };
    
    struct npl_flc_map_header_type_mask_s_table_functional_traits_t {
        typedef npl_flc_map_header_type_mask_s_table_key_t key_type;
        typedef npl_flc_map_header_type_mask_s_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_S_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_map_header_type_mask_s_table");
            return table_name;
        }
    };
    
    struct npl_flc_q_range_comp_profile_table_functional_traits_t {
        typedef npl_flc_q_range_comp_profile_table_key_t key_type;
        typedef npl_flc_q_range_comp_profile_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_Q_RANGE_COMP_PROFILE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_q_range_comp_profile_table");
            return table_name;
        }
    };
    
    struct npl_flc_range_comp_ranges_table_functional_traits_t {
        typedef npl_flc_range_comp_ranges_table_key_t key_type;
        typedef npl_flc_range_comp_ranges_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FLC_RANGE_COMP_RANGES_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("flc_range_comp_ranges_table");
            return table_name;
        }
    };
    ...
    struct npl_fwd_and_encap_types_to_field_a_offset_table_functional_traits_t {
        typedef npl_fwd_and_encap_types_to_field_a_offset_table_key_t key_type;
        typedef npl_fwd_and_encap_types_to_field_a_offset_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_A_OFFSET_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_and_encap_types_to_field_a_offset_table");
            return table_name;
        }
    };
    
    struct npl_fwd_and_encap_types_to_field_b_offset_table_functional_traits_t {
        typedef npl_fwd_and_encap_types_to_field_b_offset_table_key_t key_type;
        typedef npl_fwd_and_encap_types_to_field_b_offset_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_B_OFFSET_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_and_encap_types_to_field_b_offset_table");
            return table_name;
        }
    };
    
    struct npl_fwd_bucket_a_lu_data_selector_functional_traits_t {
        typedef npl_fwd_bucket_a_lu_data_selector_key_t key_type;
        typedef npl_fwd_bucket_a_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_BUCKET_A_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_bucket_a_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_fwd_bucket_b_lu_data_selector_functional_traits_t {
        typedef npl_fwd_bucket_b_lu_data_selector_key_t key_type;
        typedef npl_fwd_bucket_b_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_BUCKET_B_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_bucket_b_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_fwd_bucket_c_lu_data_selector_functional_traits_t {
        typedef npl_fwd_bucket_c_lu_data_selector_key_t key_type;
        typedef npl_fwd_bucket_c_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_BUCKET_C_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_bucket_c_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_fwd_bucket_d_lu_data_selector_functional_traits_t {
        typedef npl_fwd_bucket_d_lu_data_selector_key_t key_type;
        typedef npl_fwd_bucket_d_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_FWD_BUCKET_D_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("fwd_bucket_d_lu_data_selector");
            return table_name;
        }
    };
    ...
    struct npl_ip_fi_core_tcam_table_functional_traits_t {
        typedef npl_ip_fi_core_tcam_table_key_t key_type;
        typedef npl_ip_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_IP_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ip_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_ip_fi_core_tcam_table_key_t& lookup_key, const npl_ip_fi_core_tcam_table_key_t& table_key, const npl_ip_fi_core_tcam_table_key_t& table_mask);
    };
    ...
    struct npl_ip_inactivity_check_table_functional_traits_t {
        typedef npl_ip_inactivity_check_table_key_t key_type;
        typedef npl_ip_inactivity_check_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_IP_INACTIVITY_CHECK_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ip_inactivity_check_table");
            return table_name;
        }
        static const size_t table_size = 1;
        static bool key_match(const npl_ip_inactivity_check_table_key_t& lookup_key, const npl_ip_inactivity_check_table_key_t& table_key, const npl_ip_inactivity_check_table_key_t& table_mask);
    };
    ...
    struct npl_ip_mc_mpls_next_macro_static_table_functional_traits_t {
        typedef npl_ip_mc_mpls_next_macro_static_table_key_t key_type;
        typedef npl_ip_mc_mpls_next_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_IP_MC_MPLS_NEXT_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ip_mc_mpls_next_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 3;
        static bool key_match(const npl_ip_mc_mpls_next_macro_static_table_key_t& lookup_key, const npl_ip_mc_mpls_next_macro_static_table_key_t& table_key, const npl_ip_mc_mpls_next_macro_static_table_key_t& table_mask);
    };
    ...
    struct npl_ip_proto_type_mux_static_table_functional_traits_t {
        typedef npl_ip_proto_type_mux_static_table_key_t key_type;
        typedef npl_ip_proto_type_mux_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_IP_PROTO_TYPE_MUX_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ip_proto_type_mux_static_table");
            return table_name;
        }
        static const size_t table_size = 6;
        static bool key_match(const npl_ip_proto_type_mux_static_table_key_t& lookup_key, const npl_ip_proto_type_mux_static_table_key_t& table_key, const npl_ip_proto_type_mux_static_table_key_t& table_mask);
    };
    ...
    struct npl_ipv4_ip_tunnel_termination_dip_tt0_table_functional_traits_t {
        typedef npl_ipv4_ip_tunnel_termination_dip_tt0_table_key_t key_type;
        typedef npl_ipv4_ip_tunnel_termination_dip_tt0_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_IPV4_IP_TUNNEL_TERMINATION_DIP_TT0_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ipv4_ip_tunnel_termination_dip_tt0_table");
            return table_name;
        }
    };
    ...
    struct npl_ipv4_sgt_em_table_functional_traits_t {
        typedef npl_ipv4_sgt_em_table_key_t key_type;
        typedef npl_ipv4_sgt_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_IPV4_SGT_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ipv4_sgt_em_table");
            return table_name;
        }
    };
    
    struct npl_ipv4_sgt_lpm_table_functional_traits_t {
        typedef npl_ipv4_sgt_lpm_table_key_t key_type;
        typedef npl_ipv4_sgt_lpm_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_LPM;
        static const npl_tables_e table_id = NPL_TABLES_IPV4_SGT_LPM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ipv4_sgt_lpm_table");
            return table_name;
        }
        static void mask_key(npl_ipv4_sgt_lpm_table_key_t* key, size_t length);
    };
    ...
    struct npl_ipv6_sgt_em_table_functional_traits_t {
        typedef npl_ipv6_sgt_em_table_key_t key_type;
        typedef npl_ipv6_sgt_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_IPV6_SGT_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ipv6_sgt_em_table");
            return table_name;
        }
    };
    
    struct npl_ipv6_sgt_lpm_table_functional_traits_t {
        typedef npl_ipv6_sgt_lpm_table_key_t key_type;
        typedef npl_ipv6_sgt_lpm_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_LPM;
        static const npl_tables_e table_id = NPL_TABLES_IPV6_SGT_LPM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("ipv6_sgt_lpm_table");
            return table_name;
        }
        static void mask_key(npl_ipv6_sgt_lpm_table_key_t* key, size_t length);
    };
    ...
    struct npl_l3_lp_profile_filter_table_functional_traits_t {
        typedef npl_l3_lp_profile_filter_table_key_t key_type;
        typedef npl_l3_lp_profile_filter_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_L3_LP_PROFILE_FILTER_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("l3_lp_profile_filter_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_l3_lp_profile_filter_table_key_t& lookup_key, const npl_l3_lp_profile_filter_table_key_t& table_key, const npl_l3_lp_profile_filter_table_key_t& table_mask);
    };
    ...
    struct npl_large_em_key_lsb_mapping_table_functional_traits_t {
        typedef npl_large_em_key_lsb_mapping_table_key_t key_type;
        typedef npl_large_em_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_LARGE_EM_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("large_em_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 4;
        static bool key_match(const npl_large_em_key_lsb_mapping_table_key_t& lookup_key, const npl_large_em_key_lsb_mapping_table_key_t& table_key, const npl_large_em_key_lsb_mapping_table_key_t& table_mask);
    };
    ...
    struct npl_link_relay_id_static_table_functional_traits_t {
        typedef npl_link_relay_id_static_table_key_t key_type;
        typedef npl_link_relay_id_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_LINK_RELAY_ID_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("link_relay_id_static_table");
            return table_name;
        }
    };
    ...
    struct npl_local_mc_fwd_next_macro_static_table_functional_traits_t {
        typedef npl_local_mc_fwd_next_macro_static_table_key_t key_type;
        typedef npl_local_mc_fwd_next_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_LOCAL_MC_FWD_NEXT_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("local_mc_fwd_next_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 13;
        static bool key_match(const npl_local_mc_fwd_next_macro_static_table_key_t& lookup_key, const npl_local_mc_fwd_next_macro_static_table_key_t& table_key, const npl_local_mc_fwd_next_macro_static_table_key_t& table_mask);
    };
    ...
    struct npl_mac_forwarding_w_metadata_table_functional_traits_t {
        typedef npl_mac_forwarding_w_metadata_table_key_t key_type;
        typedef npl_mac_forwarding_w_metadata_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_MAC_FORWARDING_W_METADATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("mac_forwarding_w_metadata_table");
            return table_name;
        }
    };
    ...
    struct npl_mc_cud_table_functional_traits_t {
        typedef npl_mc_cud_table_key_t key_type;
        typedef npl_mc_cud_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_MC_CUD_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("mc_cud_table");
            return table_name;
        }
    };
    ...
    struct npl_mirror_code_2_hw_table_functional_traits_t {
        typedef npl_mirror_code_2_hw_table_key_t key_type;
        typedef npl_mirror_code_2_hw_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_MIRROR_CODE_2_HW_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("mirror_code_2_hw_table");
            return table_name;
        }
    };
    ...
    struct npl_nh_macro_code_to_id_l6_static_table_functional_traits_t {
        ...
        static const size_t table_size = 4;
        static bool key_match(const npl_nh_macro_code_to_id_l6_static_table_key_t& lookup_key, const npl_nh_macro_code_to_id_l6_static_table_key_t& table_key, const npl_nh_macro_code_to_id_l6_static_table_key_t& table_mask);
    };
    ...
    struct npl_npp_sgt_attributes_table_functional_traits_t {
        typedef npl_npp_sgt_attributes_table_key_t key_type;
        typedef npl_npp_sgt_attributes_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_NPP_SGT_ATTRIBUTES_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("npp_sgt_attributes_table");
            return table_name;
        }
    };
    ...
    struct npl_pbts_map_table_stage0_functional_traits_t {
        typedef npl_pbts_map_table_stage0_key_t key_type;
        typedef npl_pbts_map_table_stage0_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_PBTS_MAP_TABLE_STAGE0;
        static const std::string& get_table_name() {
            static const std::string table_name("pbts_map_table_stage0");
            return table_name;
        }
    };
    
    struct npl_pbts_map_table_stage1_functional_traits_t {
        typedef npl_pbts_map_table_stage1_key_t key_type;
        typedef npl_pbts_map_table_stage1_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_PBTS_MAP_TABLE_STAGE1;
        static const std::string& get_table_name() {
            static const std::string table_name("pbts_map_table_stage1");
            return table_name;
        }
    };
    
    struct npl_pbts_map_table_stage2_functional_traits_t {
        typedef npl_pbts_map_table_stage2_key_t key_type;
        typedef npl_pbts_map_table_stage2_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_PBTS_MAP_TABLE_STAGE2;
        static const std::string& get_table_name() {
            static const std::string table_name("pbts_map_table_stage2");
            return table_name;
        }
    };
    
    struct npl_pbts_map_table_stage3_functional_traits_t {
        typedef npl_pbts_map_table_stage3_key_t key_type;
        typedef npl_pbts_map_table_stage3_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_PBTS_MAP_TABLE_STAGE3;
        static const std::string& get_table_name() {
            static const std::string table_name("pbts_map_table_stage3");
            return table_name;
        }
    };
    ...
    struct npl_pdvoq_slice_dram_wred_lut_table_functional_traits_t {
        typedef npl_pdvoq_slice_dram_wred_lut_table_key_t key_type;
        typedef npl_pdvoq_slice_dram_wred_lut_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_PDVOQ_SLICE_DRAM_WRED_LUT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("pdvoq_slice_dram_wred_lut_table");
            return table_name;
        }
    };
    ...
    struct npl_post_fwd_rtf_next_macro_static_table_functional_traits_t {
        typedef npl_post_fwd_rtf_next_macro_static_table_key_t key_type;
        typedef npl_post_fwd_rtf_next_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_POST_FWD_RTF_NEXT_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("post_fwd_rtf_next_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 27;
        static bool key_match(const npl_post_fwd_rtf_next_macro_static_table_key_t& lookup_key, const npl_post_fwd_rtf_next_macro_static_table_key_t& table_key, const npl_post_fwd_rtf_next_macro_static_table_key_t& table_mask);
    };
    
    struct npl_probe_marker_1_static_table_functional_traits_t {
        typedef npl_probe_marker_1_static_table_key_t key_type;
        typedef npl_probe_marker_1_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_PROBE_MARKER_1_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("probe_marker_1_static_table");
            return table_name;
        }
        static const size_t table_size = 1;
        static bool key_match(const npl_probe_marker_1_static_table_key_t& lookup_key, const npl_probe_marker_1_static_table_key_t& table_key, const npl_probe_marker_1_static_table_key_t& table_mask);
    };
    
    struct npl_probe_marker_2_static_table_functional_traits_t {
        typedef npl_probe_marker_2_static_table_key_t key_type;
        typedef npl_probe_marker_2_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_PROBE_MARKER_2_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("probe_marker_2_static_table");
            return table_name;
        }
        static const size_t table_size = 1;
        static bool key_match(const npl_probe_marker_2_static_table_key_t& lookup_key, const npl_probe_marker_2_static_table_key_t& table_key, const npl_probe_marker_2_static_table_key_t& table_mask);
    };
    ...
    struct npl_rx_counters_bank_id_map_config_functional_traits_t {
        typedef npl_rx_counters_bank_id_map_config_key_t key_type;
        typedef npl_rx_counters_bank_id_map_config_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_RX_COUNTERS_BANK_ID_MAP_CONFIG;
        static const std::string& get_table_name() {
            static const std::string table_name("rx_counters_bank_id_map_config");
            return table_name;
        }
    };
    ...
    struct npl_rx_meter_bank_offset_map_functional_traits_t {
        typedef npl_rx_meter_bank_offset_map_key_t key_type;
        typedef npl_rx_meter_bank_offset_map_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_RX_METER_BANK_OFFSET_MAP;
        static const std::string& get_table_name() {
            static const std::string table_name("rx_meter_bank_offset_map");
            return table_name;
        }
    };
    ...
    struct npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_functional_traits_t {
        typedef npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_key_t key_type;
        typedef npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_RXPDR_FE_RLB_UC_TX_FB_LINK_TO_OQ_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table");
            return table_name;
        }
    };
    ...
    struct npl_sda_fabric_enable_table_functional_traits_t {
        typedef npl_sda_fabric_enable_table_key_t key_type;
        typedef npl_sda_fabric_enable_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SDA_FABRIC_ENABLE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sda_fabric_enable_table");
            return table_name;
        }
    };
    ...
    struct npl_select_mac_forwarding_static_table_functional_traits_t {
        typedef npl_select_mac_forwarding_static_table_key_t key_type;
        typedef npl_select_mac_forwarding_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SELECT_MAC_FORWARDING_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("select_mac_forwarding_static_table");
            return table_name;
        }
    };
    ...
    struct npl_service_mapping0_key_lsb_mapping_table_functional_traits_t {
        typedef npl_service_mapping0_key_lsb_mapping_table_key_t key_type;
        typedef npl_service_mapping0_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SERVICE_MAPPING0_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("service_mapping0_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_service_mapping0_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping0_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping0_key_lsb_mapping_table_key_t& table_mask);
    };
    
    struct npl_service_mapping1_key_lsb_mapping_table_functional_traits_t {
        typedef npl_service_mapping1_key_lsb_mapping_table_key_t key_type;
        typedef npl_service_mapping1_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SERVICE_MAPPING1_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("service_mapping1_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_service_mapping1_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping1_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping1_key_lsb_mapping_table_key_t& table_mask);
    };
    ...
    struct npl_service_mapping_tcam_key_lsb_mapping_table_functional_traits_t {
        typedef npl_service_mapping_tcam_key_lsb_mapping_table_key_t key_type;
        typedef npl_service_mapping_tcam_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SERVICE_MAPPING_TCAM_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("service_mapping_tcam_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& table_mask);
    };
    ...
    struct npl_service_relay_id_static_table_functional_traits_t {
        typedef npl_service_relay_id_static_table_key_t key_type;
        typedef npl_service_relay_id_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SERVICE_RELAY_ID_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("service_relay_id_static_table");
            return table_name;
        }
    };
    ...
    struct npl_sgacl_counter_bank_table_functional_traits_t {
        typedef npl_sgacl_counter_bank_table_key_t key_type;
        typedef npl_sgacl_counter_bank_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SGACL_COUNTER_BANK_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgacl_counter_bank_table");
            return table_name;
        }
    };
    
    struct npl_sgacl_ip_fragment_check_table_functional_traits_t {
        typedef npl_sgacl_ip_fragment_check_table_key_t key_type;
        typedef npl_sgacl_ip_fragment_check_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SGACL_IP_FRAGMENT_CHECK_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgacl_ip_fragment_check_table");
            return table_name;
        }
        static const size_t table_size = 3;
        static bool key_match(const npl_sgacl_ip_fragment_check_table_key_t& lookup_key, const npl_sgacl_ip_fragment_check_table_key_t& table_key, const npl_sgacl_ip_fragment_check_table_key_t& table_mask);
    };
    
    struct npl_sgacl_l4_protocol_select_table_functional_traits_t {
        typedef npl_sgacl_l4_protocol_select_table_key_t key_type;
        typedef npl_sgacl_l4_protocol_select_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SGACL_L4_PROTOCOL_SELECT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgacl_l4_protocol_select_table");
            return table_name;
        }
    };
    
    struct npl_sgacl_next_macro_static_table_functional_traits_t {
        typedef npl_sgacl_next_macro_static_table_key_t key_type;
        typedef npl_sgacl_next_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SGACL_NEXT_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgacl_next_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 5;
        static bool key_match(const npl_sgacl_next_macro_static_table_key_t& lookup_key, const npl_sgacl_next_macro_static_table_key_t& table_key, const npl_sgacl_next_macro_static_table_key_t& table_mask);
    };
    ...
    struct npl_sgt_derivation_macro_static_table_functional_traits_t {
        typedef npl_sgt_derivation_macro_static_table_key_t key_type;
        typedef npl_sgt_derivation_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SGT_DERIVATION_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgt_derivation_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 6;
        static bool key_match(const npl_sgt_derivation_macro_static_table_key_t& lookup_key, const npl_sgt_derivation_macro_static_table_key_t& table_key, const npl_sgt_derivation_macro_static_table_key_t& table_mask);
    };
    
    struct npl_sgt_matrix_table_functional_traits_t {
        typedef npl_sgt_matrix_table_key_t key_type;
        typedef npl_sgt_matrix_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_SGT_MATRIX_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgt_matrix_table");
            return table_name;
        }
    };
    
    struct npl_sgt_vxlan_termination_table_functional_traits_t {
        typedef npl_sgt_vxlan_termination_table_key_t key_type;
        typedef npl_sgt_vxlan_termination_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SGT_VXLAN_TERMINATION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("sgt_vxlan_termination_table");
            return table_name;
        }
        static const size_t table_size = 2;
        static bool key_match(const npl_sgt_vxlan_termination_table_key_t& lookup_key, const npl_sgt_vxlan_termination_table_key_t& table_key, const npl_sgt_vxlan_termination_table_key_t& table_mask);
    };
    ...
    struct npl_small_em_key_lsb_mapping_table_functional_traits_t {
        typedef npl_small_em_key_lsb_mapping_table_key_t key_type;
        typedef npl_small_em_key_lsb_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SMALL_EM_KEY_LSB_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("small_em_key_lsb_mapping_table");
            return table_name;
        }
        static const size_t table_size = 4;
        static bool key_match(const npl_small_em_key_lsb_mapping_table_key_t& lookup_key, const npl_small_em_key_lsb_mapping_table_key_t& table_key, const npl_small_em_key_lsb_mapping_table_key_t& table_mask);
    };
    ...
    struct npl_source_port_to_link_table_functional_traits_t {
        typedef npl_source_port_to_link_table_key_t key_type;
        typedef npl_source_port_to_link_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SOURCE_PORT_TO_LINK_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("source_port_to_link_table");
            return table_name;
        }
    };
    
    struct npl_splitter_lu_b_key_selector_functional_traits_t {
        typedef npl_splitter_lu_b_key_selector_key_t key_type;
        typedef npl_splitter_lu_b_key_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SPLITTER_LU_B_KEY_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("splitter_lu_b_key_selector");
            return table_name;
        }
        static const size_t table_size = 3;
        static bool key_match(const npl_splitter_lu_b_key_selector_key_t& lookup_key, const npl_splitter_lu_b_key_selector_key_t& table_key, const npl_splitter_lu_b_key_selector_key_t& table_mask);
    };
    
    struct npl_splitter_lu_d_key_selector_functional_traits_t {
        typedef npl_splitter_lu_d_key_selector_key_t key_type;
        typedef npl_splitter_lu_d_key_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SPLITTER_LU_D_KEY_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("splitter_lu_d_key_selector");
            return table_name;
        }
        static const size_t table_size = 3;
        static bool key_match(const npl_splitter_lu_d_key_selector_key_t& lookup_key, const npl_splitter_lu_d_key_selector_key_t& table_key, const npl_splitter_lu_d_key_selector_key_t& table_mask);
    };
    
    struct npl_stage0_assoc_data_table_functional_traits_t {
        typedef npl_stage0_assoc_data_table_key_t key_type;
        typedef npl_stage0_assoc_data_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE0_ASSOC_DATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage0_assoc_data_table");
            return table_name;
        }
    };
    
    struct npl_stage0_em_table_functional_traits_t {
        typedef npl_stage0_em_table_key_t key_type;
        typedef npl_stage0_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_STAGE0_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage0_em_table");
            return table_name;
        }
    };
    
    struct npl_stage0_group_size_table_functional_traits_t {
        typedef npl_stage0_group_size_table_key_t key_type;
        typedef npl_stage0_group_size_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE0_GROUP_SIZE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage0_group_size_table");
            return table_name;
        }
    };
    
    struct npl_stage0_protection_table_functional_traits_t {
        typedef npl_stage0_protection_table_key_t key_type;
        typedef npl_stage0_protection_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE0_PROTECTION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage0_protection_table");
            return table_name;
        }
    };
    
    struct npl_stage0_type_decoding_table_functional_traits_t {
        typedef npl_stage0_type_decoding_table_key_t key_type;
        typedef npl_stage0_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE0_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage0_type_decoding_table");
            return table_name;
        }
    };
    
    struct npl_stage1_assoc_data_table_functional_traits_t {
        typedef npl_stage1_assoc_data_table_key_t key_type;
        typedef npl_stage1_assoc_data_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE1_ASSOC_DATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage1_assoc_data_table");
            return table_name;
        }
    };
    
    struct npl_stage1_em_table_functional_traits_t {
        typedef npl_stage1_em_table_key_t key_type;
        typedef npl_stage1_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_STAGE1_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage1_em_table");
            return table_name;
        }
    };
    
    struct npl_stage1_group_size_table_functional_traits_t {
        typedef npl_stage1_group_size_table_key_t key_type;
        typedef npl_stage1_group_size_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE1_GROUP_SIZE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage1_group_size_table");
            return table_name;
        }
    };
    
    struct npl_stage1_protection_table_functional_traits_t {
        typedef npl_stage1_protection_table_key_t key_type;
        typedef npl_stage1_protection_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE1_PROTECTION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage1_protection_table");
            return table_name;
        }
    };
    
    struct npl_stage1_type_decoding_table_functional_traits_t {
        typedef npl_stage1_type_decoding_table_key_t key_type;
        typedef npl_stage1_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE1_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage1_type_decoding_table");
            return table_name;
        }
    };
    
    struct npl_stage2_assoc_data_table_functional_traits_t {
        typedef npl_stage2_assoc_data_table_key_t key_type;
        typedef npl_stage2_assoc_data_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE2_ASSOC_DATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage2_assoc_data_table");
            return table_name;
        }
    };
    
    struct npl_stage2_em_table_functional_traits_t {
        typedef npl_stage2_em_table_key_t key_type;
        typedef npl_stage2_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_STAGE2_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage2_em_table");
            return table_name;
        }
    };
    
    struct npl_stage2_group_size_table_functional_traits_t {
        typedef npl_stage2_group_size_table_key_t key_type;
        typedef npl_stage2_group_size_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE2_GROUP_SIZE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage2_group_size_table");
            return table_name;
        }
    };
    
    struct npl_stage2_protection_table_functional_traits_t {
        typedef npl_stage2_protection_table_key_t key_type;
        typedef npl_stage2_protection_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE2_PROTECTION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage2_protection_table");
            return table_name;
        }
    };
    
    struct npl_stage2_type_decoding_table_functional_traits_t {
        typedef npl_stage2_type_decoding_table_key_t key_type;
        typedef npl_stage2_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE2_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage2_type_decoding_table");
            return table_name;
        }
    };
    
    struct npl_stage3_assoc_data_table_functional_traits_t {
        typedef npl_stage3_assoc_data_table_key_t key_type;
        typedef npl_stage3_assoc_data_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE3_ASSOC_DATA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage3_assoc_data_table");
            return table_name;
        }
    };
    
    struct npl_stage3_em_table_functional_traits_t {
        typedef npl_stage3_em_table_key_t key_type;
        typedef npl_stage3_em_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_STAGE3_EM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage3_em_table");
            return table_name;
        }
    };
    
    struct npl_stage3_group_size_table_functional_traits_t {
        typedef npl_stage3_group_size_table_key_t key_type;
        typedef npl_stage3_group_size_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE3_GROUP_SIZE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage3_group_size_table");
            return table_name;
        }
    };
    
    struct npl_stage3_protection_table_functional_traits_t {
        typedef npl_stage3_protection_table_key_t key_type;
        typedef npl_stage3_protection_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE3_PROTECTION_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage3_protection_table");
            return table_name;
        }
    };
    
    struct npl_stage3_type_decoding_table_functional_traits_t {
        typedef npl_stage3_type_decoding_table_key_t key_type;
        typedef npl_stage3_type_decoding_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_STAGE3_TYPE_DECODING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("stage3_type_decoding_table");
            return table_name;
        }
    };
    
    struct npl_svl_dspa_table_functional_traits_t {
        typedef npl_svl_dspa_table_key_t key_type;
        typedef npl_svl_dspa_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SVL_DSPA_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_dspa_table");
            return table_name;
        }
    };
    
    struct npl_svl_is_dsp_remote_functional_traits_t {
        typedef npl_svl_is_dsp_remote_key_t key_type;
        typedef npl_svl_is_dsp_remote_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SVL_IS_DSP_REMOTE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_is_dsp_remote");
            return table_name;
        }
        static const size_t table_size = 5;
        static bool key_match(const npl_svl_is_dsp_remote_key_t& lookup_key, const npl_svl_is_dsp_remote_key_t& table_key, const npl_svl_is_dsp_remote_key_t& table_mask);
    };
    
    struct npl_svl_mirror_cmd_remote_dsp_table_functional_traits_t {
        typedef npl_svl_mirror_cmd_remote_dsp_table_key_t key_type;
        typedef npl_svl_mirror_cmd_remote_dsp_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SVL_MIRROR_CMD_REMOTE_DSP_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_mirror_cmd_remote_dsp_table");
            return table_name;
        }
    };
    
    struct npl_svl_mode_table_functional_traits_t {
        typedef npl_svl_mode_table_key_t key_type;
        typedef npl_svl_mode_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_SVL_MODE_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_mode_table");
            return table_name;
        }
    };
    ...
    struct npl_svl_sgacl_enable_static_table_functional_traits_t {
        typedef npl_svl_sgacl_enable_static_table_key_t key_type;
        typedef npl_svl_sgacl_enable_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SVL_SGACL_ENABLE_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_sgacl_enable_static_table");
            return table_name;
        }
        static const size_t table_size = 7;
        static bool key_match(const npl_svl_sgacl_enable_static_table_key_t& lookup_key, const npl_svl_sgacl_enable_static_table_key_t& table_key, const npl_svl_sgacl_enable_static_table_key_t& table_mask);
    };
    
    struct npl_svl_sgacl_next_macro_static_table_functional_traits_t {
        typedef npl_svl_sgacl_next_macro_static_table_key_t key_type;
        typedef npl_svl_sgacl_next_macro_static_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_SVL_SGACL_NEXT_MACRO_STATIC_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("svl_sgacl_next_macro_static_table");
            return table_name;
        }
        static const size_t table_size = 7;
        static bool key_match(const npl_svl_sgacl_next_macro_static_table_key_t& lookup_key, const npl_svl_sgacl_next_macro_static_table_key_t& table_key, const npl_svl_sgacl_next_macro_static_table_key_t& table_mask);
    };
    ...
    struct npl_term_bucket_a_lu_data_selector_functional_traits_t {
        typedef npl_term_bucket_a_lu_data_selector_key_t key_type;
        typedef npl_term_bucket_a_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TERM_BUCKET_A_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("term_bucket_a_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_term_bucket_b_lu_data_selector_functional_traits_t {
        typedef npl_term_bucket_b_lu_data_selector_key_t key_type;
        typedef npl_term_bucket_b_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TERM_BUCKET_B_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("term_bucket_b_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_term_bucket_c_lu_data_selector_functional_traits_t {
        typedef npl_term_bucket_c_lu_data_selector_key_t key_type;
        typedef npl_term_bucket_c_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TERM_BUCKET_C_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("term_bucket_c_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_term_bucket_d_lu_data_selector_functional_traits_t {
        typedef npl_term_bucket_d_lu_data_selector_key_t key_type;
        typedef npl_term_bucket_d_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TERM_BUCKET_D_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("term_bucket_d_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_term_to_fwd_hdr_shift_table_functional_traits_t {
        typedef npl_term_to_fwd_hdr_shift_table_key_t key_type;
        typedef npl_term_to_fwd_hdr_shift_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TERM_TO_FWD_HDR_SHIFT_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("term_to_fwd_hdr_shift_table");
            return table_name;
        }
    };
    ...
    struct npl_transmit_bucket_a_lu_data_selector_functional_traits_t {
        typedef npl_transmit_bucket_a_lu_data_selector_key_t key_type;
        typedef npl_transmit_bucket_a_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TRANSMIT_BUCKET_A_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("transmit_bucket_a_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_transmit_bucket_b_lu_data_selector_functional_traits_t {
        typedef npl_transmit_bucket_b_lu_data_selector_key_t key_type;
        typedef npl_transmit_bucket_b_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TRANSMIT_BUCKET_B_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("transmit_bucket_b_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_transmit_bucket_c_lu_data_selector_functional_traits_t {
        typedef npl_transmit_bucket_c_lu_data_selector_key_t key_type;
        typedef npl_transmit_bucket_c_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TRANSMIT_BUCKET_C_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("transmit_bucket_c_lu_data_selector");
            return table_name;
        }
    };
    
    struct npl_transmit_bucket_d_lu_data_selector_functional_traits_t {
        typedef npl_transmit_bucket_d_lu_data_selector_key_t key_type;
        typedef npl_transmit_bucket_d_lu_data_selector_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TRANSMIT_BUCKET_D_LU_DATA_SELECTOR;
        static const std::string& get_table_name() {
            static const std::string table_name("transmit_bucket_d_lu_data_selector");
            return table_name;
        }
    };
    ...
    struct npl_tx_counters_bank_id_map_config_functional_traits_t {
        typedef npl_tx_counters_bank_id_map_config_key_t key_type;
        typedef npl_tx_counters_bank_id_map_config_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TX_COUNTERS_BANK_ID_MAP_CONFIG;
        static const std::string& get_table_name() {
            static const std::string table_name("tx_counters_bank_id_map_config");
            return table_name;
        }
    };
    ...
    struct npl_txpp_dlp_profile_key_construct_parameters_table_functional_traits_t {
        typedef npl_txpp_dlp_profile_key_construct_parameters_table_key_t key_type;
        typedef npl_txpp_dlp_profile_key_construct_parameters_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_TXPP_DLP_PROFILE_KEY_CONSTRUCT_PARAMETERS_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("txpp_dlp_profile_key_construct_parameters_table");
            return table_name;
        }
    };
    
    struct npl_txpp_em_dlp_profile_mapping_table_functional_traits_t {
        typedef npl_txpp_em_dlp_profile_mapping_table_key_t key_type;
        typedef npl_txpp_em_dlp_profile_mapping_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_EM;
        static const npl_tables_e table_id = NPL_TABLES_TXPP_EM_DLP_PROFILE_MAPPING_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("txpp_em_dlp_profile_mapping_table");
            return table_name;
        }
    };
    ...
    struct npl_udp_fi_core_tcam_table_functional_traits_t {
        typedef npl_udp_fi_core_tcam_table_key_t key_type;
        typedef npl_udp_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_UDP_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("udp_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_udp_fi_core_tcam_table_key_t& lookup_key, const npl_udp_fi_core_tcam_table_key_t& table_key, const npl_udp_fi_core_tcam_table_key_t& table_mask);
    };
    ...
    struct npl_vlan0_fi_core_tcam_table_functional_traits_t {
        typedef npl_vlan0_fi_core_tcam_table_key_t key_type;
        typedef npl_vlan0_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_VLAN0_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("vlan0_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_vlan0_fi_core_tcam_table_key_t& lookup_key, const npl_vlan0_fi_core_tcam_table_key_t& table_key, const npl_vlan0_fi_core_tcam_table_key_t& table_mask);
    };
    
    struct npl_vlan1_fi_core_tcam_table_functional_traits_t {
        typedef npl_vlan1_fi_core_tcam_table_key_t key_type;
        typedef npl_vlan1_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_VLAN1_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("vlan1_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_vlan1_fi_core_tcam_table_key_t& lookup_key, const npl_vlan1_fi_core_tcam_table_key_t& table_key, const npl_vlan1_fi_core_tcam_table_key_t& table_mask);
    };
    ...
    struct npl_vlan_pe_fi_core_tcam_table_functional_traits_t {
        typedef npl_vlan_pe_fi_core_tcam_table_key_t key_type;
        typedef npl_vlan_pe_fi_core_tcam_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_TERNARY;
        static const npl_tables_e table_id = NPL_TABLES_VLAN_PE_FI_CORE_TCAM_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("vlan_pe_fi_core_tcam_table");
            return table_name;
        }
        static const size_t table_size = 16;
        static bool key_match(const npl_vlan_pe_fi_core_tcam_table_key_t& lookup_key, const npl_vlan_pe_fi_core_tcam_table_key_t& table_key, const npl_vlan_pe_fi_core_tcam_table_key_t& table_mask);
    };
    ...
    struct npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_functional_traits_t {
        typedef npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_key_t key_type;
        typedef npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_BUFFERS_CONSUMPTION_LUT_FOR_DEQ_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_buffers_consumption_lut_for_deq_table");
            return table_name;
        }
    };
    ...
    struct npl_voq_cgm_slice_drop_green_probability_selector_table_functional_traits_t {
        typedef npl_voq_cgm_slice_drop_green_probability_selector_table_key_t key_type;
        typedef npl_voq_cgm_slice_drop_green_probability_selector_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_DROP_GREEN_PROBABILITY_SELECTOR_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_drop_green_probability_selector_table");
            return table_name;
        }
    };
    
    struct npl_voq_cgm_slice_drop_yellow_probability_selector_table_functional_traits_t {
        typedef npl_voq_cgm_slice_drop_yellow_probability_selector_table_key_t key_type;
        typedef npl_voq_cgm_slice_drop_yellow_probability_selector_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_DROP_YELLOW_PROBABILITY_SELECTOR_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_drop_yellow_probability_selector_table");
            return table_name;
        }
    };
    
    struct npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_functional_traits_t {
        typedef npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_key_t key_type;
        typedef npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_EVICTED_BUFFERS_CONSUMPTION_LUT_FOR_ENQ_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table");
            return table_name;
        }
    };
    
    struct npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_functional_traits_t {
        typedef npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_key_t key_type;
        typedef npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_EVICTION_OK_LUT_FOR_ENQ_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_eviction_ok_lut_for_enq_table");
            return table_name;
        }
    };
    
    struct npl_voq_cgm_slice_mark_probability_selector_table_functional_traits_t {
        typedef npl_voq_cgm_slice_mark_probability_selector_table_key_t key_type;
        typedef npl_voq_cgm_slice_mark_probability_selector_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_MARK_PROBABILITY_SELECTOR_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_mark_probability_selector_table");
            return table_name;
        }
    };
    
    struct npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_functional_traits_t {
        typedef npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_key_t key_type;
        typedef npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_SLICE_PD_CONSUMPTION_LUT_FOR_DEQ_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_slice_pd_consumption_lut_for_deq_table");
            return table_name;
        }
    };
    ...
    struct npl_voq_cgm_wred_probability_table_functional_traits_t {
        typedef npl_voq_cgm_wred_probability_table_key_t key_type;
        typedef npl_voq_cgm_wred_probability_table_value_t value_type;
        static const table_type_e table_type = TABLE_TYPE_DIRECT;
        static const npl_tables_e table_id = NPL_TABLES_VOQ_CGM_WRED_PROBABILITY_TABLE;
        static const std::string& get_table_name() {
            static const std::string table_name("voq_cgm_wred_probability_table");
            return table_name;
        }
    };
