...
namespace silicon_one {
    ...
    public:
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_cong_level_ecn_remap_map_table_key_t& key, const npl_cong_level_ecn_remap_map_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_cong_level_ecn_remap_map_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_ingress_vlan_membership_table_lu_d_res_c_key_t& key, const npl_db_access_ingress_vlan_membership_table_lu_d_res_c_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_ingress_vlan_membership_table_lu_d_res_c_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_ingress_vlan_membership_table_lu_d_res_d_key_t& key, const npl_db_access_ingress_vlan_membership_table_lu_d_res_d_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_ingress_vlan_membership_table_lu_d_res_d_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_per_port_destination_table_key_t& key, const npl_db_access_per_port_destination_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_per_port_destination_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_key_t& key, const npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_vlan_membership_table_lu_c_res_c_key_t& key, const npl_db_access_vlan_membership_table_lu_c_res_c_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_vlan_membership_table_lu_c_res_c_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_db_access_vlan_membership_table_lu_d_res_c_key_t& key, const npl_db_access_vlan_membership_table_lu_d_res_c_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_db_access_vlan_membership_table_lu_d_res_c_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_dest_type_decoding_table_key_t& key, const npl_dest_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dest_type_decoding_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_dlp0_key_lsb_mapping_table_key_t& key, const npl_dlp0_key_lsb_mapping_table_key_t& mask, const npl_dlp0_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dlp0_key_lsb_mapping_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_dlp1_key_lsb_mapping_table_key_t& key, const npl_dlp1_key_lsb_mapping_table_key_t& mask, const npl_dlp1_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dlp1_key_lsb_mapping_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_dram_cgm_cgm_deq_lut_table_key_t& key, const npl_dram_cgm_cgm_deq_lut_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dram_cgm_cgm_deq_lut_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_dram_cgm_cgm_lut_table_key_t& key, const npl_dram_cgm_cgm_lut_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dram_cgm_cgm_lut_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_dsp_dest_msbs_for_ecn_table_key_t& key, const npl_dsp_dest_msbs_for_ecn_table_key_t& mask, const npl_dsp_dest_msbs_for_ecn_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dsp_dest_msbs_for_ecn_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_dsp_group_policy_table_key_t& key, const npl_dsp_group_policy_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_dsp_group_policy_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_encap_data_source_select_table_key_t& key, const npl_encap_data_source_select_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_encap_data_source_select_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ene_rewrite_punt_sa_prefix_index_table_key_t& key, const npl_ene_rewrite_punt_sa_prefix_index_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ene_rewrite_punt_sa_prefix_index_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ene_rewrite_sa_prefix_index_table_key_t& key, const npl_ene_rewrite_sa_prefix_index_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ene_rewrite_sa_prefix_index_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_eth_fi_core_tcam_table_key_t& key, const npl_eth_fi_core_tcam_table_key_t& mask, const npl_eth_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_eth_fi_core_tcam_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_eth_type_static_table_key_t& key, const npl_eth_type_static_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_eth_type_static_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_eve_drop_mapping_hw_table_key_t& key, const npl_eve_drop_mapping_hw_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_eve_drop_mapping_hw_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_eve_drop_vlan_id_hw_table_key_t& key, const npl_eve_drop_vlan_id_hw_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_eve_drop_vlan_id_hw_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_eve_interrupt_mapping_hw_table_key_t& key, const npl_eve_interrupt_mapping_hw_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_eve_interrupt_mapping_hw_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fc_db_performance_vlan_membership_table_key_t& key, const npl_fc_db_performance_vlan_membership_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fc_db_performance_vlan_membership_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fec_table_key_t& key, const npl_fec_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fec_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fec_type_decoding_table_key_t& key, const npl_fec_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fec_type_decoding_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_fixup_destination_for_resolution_static_table_key_t& key, const npl_fixup_destination_for_resolution_static_table_key_t& mask, const npl_fixup_destination_for_resolution_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fixup_destination_for_resolution_static_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_cache_range_comp_profile_table_key_t& key, const npl_flc_cache_range_comp_profile_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_cache_range_comp_profile_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_data_table_key_t& key, const npl_flc_data_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_data_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_db_table_key_t& key, const npl_flc_db_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_db_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_fbm_table_key_t& key, const npl_flc_fbm_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_fbm_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_flc_header_types_array_table_key_t& key, const npl_flc_header_types_array_table_key_t& mask, const npl_flc_header_types_array_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_header_types_array_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_id_table_key_t& key, const npl_flc_map_header_type_mask_id_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_id_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_l_table_key_t& key, const npl_flc_map_header_type_mask_l_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_l_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_m_table_key_t& key, const npl_flc_map_header_type_mask_m_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_m_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_s_table_key_t& key, const npl_flc_map_header_type_mask_s_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_map_header_type_mask_s_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_q_range_comp_profile_table_key_t& key, const npl_flc_q_range_comp_profile_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_q_range_comp_profile_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_flc_range_comp_ranges_table_key_t& key, const npl_flc_range_comp_ranges_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_flc_range_comp_ranges_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_and_encap_types_to_field_a_offset_table_key_t& key, const npl_fwd_and_encap_types_to_field_a_offset_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_and_encap_types_to_field_a_offset_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_and_encap_types_to_field_b_offset_table_key_t& key, const npl_fwd_and_encap_types_to_field_b_offset_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_and_encap_types_to_field_b_offset_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_bucket_a_lu_data_selector_key_t& key, const npl_fwd_bucket_a_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_bucket_a_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_bucket_b_lu_data_selector_key_t& key, const npl_fwd_bucket_b_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_bucket_b_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_bucket_c_lu_data_selector_key_t& key, const npl_fwd_bucket_c_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_bucket_c_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_fwd_bucket_d_lu_data_selector_key_t& key, const npl_fwd_bucket_d_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_fwd_bucket_d_lu_data_selector_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_ip_fi_core_tcam_table_key_t& key, const npl_ip_fi_core_tcam_table_key_t& mask, const npl_ip_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ip_fi_core_tcam_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_ip_inactivity_check_table_key_t& key, const npl_ip_inactivity_check_table_key_t& mask, const npl_ip_inactivity_check_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ip_inactivity_check_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_ip_mc_mpls_next_macro_static_table_key_t& key, const npl_ip_mc_mpls_next_macro_static_table_key_t& mask, const npl_ip_mc_mpls_next_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ip_mc_mpls_next_macro_static_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_ip_proto_type_mux_static_table_key_t& key, const npl_ip_proto_type_mux_static_table_key_t& mask, const npl_ip_proto_type_mux_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ip_proto_type_mux_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ipv4_ip_tunnel_termination_dip_tt0_table_key_t& key, const npl_ipv4_ip_tunnel_termination_dip_tt0_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ipv4_ip_tunnel_termination_dip_tt0_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ipv4_sgt_em_table_key_t& key, const npl_ipv4_sgt_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ipv4_sgt_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ipv4_sgt_lpm_table_key_t& key, const npl_ipv4_sgt_lpm_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ipv6_sgt_em_table_key_t& key, const npl_ipv6_sgt_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_ipv6_sgt_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_ipv6_sgt_lpm_table_key_t& key, const npl_ipv6_sgt_lpm_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_l3_lp_profile_filter_table_key_t& key, const npl_l3_lp_profile_filter_table_key_t& mask, const npl_l3_lp_profile_filter_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_l3_lp_profile_filter_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_large_em_key_lsb_mapping_table_key_t& key, const npl_large_em_key_lsb_mapping_table_key_t& mask, const npl_large_em_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_large_em_key_lsb_mapping_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_link_relay_id_static_table_key_t& key, const npl_link_relay_id_static_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_link_relay_id_static_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_local_mc_fwd_next_macro_static_table_key_t& key, const npl_local_mc_fwd_next_macro_static_table_key_t& mask, const npl_local_mc_fwd_next_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_local_mc_fwd_next_macro_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_mac_forwarding_w_metadata_table_key_t& key, const npl_mac_forwarding_w_metadata_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_mac_forwarding_w_metadata_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_mc_cud_table_key_t& key, const npl_mc_cud_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_mc_cud_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_mirror_code_2_hw_table_key_t& key, const npl_mirror_code_2_hw_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_mirror_code_2_hw_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_nh_macro_code_to_id_l6_static_table_key_t& key, const npl_nh_macro_code_to_id_l6_static_table_key_t& mask, const npl_nh_macro_code_to_id_l6_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_nh_macro_code_to_id_l6_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_npp_sgt_attributes_table_key_t& key, const npl_npp_sgt_attributes_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_npp_sgt_attributes_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage0_key_t& key, const npl_pbts_map_table_stage0_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage0_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage1_key_t& key, const npl_pbts_map_table_stage1_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage1_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage2_key_t& key, const npl_pbts_map_table_stage2_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage2_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage3_key_t& key, const npl_pbts_map_table_stage3_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_pbts_map_table_stage3_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_pdvoq_slice_dram_wred_lut_table_key_t& key, const npl_pdvoq_slice_dram_wred_lut_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_pdvoq_slice_dram_wred_lut_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_post_fwd_rtf_next_macro_static_table_key_t& key, const npl_post_fwd_rtf_next_macro_static_table_key_t& mask, const npl_post_fwd_rtf_next_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_post_fwd_rtf_next_macro_static_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_probe_marker_1_static_table_key_t& key, const npl_probe_marker_1_static_table_key_t& mask, const npl_probe_marker_1_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_probe_marker_1_static_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_probe_marker_2_static_table_key_t& key, const npl_probe_marker_2_static_table_key_t& mask, const npl_probe_marker_2_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_probe_marker_2_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_rx_counters_bank_id_map_config_key_t& key, const npl_rx_counters_bank_id_map_config_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_rx_counters_bank_id_map_config_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_rx_meter_bank_offset_map_key_t& key, const npl_rx_meter_bank_offset_map_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_rx_meter_bank_offset_map_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_key_t& key, const npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_sda_fabric_enable_table_key_t& key, const npl_sda_fabric_enable_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sda_fabric_enable_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_select_mac_forwarding_static_table_key_t& key, const npl_select_mac_forwarding_static_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_select_mac_forwarding_static_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_service_mapping0_key_lsb_mapping_table_key_t& key, const npl_service_mapping0_key_lsb_mapping_table_key_t& mask, const npl_service_mapping0_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_service_mapping0_key_lsb_mapping_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_service_mapping1_key_lsb_mapping_table_key_t& key, const npl_service_mapping1_key_lsb_mapping_table_key_t& mask, const npl_service_mapping1_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_service_mapping1_key_lsb_mapping_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& key, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& mask, const npl_service_mapping_tcam_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_service_relay_id_static_table_key_t& key, const npl_service_relay_id_static_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_service_relay_id_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_sgacl_counter_bank_table_key_t& key, const npl_sgacl_counter_bank_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgacl_counter_bank_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_sgacl_ip_fragment_check_table_key_t& key, const npl_sgacl_ip_fragment_check_table_key_t& mask, const npl_sgacl_ip_fragment_check_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgacl_ip_fragment_check_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_sgacl_l4_protocol_select_table_key_t& key, const npl_sgacl_l4_protocol_select_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgacl_l4_protocol_select_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_sgacl_next_macro_static_table_key_t& key, const npl_sgacl_next_macro_static_table_key_t& mask, const npl_sgacl_next_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgacl_next_macro_static_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_sgt_derivation_macro_static_table_key_t& key, const npl_sgt_derivation_macro_static_table_key_t& mask, const npl_sgt_derivation_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgt_derivation_macro_static_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_sgt_matrix_table_key_t& key, const npl_sgt_matrix_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgt_matrix_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_sgt_vxlan_termination_table_key_t& key, const npl_sgt_vxlan_termination_table_key_t& mask, const npl_sgt_vxlan_termination_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_sgt_vxlan_termination_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_small_em_key_lsb_mapping_table_key_t& key, const npl_small_em_key_lsb_mapping_table_key_t& mask, const npl_small_em_key_lsb_mapping_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_small_em_key_lsb_mapping_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_source_port_to_link_table_key_t& key, const npl_source_port_to_link_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_source_port_to_link_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_splitter_lu_b_key_selector_key_t& key, const npl_splitter_lu_b_key_selector_key_t& mask, const npl_splitter_lu_b_key_selector_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_splitter_lu_b_key_selector_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_splitter_lu_d_key_selector_key_t& key, const npl_splitter_lu_d_key_selector_key_t& mask, const npl_splitter_lu_d_key_selector_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_splitter_lu_d_key_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage0_assoc_data_table_key_t& key, const npl_stage0_assoc_data_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage0_assoc_data_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage0_em_table_key_t& key, const npl_stage0_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage0_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage0_group_size_table_key_t& key, const npl_stage0_group_size_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage0_group_size_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage0_protection_table_key_t& key, const npl_stage0_protection_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage0_protection_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage0_type_decoding_table_key_t& key, const npl_stage0_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage0_type_decoding_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage1_assoc_data_table_key_t& key, const npl_stage1_assoc_data_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage1_assoc_data_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage1_em_table_key_t& key, const npl_stage1_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage1_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage1_group_size_table_key_t& key, const npl_stage1_group_size_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage1_group_size_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage1_protection_table_key_t& key, const npl_stage1_protection_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage1_protection_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage1_type_decoding_table_key_t& key, const npl_stage1_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage1_type_decoding_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage2_assoc_data_table_key_t& key, const npl_stage2_assoc_data_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage2_assoc_data_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage2_em_table_key_t& key, const npl_stage2_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage2_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage2_group_size_table_key_t& key, const npl_stage2_group_size_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage2_group_size_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage2_protection_table_key_t& key, const npl_stage2_protection_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage2_protection_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage2_type_decoding_table_key_t& key, const npl_stage2_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage2_type_decoding_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage3_assoc_data_table_key_t& key, const npl_stage3_assoc_data_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage3_assoc_data_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage3_em_table_key_t& key, const npl_stage3_em_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage3_em_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage3_group_size_table_key_t& key, const npl_stage3_group_size_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage3_group_size_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage3_protection_table_key_t& key, const npl_stage3_protection_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage3_protection_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_stage3_type_decoding_table_key_t& key, const npl_stage3_type_decoding_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_stage3_type_decoding_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_svl_dspa_table_key_t& key, const npl_svl_dspa_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_dspa_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_svl_is_dsp_remote_key_t& key, const npl_svl_is_dsp_remote_key_t& mask, const npl_svl_is_dsp_remote_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_is_dsp_remote_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_svl_mirror_cmd_remote_dsp_table_key_t& key, const npl_svl_mirror_cmd_remote_dsp_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_mirror_cmd_remote_dsp_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_svl_mode_table_key_t& key, const npl_svl_mode_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_mode_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_svl_sgacl_enable_static_table_key_t& key, const npl_svl_sgacl_enable_static_table_key_t& mask, const npl_svl_sgacl_enable_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_sgacl_enable_static_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_svl_sgacl_next_macro_static_table_key_t& key, const npl_svl_sgacl_next_macro_static_table_key_t& mask, const npl_svl_sgacl_next_macro_static_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_svl_sgacl_next_macro_static_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_term_bucket_a_lu_data_selector_key_t& key, const npl_term_bucket_a_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_term_bucket_a_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_term_bucket_b_lu_data_selector_key_t& key, const npl_term_bucket_b_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_term_bucket_b_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_term_bucket_c_lu_data_selector_key_t& key, const npl_term_bucket_c_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_term_bucket_c_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_term_bucket_d_lu_data_selector_key_t& key, const npl_term_bucket_d_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_term_bucket_d_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_term_to_fwd_hdr_shift_table_key_t& key, const npl_term_to_fwd_hdr_shift_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_term_to_fwd_hdr_shift_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_transmit_bucket_a_lu_data_selector_key_t& key, const npl_transmit_bucket_a_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_transmit_bucket_a_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_transmit_bucket_b_lu_data_selector_key_t& key, const npl_transmit_bucket_b_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_transmit_bucket_b_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_transmit_bucket_c_lu_data_selector_key_t& key, const npl_transmit_bucket_c_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_transmit_bucket_c_lu_data_selector_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_transmit_bucket_d_lu_data_selector_key_t& key, const npl_transmit_bucket_d_lu_data_selector_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_transmit_bucket_d_lu_data_selector_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_tx_counters_bank_id_map_config_key_t& key, const npl_tx_counters_bank_id_map_config_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_tx_counters_bank_id_map_config_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_txpp_dlp_profile_key_construct_parameters_table_key_t& key, const npl_txpp_dlp_profile_key_construct_parameters_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_txpp_dlp_profile_key_construct_parameters_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_txpp_em_dlp_profile_mapping_table_key_t& key, const npl_txpp_em_dlp_profile_mapping_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_txpp_em_dlp_profile_mapping_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_udp_fi_core_tcam_table_key_t& key, const npl_udp_fi_core_tcam_table_key_t& mask, const npl_udp_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_udp_fi_core_tcam_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_vlan0_fi_core_tcam_table_key_t& key, const npl_vlan0_fi_core_tcam_table_key_t& mask, const npl_vlan0_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_vlan0_fi_core_tcam_table_key_t& key);
        
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_vlan1_fi_core_tcam_table_key_t& key, const npl_vlan1_fi_core_tcam_table_key_t& mask, const npl_vlan1_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_vlan1_fi_core_tcam_table_key_t& key);
        ...
        static void translate_ternary_entry(npl_context_e context, size_t database_id, const npl_vlan_pe_fi_core_tcam_table_key_t& key, const npl_vlan_pe_fi_core_tcam_table_key_t& mask, const npl_vlan_pe_fi_core_tcam_table_value_t& value, std::vector<ternary_table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static ternary_table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_vlan_pe_fi_core_tcam_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_key_t& key, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_drop_green_probability_selector_table_key_t& key, const npl_voq_cgm_slice_drop_green_probability_selector_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_drop_green_probability_selector_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_drop_yellow_probability_selector_table_key_t& key, const npl_voq_cgm_slice_drop_yellow_probability_selector_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_drop_yellow_probability_selector_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_key_t& key, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_key_t& key, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_mark_probability_selector_table_key_t& key, const npl_voq_cgm_slice_mark_probability_selector_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_mark_probability_selector_table_key_t& key);
        
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_key_t& key, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_key_t& key);
        ...
        static void translate_entry(npl_context_e context, size_t database_id, const npl_voq_cgm_wred_probability_table_key_t& key, const npl_voq_cgm_wred_probability_table_value_t& value, std::vector<table_generic_entry_t>& result, npu_features_t* npu_features = nullptr);
        
        static table_generic_entry_t default_action(npl_context_e context, size_t database_id, const npl_voq_cgm_wred_probability_table_key_t& key);
