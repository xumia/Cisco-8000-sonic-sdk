...
namespace silicon_one {
    ...
    private:
        ...
        std::vector<npl_cong_level_ecn_remap_map_table_t> cong_level_ecn_remap_map_table;
        ...
        std::vector<npl_db_access_ingress_vlan_membership_table_lu_d_res_c_t> db_access_ingress_vlan_membership_table_lu_d_res_c;
        std::vector<npl_db_access_ingress_vlan_membership_table_lu_d_res_d_t> db_access_ingress_vlan_membership_table_lu_d_res_d;
        std::vector<npl_db_access_per_port_destination_table_t> db_access_per_port_destination_table;
        std::vector<npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_t> db_access_transmit_per_dest_port_npu_host_macro_stamping_table;
        std::vector<npl_db_access_vlan_membership_table_lu_c_res_c_t> db_access_vlan_membership_table_lu_c_res_c;
        std::vector<npl_db_access_vlan_membership_table_lu_d_res_c_t> db_access_vlan_membership_table_lu_d_res_c;
        ...
        std::vector<npl_dest_type_decoding_table_t> dest_type_decoding_table;
        std::vector<npl_device_mode_table_t> device_mode_table;
        std::vector<npl_dlp0_key_lsb_mapping_table_t> dlp0_key_lsb_mapping_table;
        std::vector<npl_dlp1_key_lsb_mapping_table_t> dlp1_key_lsb_mapping_table;
        std::vector<npl_dram_cgm_cgm_deq_lut_table_t> dram_cgm_cgm_deq_lut_table;
        std::vector<npl_dram_cgm_cgm_lut_table_t> dram_cgm_cgm_lut_table;
        std::vector<npl_dsp_dest_msbs_for_ecn_table_t> dsp_dest_msbs_for_ecn_table;
        std::vector<npl_dsp_group_policy_table_t> dsp_group_policy_table;
        ...
        std::vector<npl_encap_data_source_select_table_t> encap_data_source_select_table;
        ...
        std::vector<npl_ene_rewrite_punt_sa_prefix_index_table_t> ene_rewrite_punt_sa_prefix_index_table;
        std::vector<npl_ene_rewrite_sa_prefix_index_table_t> ene_rewrite_sa_prefix_index_table;
        ...
        std::vector<npl_eth_fi_core_tcam_table_t> eth_fi_core_tcam_table;
        ...
        std::vector<npl_eth_type_static_table_t> eth_type_static_table;
        std::vector<npl_eve_drop_mapping_hw_table_t> eve_drop_mapping_hw_table;
        std::vector<npl_eve_drop_vlan_id_hw_table_t> eve_drop_vlan_id_hw_table;
        std::vector<npl_eve_interrupt_mapping_hw_table_t> eve_interrupt_mapping_hw_table;
        ...
        std::vector<npl_fc_db_performance_vlan_membership_table_t> fc_db_performance_vlan_membership_table;
        ...
        std::vector<npl_fec_table_t> fec_table;
        std::vector<npl_fec_type_decoding_table_t> fec_type_decoding_table;
        ...
        std::vector<npl_fixup_destination_for_resolution_static_table_t> fixup_destination_for_resolution_static_table;
        std::vector<npl_flc_cache_range_comp_profile_table_t> flc_cache_range_comp_profile_table;
        std::vector<npl_flc_data_table_t> flc_data_table;
        std::vector<npl_flc_db_table_t> flc_db_table;
        std::vector<npl_flc_fbm_table_t> flc_fbm_table;
        std::vector<npl_flc_header_types_array_table_t> flc_header_types_array_table;
        std::vector<npl_flc_map_header_type_mask_id_table_t> flc_map_header_type_mask_id_table;
        std::vector<npl_flc_map_header_type_mask_l_table_t> flc_map_header_type_mask_l_table;
        std::vector<npl_flc_map_header_type_mask_m_table_t> flc_map_header_type_mask_m_table;
        std::vector<npl_flc_map_header_type_mask_s_table_t> flc_map_header_type_mask_s_table;
        std::vector<npl_flc_q_range_comp_profile_table_t> flc_q_range_comp_profile_table;
        std::vector<npl_flc_range_comp_ranges_table_t> flc_range_comp_ranges_table;
        std::vector<npl_frm_db_fabric_routing_table_t> frm_db_fabric_routing_table;
        std::vector<npl_fwd_and_encap_types_to_field_a_offset_table_t> fwd_and_encap_types_to_field_a_offset_table;
        std::vector<npl_fwd_and_encap_types_to_field_b_offset_table_t> fwd_and_encap_types_to_field_b_offset_table;
        std::vector<npl_fwd_bucket_a_lu_data_selector_t> fwd_bucket_a_lu_data_selector;
        std::vector<npl_fwd_bucket_b_lu_data_selector_t> fwd_bucket_b_lu_data_selector;
        std::vector<npl_fwd_bucket_c_lu_data_selector_t> fwd_bucket_c_lu_data_selector;
        std::vector<npl_fwd_bucket_d_lu_data_selector_t> fwd_bucket_d_lu_data_selector;
        ...
        std::vector<npl_ip_fi_core_tcam_table_t> ip_fi_core_tcam_table;
        std::vector<npl_ip_fwd_header_mapping_to_ethtype_static_table_t> ip_fwd_header_mapping_to_ethtype_static_table;
        std::vector<npl_ip_inactivity_check_table_t> ip_inactivity_check_table;
        ...
        std::vector<npl_ip_mc_mpls_next_macro_static_table_t> ip_mc_mpls_next_macro_static_table;
        ...
        std::vector<npl_ip_proto_type_mux_static_table_t> ip_proto_type_mux_static_table;
        ...
        std::vector<npl_ipv4_ip_tunnel_termination_dip_tt0_table_t> ipv4_ip_tunnel_termination_dip_tt0_table;
        ...
        std::vector<npl_ipv4_sgt_em_table_t> ipv4_sgt_em_table;
        std::vector<npl_ipv4_sgt_lpm_table_t> ipv4_sgt_lpm_table;
        ...
        std::vector<npl_ipv6_sgt_em_table_t> ipv6_sgt_em_table;
        std::vector<npl_ipv6_sgt_lpm_table_t> ipv6_sgt_lpm_table;
        ...
        std::vector<npl_l3_lp_profile_filter_table_t> l3_lp_profile_filter_table;
        ...
        std::vector<npl_large_em_key_lsb_mapping_table_t> large_em_key_lsb_mapping_table;
        ...
        std::vector<npl_link_relay_id_static_table_t> link_relay_id_static_table;
        std::vector<npl_link_up_vector_t> link_up_vector;
        std::vector<npl_local_mc_fwd_next_macro_static_table_t> local_mc_fwd_next_macro_static_table;
        ...
        std::vector<npl_mac_forwarding_w_metadata_table_t> mac_forwarding_w_metadata_table;
        ...
        std::vector<npl_mc_cud_table_t> mc_cud_table;
        ...
        std::vector<npl_mirror_code_2_hw_table_t> mirror_code_2_hw_table;
        ...
        std::vector<npl_npp_sgt_attributes_table_t> npp_sgt_attributes_table;
        ...
        std::vector<npl_pbts_map_table_stage0_t> pbts_map_table_stage0;
        std::vector<npl_pbts_map_table_stage1_t> pbts_map_table_stage1;
        std::vector<npl_pbts_map_table_stage2_t> pbts_map_table_stage2;
        std::vector<npl_pbts_map_table_stage3_t> pbts_map_table_stage3;
        ...
        std::vector<npl_pdvoq_slice_dram_wred_lut_table_t> pdvoq_slice_dram_wred_lut_table;
        ...
        std::vector<npl_post_fwd_rtf_next_macro_static_table_t> post_fwd_rtf_next_macro_static_table;
        std::vector<npl_probe_marker_1_static_table_t> probe_marker_1_static_table;
        std::vector<npl_probe_marker_2_static_table_t> probe_marker_2_static_table;
        ...
        std::vector<npl_rx_counters_bank_id_map_config_t> rx_counters_bank_id_map_config;
        ...
        std::vector<npl_rx_meter_bank_offset_map_t> rx_meter_bank_offset_map;
        ...
        std::vector<npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_t> rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table;
        std::vector<npl_sch_oqse_cfg_t> sch_oqse_cfg;
        std::vector<npl_sda_fabric_enable_table_t> sda_fabric_enable_table;
        ...
        std::vector<npl_select_mac_forwarding_static_table_t> select_mac_forwarding_static_table;
        std::vector<npl_service_lp_attributes_table_t> service_lp_attributes_table;
        std::vector<npl_service_mapping0_key_lsb_mapping_table_t> service_mapping0_key_lsb_mapping_table;
        std::vector<npl_service_mapping1_key_lsb_mapping_table_t> service_mapping1_key_lsb_mapping_table;
        ...
        std::vector<npl_service_mapping_tcam_key_lsb_mapping_table_t> service_mapping_tcam_key_lsb_mapping_table;
        ...
        std::vector<npl_service_relay_id_static_table_t> service_relay_id_static_table;
        std::vector<npl_set_ene_macro_and_bytes_to_remove_table_t> set_ene_macro_and_bytes_to_remove_table;
        std::vector<npl_sgacl_counter_bank_table_t> sgacl_counter_bank_table;
        std::vector<npl_sgacl_ip_fragment_check_table_t> sgacl_ip_fragment_check_table;
        std::vector<npl_sgacl_l4_protocol_select_table_t> sgacl_l4_protocol_select_table;
        std::vector<npl_sgacl_next_macro_static_table_t> sgacl_next_macro_static_table;
        std::vector<npl_sgacl_table_t> sgacl_table;
        std::vector<npl_sgt_derivation_macro_static_table_t> sgt_derivation_macro_static_table;
        std::vector<npl_sgt_matrix_table_t> sgt_matrix_table;
        std::vector<npl_sgt_vxlan_termination_table_t> sgt_vxlan_termination_table;
        ...
        std::vector<npl_small_em_key_lsb_mapping_table_t> small_em_key_lsb_mapping_table;
        ...
        std::vector<npl_source_port_to_link_table_t> source_port_to_link_table;
        std::vector<npl_splitter_lu_b_key_selector_t> splitter_lu_b_key_selector;
        std::vector<npl_splitter_lu_d_key_selector_t> splitter_lu_d_key_selector;
        std::vector<npl_stage0_assoc_data_table_t> stage0_assoc_data_table;
        std::vector<npl_stage0_em_table_t> stage0_em_table;
        std::vector<npl_stage0_group_size_table_t> stage0_group_size_table;
        std::vector<npl_stage0_protection_table_t> stage0_protection_table;
        std::vector<npl_stage0_type_decoding_table_t> stage0_type_decoding_table;
        std::vector<npl_stage1_assoc_data_table_t> stage1_assoc_data_table;
        std::vector<npl_stage1_em_table_t> stage1_em_table;
        std::vector<npl_stage1_group_size_table_t> stage1_group_size_table;
        std::vector<npl_stage1_protection_table_t> stage1_protection_table;
        std::vector<npl_stage1_type_decoding_table_t> stage1_type_decoding_table;
        std::vector<npl_stage2_assoc_data_table_t> stage2_assoc_data_table;
        std::vector<npl_stage2_em_table_t> stage2_em_table;
        std::vector<npl_stage2_group_size_table_t> stage2_group_size_table;
        std::vector<npl_stage2_protection_table_t> stage2_protection_table;
        std::vector<npl_stage2_type_decoding_table_t> stage2_type_decoding_table;
        std::vector<npl_stage3_assoc_data_table_t> stage3_assoc_data_table;
        std::vector<npl_stage3_em_table_t> stage3_em_table;
        std::vector<npl_stage3_group_size_table_t> stage3_group_size_table;
        std::vector<npl_stage3_protection_table_t> stage3_protection_table;
        std::vector<npl_stage3_type_decoding_table_t> stage3_type_decoding_table;
        std::vector<npl_svl_dspa_table_t> svl_dspa_table;
        std::vector<npl_svl_is_dsp_remote_t> svl_is_dsp_remote;
        std::vector<npl_svl_mirror_cmd_remote_dsp_table_t> svl_mirror_cmd_remote_dsp_table;
        std::vector<npl_svl_mode_table_t> svl_mode_table;
        std::vector<npl_svl_next_macro_static_table_t> svl_next_macro_static_table;
        std::vector<npl_svl_sgacl_enable_static_table_t> svl_sgacl_enable_static_table;
        std::vector<npl_svl_sgacl_next_macro_static_table_t> svl_sgacl_next_macro_static_table;
        std::vector<npl_te_headend_lsp_counter_offset_table_t> te_headend_lsp_counter_offset_table;
        std::vector<npl_term_bucket_a_lu_data_selector_t> term_bucket_a_lu_data_selector;
        std::vector<npl_term_bucket_b_lu_data_selector_t> term_bucket_b_lu_data_selector;
        std::vector<npl_term_bucket_c_lu_data_selector_t> term_bucket_c_lu_data_selector;
        std::vector<npl_term_bucket_d_lu_data_selector_t> term_bucket_d_lu_data_selector;
        std::vector<npl_term_to_fwd_hdr_shift_table_t> term_to_fwd_hdr_shift_table;
        ...
        std::vector<npl_transmit_bucket_a_lu_data_selector_t> transmit_bucket_a_lu_data_selector;
        std::vector<npl_transmit_bucket_b_lu_data_selector_t> transmit_bucket_b_lu_data_selector;
        std::vector<npl_transmit_bucket_c_lu_data_selector_t> transmit_bucket_c_lu_data_selector;
        std::vector<npl_transmit_bucket_d_lu_data_selector_t> transmit_bucket_d_lu_data_selector;
        ...
        std::vector<npl_tx_counters_bank_id_map_config_t> tx_counters_bank_id_map_config;
        ...
        std::vector<npl_txpp_dlp_profile_key_construct_parameters_table_t> txpp_dlp_profile_key_construct_parameters_table;
        std::vector<npl_txpp_em_dlp_profile_mapping_table_t> txpp_em_dlp_profile_mapping_table;
        ...
        std::vector<npl_udp_fi_core_tcam_table_t> udp_fi_core_tcam_table;
        std::vector<npl_urpf_ipsa_dest_is_lpts_static_table_t> urpf_ipsa_dest_is_lpts_static_table;
        std::vector<npl_vlan0_fi_core_tcam_table_t> vlan0_fi_core_tcam_table;
        std::vector<npl_vlan1_fi_core_tcam_table_t> vlan1_fi_core_tcam_table;
        ...
        std::vector<npl_vlan_pe_fi_core_tcam_table_t> vlan_pe_fi_core_tcam_table;
        std::vector<npl_vni_table_t> vni_table;
        std::vector<npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_t> voq_cgm_slice_buffers_consumption_lut_for_deq_table;
        std::vector<npl_voq_cgm_slice_buffers_consumption_lut_for_enq_table_t> voq_cgm_slice_buffers_consumption_lut_for_enq_table;
        std::vector<npl_voq_cgm_slice_drop_green_probability_selector_table_t> voq_cgm_slice_drop_green_probability_selector_table;
        std::vector<npl_voq_cgm_slice_drop_yellow_probability_selector_table_t> voq_cgm_slice_drop_yellow_probability_selector_table;
        std::vector<npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_t> voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table;
        std::vector<npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_t> voq_cgm_slice_eviction_ok_lut_for_enq_table;
        std::vector<npl_voq_cgm_slice_mark_probability_selector_table_t> voq_cgm_slice_mark_probability_selector_table;
        std::vector<npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_t> voq_cgm_slice_pd_consumption_lut_for_deq_table;
        ...
        std::vector<npl_voq_cgm_wred_probability_table_t> voq_cgm_wred_probability_table;
