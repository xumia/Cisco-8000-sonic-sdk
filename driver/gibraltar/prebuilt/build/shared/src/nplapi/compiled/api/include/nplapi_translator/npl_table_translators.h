...
namespace silicon_one {
    ...
    /// table_translator for table: cong_level_ecn_remap_map_table
    
    typedef npl_table_translator<npl_cong_level_ecn_remap_map_table_key_t, npl_cong_level_ecn_remap_map_table_value_t> npl_cong_level_ecn_remap_map_table_table_translator_t;
    ...
    /// table_translator for table: db_access_ingress_vlan_membership_table_lu_d_res_c
    
    typedef npl_table_translator<npl_db_access_ingress_vlan_membership_table_lu_d_res_c_key_t, npl_db_access_ingress_vlan_membership_table_lu_d_res_c_value_t> npl_db_access_ingress_vlan_membership_table_lu_d_res_c_table_translator_t;
    
    /// table_translator for table: db_access_ingress_vlan_membership_table_lu_d_res_d
    
    typedef npl_table_translator<npl_db_access_ingress_vlan_membership_table_lu_d_res_d_key_t, npl_db_access_ingress_vlan_membership_table_lu_d_res_d_value_t> npl_db_access_ingress_vlan_membership_table_lu_d_res_d_table_translator_t;
    
    /// table_translator for table: db_access_per_port_destination_table
    
    typedef npl_table_translator<npl_db_access_per_port_destination_table_key_t, npl_db_access_per_port_destination_table_value_t> npl_db_access_per_port_destination_table_table_translator_t;
    
    /// table_translator for table: db_access_transmit_per_dest_port_npu_host_macro_stamping_table
    
    typedef npl_table_translator<npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_key_t, npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_value_t> npl_db_access_transmit_per_dest_port_npu_host_macro_stamping_table_table_translator_t;
    
    /// table_translator for table: db_access_vlan_membership_table_lu_c_res_c
    
    typedef npl_table_translator<npl_db_access_vlan_membership_table_lu_c_res_c_key_t, npl_db_access_vlan_membership_table_lu_c_res_c_value_t> npl_db_access_vlan_membership_table_lu_c_res_c_table_translator_t;
    
    /// table_translator for table: db_access_vlan_membership_table_lu_d_res_c
    
    typedef npl_table_translator<npl_db_access_vlan_membership_table_lu_d_res_c_key_t, npl_db_access_vlan_membership_table_lu_d_res_c_value_t> npl_db_access_vlan_membership_table_lu_d_res_c_table_translator_t;
    ...
    /// table_translator for table: dest_type_decoding_table
    
    typedef npl_table_translator<npl_dest_type_decoding_table_key_t, npl_dest_type_decoding_table_value_t> npl_dest_type_decoding_table_table_translator_t;
    ...
    /// table_translator for table: dlp0_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_dlp0_key_lsb_mapping_table_key_t, npl_dlp0_key_lsb_mapping_table_value_t> npl_dlp0_key_lsb_mapping_table_table_translator_t;
    
    /// table_translator for table: dlp1_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_dlp1_key_lsb_mapping_table_key_t, npl_dlp1_key_lsb_mapping_table_value_t> npl_dlp1_key_lsb_mapping_table_table_translator_t;
    
    /// table_translator for table: dram_cgm_cgm_deq_lut_table
    
    typedef npl_table_translator<npl_dram_cgm_cgm_deq_lut_table_key_t, npl_dram_cgm_cgm_deq_lut_table_value_t> npl_dram_cgm_cgm_deq_lut_table_table_translator_t;
    
    /// table_translator for table: dram_cgm_cgm_lut_table
    
    typedef npl_table_translator<npl_dram_cgm_cgm_lut_table_key_t, npl_dram_cgm_cgm_lut_table_value_t> npl_dram_cgm_cgm_lut_table_table_translator_t;
    
    /// table_translator for table: dsp_dest_msbs_for_ecn_table
    
    typedef npl_ternary_table_translator<npl_dsp_dest_msbs_for_ecn_table_key_t, npl_dsp_dest_msbs_for_ecn_table_value_t> npl_dsp_dest_msbs_for_ecn_table_table_translator_t;
    
    /// table_translator for table: dsp_group_policy_table
    
    typedef npl_table_translator<npl_dsp_group_policy_table_key_t, npl_dsp_group_policy_table_value_t> npl_dsp_group_policy_table_table_translator_t;
    ...
    /// table_translator for table: encap_data_source_select_table
    
    typedef npl_table_translator<npl_encap_data_source_select_table_key_t, npl_encap_data_source_select_table_value_t> npl_encap_data_source_select_table_table_translator_t;
    ...
    /// table_translator for table: ene_rewrite_punt_sa_prefix_index_table
    
    typedef npl_table_translator<npl_ene_rewrite_punt_sa_prefix_index_table_key_t, npl_ene_rewrite_punt_sa_prefix_index_table_value_t> npl_ene_rewrite_punt_sa_prefix_index_table_table_translator_t;
    
    /// table_translator for table: ene_rewrite_sa_prefix_index_table
    
    typedef npl_table_translator<npl_ene_rewrite_sa_prefix_index_table_key_t, npl_ene_rewrite_sa_prefix_index_table_value_t> npl_ene_rewrite_sa_prefix_index_table_table_translator_t;
    ...
    /// table_translator for table: eth_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_eth_fi_core_tcam_table_key_t, npl_eth_fi_core_tcam_table_value_t> npl_eth_fi_core_tcam_table_table_translator_t;
    ...
    /// table_translator for table: eth_type_static_table
    
    typedef npl_table_translator<npl_eth_type_static_table_key_t, npl_eth_type_static_table_value_t> npl_eth_type_static_table_table_translator_t;
    
    /// table_translator for table: eve_drop_mapping_hw_table
    
    typedef npl_table_translator<npl_eve_drop_mapping_hw_table_key_t, npl_eve_drop_mapping_hw_table_value_t> npl_eve_drop_mapping_hw_table_table_translator_t;
    
    /// table_translator for table: eve_drop_vlan_id_hw_table
    
    typedef npl_table_translator<npl_eve_drop_vlan_id_hw_table_key_t, npl_eve_drop_vlan_id_hw_table_value_t> npl_eve_drop_vlan_id_hw_table_table_translator_t;
    
    /// table_translator for table: eve_interrupt_mapping_hw_table
    
    typedef npl_table_translator<npl_eve_interrupt_mapping_hw_table_key_t, npl_eve_interrupt_mapping_hw_table_value_t> npl_eve_interrupt_mapping_hw_table_table_translator_t;
    ...
    /// table_translator for table: fc_db_performance_vlan_membership_table
    
    typedef npl_table_translator<npl_fc_db_performance_vlan_membership_table_key_t, npl_fc_db_performance_vlan_membership_table_value_t> npl_fc_db_performance_vlan_membership_table_table_translator_t;
    ...
    /// table_translator for table: fec_table
    
    typedef npl_table_translator<npl_fec_table_key_t, npl_fec_table_value_t> npl_fec_table_table_translator_t;
    
    /// table_translator for table: fec_type_decoding_table
    
    typedef npl_table_translator<npl_fec_type_decoding_table_key_t, npl_fec_type_decoding_table_value_t> npl_fec_type_decoding_table_table_translator_t;
    ...
    /// table_translator for table: fixup_destination_for_resolution_static_table
    
    typedef npl_ternary_table_translator<npl_fixup_destination_for_resolution_static_table_key_t, npl_fixup_destination_for_resolution_static_table_value_t> npl_fixup_destination_for_resolution_static_table_table_translator_t;
    
    /// table_translator for table: flc_cache_range_comp_profile_table
    
    typedef npl_table_translator<npl_flc_cache_range_comp_profile_table_key_t, npl_flc_cache_range_comp_profile_table_value_t> npl_flc_cache_range_comp_profile_table_table_translator_t;
    
    /// table_translator for table: flc_data_table
    
    typedef npl_table_translator<npl_flc_data_table_key_t, npl_flc_data_table_value_t> npl_flc_data_table_table_translator_t;
    
    /// table_translator for table: flc_db_table
    
    typedef npl_table_translator<npl_flc_db_table_key_t, npl_flc_db_table_value_t> npl_flc_db_table_table_translator_t;
    
    /// table_translator for table: flc_fbm_table
    
    typedef npl_table_translator<npl_flc_fbm_table_key_t, npl_flc_fbm_table_value_t> npl_flc_fbm_table_table_translator_t;
    
    /// table_translator for table: flc_header_types_array_table
    
    typedef npl_ternary_table_translator<npl_flc_header_types_array_table_key_t, npl_flc_header_types_array_table_value_t> npl_flc_header_types_array_table_table_translator_t;
    
    /// table_translator for table: flc_map_header_type_mask_id_table
    
    typedef npl_table_translator<npl_flc_map_header_type_mask_id_table_key_t, npl_flc_map_header_type_mask_id_table_value_t> npl_flc_map_header_type_mask_id_table_table_translator_t;
    
    /// table_translator for table: flc_map_header_type_mask_l_table
    
    typedef npl_table_translator<npl_flc_map_header_type_mask_l_table_key_t, npl_flc_map_header_type_mask_l_table_value_t> npl_flc_map_header_type_mask_l_table_table_translator_t;
    
    /// table_translator for table: flc_map_header_type_mask_m_table
    
    typedef npl_table_translator<npl_flc_map_header_type_mask_m_table_key_t, npl_flc_map_header_type_mask_m_table_value_t> npl_flc_map_header_type_mask_m_table_table_translator_t;
    
    /// table_translator for table: flc_map_header_type_mask_s_table
    
    typedef npl_table_translator<npl_flc_map_header_type_mask_s_table_key_t, npl_flc_map_header_type_mask_s_table_value_t> npl_flc_map_header_type_mask_s_table_table_translator_t;
    
    /// table_translator for table: flc_q_range_comp_profile_table
    
    typedef npl_table_translator<npl_flc_q_range_comp_profile_table_key_t, npl_flc_q_range_comp_profile_table_value_t> npl_flc_q_range_comp_profile_table_table_translator_t;
    
    /// table_translator for table: flc_range_comp_ranges_table
    
    typedef npl_table_translator<npl_flc_range_comp_ranges_table_key_t, npl_flc_range_comp_ranges_table_value_t> npl_flc_range_comp_ranges_table_table_translator_t;
    ...
    /// table_translator for table: fwd_and_encap_types_to_field_a_offset_table
    
    typedef npl_table_translator<npl_fwd_and_encap_types_to_field_a_offset_table_key_t, npl_fwd_and_encap_types_to_field_a_offset_table_value_t> npl_fwd_and_encap_types_to_field_a_offset_table_table_translator_t;
    
    /// table_translator for table: fwd_and_encap_types_to_field_b_offset_table
    
    typedef npl_table_translator<npl_fwd_and_encap_types_to_field_b_offset_table_key_t, npl_fwd_and_encap_types_to_field_b_offset_table_value_t> npl_fwd_and_encap_types_to_field_b_offset_table_table_translator_t;
    
    /// table_translator for table: fwd_bucket_a_lu_data_selector
    
    typedef npl_table_translator<npl_fwd_bucket_a_lu_data_selector_key_t, npl_fwd_bucket_a_lu_data_selector_value_t> npl_fwd_bucket_a_lu_data_selector_table_translator_t;
    
    /// table_translator for table: fwd_bucket_b_lu_data_selector
    
    typedef npl_table_translator<npl_fwd_bucket_b_lu_data_selector_key_t, npl_fwd_bucket_b_lu_data_selector_value_t> npl_fwd_bucket_b_lu_data_selector_table_translator_t;
    
    /// table_translator for table: fwd_bucket_c_lu_data_selector
    
    typedef npl_table_translator<npl_fwd_bucket_c_lu_data_selector_key_t, npl_fwd_bucket_c_lu_data_selector_value_t> npl_fwd_bucket_c_lu_data_selector_table_translator_t;
    
    /// table_translator for table: fwd_bucket_d_lu_data_selector
    
    typedef npl_table_translator<npl_fwd_bucket_d_lu_data_selector_key_t, npl_fwd_bucket_d_lu_data_selector_value_t> npl_fwd_bucket_d_lu_data_selector_table_translator_t;
    ...
    /// table_translator for table: ip_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_ip_fi_core_tcam_table_key_t, npl_ip_fi_core_tcam_table_value_t> npl_ip_fi_core_tcam_table_table_translator_t;
    ...
    /// table_translator for table: ip_inactivity_check_table
    
    typedef npl_ternary_table_translator<npl_ip_inactivity_check_table_key_t, npl_ip_inactivity_check_table_value_t> npl_ip_inactivity_check_table_table_translator_t;
    ...
    /// table_translator for table: ip_mc_mpls_next_macro_static_table
    
    typedef npl_ternary_table_translator<npl_ip_mc_mpls_next_macro_static_table_key_t, npl_ip_mc_mpls_next_macro_static_table_value_t> npl_ip_mc_mpls_next_macro_static_table_table_translator_t;
    ...
    /// table_translator for table: ip_proto_type_mux_static_table
    
    typedef npl_ternary_table_translator<npl_ip_proto_type_mux_static_table_key_t, npl_ip_proto_type_mux_static_table_value_t> npl_ip_proto_type_mux_static_table_table_translator_t;
    ...
    /// table_translator for table: ipv4_ip_tunnel_termination_dip_tt0_table
    
    typedef npl_table_translator<npl_ipv4_ip_tunnel_termination_dip_tt0_table_key_t, npl_ipv4_ip_tunnel_termination_dip_tt0_table_value_t> npl_ipv4_ip_tunnel_termination_dip_tt0_table_table_translator_t;
    ...
    /// table_translator for table: ipv4_sgt_em_table
    
    typedef npl_table_translator<npl_ipv4_sgt_em_table_key_t, npl_ipv4_sgt_em_table_value_t> npl_ipv4_sgt_em_table_table_translator_t;
    
    /// table_translator for table: ipv4_sgt_lpm_table
    
    typedef npl_lpm_table_translator<npl_ipv4_sgt_lpm_table_key_t, npl_ipv4_sgt_lpm_table_value_t> npl_ipv4_sgt_lpm_table_table_translator_t;
    ...
    /// table_translator for table: ipv6_sgt_em_table
    
    typedef npl_table_translator<npl_ipv6_sgt_em_table_key_t, npl_ipv6_sgt_em_table_value_t> npl_ipv6_sgt_em_table_table_translator_t;
    
    /// table_translator for table: ipv6_sgt_lpm_table
    
    typedef npl_lpm_table_translator<npl_ipv6_sgt_lpm_table_key_t, npl_ipv6_sgt_lpm_table_value_t> npl_ipv6_sgt_lpm_table_table_translator_t;
    ...
    /// table_translator for table: l3_lp_profile_filter_table
    
    typedef npl_ternary_table_translator<npl_l3_lp_profile_filter_table_key_t, npl_l3_lp_profile_filter_table_value_t> npl_l3_lp_profile_filter_table_table_translator_t;
    ...
    /// table_translator for table: large_em_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_large_em_key_lsb_mapping_table_key_t, npl_large_em_key_lsb_mapping_table_value_t> npl_large_em_key_lsb_mapping_table_table_translator_t;
    ...
    /// table_translator for table: link_relay_id_static_table
    
    typedef npl_table_translator<npl_link_relay_id_static_table_key_t, npl_link_relay_id_static_table_value_t> npl_link_relay_id_static_table_table_translator_t;
    ...
    /// table_translator for table: local_mc_fwd_next_macro_static_table
    
    typedef npl_ternary_table_translator<npl_local_mc_fwd_next_macro_static_table_key_t, npl_local_mc_fwd_next_macro_static_table_value_t> npl_local_mc_fwd_next_macro_static_table_table_translator_t;
    ...
    /// table_translator for table: mac_forwarding_w_metadata_table
    
    typedef npl_table_translator<npl_mac_forwarding_w_metadata_table_key_t, npl_mac_forwarding_w_metadata_table_value_t> npl_mac_forwarding_w_metadata_table_table_translator_t;
    ...
    /// table_translator for table: mc_cud_table
    
    typedef npl_table_translator<npl_mc_cud_table_key_t, npl_mc_cud_table_value_t> npl_mc_cud_table_table_translator_t;
    ...
    /// table_translator for table: mirror_code_2_hw_table
    
    typedef npl_table_translator<npl_mirror_code_2_hw_table_key_t, npl_mirror_code_2_hw_table_value_t> npl_mirror_code_2_hw_table_table_translator_t;
    ...
    typedef npl_ternary_table_translator<npl_nh_macro_code_to_id_l6_static_table_key_t, npl_nh_macro_code_to_id_l6_static_table_value_t> npl_nh_macro_code_to_id_l6_static_table_table_translator_t;
    ...
    /// table_translator for table: npp_sgt_attributes_table
    
    typedef npl_table_translator<npl_npp_sgt_attributes_table_key_t, npl_npp_sgt_attributes_table_value_t> npl_npp_sgt_attributes_table_table_translator_t;
    ...
    /// table_translator for table: pbts_map_table_stage0
    
    typedef npl_table_translator<npl_pbts_map_table_stage0_key_t, npl_pbts_map_table_stage0_value_t> npl_pbts_map_table_stage0_table_translator_t;
    
    /// table_translator for table: pbts_map_table_stage1
    
    typedef npl_table_translator<npl_pbts_map_table_stage1_key_t, npl_pbts_map_table_stage1_value_t> npl_pbts_map_table_stage1_table_translator_t;
    
    /// table_translator for table: pbts_map_table_stage2
    
    typedef npl_table_translator<npl_pbts_map_table_stage2_key_t, npl_pbts_map_table_stage2_value_t> npl_pbts_map_table_stage2_table_translator_t;
    
    /// table_translator for table: pbts_map_table_stage3
    
    typedef npl_table_translator<npl_pbts_map_table_stage3_key_t, npl_pbts_map_table_stage3_value_t> npl_pbts_map_table_stage3_table_translator_t;
    ...
    /// table_translator for table: pdvoq_slice_dram_wred_lut_table
    
    typedef npl_table_translator<npl_pdvoq_slice_dram_wred_lut_table_key_t, npl_pdvoq_slice_dram_wred_lut_table_value_t> npl_pdvoq_slice_dram_wred_lut_table_table_translator_t;
    ...
    /// table_translator for table: post_fwd_rtf_next_macro_static_table
    
    typedef npl_ternary_table_translator<npl_post_fwd_rtf_next_macro_static_table_key_t, npl_post_fwd_rtf_next_macro_static_table_value_t> npl_post_fwd_rtf_next_macro_static_table_table_translator_t;
    
    /// table_translator for table: probe_marker_1_static_table
    
    typedef npl_ternary_table_translator<npl_probe_marker_1_static_table_key_t, npl_probe_marker_1_static_table_value_t> npl_probe_marker_1_static_table_table_translator_t;
    
    /// table_translator for table: probe_marker_2_static_table
    
    typedef npl_ternary_table_translator<npl_probe_marker_2_static_table_key_t, npl_probe_marker_2_static_table_value_t> npl_probe_marker_2_static_table_table_translator_t;
    ...
    /// table_translator for table: rx_counters_bank_id_map_config
    
    typedef npl_table_translator<npl_rx_counters_bank_id_map_config_key_t, npl_rx_counters_bank_id_map_config_value_t> npl_rx_counters_bank_id_map_config_table_translator_t;
    ...
    /// table_translator for table: rx_meter_bank_offset_map
    
    typedef npl_table_translator<npl_rx_meter_bank_offset_map_key_t, npl_rx_meter_bank_offset_map_value_t> npl_rx_meter_bank_offset_map_table_translator_t;
    ...
    /// table_translator for table: rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table
    
    typedef npl_table_translator<npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_key_t, npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_value_t> npl_rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table_table_translator_t;
    ...
    /// table_translator for table: sda_fabric_enable_table
    
    typedef npl_table_translator<npl_sda_fabric_enable_table_key_t, npl_sda_fabric_enable_table_value_t> npl_sda_fabric_enable_table_table_translator_t;
    ...
    /// table_translator for table: select_mac_forwarding_static_table
    
    typedef npl_table_translator<npl_select_mac_forwarding_static_table_key_t, npl_select_mac_forwarding_static_table_value_t> npl_select_mac_forwarding_static_table_table_translator_t;
    ...
    /// table_translator for table: service_mapping0_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_service_mapping0_key_lsb_mapping_table_key_t, npl_service_mapping0_key_lsb_mapping_table_value_t> npl_service_mapping0_key_lsb_mapping_table_table_translator_t;
    
    /// table_translator for table: service_mapping1_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_service_mapping1_key_lsb_mapping_table_key_t, npl_service_mapping1_key_lsb_mapping_table_value_t> npl_service_mapping1_key_lsb_mapping_table_table_translator_t;
    ...
    /// table_translator for table: service_mapping_tcam_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_service_mapping_tcam_key_lsb_mapping_table_key_t, npl_service_mapping_tcam_key_lsb_mapping_table_value_t> npl_service_mapping_tcam_key_lsb_mapping_table_table_translator_t;
    ...
    /// table_translator for table: service_relay_id_static_table
    
    typedef npl_table_translator<npl_service_relay_id_static_table_key_t, npl_service_relay_id_static_table_value_t> npl_service_relay_id_static_table_table_translator_t;
    ...
    /// table_translator for table: sgacl_counter_bank_table
    
    typedef npl_table_translator<npl_sgacl_counter_bank_table_key_t, npl_sgacl_counter_bank_table_value_t> npl_sgacl_counter_bank_table_table_translator_t;
    
    /// table_translator for table: sgacl_ip_fragment_check_table
    
    typedef npl_ternary_table_translator<npl_sgacl_ip_fragment_check_table_key_t, npl_sgacl_ip_fragment_check_table_value_t> npl_sgacl_ip_fragment_check_table_table_translator_t;
    
    /// table_translator for table: sgacl_l4_protocol_select_table
    
    typedef npl_table_translator<npl_sgacl_l4_protocol_select_table_key_t, npl_sgacl_l4_protocol_select_table_value_t> npl_sgacl_l4_protocol_select_table_table_translator_t;
    
    /// table_translator for table: sgacl_next_macro_static_table
    
    typedef npl_ternary_table_translator<npl_sgacl_next_macro_static_table_key_t, npl_sgacl_next_macro_static_table_value_t> npl_sgacl_next_macro_static_table_table_translator_t;
    ...
    /// table_translator for table: sgt_derivation_macro_static_table
    
    typedef npl_ternary_table_translator<npl_sgt_derivation_macro_static_table_key_t, npl_sgt_derivation_macro_static_table_value_t> npl_sgt_derivation_macro_static_table_table_translator_t;
    
    /// table_translator for table: sgt_matrix_table
    
    typedef npl_table_translator<npl_sgt_matrix_table_key_t, npl_sgt_matrix_table_value_t> npl_sgt_matrix_table_table_translator_t;
    
    /// table_translator for table: sgt_vxlan_termination_table
    
    typedef npl_ternary_table_translator<npl_sgt_vxlan_termination_table_key_t, npl_sgt_vxlan_termination_table_value_t> npl_sgt_vxlan_termination_table_table_translator_t;
    ...
    /// table_translator for table: small_em_key_lsb_mapping_table
    
    typedef npl_ternary_table_translator<npl_small_em_key_lsb_mapping_table_key_t, npl_small_em_key_lsb_mapping_table_value_t> npl_small_em_key_lsb_mapping_table_table_translator_t;
    ...
    /// table_translator for table: source_port_to_link_table
    
    typedef npl_table_translator<npl_source_port_to_link_table_key_t, npl_source_port_to_link_table_value_t> npl_source_port_to_link_table_table_translator_t;
    
    /// table_translator for table: splitter_lu_b_key_selector
    
    typedef npl_ternary_table_translator<npl_splitter_lu_b_key_selector_key_t, npl_splitter_lu_b_key_selector_value_t> npl_splitter_lu_b_key_selector_table_translator_t;
    
    /// table_translator for table: splitter_lu_d_key_selector
    
    typedef npl_ternary_table_translator<npl_splitter_lu_d_key_selector_key_t, npl_splitter_lu_d_key_selector_value_t> npl_splitter_lu_d_key_selector_table_translator_t;
    
    /// table_translator for table: stage0_assoc_data_table
    
    typedef npl_table_translator<npl_stage0_assoc_data_table_key_t, npl_stage0_assoc_data_table_value_t> npl_stage0_assoc_data_table_table_translator_t;
    
    /// table_translator for table: stage0_em_table
    
    typedef npl_table_translator<npl_stage0_em_table_key_t, npl_stage0_em_table_value_t> npl_stage0_em_table_table_translator_t;
    
    /// table_translator for table: stage0_group_size_table
    
    typedef npl_table_translator<npl_stage0_group_size_table_key_t, npl_stage0_group_size_table_value_t> npl_stage0_group_size_table_table_translator_t;
    
    /// table_translator for table: stage0_protection_table
    
    typedef npl_table_translator<npl_stage0_protection_table_key_t, npl_stage0_protection_table_value_t> npl_stage0_protection_table_table_translator_t;
    
    /// table_translator for table: stage0_type_decoding_table
    
    typedef npl_table_translator<npl_stage0_type_decoding_table_key_t, npl_stage0_type_decoding_table_value_t> npl_stage0_type_decoding_table_table_translator_t;
    
    /// table_translator for table: stage1_assoc_data_table
    
    typedef npl_table_translator<npl_stage1_assoc_data_table_key_t, npl_stage1_assoc_data_table_value_t> npl_stage1_assoc_data_table_table_translator_t;
    
    /// table_translator for table: stage1_em_table
    
    typedef npl_table_translator<npl_stage1_em_table_key_t, npl_stage1_em_table_value_t> npl_stage1_em_table_table_translator_t;
    
    /// table_translator for table: stage1_group_size_table
    
    typedef npl_table_translator<npl_stage1_group_size_table_key_t, npl_stage1_group_size_table_value_t> npl_stage1_group_size_table_table_translator_t;
    
    /// table_translator for table: stage1_protection_table
    
    typedef npl_table_translator<npl_stage1_protection_table_key_t, npl_stage1_protection_table_value_t> npl_stage1_protection_table_table_translator_t;
    
    /// table_translator for table: stage1_type_decoding_table
    
    typedef npl_table_translator<npl_stage1_type_decoding_table_key_t, npl_stage1_type_decoding_table_value_t> npl_stage1_type_decoding_table_table_translator_t;
    
    /// table_translator for table: stage2_assoc_data_table
    
    typedef npl_table_translator<npl_stage2_assoc_data_table_key_t, npl_stage2_assoc_data_table_value_t> npl_stage2_assoc_data_table_table_translator_t;
    
    /// table_translator for table: stage2_em_table
    
    typedef npl_table_translator<npl_stage2_em_table_key_t, npl_stage2_em_table_value_t> npl_stage2_em_table_table_translator_t;
    
    /// table_translator for table: stage2_group_size_table
    
    typedef npl_table_translator<npl_stage2_group_size_table_key_t, npl_stage2_group_size_table_value_t> npl_stage2_group_size_table_table_translator_t;
    
    /// table_translator for table: stage2_protection_table
    
    typedef npl_table_translator<npl_stage2_protection_table_key_t, npl_stage2_protection_table_value_t> npl_stage2_protection_table_table_translator_t;
    
    /// table_translator for table: stage2_type_decoding_table
    
    typedef npl_table_translator<npl_stage2_type_decoding_table_key_t, npl_stage2_type_decoding_table_value_t> npl_stage2_type_decoding_table_table_translator_t;
    
    /// table_translator for table: stage3_assoc_data_table
    
    typedef npl_table_translator<npl_stage3_assoc_data_table_key_t, npl_stage3_assoc_data_table_value_t> npl_stage3_assoc_data_table_table_translator_t;
    
    /// table_translator for table: stage3_em_table
    
    typedef npl_table_translator<npl_stage3_em_table_key_t, npl_stage3_em_table_value_t> npl_stage3_em_table_table_translator_t;
    
    /// table_translator for table: stage3_group_size_table
    
    typedef npl_table_translator<npl_stage3_group_size_table_key_t, npl_stage3_group_size_table_value_t> npl_stage3_group_size_table_table_translator_t;
    
    /// table_translator for table: stage3_protection_table
    
    typedef npl_table_translator<npl_stage3_protection_table_key_t, npl_stage3_protection_table_value_t> npl_stage3_protection_table_table_translator_t;
    
    /// table_translator for table: stage3_type_decoding_table
    
    typedef npl_table_translator<npl_stage3_type_decoding_table_key_t, npl_stage3_type_decoding_table_value_t> npl_stage3_type_decoding_table_table_translator_t;
    
    /// table_translator for table: svl_dspa_table
    
    typedef npl_table_translator<npl_svl_dspa_table_key_t, npl_svl_dspa_table_value_t> npl_svl_dspa_table_table_translator_t;
    
    /// table_translator for table: svl_is_dsp_remote
    
    typedef npl_ternary_table_translator<npl_svl_is_dsp_remote_key_t, npl_svl_is_dsp_remote_value_t> npl_svl_is_dsp_remote_table_translator_t;
    
    /// table_translator for table: svl_mirror_cmd_remote_dsp_table
    
    typedef npl_table_translator<npl_svl_mirror_cmd_remote_dsp_table_key_t, npl_svl_mirror_cmd_remote_dsp_table_value_t> npl_svl_mirror_cmd_remote_dsp_table_table_translator_t;
    
    /// table_translator for table: svl_mode_table
    
    typedef npl_table_translator<npl_svl_mode_table_key_t, npl_svl_mode_table_value_t> npl_svl_mode_table_table_translator_t;
    ...
    /// table_translator for table: svl_sgacl_enable_static_table
    
    typedef npl_ternary_table_translator<npl_svl_sgacl_enable_static_table_key_t, npl_svl_sgacl_enable_static_table_value_t> npl_svl_sgacl_enable_static_table_table_translator_t;
    
    /// table_translator for table: svl_sgacl_next_macro_static_table
    
    typedef npl_ternary_table_translator<npl_svl_sgacl_next_macro_static_table_key_t, npl_svl_sgacl_next_macro_static_table_value_t> npl_svl_sgacl_next_macro_static_table_table_translator_t;
    ...
    /// table_translator for table: term_bucket_a_lu_data_selector
    
    typedef npl_table_translator<npl_term_bucket_a_lu_data_selector_key_t, npl_term_bucket_a_lu_data_selector_value_t> npl_term_bucket_a_lu_data_selector_table_translator_t;
    
    /// table_translator for table: term_bucket_b_lu_data_selector
    
    typedef npl_table_translator<npl_term_bucket_b_lu_data_selector_key_t, npl_term_bucket_b_lu_data_selector_value_t> npl_term_bucket_b_lu_data_selector_table_translator_t;
    
    /// table_translator for table: term_bucket_c_lu_data_selector
    
    typedef npl_table_translator<npl_term_bucket_c_lu_data_selector_key_t, npl_term_bucket_c_lu_data_selector_value_t> npl_term_bucket_c_lu_data_selector_table_translator_t;
    
    /// table_translator for table: term_bucket_d_lu_data_selector
    
    typedef npl_table_translator<npl_term_bucket_d_lu_data_selector_key_t, npl_term_bucket_d_lu_data_selector_value_t> npl_term_bucket_d_lu_data_selector_table_translator_t;
    
    /// table_translator for table: term_to_fwd_hdr_shift_table
    
    typedef npl_table_translator<npl_term_to_fwd_hdr_shift_table_key_t, npl_term_to_fwd_hdr_shift_table_value_t> npl_term_to_fwd_hdr_shift_table_table_translator_t;
    ...
    /// table_translator for table: transmit_bucket_a_lu_data_selector
    
    typedef npl_table_translator<npl_transmit_bucket_a_lu_data_selector_key_t, npl_transmit_bucket_a_lu_data_selector_value_t> npl_transmit_bucket_a_lu_data_selector_table_translator_t;
    
    /// table_translator for table: transmit_bucket_b_lu_data_selector
    
    typedef npl_table_translator<npl_transmit_bucket_b_lu_data_selector_key_t, npl_transmit_bucket_b_lu_data_selector_value_t> npl_transmit_bucket_b_lu_data_selector_table_translator_t;
    
    /// table_translator for table: transmit_bucket_c_lu_data_selector
    
    typedef npl_table_translator<npl_transmit_bucket_c_lu_data_selector_key_t, npl_transmit_bucket_c_lu_data_selector_value_t> npl_transmit_bucket_c_lu_data_selector_table_translator_t;
    
    /// table_translator for table: transmit_bucket_d_lu_data_selector
    
    typedef npl_table_translator<npl_transmit_bucket_d_lu_data_selector_key_t, npl_transmit_bucket_d_lu_data_selector_value_t> npl_transmit_bucket_d_lu_data_selector_table_translator_t;
    ...
    /// table_translator for table: tx_counters_bank_id_map_config
    
    typedef npl_table_translator<npl_tx_counters_bank_id_map_config_key_t, npl_tx_counters_bank_id_map_config_value_t> npl_tx_counters_bank_id_map_config_table_translator_t;
    ...
    /// table_translator for table: txpp_dlp_profile_key_construct_parameters_table
    
    typedef npl_table_translator<npl_txpp_dlp_profile_key_construct_parameters_table_key_t, npl_txpp_dlp_profile_key_construct_parameters_table_value_t> npl_txpp_dlp_profile_key_construct_parameters_table_table_translator_t;
    
    /// table_translator for table: txpp_em_dlp_profile_mapping_table
    
    typedef npl_table_translator<npl_txpp_em_dlp_profile_mapping_table_key_t, npl_txpp_em_dlp_profile_mapping_table_value_t> npl_txpp_em_dlp_profile_mapping_table_table_translator_t;
    ...
    /// table_translator for table: udp_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_udp_fi_core_tcam_table_key_t, npl_udp_fi_core_tcam_table_value_t> npl_udp_fi_core_tcam_table_table_translator_t;
    ...
    /// table_translator for table: vlan0_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_vlan0_fi_core_tcam_table_key_t, npl_vlan0_fi_core_tcam_table_value_t> npl_vlan0_fi_core_tcam_table_table_translator_t;
    
    /// table_translator for table: vlan1_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_vlan1_fi_core_tcam_table_key_t, npl_vlan1_fi_core_tcam_table_value_t> npl_vlan1_fi_core_tcam_table_table_translator_t;
    ...
    /// table_translator for table: vlan_pe_fi_core_tcam_table
    
    typedef npl_ternary_table_translator<npl_vlan_pe_fi_core_tcam_table_key_t, npl_vlan_pe_fi_core_tcam_table_value_t> npl_vlan_pe_fi_core_tcam_table_table_translator_t;
    ...
    /// table_translator for table: voq_cgm_slice_buffers_consumption_lut_for_deq_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_key_t, npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_value_t> npl_voq_cgm_slice_buffers_consumption_lut_for_deq_table_table_translator_t;
    ...
    /// table_translator for table: voq_cgm_slice_drop_green_probability_selector_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_drop_green_probability_selector_table_key_t, npl_voq_cgm_slice_drop_green_probability_selector_table_value_t> npl_voq_cgm_slice_drop_green_probability_selector_table_table_translator_t;
    
    /// table_translator for table: voq_cgm_slice_drop_yellow_probability_selector_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_drop_yellow_probability_selector_table_key_t, npl_voq_cgm_slice_drop_yellow_probability_selector_table_value_t> npl_voq_cgm_slice_drop_yellow_probability_selector_table_table_translator_t;
    
    /// table_translator for table: voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_key_t, npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_value_t> npl_voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table_table_translator_t;
    
    /// table_translator for table: voq_cgm_slice_eviction_ok_lut_for_enq_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_key_t, npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_value_t> npl_voq_cgm_slice_eviction_ok_lut_for_enq_table_table_translator_t;
    
    /// table_translator for table: voq_cgm_slice_mark_probability_selector_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_mark_probability_selector_table_key_t, npl_voq_cgm_slice_mark_probability_selector_table_value_t> npl_voq_cgm_slice_mark_probability_selector_table_table_translator_t;
    
    /// table_translator for table: voq_cgm_slice_pd_consumption_lut_for_deq_table
    
    typedef npl_table_translator<npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_key_t, npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_value_t> npl_voq_cgm_slice_pd_consumption_lut_for_deq_table_table_translator_t;
    ...
    /// table_translator for table: voq_cgm_wred_probability_table
    
    typedef npl_table_translator<npl_voq_cgm_wred_probability_table_key_t, npl_voq_cgm_wred_probability_table_value_t> npl_voq_cgm_wred_probability_table_table_translator_t;
