...
table_compiler_generated_config_t npl_tables_compiler_generated_config::get_table_config(npl_tables_e table_name, npl_context_e context)
{
    ...
    if (table_name == NPL_TABLES_BFD_PUNT_ENCAP_STATIC_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->is_ene_table = false;
            curr_entry->sram_config.index = 7;
            curr_entry->sram_config.start_line = 0;
            curr_entry->sram_config.offset_in_line = 0;
    ...
    if (table_name == NPL_TABLES_BVN_TC_MAP_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->sram_config.index = 7;
            curr_entry->sram_config.start_line = 0;
            curr_entry->sram_config.offset_in_line = 28;
    ...
    if (table_name == NPL_TABLES_CONG_LEVEL_ECN_REMAP_MAP_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(17 /* key_width */, 1 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_INGRESS_VLAN_MEMBERSHIP;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_DB_ACCESS_INGRESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_D) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_DB_ACCESS_PER_PORT_DESTINATION_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_DB_ACCESS_TRANSMIT_PER_DEST_PORT_NPU_HOST_MACRO_STAMPING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 9 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_C_RES_C) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_EGRESS_VLAN_MEMBERSHIP;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_DB_ACCESS_VLAN_MEMBERSHIP_TABLE_LU_D_RES_C) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_DEST_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_DEST_TYPE_DECODING;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_DRAM_CGM_CGM_DEQ_LUT_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_CGMLUTD;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_DRAM_CGM_CGM_LUT_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(16 /* key_width */, 6 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_DSP_GROUP_POLICY_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_table_compiler_generated_config_t(11 /* key_width */, 4 /*payload_width */));
            curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_DSP_L2_ATTRIBUTES_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 56 /*payload_width */));
            curr_entry = &(result.tables_config.back());
            ...
            curr_entry->sram_config.start_line = 0;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 56;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
        }
    ...
    if (table_name == NPL_TABLES_DSP_L3_ATTRIBUTES_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 44 /*payload_width */));
            curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_EGRESS_NH_AND_SVI_DIRECT1_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(10 /* key_width */, 160 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_ENCAP_DATA_SOURCE_SELECT_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(2 /* key_width */, 30 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_ENCAP_DATA_SOURCE_SELECT;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_ENE_REWRITE_PUNT_SA_PREFIX_INDEX_TABLE) {
        table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->database = DATABASES_ENGINE_ENE_NETWORK;
            curr_entry->database_id = 0;
            curr_entry->table_size = 16;
            
            curr_entry->is_ene_table = true;
            curr_entry->sram_config.index = 0;
            curr_entry->sram_config.start_line = 4;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 128;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = true;
        }
        
        return result;
    }
    
    if (table_name == NPL_TABLES_ENE_REWRITE_SA_PREFIX_INDEX_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_ETH_TYPE_STATIC_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_EVE_DROP_MAPPING_HW_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_EVE_DROP_MAPPING_HW_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_EVE_DROP_VLAN_ID_HW_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(16 /* key_width */, 1 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_EVE_DROP_VLAN_ID_HW_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_EVE_INTERRUPT_MAPPING_HW_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_EVE_INTERRUPT_MAPPING_HW_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_FC_DB_PERFORMANCE_VLAN_MEMBERSHIP_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_FEC_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(13 /* key_width */, 80 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_FEC_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FEC_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 85 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_FEC_ENTRY_TYPE_DECODING;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_FLC_CACHE_RANGE_COMP_PROFILE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_FLC_CACHE_RANGE_COMP_PROFILE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_DATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(14 /* key_width */, 642 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_DATA_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_DB_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(96 /* key_width */, 14 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_DB_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_FBM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(1 /* key_width */, 14 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_NPU_HOST_READ_PTR_REG;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_ID_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(5 /* key_width */, 5 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_MAP_HEADER_TYPE_MASK_ID_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_L_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(3 /* key_width */, 640 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_MAP_HEADER_TYPE_MASK_L_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_M_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(3 /* key_width */, 320 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_MAP_HEADER_TYPE_MASK_M_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_MAP_HEADER_TYPE_MASK_S_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(4 /* key_width */, 160 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_MAP_HEADER_TYPE_MASK_S_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_Q_RANGE_COMP_PROFILE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_FLC_Q_RANGE_COMP_PROFILE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FLC_RANGE_COMP_RANGES_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 64 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_RANGE_COMP_RANGES_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_A_OFFSET_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_FWD_AND_ENCAP_TYPES_TO_FIELD_A_OFFSET_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FWD_AND_ENCAP_TYPES_TO_FIELD_B_OFFSET_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_FWD_AND_ENCAP_TYPES_TO_FIELD_B_OFFSET_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_FWD_BUCKET_A_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_FWD_BUCKET_B_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_FWD_BUCKET_C_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_FWD_BUCKET_D_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_HMC_CGM_PROFILE_GLOBAL_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(5 /* key_width */, 540 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IP_RELAY_TO_VNI_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(26 /* key_width */, 112 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_IP_TUNNEL_TERMINATION_DIP_INDEX_TT0_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(26 /* key_width */, 131 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_IP_TUNNEL_TERMINATION_DIP_TT0_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(52 /* key_width */, 131 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_IP_TUNNEL_TERMINATION_SIP_DIP_INDEX_TT0_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(58 /* key_width */, 131 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_SGT_EM_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_IPV4_VRF_S_G_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(77 /* key_width */, 62 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV6_SGT_EM_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_IPV6_VRF_S_G_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(66 /* key_width */, 62 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_L2_DLP_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(22 /* key_width */, 121 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_L3_DLP_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(15 /* key_width */, 141 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LIGHT_FI_FABRIC_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(4 /* key_width */, 38 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LIGHT_FI_NPU_BASE_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 38 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LIGHT_FI_STAGES_CFG_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(3 /* key_width */, 21 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LINK_RELAY_ATTRIBUTES_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(12 /* key_width */, 66 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LINK_RELAY_ID_STATIC_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(12 /* key_width */, 14 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_MAC_LINK_RELAY_ID;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_MAC_FORWARDING_W_METADATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(69 /* key_width */, 28 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_MC_CUD_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(14 /* key_width */, 121 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_MC_CUD;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_MIRROR_CODE_2_HW_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_MIRROR_CODE_2_HW_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_MPLS_TERMINATION_EM0_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(22 /* key_width */, 50 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_NPP_SGT_ATTRIBUTES_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_NW_SMCID_THRESHOLD_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->is_ene_table = false;
            curr_entry->sram_config.index = 4;
            curr_entry->sram_config.start_line = 1056;
            curr_entry->sram_config.offset_in_line = 4;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_PBTS_MAP_TABLE_STAGE0) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(5 /* key_width */, 23 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_MAP_TABLE_PBTS;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_PBTS_MAP_TABLE_STAGE1) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_MAP_TABLE_PBTS;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_PBTS_MAP_TABLE_STAGE2) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_MAP_TABLE_PBTS;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_PBTS_MAP_TABLE_STAGE3) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_MAP_TABLE_PBTS;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_PDVOQ_SLICE_DRAM_WRED_LUT_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_PDVOQ_SLICE_DWL;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_PER_PE_AND_VRF_VPN_KEY_LARGE_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(32 /* key_width */, 76 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_PER_VRF_MPLS_FORWARDING_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(39 /* key_width */, 64 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_PUNT_TUNNEL_TRANSPORT_ENCAP_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(12 /* key_width */, 128 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RECYCLED_INJECT_UP_INFO_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->is_ene_table = false;
            curr_entry->sram_config.index = 3;
            curr_entry->sram_config.start_line = 192;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 20;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_RESOLUTION_SET_NEXT_MACRO_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->sram_config.index = 5;
            curr_entry->sram_config.start_line = 256;
            curr_entry->sram_config.offset_in_line = 56;
            curr_entry->sram_config.width_in_bits = 12;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
        }
    ...
    if (table_name == NPL_TABLES_RTF_CONF_SET_TO_POST_FWD_STAGE_MAPPING_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_table_compiler_generated_config_t(9 /* key_width */, 8 /*payload_width */));
            curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_COUNTERS_BANK_ID_MAP_CONFIG) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RX_COUNTERS_BANK_ID_MAP_CONFIG;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_RX_COUNTERS_BLOCK_CONFIG_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(7 /* key_width */, 3 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_METER_BANK_OFFSET_MAP) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RX_METER_BANK_OFFSET_MAP;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_RX_METER_BLOCK_METER_ATTRIBUTE_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(15 /* key_width */, 6 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_METER_DISTRIBUTED_METER_PROFILE_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 74 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_METER_METERS_ATTRIBUTE_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(13 /* key_width */, 6 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_METER_RATE_LIMITER_SHAPER_CONFIGURATION_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(12 /* key_width */, 10 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_RX_TERM_ERROR_HANDLING_DESTINATION_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->is_ene_table = false;
            curr_entry->sram_config.index = 3;
            curr_entry->sram_config.start_line = 160;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 20;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_RXPDR_FE_RLB_UC_TX_FB_LINK_TO_OQ_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RXPDR_FE_RLB_UC_TX_FB_LINK_TO_OQ_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_SDA_FABRIC_ENABLE_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SELECT_MAC_FORWARDING_STATIC_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SERVICE_LP_ATTRIBUTES_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(16 /* key_width */, 160 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SERVICE_RELAY_ATTRIBUTES_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(14 /* key_width */, 66 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SERVICE_RELAY_ID_STATIC_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(14 /* key_width */, 14 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_MAC_SERVICE_RELAY_ID;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_SGACL_COUNTER_BANK_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SGACL_L4_PROTOCOL_SELECT_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SGT_MATRIX_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(40 /* key_width */, 53 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SOURCE_PORT_TO_LINK_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(6 /* key_width */, 5 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RXPDR_SOURCE_PORT_TO_LINK_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE0_ASSOC_DATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(16 /* key_width */, 145 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_ASSOC_DATA;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE0_EM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(24 /* key_width */, 38 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_EM;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE0_GROUP_SIZE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(14 /* key_width */, 10 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_LB_GROUP_SIZE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE0_PROTECTION_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_PROTECTION;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE0_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE0_ENTRY_TYPE_DECODING;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE1_ASSOC_DATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(13 /* key_width */, 145 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_ASSOC_DATA;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE1_EM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(24 /* key_width */, 35 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_EM;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE1_GROUP_SIZE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_LB_GROUP_SIZE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE1_PROTECTION_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_PROTECTION;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE1_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE1_ENTRY_TYPE_DECODING;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE2_ASSOC_DATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_ASSOC_DATA;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE2_EM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_EM;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE2_GROUP_SIZE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_LB_GROUP_SIZE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE2_PROTECTION_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_PROTECTION;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE2_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE2_ENTRY_TYPE_DECODING;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE3_ASSOC_DATA_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(12 /* key_width */, 145 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_ASSOC_DATA;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE3_EM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(24 /* key_width */, 34 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_EM;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE3_GROUP_SIZE_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_LB_GROUP_SIZE_TABLE;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE3_PROTECTION_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_PROTECTION;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_STAGE3_TYPE_DECODING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_RESOLUTION_STAGE3_ENTRY_TYPE_DECODING;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_SVL_DSPA_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SVL_MIRROR_CMD_REMOTE_DSP_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SVL_MODE_TABLE) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TERM_BUCKET_A_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
        ...
        if (context == NPL_UDC_CONTEXT) {
            ...
            curr_entry->database = DATABASES_ENGINE_TERMINATION_UDC;
            curr_entry->database_id = 0;
            curr_entry->table_size = 1024;
    ...
    if (table_name == NPL_TABLES_TERM_BUCKET_B_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TERM_BUCKET_C_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TERM_BUCKET_D_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TERM_TO_FWD_HDR_SHIFT_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(1 /* key_width */, 11 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_TERM_TO_FWD_HDR_SHIFT;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_TRANSMIT_BUCKET_A_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
        ...
        if (context == NPL_UDC_CONTEXT) {
            ...
            curr_entry->database = DATABASES_ENGINE_TRANSMIT_UDC;
            curr_entry->database_id = 0;
            curr_entry->table_size = 1024;
    ...
    if (table_name == NPL_TABLES_TRANSMIT_BUCKET_B_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TRANSMIT_BUCKET_C_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TRANSMIT_BUCKET_D_LU_DATA_SELECTOR) {
        table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_TS_CMD_HW_STATIC_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(4 /* key_width */, 9 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_TX_COUNTERS_BANK_ID_MAP_CONFIG) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_TX_COUNTERS_BANK_ID_MAP_CONFIG;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_TX_ERROR_HANDLING_COUNTER_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->is_ene_table = false;
            curr_entry->sram_config.index = 3;
            curr_entry->sram_config.start_line = 544;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 20;
            curr_entry->sram_config.payload_needs_rmw_operation = true;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_TXPP_DLP_PROFILE_KEY_CONSTRUCT_PARAMETERS_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(8 /* key_width */, 11 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_LOGICAL_PORT_PROFILE_DLP_OFFSET_AND_MASK;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_TXPP_EM_DLP_PROFILE_MAPPING_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(20 /* key_width */, 24 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_EM_DLP_PROFILE_HW_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_BUFFERS_CONSUMPTION_LUT_FOR_DEQ_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_BCLFD;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_BUFFERS_CONSUMPTION_LUT_FOR_ENQ_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(11 /* key_width */, 176 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_DROP_GREEN_PROBABILITY_SELECTOR_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(8 /* key_width */, 30 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_DRPGPROB;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_DROP_YELLOW_PROBABILITY_SELECTOR_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_DRPYPROB;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_EVICTED_BUFFERS_CONSUMPTION_LUT_FOR_ENQ_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(10 /* key_width */, 2 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_EVCTBCLT;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_EVICTION_OK_LUT_FOR_ENQ_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_EVCTOK;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_MARK_PROBABILITY_SELECTOR_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_MRKPROB;
        curr_entry->database_id = 0;
        
        return result;
    }
    
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_PD_CONSUMPTION_LUT_FOR_DEQ_TABLE) {
        table_compiler_generated_config_t result;
        ...
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_PCLFD;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_PD_CONSUMPTION_LUT_FOR_ENQ_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(10 /* key_width */, 80 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_SLICE_PROFILE_BUFF_REGION_THRESHOLDS_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(5 /* key_width */, 210 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_VOQ_CGM_WRED_PROBABILITY_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(5 /* key_width */, 17 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_VOQ_CGM_WREDPRB;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_VXLAN_L2_DLP_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(22 /* key_width */, 76 /*payload_width */));
        curr_entry = &(result.tables_config.back());
...
ternary_table_compiler_generated_config_t npl_tables_compiler_generated_config::get_ternary_table_config(npl_tables_e table_name, npl_context_e context)
{
    ...
    if (table_name == NPL_TABLES_DLP0_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(8 /* key_width */, 1 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_DLP1_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_DSP_DEST_MSBS_FOR_ECN_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->default_action.payload.set_bits(3, 0, 0x8ULL);
    ...
    if (table_name == NPL_TABLES_ETH_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(16 /* key_width */, 12 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_HW_FI_CORE_TCAM;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_FIXUP_DESTINATION_FOR_RESOLUTION_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(16 /* key_width */, 32 /*payload_width */));
            curr_entry = &(result.tables_config.back());
            
            curr_entry->database = DATABASES_ENGINE_FORWARDING_NETWORK;
            curr_entry->database_id = 0;
            curr_entry->table_size = 11;
    ...
    if (table_name == NPL_TABLES_FLC_HEADER_TYPES_ARRAY_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(73 /* key_width */, 25 /*payload_width */));
        curr_entry = &(result.tables_config.back());
        
        curr_entry->database = DATABASES_EXTERNAL_FLC_HEADER_TYPES_ARRAY_TABLE;
        curr_entry->database_id = 0;
    ...
    if (table_name == NPL_TABLES_IP_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_IP_INACTIVITY_CHECK_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(32 /* key_width */, 1 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IP_MC_MPLS_NEXT_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 0;
            curr_entry->tcam_config.index_in_level = 0;
            curr_entry->tcam_config.start_line = 18;
            curr_entry->tcam_config.width_in_bits = 20;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 0;
            curr_entry->sram_config.start_line = 18;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_IP_PROTO_TYPE_MUX_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_IPV4_LPTS_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(158 /* key_width */, 64 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_L3_LP_PROFILE_FILTER_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_LARGE_EM_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_LIGHT_FI_NW_0_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(21 /* key_width */, 45 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_LOCAL_MC_FWD_NEXT_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 0;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 12;
            curr_entry->tcam_config.width_in_bits = 32;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 12;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_MAP_TX_PUNT_RCY_NEXT_MACRO_STATIC_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 4;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 19;
            curr_entry->tcam_config.width_in_bits = 16;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 19;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 32;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_NH_MACRO_CODE_TO_ID_L6_STATIC_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 4;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 22;
            curr_entry->tcam_config.width_in_bits = 16;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 22;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 32;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_OBM_NEXT_MACRO_STATIC_TABLE) {
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 0;
            curr_entry->tcam_config.index_in_level = 0;
            curr_entry->tcam_config.start_line = 15;
            curr_entry->tcam_config.width_in_bits = 20;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 0;
            curr_entry->sram_config.start_line = 15;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_POST_FWD_RTF_NEXT_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_PROBE_MARKER_1_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_PROBE_MARKER_2_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_RTF_NEXT_MACRO_STATIC_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        if (context == NPL_NETWORK_CONTEXT) {
            result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(24 /* key_width */, 16 /*payload_width */));
            curr_entry = &(result.tables_config.back());
            ...
            curr_entry->tcam_config.index_in_level = 2;
            curr_entry->tcam_config.start_line = 0;
            curr_entry->tcam_config.width_in_bits = 24;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 2;
            curr_entry->sram_config.start_line = 0;
            curr_entry->sram_config.offset_in_line = 0;
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING0_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING1_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING_TCAM_AC_PORT_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(20 /* key_width */, 320 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING_TCAM_AC_PORT_TAG_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(32 /* key_width */, 320 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING_TCAM_AC_PORT_TAG_TAG_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(44 /* key_width */, 320 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SERVICE_MAPPING_TCAM_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SGACL_IP_FRAGMENT_CHECK_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 0;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 25;
            curr_entry->tcam_config.width_in_bits = 32;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 25;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_SGACL_NEXT_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SGACL_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(100 /* key_width */, 64 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SGT_DERIVATION_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 4;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 11;
            curr_entry->tcam_config.width_in_bits = 16;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 11;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 32;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_SGT_VXLAN_TERMINATION_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SMALL_EM_KEY_LSB_MAPPING_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SPLITTER_LU_B_KEY_SELECTOR) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SPLITTER_LU_D_KEY_SELECTOR) {
        ternary_table_compiler_generated_config_t result;
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(4 /* key_width */, 2 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_SVL_IS_DSP_REMOTE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 3;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 5;
            curr_entry->tcam_config.width_in_bits = 32;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 5;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 16;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_SVL_SGACL_ENABLE_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_SVL_SGACL_NEXT_MACRO_STATIC_TABLE) {
        ternary_table_compiler_generated_config_t result;
        ...
        if (context == NPL_NETWORK_CONTEXT) {
            ...
            curr_entry->level_in_engine = 4;
            curr_entry->tcam_config.index_in_level = 1;
            curr_entry->tcam_config.start_line = 17;
            curr_entry->tcam_config.width_in_bits = 16;
            curr_entry->tcam_config.is_reverse_order = false;
            curr_entry->sram_config.index = 1;
            curr_entry->sram_config.start_line = 17;
            curr_entry->sram_config.offset_in_line = 0;
            curr_entry->sram_config.width_in_bits = 32;
            curr_entry->sram_config.payload_needs_rmw_operation = false;
            curr_entry->sram_config.msb_aligned = false;
    ...
    if (table_name == NPL_TABLES_TXPP_INITIAL_NPE_MACRO_TABLE) {
        ...
        single_ternary_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_ternary_table_compiler_generated_config_t(25 /* key_width */, 6 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_UDP_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_VLAN0_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_VLAN1_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
    ...
    if (table_name == NPL_TABLES_VLAN_PE_FI_CORE_TCAM_TABLE) {
        ternary_table_compiler_generated_config_t result;
...
table_compiler_generated_config_t npl_tables_compiler_generated_config::get_lpm_table_config(npl_tables_e table_name)
{
    if (table_name == NPL_TABLES_IPV4_LPM_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(46 /* key_width */, 28 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_OG_PCL_LPM_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(46 /* key_width */, 25 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV4_SGT_LPM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(46 /* key_width */, 20 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV6_LPM_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(142 /* key_width */, 28 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV6_OG_PCL_LPM_TABLE) {
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(142 /* key_width */, 25 /*payload_width */));
        curr_entry = &(result.tables_config.back());
    ...
    if (table_name == NPL_TABLES_IPV6_SGT_LPM_TABLE) {
        table_compiler_generated_config_t result;
        ...
        single_table_compiler_generated_config_t* curr_entry = nullptr;
        result.tables_config.push_back(single_table_compiler_generated_config_t(142 /* key_width */, 20 /*payload_width */));
        curr_entry = &(result.tables_config.back());
