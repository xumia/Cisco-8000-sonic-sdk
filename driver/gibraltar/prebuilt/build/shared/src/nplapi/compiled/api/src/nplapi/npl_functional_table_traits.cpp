...
bool
npl_dlp0_key_lsb_mapping_table_functional_traits_t::key_match(const npl_dlp0_key_lsb_mapping_table_key_t& lookup_key, const npl_dlp0_key_lsb_mapping_table_key_t& table_key, const npl_dlp0_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_a_dest, table_key.lu_a_dest, table_mask.lu_a_dest)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.lu_d_dest, table_key.lu_d_dest, table_mask.lu_d_dest)) {
        return false;
    }
...
bool
npl_dlp1_key_lsb_mapping_table_functional_traits_t::key_match(const npl_dlp1_key_lsb_mapping_table_key_t& lookup_key, const npl_dlp1_key_lsb_mapping_table_key_t& table_key, const npl_dlp1_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_a_dest, table_key.lu_a_dest, table_mask.lu_a_dest)) {
        return false;
    }
...
bool
npl_dsp_dest_msbs_for_ecn_table_functional_traits_t::key_match(const npl_dsp_dest_msbs_for_ecn_table_key_t& lookup_key, const npl_dsp_dest_msbs_for_ecn_table_key_t& table_key, const npl_dsp_dest_msbs_for_ecn_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.fwd_header_type, table_key.fwd_header_type, table_mask.fwd_header_type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv4_ecn, table_key.ipv4_ecn, table_mask.ipv4_ecn)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv6_ecn, table_key.ipv6_ecn, table_mask.ipv6_ecn)) {
        return false;
    }
...
bool
npl_eth_fi_core_tcam_table_functional_traits_t::key_match(const npl_eth_fi_core_tcam_table_key_t& lookup_key, const npl_eth_fi_core_tcam_table_key_t& table_key, const npl_eth_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
...
bool
npl_fixup_destination_for_resolution_static_table_functional_traits_t::key_match(const npl_fixup_destination_for_resolution_static_table_key_t& lookup_key, const npl_fixup_destination_for_resolution_static_table_key_t& table_key, const npl_fixup_destination_for_resolution_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.rtype, table_key.rtype, table_mask.rtype)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.prefix_class_lp13_12, table_key.prefix_class_lp13_12, table_mask.prefix_class_lp13_12)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.dest_bit, table_key.dest_bit, table_mask.dest_bit)) {
        return false;
    }
...
bool
npl_flc_header_types_array_table_functional_traits_t::key_match(const npl_flc_header_types_array_table_key_t& lookup_key, const npl_flc_header_types_array_table_key_t& table_key, const npl_flc_header_types_array_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.flc_header_types_array_key.source_port, table_key.flc_header_types_array_key.source_port, table_mask.flc_header_types_array_key.source_port)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.flc_header_types_array_key.ifg, table_key.flc_header_types_array_key.ifg, table_mask.flc_header_types_array_key.ifg)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.flc_header_types_array_key.recycle_code, table_key.flc_header_types_array_key.recycle_code, table_mask.flc_header_types_array_key.recycle_code)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.flc_header_types_array_key.fi_hdr_5to9, table_key.flc_header_types_array_key.fi_hdr_5to9, table_mask.flc_header_types_array_key.fi_hdr_5to9)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.flc_header_types_array_key.fi_hdr_4to0, table_key.flc_header_types_array_key.fi_hdr_4to0, table_mask.flc_header_types_array_key.fi_hdr_4to0)) {
        return false;
    }
...
bool
npl_ip_fi_core_tcam_table_functional_traits_t::key_match(const npl_ip_fi_core_tcam_table_key_t& lookup_key, const npl_ip_fi_core_tcam_table_key_t& table_key, const npl_ip_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.is_ipv6_header, table_key.is_ipv6_header, table_mask.is_ipv6_header)) {
        return false;
    }
...
bool
npl_ip_inactivity_check_table_functional_traits_t::key_match(const npl_ip_inactivity_check_table_key_t& lookup_key, const npl_ip_inactivity_check_table_key_t& table_key, const npl_ip_inactivity_check_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ip_version, table_key.ip_version, table_mask.ip_version)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ip_address_msb, table_key.ip_address_msb, table_mask.ip_address_msb)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.vrf_id, table_key.vrf_id, table_mask.vrf_id)) {
        return false;
    }
...
bool
npl_ip_mc_mpls_next_macro_static_table_functional_traits_t::key_match(const npl_ip_mc_mpls_next_macro_static_table_key_t& lookup_key, const npl_ip_mc_mpls_next_macro_static_table_key_t& table_key, const npl_ip_mc_mpls_next_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.type, table_key.type, table_mask.type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv4_msb, table_key.ipv4_msb, table_mask.ipv4_msb)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv6_msb, table_key.ipv6_msb, table_mask.ipv6_msb)) {
        return false;
    }
...
bool
npl_ip_proto_type_mux_static_table_functional_traits_t::key_match(const npl_ip_proto_type_mux_static_table_key_t& lookup_key, const npl_ip_proto_type_mux_static_table_key_t& table_key, const npl_ip_proto_type_mux_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ip_version, table_key.ip_version, table_mask.ip_version)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv4_proto, table_key.ipv4_proto, table_mask.ipv4_proto)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ipv6_proto, table_key.ipv6_proto, table_mask.ipv6_proto)) {
        return false;
    }
...
void
npl_ipv4_sgt_lpm_table_functional_traits_t::mask_key(npl_ipv4_sgt_lpm_table_key_t* key, size_t length)
{
    if (length < 32) {
        key->ip_address &= (((1ULL << length) - 1) << (32 - length));
    }
...
void
npl_ipv6_sgt_lpm_table_functional_traits_t::mask_key(npl_ipv6_sgt_lpm_table_key_t* key, size_t length)
{
    npl_lpm_wide_field_apply_mask(key->ip_address, 128, length);
...
bool
npl_l3_lp_profile_filter_table_functional_traits_t::key_match(const npl_l3_lp_profile_filter_table_key_t& lookup_key, const npl_l3_lp_profile_filter_table_key_t& table_key, const npl_l3_lp_profile_filter_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.slp_profile, table_key.slp_profile, table_mask.slp_profile)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.lp_profile, table_key.lp_profile, table_mask.lp_profile)) {
        return false;
    }
...
bool
npl_large_em_key_lsb_mapping_table_functional_traits_t::key_match(const npl_large_em_key_lsb_mapping_table_key_t& lookup_key, const npl_large_em_key_lsb_mapping_table_key_t& table_key, const npl_large_em_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_c_dest, table_key.lu_c_dest, table_mask.lu_c_dest)) {
        return false;
    }
...
bool
npl_local_mc_fwd_next_macro_static_table_functional_traits_t::key_match(const npl_local_mc_fwd_next_macro_static_table_key_t& lookup_key, const npl_local_mc_fwd_next_macro_static_table_key_t& table_key, const npl_local_mc_fwd_next_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.post_fwd_stage, table_key.post_fwd_stage, table_mask.post_fwd_stage)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.current_proto_type, table_key.current_proto_type, table_mask.current_proto_type)) {
        return false;
    }
...
{
    if (!npl_ternary_field_compare(lookup_key.mac_relay_local_vars_mac_next_macro_packed_data, table_key.mac_relay_local_vars_mac_next_macro_packed_data, table_mask.mac_relay_local_vars_mac_next_macro_packed_data)) {
        return false;
    }
...
bool
npl_nh_macro_code_to_id_l6_static_table_functional_traits_t::key_match(const npl_nh_macro_code_to_id_l6_static_table_key_t& lookup_key, const npl_nh_macro_code_to_id_l6_static_table_key_t& table_key, const npl_nh_macro_code_to_id_l6_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.nh_ene_code, table_key.nh_ene_code, table_mask.nh_ene_code)) {
        return false;
    }
...
bool
npl_post_fwd_rtf_next_macro_static_table_functional_traits_t::key_match(const npl_post_fwd_rtf_next_macro_static_table_key_t& lookup_key, const npl_post_fwd_rtf_next_macro_static_table_key_t& table_key, const npl_post_fwd_rtf_next_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ip_ver_and_post_fwd_stage.ip_ver, table_key.ip_ver_and_post_fwd_stage.ip_ver, table_mask.ip_ver_and_post_fwd_stage.ip_ver)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.ip_ver_and_post_fwd_stage.post_fwd_rtf_stage, table_key.ip_ver_and_post_fwd_stage.post_fwd_rtf_stage, table_mask.ip_ver_and_post_fwd_stage.post_fwd_rtf_stage)) {
        return false;
    }
    ...
    if (!npl_ternary_field_compare(lookup_key.eth_rtf_stage, table_key.eth_rtf_stage, table_mask.eth_rtf_stage)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.fwd_layer_and_rtf_stage.fwd_layer, table_key.fwd_layer_and_rtf_stage.fwd_layer, table_mask.fwd_layer_and_rtf_stage.fwd_layer)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.fwd_layer_and_rtf_stage.rtf_stage, table_key.fwd_layer_and_rtf_stage.rtf_stage, table_mask.fwd_layer_and_rtf_stage.rtf_stage)) {
        return false;
    }
...
bool
npl_probe_marker_1_static_table_functional_traits_t::key_match(const npl_probe_marker_1_static_table_key_t& lookup_key, const npl_probe_marker_1_static_table_key_t& table_key, const npl_probe_marker_1_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.probe_marker_1, table_key.probe_marker_1, table_mask.probe_marker_1)) {
        return false;
    }
...
bool
npl_probe_marker_2_static_table_functional_traits_t::key_match(const npl_probe_marker_2_static_table_key_t& lookup_key, const npl_probe_marker_2_static_table_key_t& table_key, const npl_probe_marker_2_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.type, table_key.type, table_mask.type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.probe_marker_2, table_key.probe_marker_2, table_mask.probe_marker_2)) {
        return false;
    }
...
bool
npl_service_mapping0_key_lsb_mapping_table_functional_traits_t::key_match(const npl_service_mapping0_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping0_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping0_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.res_a_dest, table_key.res_a_dest, table_mask.res_a_dest)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.res_b_dest, table_key.res_b_dest, table_mask.res_b_dest)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.res_c_dest, table_key.res_c_dest, table_mask.res_c_dest)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.res_d_dest, table_key.res_d_dest, table_mask.res_d_dest)) {
        return false;
    }
...
bool
npl_service_mapping1_key_lsb_mapping_table_functional_traits_t::key_match(const npl_service_mapping1_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping1_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping1_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.res_a_dest, table_key.res_a_dest, table_mask.res_a_dest)) {
        return false;
    }
...
bool
npl_service_mapping_tcam_key_lsb_mapping_table_functional_traits_t::key_match(const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& lookup_key, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& table_key, const npl_service_mapping_tcam_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.res_a_dest, table_key.res_a_dest, table_mask.res_a_dest)) {
        return false;
    }
...
bool
npl_sgacl_ip_fragment_check_table_functional_traits_t::key_match(const npl_sgacl_ip_fragment_check_table_key_t& lookup_key, const npl_sgacl_ip_fragment_check_table_key_t& table_key, const npl_sgacl_ip_fragment_check_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ip_version, table_key.ip_version, table_mask.ip_version)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.v6_not_first_frag, table_key.v6_not_first_frag, table_mask.v6_not_first_frag)) {
        return false;
    }
...
bool
npl_sgacl_next_macro_static_table_functional_traits_t::key_match(const npl_sgacl_next_macro_static_table_key_t& lookup_key, const npl_sgacl_next_macro_static_table_key_t& table_key, const npl_sgacl_next_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.fwd_header_type, table_key.fwd_header_type, table_mask.fwd_header_type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.sgacl_stage, table_key.sgacl_stage, table_mask.sgacl_stage)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.svl, table_key.svl, table_mask.svl)) {
        return false;
    }
...
npl_sgacl_table_functional_traits_t::key_match(const npl_sgacl_table_key_t& lookup_key, const npl_sgacl_table_key_t& table_key, const npl_sgacl_table_key_t& table_mask)
{
    ...
    if (!npl_ternary_field_compare(lookup_key.tos, table_key.tos, table_mask.tos)) {
        return false;
    }
    ...
    if (!npl_ternary_field_compare(lookup_key.first_fragment, table_key.first_fragment, table_mask.first_fragment)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.sgacl_id, table_key.sgacl_id, table_mask.sgacl_id)) {
        return false;
    }
...
bool
npl_sgt_derivation_macro_static_table_functional_traits_t::key_match(const npl_sgt_derivation_macro_static_table_key_t& lookup_key, const npl_sgt_derivation_macro_static_table_key_t& table_key, const npl_sgt_derivation_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.fwd_header_type, table_key.fwd_header_type, table_mask.fwd_header_type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.enforcement, table_key.enforcement, table_mask.enforcement)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.valid_ip_sgt_derived, table_key.valid_ip_sgt_derived, table_mask.valid_ip_sgt_derived)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.macro_stage_vxlan_svl_pack, table_key.macro_stage_vxlan_svl_pack, table_mask.macro_stage_vxlan_svl_pack)) {
        return false;
    }
...
bool
npl_sgt_vxlan_termination_table_functional_traits_t::key_match(const npl_sgt_vxlan_termination_table_key_t& lookup_key, const npl_sgt_vxlan_termination_table_key_t& table_key, const npl_sgt_vxlan_termination_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.hdr_type_2, table_key.hdr_type_2, table_mask.hdr_type_2)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.policy_flag, table_key.policy_flag, table_mask.policy_flag)) {
        return false;
    }
...
bool
npl_small_em_key_lsb_mapping_table_functional_traits_t::key_match(const npl_small_em_key_lsb_mapping_table_key_t& lookup_key, const npl_small_em_key_lsb_mapping_table_key_t& table_key, const npl_small_em_key_lsb_mapping_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_c_dest, table_key.lu_c_dest, table_mask.lu_c_dest)) {
        return false;
    }
...
bool
npl_splitter_lu_b_key_selector_functional_traits_t::key_match(const npl_splitter_lu_b_key_selector_key_t& lookup_key, const npl_splitter_lu_b_key_selector_key_t& table_key, const npl_splitter_lu_b_key_selector_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_b_dest, table_key.lu_b_dest, table_mask.lu_b_dest)) {
        return false;
    }
...
bool
npl_splitter_lu_d_key_selector_functional_traits_t::key_match(const npl_splitter_lu_d_key_selector_key_t& lookup_key, const npl_splitter_lu_d_key_selector_key_t& table_key, const npl_splitter_lu_d_key_selector_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.lu_d_dest, table_key.lu_d_dest, table_mask.lu_d_dest)) {
        return false;
    }
...
bool
npl_svl_is_dsp_remote_functional_traits_t::key_match(const npl_svl_is_dsp_remote_key_t& lookup_key, const npl_svl_is_dsp_remote_key_t& table_key, const npl_svl_is_dsp_remote_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.destmsb, table_key.destmsb, table_mask.destmsb)) {
        return false;
    }
...
bool
npl_svl_sgacl_enable_static_table_functional_traits_t::key_match(const npl_svl_sgacl_enable_static_table_key_t& lookup_key, const npl_svl_sgacl_enable_static_table_key_t& table_key, const npl_svl_sgacl_enable_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.fwd_header_type, table_key.fwd_header_type, table_mask.fwd_header_type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.sda_fabric_enable, table_key.sda_fabric_enable, table_mask.sda_fabric_enable)) {
        return false;
    }
...
bool
npl_svl_sgacl_next_macro_static_table_functional_traits_t::key_match(const npl_svl_sgacl_next_macro_static_table_key_t& lookup_key, const npl_svl_sgacl_next_macro_static_table_key_t& table_key, const npl_svl_sgacl_next_macro_static_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.fwd_header_type, table_key.fwd_header_type, table_mask.fwd_header_type)) {
        return false;
    }
    ...
    if (!npl_ternary_field_compare(lookup_key.svl_dest, table_key.svl_dest, table_mask.svl_dest)) {
        return false;
    }
...
npl_txpp_initial_npe_macro_table_functional_traits_t::key_match(const npl_txpp_initial_npe_macro_table_key_t& lookup_key, const npl_txpp_initial_npe_macro_table_key_t& table_key, const npl_txpp_initial_npe_macro_table_key_t& table_mask)
{
    ...
    if (!npl_ternary_field_compare(lookup_key.txpp_first_macro_table_key.encap_type, table_key.txpp_first_macro_table_key.encap_type, table_mask.txpp_first_macro_table_key.encap_type)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.txpp_first_macro_table_key.field_a, table_key.txpp_first_macro_table_key.field_a, table_mask.txpp_first_macro_table_key.field_a)) {
        return false;
    }
    
    if (!npl_ternary_field_compare(lookup_key.txpp_first_macro_table_key.field_b, table_key.txpp_first_macro_table_key.field_b, table_mask.txpp_first_macro_table_key.field_b)) {
        return false;
    }
...
bool
npl_udp_fi_core_tcam_table_functional_traits_t::key_match(const npl_udp_fi_core_tcam_table_key_t& lookup_key, const npl_udp_fi_core_tcam_table_key_t& table_key, const npl_udp_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
...
bool
npl_vlan0_fi_core_tcam_table_functional_traits_t::key_match(const npl_vlan0_fi_core_tcam_table_key_t& lookup_key, const npl_vlan0_fi_core_tcam_table_key_t& table_key, const npl_vlan0_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
...
bool
npl_vlan1_fi_core_tcam_table_functional_traits_t::key_match(const npl_vlan1_fi_core_tcam_table_key_t& lookup_key, const npl_vlan1_fi_core_tcam_table_key_t& table_key, const npl_vlan1_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
...
bool
npl_vlan_pe_fi_core_tcam_table_functional_traits_t::key_match(const npl_vlan_pe_fi_core_tcam_table_key_t& lookup_key, const npl_vlan_pe_fi_core_tcam_table_key_t& table_key, const npl_vlan_pe_fi_core_tcam_table_key_t& table_mask)
{
    if (!npl_ternary_field_compare(lookup_key.ethertype_or_tpid, table_key.ethertype_or_tpid, table_mask.ethertype_or_tpid)) {
        return false;
    }
