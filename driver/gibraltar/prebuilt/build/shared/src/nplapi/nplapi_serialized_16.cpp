...
template <class Archive> void save(Archive&, const npl_app_mc_cud_narrow_t&);
template <class Archive> void load(Archive&, npl_app_mc_cud_narrow_t&);
...
template <class Archive> void save(Archive&, const npl_em_result_dsp_host_w_class_t&);
template <class Archive> void load(Archive&, npl_em_result_dsp_host_w_class_t&);

template <class Archive> void save(Archive&, const npl_em_result_dsp_host_wo_class_t&);
template <class Archive> void load(Archive&, npl_em_result_dsp_host_wo_class_t&);
...
template <class Archive> void save(Archive&, const npl_gb_std_ip_em_lpm_result_destination_with_default_t&);
template <class Archive> void load(Archive&, npl_gb_std_ip_em_lpm_result_destination_with_default_t&);

template <class Archive> void save(Archive&, const npl_host_nh_mac_t&);
template <class Archive> void load(Archive&, npl_host_nh_mac_t&);

template <class Archive> void save(Archive&, const npl_host_nh_ptr_t&);
template <class Archive> void load(Archive&, npl_host_nh_ptr_t&);

template <class Archive> void save(Archive&, const npl_inject_down_encap_ptr_or_dlp_t&);
template <class Archive> void load(Archive&, npl_inject_down_encap_ptr_or_dlp_t&);
...
template <class Archive> void save(Archive&, const npl_ip_mc_result_payload_t&);
template <class Archive> void load(Archive&, npl_ip_mc_result_payload_t&);

template <class Archive> void save(Archive&, const npl_ip_mc_result_payload_with_format_t&);
template <class Archive> void load(Archive&, npl_ip_mc_result_payload_with_format_t&);
...
template <class Archive> void save(Archive&, const npl_lpm_std_ip_em_lpm_result_destination_t&);
template <class Archive> void load(Archive&, npl_lpm_std_ip_em_lpm_result_destination_t&);
...
template <class Archive> void save(Archive&, const npl_mac_lp_attributes_payload_t_anonymous_union_layer_t&);
template <class Archive> void load(Archive&, npl_mac_lp_attributes_payload_t_anonymous_union_layer_t&);
...
template <class Archive> void save(Archive&, const npl_npu_l3_common_encap_header_t_anonymous_union_l3_dlp_nh_encap_t&);
template <class Archive> void load(Archive&, npl_npu_l3_common_encap_header_t_anonymous_union_l3_dlp_nh_encap_t&);

template <class Archive> void save(Archive&, const npl_npu_l3_encap_header_t_anonymous_union_encap_ext_t&);
template <class Archive> void load(Archive&, npl_npu_l3_encap_header_t_anonymous_union_encap_ext_t&);
...
template <class Archive> void save(Archive&, const npl_punt_l3_lp_t&);
template <class Archive> void load(Archive&, npl_punt_l3_lp_t&);
...
template <class Archive> void save(Archive&, const npl_resolution_result_dest_data_t&);
template <class Archive> void load(Archive&, npl_resolution_result_dest_data_t&);

template <class Archive> void save(Archive&, const npl_rtf_payload_t_anonymous_union_rtf_result_profile_t&);
template <class Archive> void load(Archive&, npl_rtf_payload_t_anonymous_union_rtf_result_profile_t&);
...
template <class Archive> void save(Archive&, const npl_snoop_or_rcy_data_t_anonymous_union_snoop_or_rcy_data_t&);
template <class Archive> void load(Archive&, npl_snoop_or_rcy_data_t_anonymous_union_snoop_or_rcy_data_t&);

template <class Archive> void save(Archive&, const npl_std_ip_em_lpm_result_host_and_l3_dlp_t_anonymous_union_dest_or_dest_with_class_id_t&);
template <class Archive> void load(Archive&, npl_std_ip_em_lpm_result_host_and_l3_dlp_t_anonymous_union_dest_or_dest_with_class_id_t&);

template <class Archive> void save(Archive&, const npl_svi_eve_profile_and_data_t_anonymous_union_sub_type_or_vid_2_plus_prf_t&);
template <class Archive> void load(Archive&, npl_svi_eve_profile_and_data_t_anonymous_union_sub_type_or_vid_2_plus_prf_t&);

template <class Archive> void save(Archive&, const npl_tm_headers_template_t_anonymous_union_u_t&);
template <class Archive> void load(Archive&, npl_tm_headers_template_t_anonymous_union_u_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_std_ip_em_lpm_result_host_and_l3_dlp_t& m) {
        uint64_t m_lpm_payload = m.lpm_payload;
            archive(::cereal::make_nvp("lpm_payload", m_lpm_payload));
            archive(::cereal::make_nvp("host_nh_mac", m.host_nh_mac));
            archive(::cereal::make_nvp("dest_or_dest_with_class_id", m.dest_or_dest_with_class_id));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_std_ip_em_lpm_result_host_and_l3_dlp_t& m) {
        uint64_t m_lpm_payload;
            archive(::cereal::make_nvp("lpm_payload", m_lpm_payload));
            archive(::cereal::make_nvp("host_nh_mac", m.host_nh_mac));
            archive(::cereal::make_nvp("dest_or_dest_with_class_id", m.dest_or_dest_with_class_id));
        m.lpm_payload = m_lpm_payload;
    }
};
template <class Archive>
void
...
template<>
class serializer_class<npl_std_ip_uc_lpm_results_t_anonymous_union_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_std_ip_uc_lpm_results_t_anonymous_union_result_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_std_ip_uc_lpm_results_t_anonymous_union_result_t& m) {
            archive(::cereal::make_nvp("ptr_and_l3_dlp", m.ptr_and_l3_dlp));
            archive(::cereal::make_nvp("host_and_l3_dlp", m.host_and_l3_dlp));
            archive(::cereal::make_nvp("destination_from_lpm", m.destination_from_lpm));
            archive(::cereal::make_nvp("mc_result", m.mc_result));
...
template <class Archive>
void
save(Archive& archive, const npl_std_ip_uc_lpm_results_t_anonymous_union_result_t& m)
{
    serializer_class<npl_std_ip_uc_lpm_results_t_anonymous_union_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_std_ip_uc_lpm_results_t_anonymous_union_result_t&);

template <class Archive>
void
load(Archive& archive, npl_std_ip_uc_lpm_results_t_anonymous_union_result_t& m)
{
    serializer_class<npl_std_ip_uc_lpm_results_t_anonymous_union_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_std_ip_uc_lpm_results_t_anonymous_union_result_t&);
...
template<>
class serializer_class<npl_app_mc_cud_narrow_even_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_app_mc_cud_narrow_even_t& m) {
        uint64_t m_raw = m.raw;
        uint64_t m_raw1 = m.raw1;
            archive(::cereal::make_nvp("raw", m_raw));
            archive(::cereal::make_nvp("app_mc_cud_narrow", m.app_mc_cud_narrow));
            archive(::cereal::make_nvp("raw1", m_raw1));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_app_mc_cud_narrow_even_t& m) {
        uint64_t m_raw;
        uint64_t m_raw1;
            archive(::cereal::make_nvp("raw", m_raw));
            archive(::cereal::make_nvp("app_mc_cud_narrow", m.app_mc_cud_narrow));
...
template <class Archive>
void
save(Archive& archive, const npl_app_mc_cud_narrow_even_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_even_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_app_mc_cud_narrow_even_t&);

template <class Archive>
void
load(Archive& archive, npl_app_mc_cud_narrow_even_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_even_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_app_mc_cud_narrow_even_t&);



template<>
class serializer_class<npl_app_mc_cud_narrow_odd_and_even_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_app_mc_cud_narrow_odd_and_even_t& m) {
        uint64_t m_raw = m.raw;
        uint64_t m_raw1 = m.raw1;
            archive(::cereal::make_nvp("odd", m.odd));
            archive(::cereal::make_nvp("raw", m_raw));
            archive(::cereal::make_nvp("even", m.even));
            archive(::cereal::make_nvp("raw1", m_raw1));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_app_mc_cud_narrow_odd_and_even_t& m) {
        uint64_t m_raw;
        uint64_t m_raw1;
            archive(::cereal::make_nvp("odd", m.odd));
            archive(::cereal::make_nvp("raw", m_raw));
...
template <class Archive>
void
save(Archive& archive, const npl_app_mc_cud_narrow_odd_and_even_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_odd_and_even_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_app_mc_cud_narrow_odd_and_even_t&);

template <class Archive>
void
load(Archive& archive, npl_app_mc_cud_narrow_odd_and_even_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_odd_and_even_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_app_mc_cud_narrow_odd_and_even_t&);



template<>
class serializer_class<npl_app_mc_cud_narrow_odd_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_app_mc_cud_narrow_odd_t& m) {
            archive(::cereal::make_nvp("app_mc_cud_narrow", m.app_mc_cud_narrow));
            archive(::cereal::make_nvp("reserved", m.reserved));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_app_mc_cud_narrow_odd_t& m) {
            archive(::cereal::make_nvp("app_mc_cud_narrow", m.app_mc_cud_narrow));
            archive(::cereal::make_nvp("reserved", m.reserved));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_app_mc_cud_narrow_odd_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_odd_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_app_mc_cud_narrow_odd_t&);

template <class Archive>
void
load(Archive& archive, npl_app_mc_cud_narrow_odd_t& m)
{
    serializer_class<npl_app_mc_cud_narrow_odd_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_app_mc_cud_narrow_odd_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_ip_em_result_t_anonymous_union_result_t& m) {
            ...
            archive(::cereal::make_nvp("dsp_host_w_class", m.dsp_host_w_class));
            archive(::cereal::make_nvp("dsp_host_wo_class", m.dsp_host_wo_class));
            archive(::cereal::make_nvp("mc_result", m.mc_result));
    }
    template <class Archive>
    static void
...
template<>
class serializer_class<npl_og_em_padded_result_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_og_em_padded_result_t& m) {
            archive(::cereal::make_nvp("og_em_result", m.og_em_result));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_og_em_padded_result_t& m) {
            archive(::cereal::make_nvp("og_em_result", m.og_em_result));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_og_em_padded_result_t& m)
{
    serializer_class<npl_og_em_padded_result_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_og_em_padded_result_t&);

template <class Archive>
void
load(Archive& archive, npl_og_em_padded_result_t& m)
{
    serializer_class<npl_og_em_padded_result_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_og_em_padded_result_t&);
...
template<>
class serializer_class<npl_std_ip_uc_lpm_results_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_std_ip_uc_lpm_results_t& m) {
    ...
    template <class Archive>
    static void
    do_load(Archive& archive, npl_std_ip_uc_lpm_results_t& m) {
...
template <class Archive>
void
save(Archive& archive, const npl_std_ip_uc_lpm_results_t& m)
{
    serializer_class<npl_std_ip_uc_lpm_results_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_std_ip_uc_lpm_results_t&);

template <class Archive>
void
load(Archive& archive, npl_std_ip_uc_lpm_results_t& m)
{
    serializer_class<npl_std_ip_uc_lpm_results_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_std_ip_uc_lpm_results_t&);
...
public:
    ...
    do_save(Archive& archive, const npl_ip_em_lpm_result_t_anonymous_union_result_t& m) {
            archive(::cereal::make_nvp("lpm_result", m.lpm_result));
...
template<>
class serializer_class<npl_resolution_result_dest_and_enc_data_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_resolution_result_dest_and_enc_data_t& m) {
            archive(::cereal::make_nvp("enc", m.enc));
            archive(::cereal::make_nvp("dest", m.dest));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_resolution_result_dest_and_enc_data_t& m) {
            archive(::cereal::make_nvp("enc", m.enc));
            archive(::cereal::make_nvp("dest", m.dest));
    }
};
template <class Archive>
void
save(Archive& archive, const npl_resolution_result_dest_and_enc_data_t& m)
{
    serializer_class<npl_resolution_result_dest_and_enc_data_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_resolution_result_dest_and_enc_data_t&);

template <class Archive>
void
load(Archive& archive, npl_resolution_result_dest_and_enc_data_t& m)
{
    serializer_class<npl_resolution_result_dest_and_enc_data_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_resolution_result_dest_and_enc_data_t&);
...
template<>
class serializer_class<npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t& m) {
            archive(::cereal::make_nvp("app_mc_cud", m.app_mc_cud));
            archive(::cereal::make_nvp("app_mc_cud_narrow_odd", m.app_mc_cud_narrow_odd));
            archive(::cereal::make_nvp("app_mc_cud_narrow_even", m.app_mc_cud_narrow_even));
            archive(::cereal::make_nvp("app_mc_cud_narrow_odd_and_even", m.app_mc_cud_narrow_odd_and_even));
            archive(::cereal::make_nvp("mirror", m.mirror));
            archive(::cereal::make_nvp("raw", m.raw));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t& m) {
            archive(::cereal::make_nvp("app_mc_cud", m.app_mc_cud));
            archive(::cereal::make_nvp("app_mc_cud_narrow_odd", m.app_mc_cud_narrow_odd));
            archive(::cereal::make_nvp("app_mc_cud_narrow_even", m.app_mc_cud_narrow_even));
            archive(::cereal::make_nvp("app_mc_cud_narrow_odd_and_even", m.app_mc_cud_narrow_odd_and_even));
...
template <class Archive>
void
save(Archive& archive, const npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t& m)
{
    serializer_class<npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t&);

template <class Archive>
void
load(Archive& archive, npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t& m)
{
    serializer_class<npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, npl_cud_mapping_local_vars_t_anonymous_union_mapped_cud_t&);
...
public:
    ...
    do_save(Archive& archive, const silicon_one::device_tables& m) {
            ...
            archive(::cereal::make_nvp("cong_level_ecn_remap_map_table", m.cong_level_ecn_remap_map_table));
            ...
            archive(::cereal::make_nvp("db_access_ingress_vlan_membership_table_lu_d_res_c", m.db_access_ingress_vlan_membership_table_lu_d_res_c));
            archive(::cereal::make_nvp("db_access_ingress_vlan_membership_table_lu_d_res_d", m.db_access_ingress_vlan_membership_table_lu_d_res_d));
            archive(::cereal::make_nvp("db_access_per_port_destination_table", m.db_access_per_port_destination_table));
            archive(::cereal::make_nvp("db_access_transmit_per_dest_port_npu_host_macro_stamping_table", m.db_access_transmit_per_dest_port_npu_host_macro_stamping_table));
            ...
            archive(::cereal::make_nvp("dest_type_decoding_table", m.dest_type_decoding_table));
            archive(::cereal::make_nvp("device_mode_table", m.device_mode_table));
            archive(::cereal::make_nvp("dlp0_key_lsb_mapping_table", m.dlp0_key_lsb_mapping_table));
            archive(::cereal::make_nvp("dlp1_key_lsb_mapping_table", m.dlp1_key_lsb_mapping_table));
            archive(::cereal::make_nvp("dram_cgm_cgm_deq_lut_table", m.dram_cgm_cgm_deq_lut_table));
            archive(::cereal::make_nvp("dram_cgm_cgm_lut_table", m.dram_cgm_cgm_lut_table));
            archive(::cereal::make_nvp("dsp_dest_msbs_for_ecn_table", m.dsp_dest_msbs_for_ecn_table));
            archive(::cereal::make_nvp("dsp_group_policy_table", m.dsp_group_policy_table));
            ...
            archive(::cereal::make_nvp("encap_data_source_select_table", m.encap_data_source_select_table));
            ...
            archive(::cereal::make_nvp("ene_rewrite_punt_sa_prefix_index_table", m.ene_rewrite_punt_sa_prefix_index_table));
            archive(::cereal::make_nvp("ene_rewrite_sa_prefix_index_table", m.ene_rewrite_sa_prefix_index_table));
            ...
            archive(::cereal::make_nvp("eth_type_static_table", m.eth_type_static_table));
            archive(::cereal::make_nvp("eve_drop_mapping_hw_table", m.eve_drop_mapping_hw_table));
            archive(::cereal::make_nvp("eve_drop_vlan_id_hw_table", m.eve_drop_vlan_id_hw_table));
            archive(::cereal::make_nvp("eve_interrupt_mapping_hw_table", m.eve_interrupt_mapping_hw_table));
            ...
            archive(::cereal::make_nvp("fec_table", m.fec_table));
            archive(::cereal::make_nvp("fec_type_decoding_table", m.fec_type_decoding_table));
            ...
            archive(::cereal::make_nvp("fixup_destination_for_resolution_static_table", m.fixup_destination_for_resolution_static_table));
            archive(::cereal::make_nvp("flc_cache_range_comp_profile_table", m.flc_cache_range_comp_profile_table));
            archive(::cereal::make_nvp("flc_header_types_array_table", m.flc_header_types_array_table));
            archive(::cereal::make_nvp("flc_map_header_type_mask_id_table", m.flc_map_header_type_mask_id_table));
            archive(::cereal::make_nvp("flc_map_header_type_mask_l_table", m.flc_map_header_type_mask_l_table));
            archive(::cereal::make_nvp("flc_map_header_type_mask_m_table", m.flc_map_header_type_mask_m_table));
            archive(::cereal::make_nvp("flc_map_header_type_mask_s_table", m.flc_map_header_type_mask_s_table));
            archive(::cereal::make_nvp("flc_q_range_comp_profile_table", m.flc_q_range_comp_profile_table));
            archive(::cereal::make_nvp("flc_range_comp_ranges_table", m.flc_range_comp_ranges_table));
            archive(::cereal::make_nvp("frm_db_fabric_routing_table", m.frm_db_fabric_routing_table));
            archive(::cereal::make_nvp("fwd_and_encap_types_to_field_a_offset_table", m.fwd_and_encap_types_to_field_a_offset_table));
            archive(::cereal::make_nvp("fwd_and_encap_types_to_field_b_offset_table", m.fwd_and_encap_types_to_field_b_offset_table));
            archive(::cereal::make_nvp("fwd_bucket_a_lu_data_selector", m.fwd_bucket_a_lu_data_selector));
            archive(::cereal::make_nvp("fwd_bucket_b_lu_data_selector", m.fwd_bucket_b_lu_data_selector));
            archive(::cereal::make_nvp("fwd_bucket_c_lu_data_selector", m.fwd_bucket_c_lu_data_selector));
            archive(::cereal::make_nvp("fwd_bucket_d_lu_data_selector", m.fwd_bucket_d_lu_data_selector));
            ...
            archive(::cereal::make_nvp("ip_inactivity_check_table", m.ip_inactivity_check_table));
            ...
            archive(::cereal::make_nvp("ip_mc_mpls_next_macro_static_table", m.ip_mc_mpls_next_macro_static_table));
            ...
            archive(::cereal::make_nvp("ip_proto_type_mux_static_table", m.ip_proto_type_mux_static_table));
            ...
            archive(::cereal::make_nvp("ipv4_ip_tunnel_termination_dip_tt0_table", m.ipv4_ip_tunnel_termination_dip_tt0_table));
            ...
            archive(::cereal::make_nvp("ipv4_sgt_em_table", m.ipv4_sgt_em_table));
            archive(::cereal::make_nvp("ipv4_sgt_lpm_table", m.ipv4_sgt_lpm_table));
            ...
            archive(::cereal::make_nvp("ipv6_sgt_em_table", m.ipv6_sgt_em_table));
            archive(::cereal::make_nvp("ipv6_sgt_lpm_table", m.ipv6_sgt_lpm_table));
            ...
            archive(::cereal::make_nvp("l3_lp_profile_filter_table", m.l3_lp_profile_filter_table));
            ...
            archive(::cereal::make_nvp("large_em_key_lsb_mapping_table", m.large_em_key_lsb_mapping_table));
            ...
            archive(::cereal::make_nvp("link_relay_id_static_table", m.link_relay_id_static_table));
            archive(::cereal::make_nvp("link_up_vector", m.link_up_vector));
            archive(::cereal::make_nvp("local_mc_fwd_next_macro_static_table", m.local_mc_fwd_next_macro_static_table));
            ...
            archive(::cereal::make_nvp("mac_forwarding_w_metadata_table", m.mac_forwarding_w_metadata_table));
            ...
            archive(::cereal::make_nvp("mc_cud_table", m.mc_cud_table));
            ...
            archive(::cereal::make_nvp("npp_sgt_attributes_table", m.npp_sgt_attributes_table));
            ...
            archive(::cereal::make_nvp("pbts_map_table_stage0", m.pbts_map_table_stage0));
            archive(::cereal::make_nvp("pbts_map_table_stage1", m.pbts_map_table_stage1));
            archive(::cereal::make_nvp("pbts_map_table_stage2", m.pbts_map_table_stage2));
            archive(::cereal::make_nvp("pbts_map_table_stage3", m.pbts_map_table_stage3));
            archive(::cereal::make_nvp("pdoq_oq_ifc_mapping", m.pdoq_oq_ifc_mapping));
            archive(::cereal::make_nvp("pdvoq_slice_dram_wred_lut_table", m.pdvoq_slice_dram_wred_lut_table));
            ...
            archive(::cereal::make_nvp("post_fwd_rtf_next_macro_static_table", m.post_fwd_rtf_next_macro_static_table));
            archive(::cereal::make_nvp("probe_marker_1_static_table", m.probe_marker_1_static_table));
            archive(::cereal::make_nvp("probe_marker_2_static_table", m.probe_marker_2_static_table));
            ...
            archive(::cereal::make_nvp("rx_counters_bank_id_map_config", m.rx_counters_bank_id_map_config));
            ...
            archive(::cereal::make_nvp("rx_meter_bank_offset_map", m.rx_meter_bank_offset_map));
            ...
            archive(::cereal::make_nvp("rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table", m.rxpdr_fe_rlb_uc_tx_fb_link_to_oq_table));
            archive(::cereal::make_nvp("sch_oqse_cfg", m.sch_oqse_cfg));
            archive(::cereal::make_nvp("sda_fabric_enable_table", m.sda_fabric_enable_table));
            ...
            archive(::cereal::make_nvp("select_mac_forwarding_static_table", m.select_mac_forwarding_static_table));
            archive(::cereal::make_nvp("service_lp_attributes_table", m.service_lp_attributes_table));
            archive(::cereal::make_nvp("service_mapping0_key_lsb_mapping_table", m.service_mapping0_key_lsb_mapping_table));
            archive(::cereal::make_nvp("service_mapping1_key_lsb_mapping_table", m.service_mapping1_key_lsb_mapping_table));
            ...
            archive(::cereal::make_nvp("service_mapping_tcam_key_lsb_mapping_table", m.service_mapping_tcam_key_lsb_mapping_table));
            ...
            archive(::cereal::make_nvp("service_relay_id_static_table", m.service_relay_id_static_table));
            archive(::cereal::make_nvp("set_ene_macro_and_bytes_to_remove_table", m.set_ene_macro_and_bytes_to_remove_table));
            archive(::cereal::make_nvp("sgacl_counter_bank_table", m.sgacl_counter_bank_table));
            archive(::cereal::make_nvp("sgacl_ip_fragment_check_table", m.sgacl_ip_fragment_check_table));
            archive(::cereal::make_nvp("sgacl_l4_protocol_select_table", m.sgacl_l4_protocol_select_table));
            archive(::cereal::make_nvp("sgacl_next_macro_static_table", m.sgacl_next_macro_static_table));
            archive(::cereal::make_nvp("sgacl_table", m.sgacl_table));
            archive(::cereal::make_nvp("sgt_derivation_macro_static_table", m.sgt_derivation_macro_static_table));
            archive(::cereal::make_nvp("sgt_matrix_table", m.sgt_matrix_table));
            archive(::cereal::make_nvp("sgt_vxlan_termination_table", m.sgt_vxlan_termination_table));
            ...
            archive(::cereal::make_nvp("small_em_key_lsb_mapping_table", m.small_em_key_lsb_mapping_table));
            ...
            archive(::cereal::make_nvp("source_port_to_link_table", m.source_port_to_link_table));
            archive(::cereal::make_nvp("splitter_lu_b_key_selector", m.splitter_lu_b_key_selector));
            archive(::cereal::make_nvp("splitter_lu_d_key_selector", m.splitter_lu_d_key_selector));
            archive(::cereal::make_nvp("stage0_assoc_data_table", m.stage0_assoc_data_table));
            archive(::cereal::make_nvp("stage0_em_table", m.stage0_em_table));
            archive(::cereal::make_nvp("stage0_group_size_table", m.stage0_group_size_table));
            archive(::cereal::make_nvp("stage0_protection_table", m.stage0_protection_table));
            archive(::cereal::make_nvp("stage0_type_decoding_table", m.stage0_type_decoding_table));
            archive(::cereal::make_nvp("stage1_assoc_data_table", m.stage1_assoc_data_table));
            archive(::cereal::make_nvp("stage1_em_table", m.stage1_em_table));
            archive(::cereal::make_nvp("stage1_group_size_table", m.stage1_group_size_table));
            archive(::cereal::make_nvp("stage1_protection_table", m.stage1_protection_table));
            archive(::cereal::make_nvp("stage1_type_decoding_table", m.stage1_type_decoding_table));
            archive(::cereal::make_nvp("stage2_assoc_data_table", m.stage2_assoc_data_table));
            archive(::cereal::make_nvp("stage2_em_table", m.stage2_em_table));
            archive(::cereal::make_nvp("stage2_group_size_table", m.stage2_group_size_table));
            archive(::cereal::make_nvp("stage2_protection_table", m.stage2_protection_table));
            archive(::cereal::make_nvp("stage2_type_decoding_table", m.stage2_type_decoding_table));
            archive(::cereal::make_nvp("stage3_assoc_data_table", m.stage3_assoc_data_table));
            archive(::cereal::make_nvp("stage3_em_table", m.stage3_em_table));
            archive(::cereal::make_nvp("stage3_group_size_table", m.stage3_group_size_table));
            archive(::cereal::make_nvp("stage3_protection_table", m.stage3_protection_table));
            archive(::cereal::make_nvp("stage3_type_decoding_table", m.stage3_type_decoding_table));
            archive(::cereal::make_nvp("svl_dspa_table", m.svl_dspa_table));
            archive(::cereal::make_nvp("svl_is_dsp_remote", m.svl_is_dsp_remote));
            archive(::cereal::make_nvp("svl_mirror_cmd_remote_dsp_table", m.svl_mirror_cmd_remote_dsp_table));
            archive(::cereal::make_nvp("svl_mode_table", m.svl_mode_table));
            archive(::cereal::make_nvp("svl_next_macro_static_table", m.svl_next_macro_static_table));
            archive(::cereal::make_nvp("svl_sgacl_enable_static_table", m.svl_sgacl_enable_static_table));
            archive(::cereal::make_nvp("svl_sgacl_next_macro_static_table", m.svl_sgacl_next_macro_static_table));
            archive(::cereal::make_nvp("te_headend_lsp_counter_offset_table", m.te_headend_lsp_counter_offset_table));
            archive(::cereal::make_nvp("term_bucket_a_lu_data_selector", m.term_bucket_a_lu_data_selector));
            archive(::cereal::make_nvp("term_bucket_b_lu_data_selector", m.term_bucket_b_lu_data_selector));
            archive(::cereal::make_nvp("term_bucket_c_lu_data_selector", m.term_bucket_c_lu_data_selector));
            archive(::cereal::make_nvp("term_bucket_d_lu_data_selector", m.term_bucket_d_lu_data_selector));
            archive(::cereal::make_nvp("term_to_fwd_hdr_shift_table", m.term_to_fwd_hdr_shift_table));
            ...
            archive(::cereal::make_nvp("transmit_bucket_a_lu_data_selector", m.transmit_bucket_a_lu_data_selector));
            archive(::cereal::make_nvp("transmit_bucket_b_lu_data_selector", m.transmit_bucket_b_lu_data_selector));
            archive(::cereal::make_nvp("transmit_bucket_c_lu_data_selector", m.transmit_bucket_c_lu_data_selector));
            archive(::cereal::make_nvp("transmit_bucket_d_lu_data_selector", m.transmit_bucket_d_lu_data_selector));
            ...
            archive(::cereal::make_nvp("tx_counters_bank_id_map_config", m.tx_counters_bank_id_map_config));
            ...
            archive(::cereal::make_nvp("txpp_dlp_profile_key_construct_parameters_table", m.txpp_dlp_profile_key_construct_parameters_table));
            archive(::cereal::make_nvp("txpp_em_dlp_profile_mapping_table", m.txpp_em_dlp_profile_mapping_table));
            ...
            archive(::cereal::make_nvp("voq_cgm_slice_buffers_consumption_lut_for_deq_table", m.voq_cgm_slice_buffers_consumption_lut_for_deq_table));
            ...
            archive(::cereal::make_nvp("voq_cgm_slice_drop_green_probability_selector_table", m.voq_cgm_slice_drop_green_probability_selector_table));
            archive(::cereal::make_nvp("voq_cgm_slice_drop_yellow_probability_selector_table", m.voq_cgm_slice_drop_yellow_probability_selector_table));
            archive(::cereal::make_nvp("voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table", m.voq_cgm_slice_evicted_buffers_consumption_lut_for_enq_table));
            archive(::cereal::make_nvp("voq_cgm_slice_eviction_ok_lut_for_enq_table", m.voq_cgm_slice_eviction_ok_lut_for_enq_table));
            archive(::cereal::make_nvp("voq_cgm_slice_mark_probability_selector_table", m.voq_cgm_slice_mark_probability_selector_table));
            archive(::cereal::make_nvp("voq_cgm_slice_pd_consumption_lut_for_deq_table", m.voq_cgm_slice_pd_consumption_lut_for_deq_table));
            ...
            archive(::cereal::make_nvp("voq_cgm_wred_probability_table", m.voq_cgm_wred_probability_table));
