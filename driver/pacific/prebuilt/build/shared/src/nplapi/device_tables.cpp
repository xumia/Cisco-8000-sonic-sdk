...
device_tables::initialize_tables(translator_creator& creator)
{
    ...
    bitmap_oqg_map_table = std::make_shared<npl_bitmap_oqg_map_table_t>();
    retval = init_table(creator, bitmap_oqg_map_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: bitmap_oqg_map_table, %s", la_status2str(retval).c_str());
    ...
    destination_decoding_table = std::make_shared<npl_destination_decoding_table_t>();
    retval = init_table(creator, destination_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: destination_decoding_table, %s", la_status2str(retval).c_str());
    ...
    em_pfc_cong_table = std::make_shared<npl_em_pfc_cong_table_t>();
    retval = init_table(creator, em_pfc_cong_table, 6 /*slice id*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: em_pfc_cong_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(eve_byte_addition_static_table); slice_id++) {
        eve_byte_addition_static_table[slice_id] = std::make_shared<npl_eve_byte_addition_static_table_t>();
        retval = init_table(creator, eve_byte_addition_static_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: eve_byte_addition_static_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    get_ecm_meter_ptr_table = std::make_shared<npl_get_ecm_meter_ptr_table_t>();
    retval = init_table(creator, get_ecm_meter_ptr_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: get_ecm_meter_ptr_table, %s", la_status2str(retval).c_str());
    ...
    hmc_cgm_cgm_lut_table = std::make_shared<npl_hmc_cgm_cgm_lut_table_t>();
    retval = init_table(creator, hmc_cgm_cgm_lut_table, 0 /*slice id*/, table_allocation_e::DEVICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: hmc_cgm_cgm_lut_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(inject_down_tx_redirect_counter_table); slice_id++) {
        ...
        retval = init_table(creator, inject_down_tx_redirect_counter_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(inject_up_pif_ifg_init_data_table); slice_id++) {
        ...
        retval = init_table(creator, inject_up_pif_ifg_init_data_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(inject_up_ssp_init_data_table); slice_id++) {
        ...
        retval = init_table(creator, inject_up_ssp_init_data_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(ipv6_mc_select_qos_id); slice_id++) {
        ipv6_mc_select_qos_id[slice_id] = std::make_shared<npl_ipv6_mc_select_qos_id_t>();
        retval = init_table(creator, ipv6_mc_select_qos_id[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: ipv6_mc_select_qos_id(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(is_pacific_b1_static_table); slice_id++) {
        is_pacific_b1_static_table[slice_id] = std::make_shared<npl_is_pacific_b1_static_table_t>();
        retval = init_table(creator, is_pacific_b1_static_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: is_pacific_b1_static_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(l2_lpts_ip_fragment_static_table); slice_id++) {
        l2_lpts_ip_fragment_static_table[slice_id] = std::make_shared<npl_l2_lpts_ip_fragment_static_table_t>();
        retval = init_table(creator, l2_lpts_ip_fragment_static_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: l2_lpts_ip_fragment_static_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    lpm_destination_prefix_map_table = std::make_shared<npl_lpm_destination_prefix_map_table_t>();
    retval = init_table(creator, lpm_destination_prefix_map_table, 0 /*slice id*/, table_allocation_e::DEVICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: lpm_destination_prefix_map_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(mpls_termination_em0_table); slice_id++) {
        ...
        retval = init_table(creator, mpls_termination_em0_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(mpls_termination_em1_table); slice_id++) {
        ...
        retval = init_table(creator, mpls_termination_em1_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    native_ce_ptr_table = std::make_shared<npl_native_ce_ptr_table_t>();
    retval = init_table(creator, native_ce_ptr_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_ce_ptr_table, %s", la_status2str(retval).c_str());
    
    native_fec_table = std::make_shared<npl_native_fec_table_t>();
    retval = init_table(creator, native_fec_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_fec_table, %s", la_status2str(retval).c_str());
    
    native_fec_type_decoding_table = std::make_shared<npl_native_fec_type_decoding_table_t>();
    retval = init_table(creator, native_fec_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_fec_type_decoding_table, %s", la_status2str(retval).c_str());
    
    native_frr_table = std::make_shared<npl_native_frr_table_t>();
    retval = init_table(creator, native_frr_table, 0 /*slice id*/, table_allocation_e::DEVICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_frr_table, %s", la_status2str(retval).c_str());
    
    native_frr_type_decoding_table = std::make_shared<npl_native_frr_type_decoding_table_t>();
    retval = init_table(creator, native_frr_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_frr_type_decoding_table, %s", la_status2str(retval).c_str());
    
    native_l2_lp_table = std::make_shared<npl_native_l2_lp_table_t>();
    retval = init_table(creator, native_l2_lp_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_l2_lp_table, %s", la_status2str(retval).c_str());
    
    native_l2_lp_type_decoding_table = std::make_shared<npl_native_l2_lp_type_decoding_table_t>();
    retval = init_table(creator, native_l2_lp_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_l2_lp_type_decoding_table, %s", la_status2str(retval).c_str());
    
    native_lb_group_size_table = std::make_shared<npl_native_lb_group_size_table_t>();
    retval = init_table(creator, native_lb_group_size_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_lb_group_size_table, %s", la_status2str(retval).c_str());
    
    native_lb_table = std::make_shared<npl_native_lb_table_t>();
    retval = init_table(creator, native_lb_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_lb_table, %s", la_status2str(retval).c_str());
    
    native_lb_type_decoding_table = std::make_shared<npl_native_lb_type_decoding_table_t>();
    retval = init_table(creator, native_lb_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_lb_type_decoding_table, %s", la_status2str(retval).c_str());
    
    native_lp_is_pbts_prefix_table = std::make_shared<npl_native_lp_is_pbts_prefix_table_t>();
    retval = init_table(creator, native_lp_is_pbts_prefix_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_lp_is_pbts_prefix_table, %s", la_status2str(retval).c_str());
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(native_lp_pbts_map_table); slice_id++) {
        native_lp_pbts_map_table[slice_id] = std::make_shared<npl_native_lp_pbts_map_table_t>();
        retval = init_table(creator, native_lp_pbts_map_table[slice_id], slice_id, table_allocation_e::SLICE_PAIR);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: native_lp_pbts_map_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    
    native_protection_table = std::make_shared<npl_native_protection_table_t>();
    retval = init_table(creator, native_protection_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: native_protection_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(overlay_ipv4_sip_table); slice_id++) {
        ...
        retval = init_table(creator, overlay_ipv4_sip_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    path_lb_type_decoding_table = std::make_shared<npl_path_lb_type_decoding_table_t>();
    retval = init_table(creator, path_lb_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: path_lb_type_decoding_table, %s", la_status2str(retval).c_str());
    
    path_lp_is_pbts_prefix_table = std::make_shared<npl_path_lp_is_pbts_prefix_table_t>();
    retval = init_table(creator, path_lp_is_pbts_prefix_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: path_lp_is_pbts_prefix_table, %s", la_status2str(retval).c_str());
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(path_lp_pbts_map_table); slice_id++) {
        path_lp_pbts_map_table[slice_id] = std::make_shared<npl_path_lp_pbts_map_table_t>();
        retval = init_table(creator, path_lp_pbts_map_table[slice_id], slice_id, table_allocation_e::SLICE_PAIR);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: path_lp_pbts_map_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    
    path_lp_table = std::make_shared<npl_path_lp_table_t>();
    retval = init_table(creator, path_lp_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: path_lp_table, %s", la_status2str(retval).c_str());
    
    path_lp_type_decoding_table = std::make_shared<npl_path_lp_type_decoding_table_t>();
    retval = init_table(creator, path_lp_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: path_lp_type_decoding_table, %s", la_status2str(retval).c_str());
    
    path_protection_table = std::make_shared<npl_path_protection_table_t>();
    retval = init_table(creator, path_protection_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: path_protection_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(pfc_event_queue_table); slice_id++) {
        pfc_event_queue_table[slice_id] = std::make_shared<npl_pfc_event_queue_table_t>();
        retval = init_table(creator, pfc_event_queue_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: pfc_event_queue_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    pfc_tc_latency_table = std::make_shared<npl_pfc_tc_latency_table_t>();
    retval = init_table(creator, pfc_tc_latency_table, 6 /*slice id*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: pfc_tc_latency_table, %s", la_status2str(retval).c_str());
    
    pfc_tc_table = std::make_shared<npl_pfc_tc_table_t>();
    retval = init_table(creator, pfc_tc_table, 6 /*slice id*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: pfc_tc_table, %s", la_status2str(retval).c_str());
    
    pfc_tc_wrap_latency_table = std::make_shared<npl_pfc_tc_wrap_latency_table_t>();
    retval = init_table(creator, pfc_tc_wrap_latency_table, 6 /*slice id*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: pfc_tc_wrap_latency_table, %s", la_status2str(retval).c_str());
    
    pfc_vector_static_table = std::make_shared<npl_pfc_vector_static_table_t>();
    retval = init_table(creator, pfc_vector_static_table, 6 /*slice id*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: pfc_vector_static_table, %s", la_status2str(retval).c_str());
    ...
    port_dspa_group_size_table = std::make_shared<npl_port_dspa_group_size_table_t>();
    retval = init_table(creator, port_dspa_group_size_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: port_dspa_group_size_table, %s", la_status2str(retval).c_str());
    
    port_dspa_table = std::make_shared<npl_port_dspa_table_t>();
    retval = init_table(creator, port_dspa_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: port_dspa_table, %s", la_status2str(retval).c_str());
    
    port_dspa_type_decoding_table = std::make_shared<npl_port_dspa_type_decoding_table_t>();
    retval = init_table(creator, port_dspa_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: port_dspa_type_decoding_table, %s", la_status2str(retval).c_str());
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(port_npp_protection_table); slice_id++) {
        port_npp_protection_table[slice_id] = std::make_shared<npl_port_npp_protection_table_t>();
        retval = init_table(creator, port_npp_protection_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: port_npp_protection_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    
    port_npp_protection_type_decoding_table = std::make_shared<npl_port_npp_protection_type_decoding_table_t>();
    retval = init_table(creator, port_npp_protection_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: port_npp_protection_type_decoding_table, %s", la_status2str(retval).c_str());
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(port_protection_table); slice_id++) {
        port_protection_table[slice_id] = std::make_shared<npl_port_protection_table_t>();
        retval = init_table(creator, port_protection_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: port_protection_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    resolution_pfc_select_table = std::make_shared<npl_resolution_pfc_select_table_t>();
    retval = init_table(creator, resolution_pfc_select_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: resolution_pfc_select_table, %s", la_status2str(retval).c_str());
    ...
    rewrite_sa_prefix_index_table = std::make_shared<npl_rewrite_sa_prefix_index_table_t>();
    retval = init_table(creator, rewrite_sa_prefix_index_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: rewrite_sa_prefix_index_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_em0_ac_port_table); slice_id++) {
        ...
        retval = init_table(creator, service_mapping_em0_ac_port_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_em0_ac_port_tag_table); slice_id++) {
        ...
        retval = init_table(creator, service_mapping_em0_ac_port_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_em0_ac_port_tag_tag_table); slice_id++) {
        ...
        retval = init_table(creator, service_mapping_em0_ac_port_tag_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_em0_pwe_tag_table); slice_id++) {
        ...
        retval = init_table(creator, service_mapping_em0_pwe_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_em1_ac_port_tag_table); slice_id++) {
        ...
        retval = init_table(creator, service_mapping_em1_ac_port_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_tcam_ac_port_table); slice_id++) {
        service_mapping_tcam_ac_port_table[slice_id] = std::make_shared<npl_service_mapping_tcam_ac_port_table_t>();
        retval = init_table(creator, service_mapping_tcam_ac_port_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: service_mapping_tcam_ac_port_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_tcam_ac_port_tag_table); slice_id++) {
        service_mapping_tcam_ac_port_tag_table[slice_id] = std::make_shared<npl_service_mapping_tcam_ac_port_tag_table_t>();
        retval = init_table(creator, service_mapping_tcam_ac_port_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: service_mapping_tcam_ac_port_tag_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    
    for (la_slice_id_t slice_id = 0; slice_id < array_size(service_mapping_tcam_ac_port_tag_tag_table); slice_id++) {
        service_mapping_tcam_ac_port_tag_tag_table[slice_id] = std::make_shared<npl_service_mapping_tcam_ac_port_tag_tag_table_t>();
        retval = init_table(creator, service_mapping_tcam_ac_port_tag_tag_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: service_mapping_tcam_ac_port_tag_tag_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    stage2_lb_group_size_table = std::make_shared<npl_stage2_lb_group_size_table_t>();
    retval = init_table(creator, stage2_lb_group_size_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: stage2_lb_group_size_table, %s", la_status2str(retval).c_str());
    
    stage2_lb_table = std::make_shared<npl_stage2_lb_table_t>();
    retval = init_table(creator, stage2_lb_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: stage2_lb_table, %s", la_status2str(retval).c_str());
    
    stage3_lb_group_size_table = std::make_shared<npl_stage3_lb_group_size_table_t>();
    retval = init_table(creator, stage3_lb_group_size_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: stage3_lb_group_size_table, %s", la_status2str(retval).c_str());
    
    stage3_lb_table = std::make_shared<npl_stage3_lb_table_t>();
    retval = init_table(creator, stage3_lb_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: stage3_lb_table, %s", la_status2str(retval).c_str());
    
    stage3_lb_type_decoding_table = std::make_shared<npl_stage3_lb_type_decoding_table_t>();
    retval = init_table(creator, stage3_lb_type_decoding_table, {0, 1, 2} /*all slice pairs*/, table_allocation_e::SLICE_PAIR);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: stage3_lb_type_decoding_table, %s", la_status2str(retval).c_str());
    ...
    for (size_t slice_pair = 0; slice_pair < array_size(txpp_dlp_profile_table); slice_pair++) {
        txpp_dlp_profile_table[slice_pair] = std::make_shared<npl_txpp_dlp_profile_table_t>();
        retval = init_table(creator, txpp_dlp_profile_table[slice_pair], {slice_pair * 2, slice_pair * 2 + 1}, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: txpp_dlp_profile_table(%ld), %s", slice_pair, la_status2str(retval).c_str());
    }
    ...
    txpp_fwd_header_type_is_l2_table = std::make_shared<npl_txpp_fwd_header_type_is_l2_table_t>();
    retval = init_table(creator, txpp_fwd_header_type_is_l2_table, {0, 1, 2, 3, 4, 5} /*all slices*/, table_allocation_e::SLICE);
    return_on_error(retval, TABLES, ERROR, "table initialization failed: txpp_fwd_header_type_is_l2_table, %s", la_status2str(retval).c_str());
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(voq_cgm_slice_dram_cgm_profile_table); slice_id++) {
        voq_cgm_slice_dram_cgm_profile_table[slice_id] = std::make_shared<npl_voq_cgm_slice_dram_cgm_profile_table_t>();
        retval = init_table(creator, voq_cgm_slice_dram_cgm_profile_table[slice_id], slice_id, table_allocation_e::SLICE);
        return_on_error(retval, TABLES, ERROR, "table initialization failed: voq_cgm_slice_dram_cgm_profile_table(%d), %s", slice_id, la_status2str(retval).c_str());
    }
    ...
    for (la_slice_id_t slice_id = 0; slice_id < array_size(vsid_table); slice_id++) {
        ...
        retval = init_table(creator, vsid_table[slice_id], slice_id, table_allocation_e::SLICE);
