...
struct npl_destination_decoding_table_result_t
{
    npl_check_npp_range_mode_e check_npp_range;
    npl_lb_table_behavior_type_e lb_table_behavior;
    npl_resolution_table_type_e resolution_table;
    npl_resolution_stage_type_e resolution_stage;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_destination_decoding_table_result_t element);
std::string to_short_string(npl_destination_decoding_table_result_t element);
...
std::string to_string(npl_fec_t element);
std::string to_short_string(npl_fec_t element);
...
std::string to_string(npl_frr_t element);
std::string to_short_string(npl_frr_t element);
...
struct npl_hmc_cgm_cgm_lut_results_t
{
    uint64_t dp1 : 1;
    uint64_t dp0 : 1;
    uint64_t mark : 1;
...
std::string to_string(npl_hmc_cgm_cgm_lut_results_t element);
std::string to_short_string(npl_hmc_cgm_cgm_lut_results_t element);
...
struct npl_invert_crc_and_context_id_local_var_t
{
    uint64_t inver_crc : 1;
    uint64_t context_id_bit_8 : 1;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_invert_crc_and_context_id_local_var_t element);
std::string to_short_string(npl_invert_crc_and_context_id_local_var_t element);
...
struct npl_is_pbts_prefix_t
{
    npl_is_pbts_prefix_e val;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_is_pbts_prefix_t element);
std::string to_short_string(npl_is_pbts_prefix_t element);
...
struct npl_lb_group_size_table_result_t
{
    uint64_t curr_group_size : 9;
    npl_lb_consistency_mode_e consistency_mode;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_lb_group_size_table_result_t element);
std::string to_short_string(npl_lb_group_size_table_result_t element);
...
struct npl_lpm_prefix_map_output_t
{
    uint64_t prefix : 6;
    uint64_t is_default : 1;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_lpm_prefix_map_output_t element);
std::string to_short_string(npl_lpm_prefix_map_output_t element);
...
struct npl_mc_macro_compressed_fields_t
{
    ...
    npl_counter_ptr_t q_m_counter_ptr;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
...
struct npl_mtu_and_pkt_size_t
{
    uint64_t muxed_pad_constant : 14;
    uint64_t dsp_mtu : 14;
    uint64_t pd_pkt_size : 14;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_mtu_and_pkt_size_t element);
std::string to_short_string(npl_mtu_and_pkt_size_t element);


struct npl_native_fec_destination1_t
{
    uint64_t enc_type : 4;
...
std::string to_string(npl_native_fec_destination1_t element);
std::string to_short_string(npl_native_fec_destination1_t element);


struct npl_native_fec_destination_t
{
    uint64_t destination : 20;
    npl_native_fec_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_fec_destination_t element);
std::string to_short_string(npl_native_fec_destination_t element);


struct npl_native_fec_raw_t
{
    uint64_t payload : 52;
    npl_native_fec_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_fec_raw_t element);
std::string to_short_string(npl_native_fec_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_fec_table_result_t
{
    npl_native_fec_destination_t destination;
    npl_native_fec_destination1_t destination1;
    npl_native_fec_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_fec_table_result_t element);
std::string to_short_string(npl_native_fec_table_result_t element);


struct npl_native_frr_destination_frr_protection_t
{
    uint64_t frr_protection : 8;
    uint64_t destination : 20;
...
std::string to_string(npl_native_frr_destination_frr_protection_t element);
std::string to_short_string(npl_native_frr_destination_frr_protection_t element);


struct npl_native_frr_protected_raw_t
{
    uint64_t payload : 48;
    npl_native_frr_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_frr_protected_raw_t element);
std::string to_short_string(npl_native_frr_protected_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_frr_table_protection_entry_t
{
    npl_native_frr_destination_frr_protection_t destination_frr_protection;
    npl_native_frr_protected_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_frr_table_protection_entry_t element);
std::string to_short_string(npl_native_frr_table_protection_entry_t element);


struct npl_native_l2_lp_bvn_l2_dlp_t
{
    uint64_t l2_dlp : 18;
    uint64_t bvn : 16;
...
std::string to_string(npl_native_l2_lp_bvn_l2_dlp_t element);
std::string to_short_string(npl_native_l2_lp_bvn_l2_dlp_t element);


struct npl_native_l2_lp_destination1_t
{
    uint64_t destination : 20;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_destination1_t element);
std::string to_short_string(npl_native_l2_lp_destination1_t element);


struct npl_native_l2_lp_destination2_t
{
    uint64_t destination : 20;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_destination2_t element);
std::string to_short_string(npl_native_l2_lp_destination2_t element);


struct npl_native_l2_lp_destination_ip_tunnel_t
{
    uint64_t enc_type : 4;
...
std::string to_string(npl_native_l2_lp_destination_ip_tunnel_t element);
std::string to_short_string(npl_native_l2_lp_destination_ip_tunnel_t element);


struct npl_native_l2_lp_destination_overlay_nh_t
{
    uint64_t enc_type : 4;
...
std::string to_string(npl_native_l2_lp_destination_overlay_nh_t element);
std::string to_short_string(npl_native_l2_lp_destination_overlay_nh_t element);


struct npl_native_l2_lp_destination_t
{
    uint64_t destination : 20;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_destination_t element);
std::string to_short_string(npl_native_l2_lp_destination_t element);


struct npl_native_l2_lp_destination_te_tunnel16b_t
{
    uint64_t enc_type : 4;
...
std::string to_string(npl_native_l2_lp_destination_te_tunnel16b_t element);
std::string to_short_string(npl_native_l2_lp_destination_te_tunnel16b_t element);


struct npl_native_l2_lp_dsp_l2_dlp_t
{
    uint64_t enc_type : 4;
    uint64_t l2_dlp : 18;
    uint64_t dsp : 12;
...
std::string to_string(npl_native_l2_lp_dsp_l2_dlp_t element);
std::string to_short_string(npl_native_l2_lp_dsp_l2_dlp_t element);


struct npl_native_l2_lp_dspa_l2_dlp_t
{
    uint64_t enc_type : 4;
    uint64_t l2_dlp : 18;
    uint64_t dspa : 13;
...
std::string to_string(npl_native_l2_lp_dspa_l2_dlp_t element);
std::string to_short_string(npl_native_l2_lp_dspa_l2_dlp_t element);


struct npl_native_l2_lp_narrow_raw_t
{
    uint64_t payload : 20;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_narrow_raw_t element);
std::string to_short_string(npl_native_l2_lp_narrow_raw_t element);


struct npl_native_l2_lp_protected_raw_t
{
    uint64_t payload : 37;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_protected_raw_t element);
std::string to_short_string(npl_native_l2_lp_protected_raw_t element);


struct npl_native_l2_lp_stage2_ecmp_ce_ptr_t
{
    uint64_t ce_ptr : 18;
    uint64_t stage2_ecmp : 13;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_stage2_ecmp_ce_ptr_t element);
std::string to_short_string(npl_native_l2_lp_stage2_ecmp_ce_ptr_t element);


struct npl_native_l2_lp_stage2_ecmp_vpn_inter_as_t
{
...
std::string to_string(npl_native_l2_lp_stage2_ecmp_vpn_inter_as_t element);
std::string to_short_string(npl_native_l2_lp_stage2_ecmp_vpn_inter_as_t element);


struct npl_native_l2_lp_stage2_p_nh_ce_ptr_t
{
    uint64_t enc_type : 4;
    uint64_t ce_ptr : 18;
    uint64_t stage2_p_nh : 12;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_stage2_p_nh_ce_ptr_t element);
std::string to_short_string(npl_native_l2_lp_stage2_p_nh_ce_ptr_t element);


struct npl_native_l2_lp_stage3_nh_ce_ptr_t
{
    uint64_t enc_type : 4;
    uint64_t ce_ptr : 18;
    uint64_t stage3_nh : 12;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_stage3_nh_ce_ptr_t element);
std::string to_short_string(npl_native_l2_lp_stage3_nh_ce_ptr_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_l2_lp_table_protection_entry_t
{
    npl_native_l2_lp_dsp_l2_dlp_t dsp_l2_dlp;
    npl_native_l2_lp_dspa_l2_dlp_t dspa_l2_dlp;
    npl_native_l2_lp_bvn_l2_dlp_t bvn_l2_dlp;
    npl_native_l2_lp_protected_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_table_protection_entry_t element);
std::string to_short_string(npl_native_l2_lp_table_protection_entry_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_l2_lp_table_result_narrow_t
{
    npl_native_l2_lp_destination_t destination;
    npl_native_l2_lp_destination1_t destination1;
    npl_native_l2_lp_destination2_t destination2;
    npl_native_l2_lp_stage2_ecmp_vpn_inter_as_t stage2_ecmp_vpn_inter_as;
    npl_native_l2_lp_narrow_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_table_result_narrow_t element);
std::string to_short_string(npl_native_l2_lp_table_result_narrow_t element);


struct npl_native_l2_lp_wide_raw_t
{
    uint64_t payload : 44;
    npl_native_l2_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_l2_lp_wide_raw_t element);
std::string to_short_string(npl_native_l2_lp_wide_raw_t element);


struct npl_native_lb_destination1_t
{
    uint64_t destination : 20;
...
std::string to_string(npl_native_lb_destination1_t element);
std::string to_short_string(npl_native_lb_destination1_t element);


struct npl_native_lb_destination2_t
{
    uint64_t enc_type : 4;
    uint64_t destination : 20;
    npl_native_lb_entry_type_e type;
...
std::string to_string(npl_native_lb_destination2_t element);
std::string to_short_string(npl_native_lb_destination2_t element);


struct npl_native_lb_destination_t
{
    uint64_t destination : 20;
    npl_native_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_lb_destination_t element);
std::string to_short_string(npl_native_lb_destination_t element);


struct npl_native_lb_raw_t
{
    uint64_t payload : 45;
    npl_native_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_native_lb_raw_t element);
std::string to_short_string(npl_native_lb_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_lb_table_result_t
{
    npl_native_lb_destination_t destination;
    npl_native_lb_destination1_t destination1;
    npl_native_lb_destination2_t destination2;
    npl_native_lb_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_lb_table_result_t element);
std::string to_short_string(npl_native_lb_table_result_t element);


struct npl_native_protection_id_t
{
    uint64_t id : 13;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_native_protection_id_t element);
std::string to_short_string(npl_native_protection_id_t element);
...
std::string to_string(npl_no_acls_t element);
std::string to_short_string(npl_no_acls_t element);
...
std::string to_string(npl_npp_protection_t element);
std::string to_short_string(npl_npp_protection_t element);
...
struct npl_path_lb_destination1_t
{
    uint64_t destination : 20;
...
std::string to_string(npl_path_lb_destination1_t element);
std::string to_short_string(npl_path_lb_destination1_t element);


struct npl_path_lb_destination_t
{
    uint64_t enc_type : 4;
    uint64_t destination : 20;
    npl_path_lb_entry_type_e type;
...
std::string to_string(npl_path_lb_destination_t element);
std::string to_short_string(npl_path_lb_destination_t element);


struct npl_path_lb_raw_t
{
    uint64_t payload : 26;
    npl_path_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_path_lb_raw_t element);
std::string to_short_string(npl_path_lb_raw_t element);


struct npl_path_lb_stage2_p_nh_11b_asbr_t
{
    uint64_t asbr : 15;
    uint64_t stage2_p_nh_11b : 11;
    npl_path_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lb_stage2_p_nh_11b_asbr_t element);
std::string to_short_string(npl_path_lb_stage2_p_nh_11b_asbr_t element);


struct npl_path_lb_stage2_p_nh_te_tunnel14b1_t
{
    uint64_t te_tunnel14b : 14;
    uint64_t stage2_p_nh : 12;
    npl_path_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_path_lb_stage2_p_nh_te_tunnel14b1_t element);
std::string to_short_string(npl_path_lb_stage2_p_nh_te_tunnel14b1_t element);


struct npl_path_lb_stage2_p_nh_te_tunnel14b_t
{
    uint64_t te_tunnel14b : 14;
    uint64_t stage2_p_nh : 12;
    npl_path_lb_entry_type_e type;
...
std::string to_string(npl_path_lb_stage2_p_nh_te_tunnel14b_t element);
std::string to_short_string(npl_path_lb_stage2_p_nh_te_tunnel14b_t element);


struct npl_path_lb_stage3_nh_11b_asbr_t
{
    uint64_t asbr : 15;
    uint64_t stage3_nh_11b : 11;
    npl_path_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lb_stage3_nh_11b_asbr_t element);
std::string to_short_string(npl_path_lb_stage3_nh_11b_asbr_t element);


struct npl_path_lb_stage3_nh_te_tunnel14b1_t
{
    uint64_t te_tunnel14b : 14;
    uint64_t stage3_nh : 12;
    npl_path_lb_entry_type_e type;
...
std::string to_string(npl_path_lb_stage3_nh_te_tunnel14b1_t element);
std::string to_short_string(npl_path_lb_stage3_nh_te_tunnel14b1_t element);


struct npl_path_lb_stage3_nh_te_tunnel14b_t
{
    uint64_t te_tunnel14b : 14;
    uint64_t stage3_nh : 12;
    npl_path_lb_entry_type_e type;
...
std::string to_string(npl_path_lb_stage3_nh_te_tunnel14b_t element);
std::string to_short_string(npl_path_lb_stage3_nh_te_tunnel14b_t element);


struct npl_path_lp_narrow_raw_t
{
    uint64_t payload : 17;
...
std::string to_string(npl_path_lp_narrow_raw_t element);
std::string to_short_string(npl_path_lp_narrow_raw_t element);


struct npl_path_lp_protected_raw_t
{
    uint64_t payload : 31;
    npl_path_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_path_lp_protected_raw_t element);
std::string to_short_string(npl_path_lp_protected_raw_t element);


struct npl_path_lp_stage3_nh1_t
{
    uint64_t stage3_nh : 12;
    npl_path_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_path_lp_stage3_nh1_t element);
std::string to_short_string(npl_path_lp_stage3_nh1_t element);


struct npl_path_lp_stage3_nh_te_tunnel16b_t
{
    uint64_t te_tunnel16b : 16;
    uint64_t stage3_nh : 12;
    npl_path_lp_entry_type_e type;
...
std::string to_string(npl_path_lp_stage3_nh_te_tunnel16b_t element);
std::string to_short_string(npl_path_lp_stage3_nh_te_tunnel16b_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_path_lp_table_protection_entry_t
{
    npl_path_lp_stage3_nh1_t stage3_nh1;
    npl_path_lp_stage3_nh_te_tunnel16b_t stage3_nh_te_tunnel16b;
    npl_path_lp_protected_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lp_table_protection_entry_t element);
std::string to_short_string(npl_path_lp_table_protection_entry_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_path_lp_table_result_narrow_t
{
    npl_path_lp_narrow_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lp_table_result_narrow_t element);
std::string to_short_string(npl_path_lp_table_result_narrow_t element);


struct npl_path_lp_wide_raw_t
{
    uint64_t payload : 37;
    npl_path_lp_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_path_lp_wide_raw_t element);
std::string to_short_string(npl_path_lp_wide_raw_t element);


struct npl_path_protection_id_t
{
    uint64_t id : 13;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_path_protection_id_t element);
std::string to_short_string(npl_path_protection_id_t element);


struct npl_pbts_map_table_key_t
{
    uint64_t qos : 3;
    uint64_t profile : 2;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_pbts_map_table_key_t element);
std::string to_short_string(npl_pbts_map_table_key_t element);


struct npl_pbts_map_table_result_t
{
...
std::string to_string(npl_pbts_map_table_result_t element);
std::string to_short_string(npl_pbts_map_table_result_t element);
...
std::string to_string(npl_pfc_latency_t element);
std::string to_short_string(npl_pfc_latency_t element);


struct npl_pfc_quanta_table_result_t
{
    uint64_t dual_entry : 32;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_pfc_quanta_table_result_t element);
std::string to_short_string(npl_pfc_quanta_table_result_t element);
...
std::string to_string(npl_port_dspa_dsp_t element);
std::string to_short_string(npl_port_dspa_dsp_t element);


struct npl_port_dspa_raw_t
{
    uint64_t payload : 14;
    npl_port_dspa_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_port_dspa_raw_t element);
std::string to_short_string(npl_port_dspa_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_port_dspa_table_result_t
{
    npl_port_dspa_dsp_t dsp;
    npl_port_dspa_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_port_dspa_table_result_t element);
std::string to_short_string(npl_port_dspa_table_result_t element);


struct npl_port_npp_protection_protected_raw_t
{
    uint64_t payload : 38;
...
std::string to_string(npl_port_npp_protection_protected_raw_t element);
std::string to_short_string(npl_port_npp_protection_protected_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_port_npp_protection_table_protection_entry_t
{
    npl_port_npp_protection_protected_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_port_npp_protection_table_protection_entry_t element);
std::string to_short_string(npl_port_npp_protection_table_protection_entry_t element);


struct npl_port_protection_id_t
{
    uint64_t id : 10;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_port_protection_id_t element);
std::string to_short_string(npl_port_protection_id_t element);
...
struct npl_protection_selector_t
{
    npl_resolution_protection_selector_e sel;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_protection_selector_t element);
std::string to_short_string(npl_protection_selector_t element);
...
struct npl_resolution_type_decoding_table_field_t
{
    uint64_t destination_in_nibbles : 5;
    uint64_t size_in_bits : 5;
    uint64_t offset_in_bits : 6;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_resolution_type_decoding_table_field_t element);
std::string to_short_string(npl_resolution_type_decoding_table_field_t element);


struct npl_resolution_type_decoding_table_result_t
{
    uint64_t lb_key_offset : 6;
    uint64_t lb_key_overwrite : 1;
    npl_resolution_type_decoding_table_field_t field_1;
    npl_resolution_type_decoding_table_field_t field_0;
    uint64_t index_destination_in_nibbles : 5;
    uint64_t index_size_in_nibbles : 3;
    uint64_t encapsulation_type : 4;
    uint64_t encapsulation_add_type : 1;
    uint64_t encapsulation_start : 1;
    uint64_t next_destination_mask : 5;
    uint64_t next_destination_size : 5;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_resolution_type_decoding_table_result_t element);
std::string to_short_string(npl_resolution_type_decoding_table_result_t element);
...
struct npl_rx_meter_block_meter_attribute_result_t
{
    ...
    uint64_t commited_coupling_flag : 1;
...
struct npl_rx_meter_distributed_meter_profile_result_t
{
    ...
    uint64_t tx_message_template_index : 3;
...
// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_stage2_lb_table_result_t
{
    npl_path_lb_stage3_nh_11b_asbr_t stage3_nh_11b_asbr;
    npl_path_lb_stage2_p_nh_11b_asbr_t stage2_p_nh_11b_asbr;
    npl_path_lb_stage3_nh_te_tunnel14b_t stage3_nh_te_tunnel14b;
    npl_path_lb_stage3_nh_te_tunnel14b1_t stage3_nh_te_tunnel14b1;
    npl_path_lb_stage2_p_nh_te_tunnel14b_t stage2_p_nh_te_tunnel14b;
    npl_path_lb_stage2_p_nh_te_tunnel14b1_t stage2_p_nh_te_tunnel14b1;
    npl_path_lb_destination_t destination;
    npl_path_lb_destination1_t destination1;
    npl_path_lb_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_stage2_lb_table_result_t element);
std::string to_short_string(npl_stage2_lb_table_result_t element);


struct npl_stage3_lb_bvn_l3_dlp_dlp_attr_t
{
    uint64_t dlp_attr : 6;
    uint64_t l3_dlp : 16;
    uint64_t bvn : 16;
...
std::string to_string(npl_stage3_lb_bvn_l3_dlp_dlp_attr_t element);
std::string to_short_string(npl_stage3_lb_bvn_l3_dlp_dlp_attr_t element);


struct npl_stage3_lb_destination_l3_dlp_t
{
    uint64_t l3_dlp : 16;
    uint64_t destination : 20;
    npl_stage3_lb_entry_type_e type;
...
std::string to_string(npl_stage3_lb_destination_l3_dlp_t element);
std::string to_short_string(npl_stage3_lb_destination_l3_dlp_t element);


struct npl_stage3_lb_dsp_l3_dlp_dlp_attr_t
{
    uint64_t dlp_attr : 6;
    uint64_t l3_dlp : 16;
    uint64_t dsp : 12;
...
std::string to_string(npl_stage3_lb_dsp_l3_dlp_dlp_attr_t element);
std::string to_short_string(npl_stage3_lb_dsp_l3_dlp_dlp_attr_t element);


struct npl_stage3_lb_dspa_l3_dlp_dlp_attr_t
{
    uint64_t dlp_attr : 6;
    uint64_t l3_dlp : 16;
    uint64_t dspa : 13;
...
std::string to_string(npl_stage3_lb_dspa_l3_dlp_dlp_attr_t element);
std::string to_short_string(npl_stage3_lb_dspa_l3_dlp_dlp_attr_t element);


struct npl_stage3_lb_raw_t
{
    uint64_t payload : 38;
    npl_stage3_lb_entry_type_e type;
    bit_vector64_t pack(void) const;
...
std::string to_string(npl_stage3_lb_raw_t element);
std::string to_short_string(npl_stage3_lb_raw_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_stage3_lb_table_result_t
{
    npl_stage3_lb_bvn_l3_dlp_dlp_attr_t bvn_l3_dlp_dlp_attr;
    npl_stage3_lb_dsp_l3_dlp_dlp_attr_t dsp_l3_dlp_dlp_attr;
    npl_stage3_lb_dspa_l3_dlp_dlp_attr_t dspa_l3_dlp_dlp_attr;
    npl_stage3_lb_destination_l3_dlp_t destination_l3_dlp;
    npl_stage3_lb_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_stage3_lb_table_result_t element);
std::string to_short_string(npl_stage3_lb_table_result_t element);
...
struct npl_std_ip_em_lpm_result_destination_t
{
    npl_destination_t destination;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
...
std::string to_string(npl_std_ip_em_lpm_result_destination_t element);
std::string to_short_string(npl_std_ip_em_lpm_result_destination_t element);
...
std::string to_string(npl_tunnel_dlp_t element);
std::string to_short_string(npl_tunnel_dlp_t element);
...
struct npl_txpp_first_macro_table_key_t
{
    uint64_t is_mc : 1;
    uint64_t fwd_type : 4;
    uint64_t first_encap_type : 4;
    uint64_t second_encap_type : 4;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
...
struct npl_voq_cgm_slice_dram_cgm_profile_results_t
{
    npl_quan_13b wred_probability_region[8];
    npl_wred_action_e wred_action;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_voq_cgm_slice_dram_cgm_profile_results_t element);
std::string to_short_string(npl_voq_cgm_slice_dram_cgm_profile_results_t element);


struct npl_voq_cgm_slice_profile_buff_region_thresholds_results_t
{
    npl_quan_14b q_size_buff_region[7];
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
...
struct npl_hmc_cgm_profile_global_results_t
{
    ...
    npl_quan_13b wred_fcn_probability_region[8];
    npl_quan_19b wred_region_borders[7];
...
// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_ce_ptr_table_result_narrow_t
{
    npl_native_l2_lp_destination1_t destination1;
    npl_native_l2_lp_destination2_t destination2;
    npl_native_l2_lp_stage2_ecmp_vpn_inter_as_t stage2_ecmp_vpn_inter_as;
...
std::string to_string(npl_native_ce_ptr_table_result_narrow_t element);
std::string to_short_string(npl_native_ce_ptr_table_result_narrow_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_ce_ptr_table_result_wide_t
{
    npl_native_l2_lp_destination_te_tunnel16b_t destination_te_tunnel16b;
    npl_native_l2_lp_destination_ip_tunnel_t destination_ip_tunnel;
    npl_native_l2_lp_stage2_ecmp_ce_ptr_t destination_ecmp_ce_ptr;
    npl_native_l2_lp_stage3_nh_ce_ptr_t destination_stage3_nh;
    npl_native_l2_lp_stage2_p_nh_ce_ptr_t destination_stage2_p_nh;
    npl_native_l2_lp_wide_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_ce_ptr_table_result_wide_t element);
std::string to_short_string(npl_native_ce_ptr_table_result_wide_t element);


struct npl_native_frr_table_result_protected_t
{
    uint64_t type : 1;
    npl_protection_selector_t path;
    npl_native_protection_id_t protection_id;
    npl_native_frr_table_protection_entry_t primary;
    npl_native_frr_table_protection_entry_t protecting;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_frr_table_result_protected_t element);
std::string to_short_string(npl_native_frr_table_result_protected_t element);


struct npl_native_l2_lp_table_result_protected_t
{
    uint64_t type : 1;
    npl_protection_selector_t path;
    npl_native_protection_id_t protection_id;
    npl_native_l2_lp_table_protection_entry_t primary;
    npl_native_l2_lp_table_protection_entry_t protecting;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_native_l2_lp_table_result_protected_t element);
std::string to_short_string(npl_native_l2_lp_table_result_protected_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_native_l2_lp_table_result_wide_t
{
    npl_native_l2_lp_destination_t destination;
    npl_native_l2_lp_destination_te_tunnel16b_t destination_te_tunnel16b;
    npl_native_l2_lp_destination_overlay_nh_t destination_overlay_nh;
    npl_native_l2_lp_destination_ip_tunnel_t destination_ip_tunnel;
    npl_native_l2_lp_wide_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
...
std::string to_string(npl_native_l2_lp_table_result_wide_t element);
std::string to_short_string(npl_native_l2_lp_table_result_wide_t element);
...
struct npl_path_lp_table_result_protected_t
{
    uint64_t type : 1;
    npl_protection_selector_t path;
    npl_path_protection_id_t protection_id;
    npl_path_lp_table_protection_entry_t primary;
    npl_path_lp_table_protection_entry_t protecting;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lp_table_result_protected_t element);
std::string to_short_string(npl_path_lp_table_result_protected_t element);

// This is an NPL union modeled as a C struct. Only one field may be non-zero.
struct npl_path_lp_table_result_wide_t
{
    npl_path_lp_wide_raw_t raw;
    bit_vector64_t pack(void) const;
    void unpack(bit_vector64_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_path_lp_table_result_wide_t element);
std::string to_short_string(npl_path_lp_table_result_wide_t element);
...
struct npl_port_npp_protection_table_result_protected_t
{
    uint64_t type : 1;
    npl_protection_selector_t path;
    npl_port_protection_id_t protection_id;
    npl_port_npp_protection_table_protection_entry_t primary;
    npl_port_npp_protection_table_protection_entry_t protecting;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
    field_structure to_field_structure(void) const;
};
std::string to_string(npl_port_npp_protection_table_result_protected_t element);
std::string to_short_string(npl_port_npp_protection_table_result_protected_t element);
...
{
    npl_quan_1b congestion_mark[16];
...
struct npl_base_l3_lp_attributes_t
{
    ...
    npl_common_cntr_offset_and_padding_t acl_drop_offset;
    npl_counter_ptr_t q_counter;
    npl_counter_ptr_t m_counter;
    bit_vector128_t pack(void) const;
    void unpack(bit_vector128_t);
...
struct npl_std_ip_em_lpm_result_mc_t
{
...
std::string to_string(npl_std_ip_em_lpm_result_mc_t element);
std::string to_short_string(npl_std_ip_em_lpm_result_mc_t element);
