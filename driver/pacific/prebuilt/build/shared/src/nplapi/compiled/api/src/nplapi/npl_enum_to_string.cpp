...
std::string npl_enum_to_string(const npl_check_npp_range_mode_e enum_instance)
{
    switch(enum_instance) {
        case NPL_CHECK_NPP_RANGE_MODE_DISABLED:
        {
            return "NPL_CHECK_NPP_RANGE_MODE_DISABLED(0x0)";
            break;
        }
        case NPL_CHECK_NPP_RANGE_MODE_ENABLED:
        {
            return "NPL_CHECK_NPP_RANGE_MODE_ENABLED(0x1)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_check_npp_range_mode_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_destination_type_e enum_instance)
{
    switch(enum_instance) {
        ...
        {
            return "NPL_DESTINATION_TYPE_L2_DLP(0x4)";
            break;
        }
        case NPL_DESTINATION_TYPE_L2_DLPA_OR_ECMP:
        {
            return "NPL_DESTINATION_TYPE_L2_DLPA_OR_ECMP(0x5)";
            break;
        }
        case NPL_DESTINATION_TYPE_FEC:
        {
            return "NPL_DESTINATION_TYPE_FEC(0x6)";
            break;
        }
        ...
        case NPL_DESTINATION_TYPE_STAGE2_ECMP:
        {
            return "NPL_DESTINATION_TYPE_STAGE2_ECMP(0x9)";
            break;
        }
        case NPL_DESTINATION_TYPE_STAGE2_P_NH:
        {
            return "NPL_DESTINATION_TYPE_STAGE2_P_NH(0xa)";
            break;
        }
        ...
        case NPL_DESTINATION_TYPE_STAGE3_NH:
        {
            return "NPL_DESTINATION_TYPE_STAGE3_NH(0xc)";
            break;
        }
        ...
        default:
        return std::string("UNKNOWN") + std::string("_npl_destination_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_ene_macro_ids_e enum_instance)
{
    switch(enum_instance) {
        ...
        case NPL_ENE_DMA_16BYTES_HEADER_MACRO:
        {
            return "NPL_ENE_DMA_16BYTES_HEADER_MACRO(0x4a)";
            break;
        }
        case NPL_ENE_DMA_8BYTES_HEADER_MACRO:
        {
            return "NPL_ENE_DMA_8BYTES_HEADER_MACRO(0x4b)";
            break;
        }
        ...
        {
            return "NPL_ERSPAN_II_HEADER_ENE_MACRO(0x4f)";
            break;
        }
        case NPL_FABRIC_ELEMENT_KEEPALIVE_ENE_MACRO:
        {
            return "NPL_FABRIC_ELEMENT_KEEPALIVE_ENE_MACRO(0x50)";
            break;
        }
        case NPL_FABRIC_ELEMENT_TS1_ENE_MACRO:
        {
            return "NPL_FABRIC_ELEMENT_TS1_ENE_MACRO(0x51)";
            break;
        }
        case NPL_FABRIC_ELEMENT_TS3_ENE_MACRO:
        {
            return "NPL_FABRIC_ELEMENT_TS3_ENE_MACRO(0x52)";
            break;
        }
        case NPL_FLB_FABRIC_HEADER_ENE_MACRO:
        {
            return "NPL_FLB_FABRIC_HEADER_ENE_MACRO(0x53)";
            break;
        }
        case NPL_FLB_MLP_FABRIC_HEADER_ENE_MACRO:
        {
            return "NPL_FLB_MLP_FABRIC_HEADER_ENE_MACRO(0x54)";
            break;
        }
        case NPL_GRE_MPLS_ENE_MACRO:
        {
            return "NPL_GRE_MPLS_ENE_MACRO(0x55)";
            break;
        }
        case NPL_GRE_NO_KEY_ENE_MACRO:
        {
            return "NPL_GRE_NO_KEY_ENE_MACRO(0x56)";
            break;
        }
        case NPL_GRE_WITH_SN_ENE_MACRO:
        {
            return "NPL_GRE_WITH_SN_ENE_MACRO(0x57)";
            break;
        }
        case NPL_IPV4_ENE_MACRO:
        {
            return "NPL_IPV4_ENE_MACRO(0x58)";
            break;
        }
        case NPL_IPV6_ENE_MACRO:
        {
            return "NPL_IPV6_ENE_MACRO(0x59)";
            break;
        }
        case NPL_KEEPALIVE_FABRIC_HEADER_ENE_MACRO:
        {
            return "NPL_KEEPALIVE_FABRIC_HEADER_ENE_MACRO(0x5a)";
            break;
        }
        case NPL_KEEPALIVE_MLP_ENE_MACRO:
        {
            return "NPL_KEEPALIVE_MLP_ENE_MACRO(0x5b)";
            break;
        }
        case NPL_MMM_TM_HEADER_ENE_MACRO:
        {
            return "NPL_MMM_TM_HEADER_ENE_MACRO(0x5c)";
            break;
        }
        case NPL_MMM_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO:
        {
            return "NPL_MMM_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO(0x5d)";
            break;
        }
        case NPL_MPLS_IMPOSE_1_TO_4_FIRST_LABELS_ENE_MACRO:
        {
            return "NPL_MPLS_IMPOSE_1_TO_4_FIRST_LABELS_ENE_MACRO(0x5e)";
            break;
        }
        case NPL_MPLS_IMPOSE_3_TO_8_LABELS_ENE_MACRO:
        {
            return "NPL_MPLS_IMPOSE_3_TO_8_LABELS_ENE_MACRO(0x5f)";
            break;
        }
        case NPL_MPLS_IMPOSE_INNER_AND_1_TO_4_LABELS_ENE_MACRO:
        {
            return "NPL_MPLS_IMPOSE_INNER_AND_1_TO_4_LABELS_ENE_MACRO(0x60)";
            break;
        }
        case NPL_MPLS_IMPOSE_INNER_LABEL_ENE_MACRO:
        {
            return "NPL_MPLS_IMPOSE_INNER_LABEL_ENE_MACRO(0x61)";
            break;
        }
        case NPL_MUM_TM_HEADER_ENE_MACRO:
        {
            return "NPL_MUM_TM_HEADER_ENE_MACRO(0x62)";
            break;
        }
        case NPL_MUM_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO:
        {
            return "NPL_MUM_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO(0x63)";
            break;
        }
        case NPL_NH_ETHERNET_NO_VLAN_ENE_MACRO:
        {
            return "NPL_NH_ETHERNET_NO_VLAN_ENE_MACRO(0x64)";
            break;
        }
        case NPL_NH_ETHERNET_NO_VLAN_INNER_VXLAN_ENE_MACRO:
        {
            return "NPL_NH_ETHERNET_NO_VLAN_INNER_VXLAN_ENE_MACRO(0x65)";
            break;
        }
        case NPL_NH_ETHERNET_WITH_ONE_VLAN_ENE_MACRO:
        {
            return "NPL_NH_ETHERNET_WITH_ONE_VLAN_ENE_MACRO(0x66)";
            break;
        }
        case NPL_NH_ETHERNET_WITH_TWO_VLAN_ENE_MACRO:
        {
            return "NPL_NH_ETHERNET_WITH_TWO_VLAN_ENE_MACRO(0x67)";
            break;
        }
        case NPL_NPU_HEADER_ENE_MACRO:
        {
            return "NPL_NPU_HEADER_ENE_MACRO(0x68)";
            break;
        }
        case NPL_NPU_HEADER_WITH_SOFT_NPUH_ENE_MACRO:
        {
            return "NPL_NPU_HEADER_WITH_SOFT_NPUH_ENE_MACRO(0x69)";
            break;
        }
        case NPL_OAMP_PFC_ETH_ENE_MACRO:
        {
            return "NPL_OAMP_PFC_ETH_ENE_MACRO(0x6a)";
            break;
        }
        case NPL_OAMP_PUNT_ETH_ENE_MACRO:
        {
            return "NPL_OAMP_PUNT_ETH_ENE_MACRO(0x6b)";
            break;
        }
        case NPL_PUNT_VLAN_ENE_MACRO:
        {
            return "NPL_PUNT_VLAN_ENE_MACRO(0x6c)";
            break;
        }
        case NPL_PUSH_INJECT_ETH_HEADER_ENE_MACRO:
        {
            return "NPL_PUSH_INJECT_ETH_HEADER_ENE_MACRO(0x6d)";
            break;
        }
        case NPL_PUSH_INJECT_HEADER_ENE_MACRO:
        {
            return "NPL_PUSH_INJECT_HEADER_ENE_MACRO(0x6e)";
            break;
        }
        case NPL_PWE_NO_CW_WITH_FAT_ENE_MACRO:
        {
            return "NPL_PWE_NO_CW_WITH_FAT_ENE_MACRO(0x6f)";
            break;
        }
        case NPL_PWE_WITH_CW_NO_FAT_ENE_MACRO:
        {
            return "NPL_PWE_WITH_CW_NO_FAT_ENE_MACRO(0x70)";
            break;
        }
        case NPL_PWE_WITH_CW_WITH_FAT_ENE_MACRO:
        {
            return "NPL_PWE_WITH_CW_WITH_FAT_ENE_MACRO(0x71)";
            break;
        }
        case NPL_REMOVE_PUNT_HEADER_ENE_MACRO:
        {
            return "NPL_REMOVE_PUNT_HEADER_ENE_MACRO(0x72)";
            break;
        }
        case NPL_SN_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO:
        {
            return "NPL_SN_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO(0x73)";
            break;
        }
        case NPL_SN_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO:
        {
            return "NPL_SN_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO(0x74)";
            break;
        }
        case NPL_TS1_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO:
        {
            return "NPL_TS1_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO(0x75)";
            break;
        }
        case NPL_TS1_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO:
        {
            return "NPL_TS1_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO(0x76)";
            break;
        }
        case NPL_TS3_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO:
        {
            return "NPL_TS3_PLB_FABRIC_HEADER_ONE_PACKET_ENE_MACRO(0x77)";
            break;
        }
        case NPL_TS3_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO:
        {
            return "NPL_TS3_PLB_FABRIC_HEADER_TWO_PACKETS_ENE_MACRO(0x78)";
            break;
        }
        case NPL_TX_INJECT_HEADER_AND_ETH_HEADER_ENE_MACRO:
        {
            return "NPL_TX_INJECT_HEADER_AND_ETH_HEADER_ENE_MACRO(0x79)";
            break;
        }
        case NPL_TX_INJECT_HEADER_WITH_NPUH_ENE_MACRO:
        {
            return "NPL_TX_INJECT_HEADER_WITH_NPUH_ENE_MACRO(0x7a)";
            break;
        }
        case NPL_TX_PUNT_ETH_ENE_MACRO:
        {
            return "NPL_TX_PUNT_ETH_ENE_MACRO(0x7b)";
            break;
        }
        case NPL_TX_PUNT_ETH_NO_VLAN_ENE_MACRO:
        {
            return "NPL_TX_PUNT_ETH_NO_VLAN_ENE_MACRO(0x7c)";
            break;
        }
        case NPL_TX_PUNT_HEADER_ENE_MACRO:
        {
            return "NPL_TX_PUNT_HEADER_ENE_MACRO(0x7d)";
            break;
        }
        case NPL_TX_PUNT_METADATA_ENE_MACRO:
        {
            return "NPL_TX_PUNT_METADATA_ENE_MACRO(0x7e)";
            break;
        }
        case NPL_TX_PUNT_NPU_HOST_HEADER_ENE_MACRO:
        {
            return "NPL_TX_PUNT_NPU_HOST_HEADER_ENE_MACRO(0x7f)";
            break;
        }
        case NPL_UDP_ENE_MACRO:
        {
            return "NPL_UDP_ENE_MACRO(0x80)";
            break;
        }
        case NPL_UNICAST_FLB_TM_HEADER_ENE_MACRO:
        {
            return "NPL_UNICAST_FLB_TM_HEADER_ENE_MACRO(0x81)";
            break;
        }
        case NPL_UNICAST_FLB_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO:
        {
            return "NPL_UNICAST_FLB_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO(0x82)";
            break;
        }
        case NPL_UNICAST_PLB_TM_HEADER_ENE_MACRO:
        {
            return "NPL_UNICAST_PLB_TM_HEADER_ENE_MACRO(0x83)";
            break;
        }
        case NPL_UNICAST_PLB_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO:
        {
            return "NPL_UNICAST_PLB_TM_HEADER_WITH_SOFT_NPUH_ENE_MACRO(0x84)";
            break;
        }
        case NPL_VPN_OR_6PE_LABEL_ENE_MACRO:
        {
            return "NPL_VPN_OR_6PE_LABEL_ENE_MACRO(0x85)";
            break;
        }
        case NPL_VXLAN_UDP_ENE_MACRO:
        {
            return "NPL_VXLAN_UDP_ENE_MACRO(0x86)";
            break;
        }
...
std::string npl_enum_to_string(const npl_is_pbts_prefix_e enum_instance)
{
    switch(enum_instance) {
        case NPL_IS_PBTS_PREFIX_FALSE:
        {
            return "NPL_IS_PBTS_PREFIX_FALSE(0x0)";
            break;
        }
        case NPL_IS_PBTS_PREFIX_TRUE:
        {
            return "NPL_IS_PBTS_PREFIX_TRUE(0x1)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_is_pbts_prefix_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_lb_profile_enum_e enum_instance)
{
    switch(enum_instance) {
        ...
        {
            return "NPL_LB_PROFILE_MPLS(0x0)";
            break;
        }
        case NPL_LB_PROFILE_IP:
        {
            return "NPL_LB_PROFILE_IP(0x1)";
            break;
        }
...
std::string npl_enum_to_string(const npl_lb_table_behavior_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_LB_TABLE_BEHAVIOR_TYPE_LB:
        {
            return "NPL_LB_TABLE_BEHAVIOR_TYPE_LB(0x0)";
            break;
        }
        case NPL_LB_TABLE_BEHAVIOR_TYPE_EM:
        {
            return "NPL_LB_TABLE_BEHAVIOR_TYPE_EM(0x1)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_lb_table_behavior_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_native_fec_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_NATIVE_FEC_ENTRY_TYPE_NATIVE_FEC_DESTINATION:
        {
            return "NPL_NATIVE_FEC_ENTRY_TYPE_NATIVE_FEC_DESTINATION(0x0)";
            break;
        }
        case NPL_NATIVE_FEC_ENTRY_TYPE_NATIVE_FEC_DESTINATION1:
        {
            return "NPL_NATIVE_FEC_ENTRY_TYPE_NATIVE_FEC_DESTINATION1(0x1)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_native_fec_entry_type_e");
    }
    return "";
}


std::string npl_enum_to_string(const npl_native_frr_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_NATIVE_FRR_ENTRY_TYPE_NATIVE_FRR_DESTINATION_FRR_PROTECTION:
        {
            return "NPL_NATIVE_FRR_ENTRY_TYPE_NATIVE_FRR_DESTINATION_FRR_PROTECTION(0x0)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_native_frr_entry_type_e");
    }
    return "";
}


std::string npl_enum_to_string(const npl_native_l2_lp_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION(0x0)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION1:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION1(0x1)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION2:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION2(0x2)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_ECMP_VPN_INTER_AS:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_ECMP_VPN_INTER_AS(0x3)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_OVERLAY_NH:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_OVERLAY_NH(0x4)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_IP_TUNNEL:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_IP_TUNNEL(0x5)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_TE_TUNNEL16B:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DESTINATION_TE_TUNNEL16B(0x6)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE3_NH_CE_PTR:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE3_NH_CE_PTR(0x7)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_P_NH_CE_PTR:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_P_NH_CE_PTR(0x8)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DSP_L2_DLP:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DSP_L2_DLP(0x9)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DSPA_L2_DLP:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_DSPA_L2_DLP(0xa)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_ECMP_CE_PTR:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_STAGE2_ECMP_CE_PTR(0xb)";
            break;
        }
        case NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_BVN_L2_DLP:
        {
            return "NPL_NATIVE_L2_LP_ENTRY_TYPE_NATIVE_L2_LP_BVN_L2_DLP(0xc)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_native_l2_lp_entry_type_e");
    }
    return "";
}


std::string npl_enum_to_string(const npl_native_lb_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION:
        {
            return "NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION(0x0)";
            break;
        }
        case NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION1:
        {
            return "NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION1(0x1)";
            break;
        }
        case NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION2:
        {
            return "NPL_NATIVE_LB_ENTRY_TYPE_NATIVE_LB_DESTINATION2(0x2)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_native_lb_entry_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_path_lb_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_11B_ASBR:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_11B_ASBR(0x0)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_11B_ASBR:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_11B_ASBR(0x1)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_TE_TUNNEL14B:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_TE_TUNNEL14B(0x2)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_TE_TUNNEL14B1:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE3_NH_TE_TUNNEL14B1(0x3)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_TE_TUNNEL14B:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_TE_TUNNEL14B(0x4)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_TE_TUNNEL14B1:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_STAGE2_P_NH_TE_TUNNEL14B1(0x5)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_DESTINATION:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_DESTINATION(0x6)";
            break;
        }
        case NPL_PATH_LB_ENTRY_TYPE_PATH_LB_DESTINATION1:
        {
            return "NPL_PATH_LB_ENTRY_TYPE_PATH_LB_DESTINATION1(0x7)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_path_lb_entry_type_e");
    }
    return "";
}


std::string npl_enum_to_string(const npl_path_lp_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH:
        {
            return "NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH(0x0)";
            break;
        }
        case NPL_PATH_LP_ENTRY_TYPE_PATH_LP_DESTINATION_TE_TUNNEL16B:
        {
            return "NPL_PATH_LP_ENTRY_TYPE_PATH_LP_DESTINATION_TE_TUNNEL16B(0x1)";
            break;
        }
        case NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH1:
        {
            return "NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH1(0x2)";
            break;
        }
        case NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH_TE_TUNNEL16B:
        {
            return "NPL_PATH_LP_ENTRY_TYPE_PATH_LP_STAGE3_NH_TE_TUNNEL16B(0x3)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_path_lp_entry_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_port_dspa_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_PORT_DSPA_ENTRY_TYPE_PORT_DSPA_DSP:
        {
            return "NPL_PORT_DSPA_ENTRY_TYPE_PORT_DSPA_DSP(0x0)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_port_dspa_entry_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_port_npp_protection_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_PORT_NPP_PROTECTION_ENTRY_TYPE_PORT_NPP_PROTECTION_DESTINATION_TUNNEL1_DLP:
        {
            return "NPL_PORT_NPP_PROTECTION_ENTRY_TYPE_PORT_NPP_PROTECTION_DESTINATION_TUNNEL1_DLP(0x0)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_port_npp_protection_entry_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_ptp_ts_cmd_op_e enum_instance)
{
    switch(enum_instance) {
        ...
        case NPL_TS_CMD_RECORD_RESET_CS:
        {
            return "NPL_TS_CMD_RECORD_RESET_CS(0xb)";
            break;
        }
...
std::string npl_enum_to_string(const npl_resolution_stage_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_RESOLUTION_STAGE_TYPE_NATIVE:
        {
            return "NPL_RESOLUTION_STAGE_TYPE_NATIVE(0x0)";
            break;
        }
        case NPL_RESOLUTION_STAGE_TYPE_PATH:
        {
            return "NPL_RESOLUTION_STAGE_TYPE_PATH(0x1)";
            break;
        }
        case NPL_RESOLUTION_STAGE_TYPE_PORT:
        {
            return "NPL_RESOLUTION_STAGE_TYPE_PORT(0x2)";
            break;
        }
        case NPL_RESOLUTION_STAGE_TYPE_RETURN:
        {
            return "NPL_RESOLUTION_STAGE_TYPE_RETURN(0x3)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_resolution_stage_type_e");
    }
    return "";
}


std::string npl_enum_to_string(const npl_resolution_table_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_RESOLUTION_TABLE_TYPE_NATIVE_FEC:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_NATIVE_FEC(0x0)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_NATIVE_LB:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_NATIVE_LB(0x1)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_NATIVE_L2_LP:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_NATIVE_L2_LP(0x2)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_NATIVE_L3_LP:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_NATIVE_L3_LP(0x3)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_NATIVE_FRR:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_NATIVE_FRR(0x4)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_STAGE2_LB:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_STAGE2_LB(0x5)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_PATH_LP:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_PATH_LP(0x6)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_STAGE3_LB:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_STAGE3_LB(0x7)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_PORT_NPP_PROTECTION:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_PORT_NPP_PROTECTION(0x8)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_PORT_DSPA:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_PORT_DSPA(0x9)";
            break;
        }
        case NPL_RESOLUTION_TABLE_TYPE_UNKNOWN:
        {
            return "NPL_RESOLUTION_TABLE_TYPE_UNKNOWN(0xf)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_resolution_table_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_stage3_lb_entry_type_e enum_instance)
{
    switch(enum_instance) {
        case NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_BVN_L3_DLP_DLP_ATTR:
        {
            return "NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_BVN_L3_DLP_DLP_ATTR(0x0)";
            break;
        }
        case NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DSP_L3_DLP_DLP_ATTR:
        {
            return "NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DSP_L3_DLP_DLP_ATTR(0x1)";
            break;
        }
        case NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DSPA_L3_DLP_DLP_ATTR:
        {
            return "NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DSPA_L3_DLP_DLP_ATTR(0x2)";
            break;
        }
        case NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DESTINATION_L3_DLP:
        {
            return "NPL_STAGE3_LB_ENTRY_TYPE_STAGE3_LB_DESTINATION_L3_DLP(0x3)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_stage3_lb_entry_type_e");
    }
    return "";
}
...
std::string npl_enum_to_string(const npl_wred_action_e enum_instance)
{
    switch(enum_instance) {
        case NPL_WRED_ACTION_PASS:
        {
            return "NPL_WRED_ACTION_PASS(0x0)";
            break;
        }
        case NPL_WRED_ACTION_DROP:
        {
            return "NPL_WRED_ACTION_DROP(0x1)";
            break;
        }
        case NPL_WRED_ACTION_MARK:
        {
            return "NPL_WRED_ACTION_MARK(0x2)";
            break;
        }
        
        default:
        return std::string("UNKNOWN") + std::string("_npl_wred_action_e");
    }
    return "";
}
