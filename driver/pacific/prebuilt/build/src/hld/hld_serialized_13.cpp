...
template<>
class serializer_class<silicon_one::la_next_hop_pacific::resolution_data> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_next_hop_pacific::resolution_data& m) {
            archive(::cereal::make_nvp("users_for_step", m.users_for_step));
            archive(::cereal::make_nvp("fec_impl", m.fec_impl));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_next_hop_pacific::resolution_data& m) {
            archive(::cereal::make_nvp("users_for_step", m.users_for_step));
            archive(::cereal::make_nvp("fec_impl", m.fec_impl));
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_next_hop_pacific::resolution_data& m)
{
    serializer_class<silicon_one::la_next_hop_pacific::resolution_data>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_next_hop_pacific::resolution_data&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_next_hop_pacific::resolution_data& m)
{
    serializer_class<silicon_one::la_next_hop_pacific::resolution_data>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_next_hop_pacific::resolution_data&);
...
template<>
class serializer_class<silicon_one::la_prefix_object_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_prefix_object_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_prefix_object_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_prefix_object_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_prefix_object_base>(&m));
    serializer_class<silicon_one::la_prefix_object_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_prefix_object_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_prefix_object_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_prefix_object_base>(&m));
    serializer_class<silicon_one::la_prefix_object_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_prefix_object_pacific&);
...
template<>
class serializer_class<silicon_one::la_rate_limiter_set_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_rate_limiter_set_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_rate_limiter_set_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_rate_limiter_set_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_rate_limiter_set_base>(&m));
    serializer_class<silicon_one::la_rate_limiter_set_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_rate_limiter_set_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_rate_limiter_set_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_rate_limiter_set_base>(&m));
    serializer_class<silicon_one::la_rate_limiter_set_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_rate_limiter_set_pacific&);
...
template<>
class serializer_class<silicon_one::la_security_group_cell_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_security_group_cell_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_security_group_cell_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_security_group_cell_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_security_group_cell_base>(&m));
    serializer_class<silicon_one::la_security_group_cell_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_security_group_cell_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_security_group_cell_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_security_group_cell_base>(&m));
    serializer_class<silicon_one::la_security_group_cell_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_security_group_cell_pacific&);
...
template<>
class serializer_class<silicon_one::la_stack_port_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_stack_port_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_stack_port_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_stack_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_stack_port_base>(&m));
    serializer_class<silicon_one::la_stack_port_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_stack_port_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_stack_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_stack_port_base>(&m));
    serializer_class<silicon_one::la_stack_port_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_stack_port_pacific&);
...
template<>
class serializer_class<silicon_one::la_svi_port_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_svi_port_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_svi_port_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_svi_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_svi_port_base>(&m));
    serializer_class<silicon_one::la_svi_port_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_svi_port_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_svi_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_svi_port_base>(&m));
    serializer_class<silicon_one::la_svi_port_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_svi_port_pacific&);
...
{
    silicon_one::la_prefix_object_base::prefix_nh_pair var0;
    ar(var0);
    silicon_one::la_prefix_object_pacific var1;
    ar(var1);
    silicon_one::la_rate_limiter_set_pacific var2;
    ar(var2);
    silicon_one::la_stack_port_pacific var3;
    ar(var3);
    silicon_one::la_svi_port_pacific var4;
    ar(var4);
}
...
CEREAL_REGISTER_TYPE(silicon_one::la_prefix_object_pacific);
CEREAL_REGISTER_TYPE(silicon_one::la_rate_limiter_set_base);
CEREAL_REGISTER_TYPE(silicon_one::la_rate_limiter_set_pacific);
CEREAL_REGISTER_TYPE(silicon_one::la_security_group_cell_base);
CEREAL_REGISTER_TYPE(silicon_one::la_security_group_cell_pacific);
CEREAL_REGISTER_TYPE(silicon_one::la_stack_port_base);
CEREAL_REGISTER_TYPE(silicon_one::la_stack_port_pacific);
CEREAL_REGISTER_TYPE(silicon_one::la_svi_port_base);
CEREAL_REGISTER_TYPE(silicon_one::la_svi_port_pacific);
