...
template<>
class serializer_class<silicon_one::la_l3_ac_port_impl::slice_data> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_l3_ac_port_impl::slice_data& m) {
            archive(::cereal::make_nvp("lp_attributes_entry", m.lp_attributes_entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_l3_ac_port_impl::slice_data& m) {
            archive(::cereal::make_nvp("lp_attributes_entry", m.lp_attributes_entry));
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_l3_ac_port_impl::slice_data& m)
{
    serializer_class<silicon_one::la_l3_ac_port_impl::slice_data>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_l3_ac_port_impl::slice_data&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_l3_ac_port_impl::slice_data& m)
{
    serializer_class<silicon_one::la_l3_ac_port_impl::slice_data>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_l3_ac_port_impl::slice_data&);
...
public:
    ...
    do_save(Archive& archive, const silicon_one::la_l3_fec_impl& m) {
            ...
            archive(::cereal::make_nvp("m_native_fec_table_entry", m.m_native_fec_table_entry));
...
template<>
class serializer_class<silicon_one::la_mldp_vpn_decap_impl::slice_data> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_mldp_vpn_decap_impl::slice_data& m) {
            archive(::cereal::make_nvp("m_mldp_termination_entry", m.m_mldp_termination_entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_mldp_vpn_decap_impl::slice_data& m) {
            archive(::cereal::make_nvp("m_mldp_termination_entry", m.m_mldp_termination_entry));
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_mldp_vpn_decap_impl::slice_data& m)
{
    serializer_class<silicon_one::la_mldp_vpn_decap_impl::slice_data>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_mldp_vpn_decap_impl::slice_data&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_mldp_vpn_decap_impl::slice_data& m)
{
    serializer_class<silicon_one::la_mldp_vpn_decap_impl::slice_data>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_mldp_vpn_decap_impl::slice_data&);
...
template<>
class serializer_class<silicon_one::la_mpls_vpn_decap_impl::slice_data> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_mpls_vpn_decap_impl::slice_data& m) {
            archive(::cereal::make_nvp("m_mpls_termination_entry", m.m_mpls_termination_entry));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_mpls_vpn_decap_impl::slice_data& m) {
            archive(::cereal::make_nvp("m_mpls_termination_entry", m.m_mpls_termination_entry));
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_mpls_vpn_decap_impl::slice_data& m)
{
    serializer_class<silicon_one::la_mpls_vpn_decap_impl::slice_data>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_mpls_vpn_decap_impl::slice_data&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_mpls_vpn_decap_impl::slice_data& m)
{
    serializer_class<silicon_one::la_mpls_vpn_decap_impl::slice_data>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_mpls_vpn_decap_impl::slice_data&);
...
public:
    ...
    do_save(Archive& archive, const silicon_one::la_protection_monitor_impl& m) {
            ...
            archive(::cereal::make_nvp("m_resolution_data", m.m_resolution_data));
            archive(::cereal::make_nvp("m_device", m.m_device));
            archive(::cereal::make_nvp("m_native_table_entry", m.m_native_table_entry));
            archive(::cereal::make_nvp("m_path_table_entry", m.m_path_table_entry));
    }
    template <class Archive>
    static void
...
{
    silicon_one::la_l3_ac_port_impl var0;
    ar(var0);
    silicon_one::la_l3_fec_impl var1;
    ar(var1);
    silicon_one::la_l3_protection_group_impl var2;
    ar(var2);
    silicon_one::la_lpts_impl var3;
    ar(var3);
    silicon_one::la_lsr_impl var4;
    ar(var4);
    silicon_one::la_mldp_vpn_decap_impl var5;
    ar(var5);
    silicon_one::la_mpls_label_destination_impl var6;
    ar(var6);
    silicon_one::la_mpls_multicast_group_impl var7;
    ar(var7);
    silicon_one::la_mpls_nhlfe_impl var8;
    ar(var8);
    silicon_one::la_mpls_vpn_decap_impl var9;
    ar(var9);
    ...
    ar(var14);
    silicon_one::la_protection_monitor_impl var15;
    ar(var15);
    silicon_one::la_switch_impl var16;
    ar(var16);
}
