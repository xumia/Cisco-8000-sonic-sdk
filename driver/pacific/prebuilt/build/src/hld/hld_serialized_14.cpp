...
template <class Archive> void save(Archive&, const silicon_one::ifg_handler_base::fc_mode_periodic_config_data&);
template <class Archive> void load(Archive&, silicon_one::ifg_handler_base::fc_mode_periodic_config_data&);

template <class Archive> void save(Archive&, const silicon_one::ifg_handler_base::ifg_handler_common&);
template <class Archive> void load(Archive&, silicon_one::ifg_handler_base::ifg_handler_common&);
...
template<>
class serializer_class<silicon_one::la_vrf_port_common_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_vrf_port_common_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_vrf_port_common_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_vrf_port_common_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_vrf_port_common_pacgb>(&m));
    serializer_class<silicon_one::la_vrf_port_common_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_vrf_port_common_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_vrf_port_common_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_vrf_port_common_pacgb>(&m));
    serializer_class<silicon_one::la_vrf_port_common_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_vrf_port_common_pacific&);
...
template<>
class serializer_class<silicon_one::la_vxlan_next_hop_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_vxlan_next_hop_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_vxlan_next_hop_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_vxlan_next_hop_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_vxlan_next_hop_base>(&m));
    serializer_class<silicon_one::la_vxlan_next_hop_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_vxlan_next_hop_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_vxlan_next_hop_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_vxlan_next_hop_base>(&m));
    serializer_class<silicon_one::la_vxlan_next_hop_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_vxlan_next_hop_pacific&);
...
template<>
class serializer_class<silicon_one::device_port_handler_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::device_port_handler_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::device_port_handler_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::device_port_handler_pacific& m)
{
    archive(cereal::base_class<silicon_one::device_port_handler_base>(&m));
    serializer_class<silicon_one::device_port_handler_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::device_port_handler_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::device_port_handler_pacific& m)
{
    archive(cereal::base_class<silicon_one::device_port_handler_base>(&m));
    serializer_class<silicon_one::device_port_handler_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::device_port_handler_pacific&);
...
template<>
class serializer_class<silicon_one::hld_notification_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::hld_notification_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::hld_notification_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::hld_notification_pacific& m)
{
    archive(cereal::base_class<silicon_one::hld_notification_base>(&m));
    serializer_class<silicon_one::hld_notification_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::hld_notification_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::hld_notification_pacific& m)
{
    archive(cereal::base_class<silicon_one::hld_notification_base>(&m));
    serializer_class<silicon_one::hld_notification_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::hld_notification_pacific&);
...
{
    silicon_one::la_vrf_port_common_pacific var0;
    ar(var0);
    silicon_one::la_vxlan_next_hop_pacific var1;
    ar(var1);
    silicon_one::device_port_handler_pacific var2;
    ar(var2);
    silicon_one::dummy_serdes_device_handler_base var3;
    ar(var3);
    silicon_one::dummy_serdes_handler_base var4;
    ar(var4);
    silicon_one::hld_notification_pacific var5;
    ar(var5);
}
...
CEREAL_REGISTER_TYPE(silicon_one::la_vrf_port_common_pacific);
CEREAL_REGISTER_TYPE(silicon_one::la_vxlan_next_hop_base);
CEREAL_REGISTER_TYPE(silicon_one::la_vxlan_next_hop_pacific);
...
CEREAL_REGISTER_TYPE(silicon_one::device_port_handler_pacific);
...
CEREAL_REGISTER_TYPE(silicon_one::hld_notification_pacific);
