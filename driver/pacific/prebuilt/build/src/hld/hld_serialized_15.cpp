...
template <class Archive> void save(Archive&, const silicon_one::ifg_handler_base&);
template <class Archive> void load(Archive&, silicon_one::ifg_handler_base&);
...
template<>
class serializer_class<silicon_one::ifg_handler_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::ifg_handler_pacific& m) {
            archive(::cereal::make_nvp("m_pacific_tree", m.m_pacific_tree));
            archive(::cereal::make_nvp("m_single_port_lines", m.m_single_port_lines));
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::ifg_handler_pacific& m) {
            archive(::cereal::make_nvp("m_pacific_tree", m.m_pacific_tree));
            archive(::cereal::make_nvp("m_single_port_lines", m.m_single_port_lines));
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::ifg_handler_pacific& m)
{
    archive(cereal::base_class<silicon_one::ifg_handler_ifg>(&m));
    serializer_class<silicon_one::ifg_handler_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::ifg_handler_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::ifg_handler_pacific& m)
{
    archive(cereal::base_class<silicon_one::ifg_handler_ifg>(&m));
    serializer_class<silicon_one::ifg_handler_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::ifg_handler_pacific&);
...
template<>
class serializer_class<silicon_one::la_erspan_mirror_command_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_erspan_mirror_command_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_erspan_mirror_command_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_erspan_mirror_command_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_erspan_mirror_command_base>(&m));
    serializer_class<silicon_one::la_erspan_mirror_command_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_erspan_mirror_command_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_erspan_mirror_command_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_erspan_mirror_command_base>(&m));
    serializer_class<silicon_one::la_erspan_mirror_command_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_erspan_mirror_command_pacific&);
...
template<>
class serializer_class<silicon_one::la_l2_mirror_command_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_l2_mirror_command_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_l2_mirror_command_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_l2_mirror_command_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_l2_mirror_command_pacgb>(&m));
    serializer_class<silicon_one::la_l2_mirror_command_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_l2_mirror_command_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_l2_mirror_command_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_l2_mirror_command_pacgb>(&m));
    serializer_class<silicon_one::la_l2_mirror_command_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_l2_mirror_command_pacific&);
...
template<>
class serializer_class<silicon_one::la_mac_port_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_mac_port_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_mac_port_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_mac_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_mac_port_pacgb>(&m));
    serializer_class<silicon_one::la_mac_port_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_mac_port_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_mac_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_mac_port_pacgb>(&m));
    serializer_class<silicon_one::la_mac_port_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_mac_port_pacific&);
...
template<>
class serializer_class<silicon_one::la_npu_host_port_pacific> {
public:
    template <class Archive>
    static void
    do_save(Archive& archive, const silicon_one::la_npu_host_port_pacific& m) {
    }
    template <class Archive>
    static void
    do_load(Archive& archive, silicon_one::la_npu_host_port_pacific& m) {
    }
};
template <class Archive>
void
save(Archive& archive, const silicon_one::la_npu_host_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_npu_host_port_base>(&m));
    serializer_class<silicon_one::la_npu_host_port_pacific>::do_save(archive, m);
}
template void save<cereal_output_archive_class>(cereal_output_archive_class&, const silicon_one::la_npu_host_port_pacific&);

template <class Archive>
void
load(Archive& archive, silicon_one::la_npu_host_port_pacific& m)
{
    archive(cereal::base_class<silicon_one::la_npu_host_port_base>(&m));
    serializer_class<silicon_one::la_npu_host_port_pacific>::do_load(archive, m);
}
template void load<cereal_input_archive_class>(cereal_input_archive_class&, silicon_one::la_npu_host_port_pacific&);
...
{
    silicon_one::ifg_handler_pacific var0;
    ar(var0);
    silicon_one::la_erspan_mirror_command_pacific var1;
    ar(var1);
    silicon_one::la_l2_mirror_command_pacific var2;
    ar(var2);
    silicon_one::la_mac_port_pacific var3;
    ar(var3);
    silicon_one::la_npu_host_port_pacific var4;
    ar(var4);
}
