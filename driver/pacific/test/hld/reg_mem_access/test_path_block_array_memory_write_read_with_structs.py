...
class path_block_array_memory_write_read_with_structs(reg_mem_access_base_with_structs):

    def test_path_block_array_memory_write_read(self):
        self.MEM = self.pacific_tree.csms.dst_dev_map_mem[2]
        self.MEM_VALUE = self.debug_device.create_register(self.MEM)
        self.MEM_VALUE.flat = 500
        mem_index = 2
