...
static const std::array<la_resource_descriptor::type_e, (size_t)la_resource_descriptor::type_e::LAST + 1> m_types
    = {{la_resource_descriptor::type_e::AC_PROFILE,
        ...
        la_resource_descriptor::type_e::STAGE3_LB_GROUP,
        ...
        la_resource_descriptor::type_e::NATIVE_CE_PTR_TABLE,
        la_resource_descriptor::type_e::PROTECTION_GROUP,
...
resource_handler::initialize_resources_types()
{
    ...
    resources[(size_t)la_resource_descriptor::type_e::NATIVE_CE_PTR_TABLE] = la_resource_granularity::DEVICE;
    resources[(size_t)la_resource_descriptor::type_e::PROTECTION_GROUP] = la_resource_granularity::DEVICE;
...
resource_handler::initialize_resources_instances()
{
    ...
    add_resource(m_device->m_tables.native_fec_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE1_LB_GROUP;
    add_resource(&(m_device->m_index_generators.ecmp_groups[RESOLUTION_STEP_NATIVE_LB]), resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE1_LB_MEMBER;
    add_resource(m_device->m_tables.native_lb_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE1_PROTECTION_MONITOR;
    add_resource(m_device->m_tables.native_protection_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE2_LB_GROUP;
    add_resource(&(m_device->m_index_generators.ecmp_groups[RESOLUTION_STEP_STAGE2_LB]), resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE2_LB_MEMBER;
    add_resource(m_device->m_tables.stage2_lb_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE2_PROTECTION_MONITOR;
    add_resource(m_device->m_tables.path_protection_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE3_LB_GROUP;
    add_resource(m_device->m_tables.stage3_lb_group_size_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::STAGE3_LB_MEMBER;
    add_resource(m_device->m_tables.stage3_lb_table, resource_descriptor);
    ...
    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::NATIVE_CE_PTR_TABLE;
    add_resource(m_device->m_tables.native_ce_ptr_table, resource_descriptor);

    resource_descriptor.m_resource_type = la_resource_descriptor::type_e::PROTECTION_GROUP;
    add_resource(m_device->m_tables.path_lp_table, resource_descriptor);
