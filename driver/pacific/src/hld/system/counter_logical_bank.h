...
enum {
    MAX_LOGICAL_ROWS_IN_COUNTER_BANK = 4 * 1024,
...
class counter_logical_bank
{
    ...
    // Reads a specific physical-counter (clears HW counter while updating SW shadow)
    void read_phys_counter(size_t slice, la_ifg_id_t ifg, size_t row_index);
