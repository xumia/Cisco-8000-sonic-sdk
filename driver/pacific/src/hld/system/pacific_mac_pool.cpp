...
pacific_mac_pool::pacific_mac_pool(const la_device_impl_wptr& device) : mac_pool_port(device)
{
...
pacific_mac_pool::~pacific_mac_pool()
{
}

la_status
pacific_mac_pool::initialize(la_slice_id_t slice_id,
                             la_ifg_id_t ifg_id,
...
{
    static_assert((size_t)mac_pool8_counter_timer_register::SIZE == (size_t)mac_pool2_counter_timer_register::SIZE,
                  "mac_pool_counter_timer_register SIZE does not match");

    static_assert((size_t)mac_pool8_counter_timer_trigger_reg_register::SIZE
                      == (size_t)mac_pool2_counter_timer_trigger_reg_register::SIZE,
                  "mac_pool_counter_timer_trigger_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_cfg0_register::SIZE == (size_t)mac_pool2_rx_cfg0_register::SIZE,
                  "mac_pool_rx_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_tx_cfg0_register::SIZE == (size_t)mac_pool2_tx_cfg0_register::SIZE,
                  "mac_pool_tx_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_am_cfg_register::SIZE == (size_t)mac_pool2_am_cfg_register::SIZE,
                  "mac_pool_am_cfg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_mac_cfg0_register::SIZE == (size_t)mac_pool2_rx_mac_cfg0_register::SIZE,
                  "mac_pool_rx_mac_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_tx_mac_cfg0_register::SIZE == (size_t)mac_pool2_tx_mac_cfg0_register::SIZE,
                  "mac_pool_tx_mac_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_rsf_cfg0_register::SIZE == (size_t)mac_pool2_rx_rsf_cfg0_register::SIZE,
                  "mac_pool_rx_rsf_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_high_ser_fsm_cfg_register::SIZE == (size_t)mac_pool2_rx_high_ser_fsm_cfg_register::SIZE,
                  "mac_pool_rx_high_ser_fsm_cfg_register SIZE does not match");

    static_assert((size_t)mac_pool8_port_mib_counter_register::SIZE == (size_t)mac_pool2_port_mib_counter_register::SIZE,
                  "mac_pool_port_mib_counter_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_pcs_test_counter_register::SIZE == (size_t)mac_pool2_rx_pcs_test_counter_register::SIZE,
                  "mac_pool_rx_pcs_test_counter_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_pma_test_counter_register::SIZE == (size_t)mac_pool2_rx_pma_test_counter_register::SIZE,
                  "mac_pool_rx_pma_test_counter_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_errored_blocks_cnt_reg_register::SIZE
                      == (size_t)mac_pool2_rx_errored_blocks_cnt_reg_register::SIZE,
                  "mac_pool_rx_errored_blocks_cnt_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_ber_cnt_reg_register::SIZE == (size_t)mac_pool2_rx_ber_cnt_reg_register::SIZE,
                  "mac_pool_rx_ber_cnt_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_status_register_register::SIZE == (size_t)mac_pool2_rx_status_register_register::SIZE,
                  "mac_pool_rx_status_register_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_status_lane_mapping_register::SIZE
                      == (size_t)mac_pool2_rx_status_lane_mapping_register::SIZE,
                  "mac_pool_rx_status_lane_mapping_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_krf_status_register::SIZE == (size_t)mac_pool2_rx_krf_status_register::SIZE,
                  "mac_pool_rx_krf_status_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_krf_cor_blocks_cnt_reg_register::SIZE
                      == (size_t)mac_pool2_rx_krf_cor_blocks_cnt_reg_register::SIZE,
                  "mac_pool_rx_krf_cor_blocks_cnt_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_krf_uncor_blocks_cnt_reg_register::SIZE
                      == (size_t)mac_pool2_rx_krf_uncor_blocks_cnt_reg_register::SIZE,
                  "mac_pool_rx_krf_uncor_blocks_cnt_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_cor_cw_reg_register::SIZE == (size_t)mac_pool2_rx_cor_cw_reg_register::SIZE,
                  "mac_pool_rx_cor_cw_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_uncor_cw_reg_register::SIZE == (size_t)mac_pool2_rx_uncor_cw_reg_register::SIZE,
                  "mac_pool_rx_uncor_cw_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_rsf_dbg_cntrs_reg_register::SIZE == (size_t)mac_pool2_rx_rsf_dbg_cntrs_reg_register::SIZE,
                  "mac_pool_rx_rsf_dbg_cntrs_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_ber_fsm_cfg_register::SIZE == (size_t)mac_pool2_rx_ber_fsm_cfg_register::SIZE,
                  "mac_pool_rx_ber_fsm_cfg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rsf_degraded_ser_cfg0_register::SIZE == (size_t)mac_pool2_rsf_degraded_ser_cfg0_register::SIZE,
                  "mac_pool8_rsf_degraded_ser_cfg0_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_high_ser_fsm_cfg_register::SIZE == (size_t)mac_pool2_rx_high_ser_fsm_cfg_register::SIZE,
                  "mac_pool8_rx_high_ser_fsm_cfg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_symb_err_lane0_reg_register::SIZE == (size_t)mac_pool2_rx_symb_err_lane0_reg_register::SIZE,
                  "mac_pool8_rx_symb_err_lane0_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rsf_ck_cycles_per_1ms_reg_register::SIZE
                      == (size_t)mac_pool2_rsf_ck_cycles_per_1ms_reg_register::SIZE,
                  "mac_pool8_rsf_ck_cycles_per_1ms_reg_register SIZE does not match");

    static_assert((size_t)mac_pool8_rx_krf_cfg_register::SIZE == (size_t)mac_pool2_rx_krf_cfg_register::SIZE,
                  "mac_pool8_rx_krf_cfg_register SIZE does not match");
    m_slice_id = slice_id;
    m_ifg_id = ifg_id;
...
la_status
pacific_mac_pool::reset_rs_fec_config()
{
    mac_pool2_rx_rsf_cfg0_register rx_rsf_cfg0_register{{0}};
...
la_status
pacific_mac_pool::read_mib_counters(bool clear, la_mac_port::mib_counters& out_mib_counters) const
{
    mac_pool2_port_mib_counter_register reg;
    ...
    out_mib_counters.tx_oob_mac_crc_err = reg.fields.tx_oob_mac_crc_err_cnt;
    ...
    out_mib_counters.rx_oob_mac_invert_crc = reg.fields.rx_oob_mac_invert_crc_cnt;
    out_mib_counters.rx_oob_mac_crc_err = reg.fields.rx_oob_mac_crc_err_cnt;
...
la_status
pacific_mac_pool::get_mac_config(mac_pool2_rx_mac_cfg0_register* rx_mac_cfg0_register,
                                 mac_pool2_tx_mac_cfg0_register* tx_mac_cfg0_register) const
{
    la_status stat;
...
la_status
pacific_mac_pool::set_mac_config(mac_pool_rx_mac_cfg0_register* rx_mac_cfg0_register,
...
la_status
pacific_mac_pool::reset_mac_config()
{
    mac_pool2_rx_mac_cfg0_register rx_mac_cfg0_register;
    mac_pool2_tx_mac_cfg0_register tx_mac_cfg0_register;

    bzero(&rx_mac_cfg0_register, mac_pool2_rx_mac_cfg0_register::SIZE);
    bzero(&tx_mac_cfg0_register, mac_pool2_tx_mac_cfg0_register::SIZE);
    ...
    rx_mac_cfg0_register.fields.rx_ctrl_pkts_term_by_address
        = 0; ///< MAC FC packets termination based on DA (0-terminate DA==multicast only, 1-terminate
             ///< DA==multicast or port address).
...
la_status
pacific_mac_pool::set_fc_mode(la_mac_port::fc_direction_e fc_dir, la_mac_port::fc_mode_e fc_mode)
{
...
la_status
pacific_mac_pool::get_ipg(la_uint16_t& out_gap_len, la_uint16_t& out_gap_tx_bytes) const
{
    mac_pool2_tx_mac_cfg_ipg_register tx_mac_cfg_ipg;
...
la_status
pacific_mac_pool::set_ipg(la_uint16_t gap_len, la_uint16_t gap_tx_bytes)
{
    mac_pool2_tx_mac_cfg_ipg_register tx_mac_cfg_ipg;
...
la_status
pacific_mac_pool::get_crc_enabled(bool& out_enabled) const
{
    mac_pool2_rx_mac_cfg0_register rx_mac_cfg0_register;
    mac_pool2_tx_mac_cfg0_register tx_mac_cfg0_register;
    la_status stat = get_mac_config(&rx_mac_cfg0_register, &tx_mac_cfg0_register);
...
la_status
pacific_mac_pool::set_crc_enabled(bool enabled)
{
    mac_pool2_rx_mac_cfg0_register rx_mac_cfg0_register;
    mac_pool2_tx_mac_cfg0_register tx_mac_cfg0_register;
    la_status stat = get_mac_config(&rx_mac_cfg0_register, &tx_mac_cfg0_register);
...
la_status
pacific_mac_pool::destroy_general_config()
{
    mac_pool2_tx_cfg0_register tx_cfg_register;
    mac_pool2_rx_cfg0_register rx_cfg_register;
    mac_pool2_am_cfg_register am_cfg_register;
    mac_pool2_rsf_ck_cycles_per_1ms_reg_register rsf_ck_cycles_reg;

    bzero(&tx_cfg_register, mac_pool2_tx_cfg0_register::SIZE);
    bzero(&rx_cfg_register, mac_pool2_rx_cfg0_register::SIZE);
    bzero(&am_cfg_register, mac_pool2_am_cfg_register::SIZE);
    bzero(&rsf_ck_cycles_reg, mac_pool2_rsf_ck_cycles_per_1ms_reg_register::SIZE);
...
la_status
pacific_mac_pool::reset_general_config()
{
    mac_pool2_tx_cfg0_register tx_cfg_register;
    mac_pool2_rx_cfg0_register rx_cfg_register;
    mac_pool2_am_cfg_register am_cfg_register;
    ...
    if (is_network_slice(m_port_slice_mode)) {
        ...
        // Fabric
        if (m_fec_mode == la_mac_port::fec_mode_e::RS_KP4) {
            // Fabric slice but non RS_KP4_FI fec mode
            tx_cfg_register.fields.tx_100g_frame_intrlv_en = 0;
            tx_cfg_register.fields.tx_bypass_scr = 0;
            tx_cfg_register.fields.tx_rsf_scr_enable = 0;
            tx_cfg_register.fields.tx_preamble_compression = 0;
            ...
            if (((revision == la_device_revision_e::PACIFIC_B0) || (revision == la_device_revision_e::PACIFIC_B1))
                ...
                // Workaround for B0 ifg OOB interleaving
                rsf_ck_cycles_reg.fields.rsf_ck_cycles_per_1ms = m_device->m_device_frequency_int_khz * 120 / 1000000;
            } else {
                tx_cfg_register.fields.tx_oob_intrlv_en = 0;
            }
...
la_status
pacific_mac_pool::update_general_config()
{
    mac_pool2_tx_cfg0_register tx_cfg_register;
    mac_pool2_rx_cfg0_register rx_cfg_register;
    mac_pool2_am_cfg_register am_cfg_register;
...
la_status
pacific_mac_pool::recalc_general_config(mac_pool2_tx_cfg0_register* tx_cfg_register,
                                        mac_pool2_rx_cfg0_register* rx_cfg_register,
                                        mac_pool2_am_cfg_register* am_cfg_register)
{
    ...
    if (((m_speed == la_mac_port::port_speed_e::E_25G) || (m_speed == la_mac_port::port_speed_e::E_50G))
    ...
    if (is_network_slice(m_port_slice_mode) || m_fec_mode == la_mac_port::fec_mode_e::RS_KP4) {
        switch (m_speed) {
        case la_mac_port::port_speed_e::E_10G:
        case la_mac_port::port_speed_e::E_40G:
        ...
        case la_mac_port::port_speed_e::E_50G:
            ...
            break;
        case la_mac_port::port_speed_e::E_100G:
            rx_cfg_register->fields.rx_rsf_err_ind_mark_mode = 3;
            break;
        case la_mac_port::port_speed_e::E_200G:
        case la_mac_port::port_speed_e::E_400G:
...
la_status
pacific_mac_pool::get_general_config(mac_pool2_tx_cfg0_register* tx_cfg_register,
                                     mac_pool2_rx_cfg0_register* rx_cfg_register,
                                     mac_pool2_am_cfg_register* am_cfg_register) const
{
    la_status stat;
...
la_status
pacific_mac_pool::set_general_config(mac_pool2_tx_cfg0_register* tx_cfg_register,
                                     mac_pool2_rx_cfg0_register* rx_cfg_register,
                                     mac_pool2_am_cfg_register* am_cfg_register)
{
    la_status stat;
    ...
    mac_pool_tx_cfg0_register tx_cfg_fec_only_register;
...
la_status
pacific_mac_pool::set_packet_sizes(la_uint_t min_size, la_uint_t max_size)
{
    mac_pool2_rx_mac_cfg1_register rx_mac_cfg1_register;
    bzero(&rx_mac_cfg1_register, mac_pool2_rx_mac_cfg1_register::SIZE);
...
la_status
pacific_mac_pool::get_packet_sizes(la_uint_t& out_min_size, la_uint_t& out_max_size) const
{
    mac_pool2_rx_mac_cfg1_register rx_mac_cfg1_register;
    /// MAC RX configurations 1
...
la_status
pacific_mac_pool::update_rs_fec_config()
{
    mac_pool2_rx_rsf_cfg0_register rx_rsf_cfg0_register;

    bzero(&rx_rsf_cfg0_register, mac_pool2_rx_rsf_cfg0_register::SIZE);
...
la_status
pacific_mac_pool::recalc_rs_fec_config(mac_pool2_rx_rsf_cfg0_register* rx_rsf_cfg0_register) const
{
    ...
    bool pacific_oobi_en;
    m_device->get_bool_property(la_device_property_e::ENABLE_PACIFIC_OOB_INTERLEAVING, pacific_oobi_en);
    if ((m_device->m_pacific_tree->get_revision() != la_device_revision_e::PACIFIC_A0) && (!is_network_slice(m_port_slice_mode))
        && (pacific_oobi_en)) {
        rx_rsf_cfg0_register->fields.rx_high_ser_fsm_en_port0 = 1;
        rx_rsf_cfg0_register->fields.rx_high_ser_fsm_en_act_port0 = 1;
    }
    ...
    // FEC bypass indication is enabled due to HW issue in Pacific A0 on 100G port
    la_device_revision_e revision = m_device->m_pacific_tree->get_revision();
    if (((revision != la_device_revision_e::PACIFIC_B0) && (revision != la_device_revision_e::PACIFIC_B1))
        && (m_speed == la_mac_port::port_speed_e::E_100G)) {
        rx_rsf_cfg0_register->fields.rx_bypass_ind = 1;
        rx_rsf_cfg0_register->fields.rx_port_bypass_ind = 1;
    }
...
la_status
pacific_mac_pool::reset_rs_fec_config(mac_pool2_rx_rsf_cfg0_register* rx_rsf_cfg0_register)
{
    // Configure port 0 of the RS-FEC
    bool configure_port0 = (m_serdes_index_in_mac_pool % 2) == 0;
...
la_status
pacific_mac_pool::get_rs_fec_config(mac_pool2_rx_rsf_cfg0_register* rx_rsf_cfg0_register) const
{
    la_status stat;
...
la_status
pacific_mac_pool::set_rs_fec_config(mac_pool2_rx_rsf_cfg0_register* rx_rsf_cfg0_register)
{
...
la_status
pacific_mac_pool::reset_ipg()
{
    mac_pool2_tx_mac_cfg_ipg_register tx_mac_cfg_ipg;
    bzero(&tx_mac_cfg_ipg, mac_pool2_tx_mac_cfg_ipg_register::SIZE);
...
la_status
pacific_mac_pool::reset_xon_xoff_timers()
{
    mac_pool2_tx_mac_fc_xoff_timer_register xoff_reg;
    mac_pool2_tx_mac_fc_xon_timer_register xon_reg;

    bzero(&xoff_reg, mac_pool2_tx_mac_fc_xoff_timer_register::SIZE);
    bzero(&xon_reg, mac_pool2_tx_mac_fc_xon_timer_register::SIZE);
...
la_status
pacific_mac_pool::set_xoff_timer_settings(la_uint8_t tc_bitmap, la_uint_t quanta)
{
    mac_pool2_tx_mac_fc_xoff_timer_register xoff_reg;
...
la_status
pacific_mac_pool::set_xon_timer_settings(la_uint8_t tc_bitmap, la_uint_t quanta)
{
    mac_pool2_tx_mac_fc_xon_timer_register xon_reg;

    bzero(&xon_reg, mac_pool2_tx_mac_fc_xoff_timer_register::SIZE);
...
la_status
pacific_mac_pool::configure_pcs_test_mode()
{
    mac_pool2_tx_pcs_test_cfg0_register tx_pcs_test_cfg0;
    mac_pool2_rx_pcs_test_cfg0_register rx_pcs_test_cfg0;

    bzero(&tx_pcs_test_cfg0, mac_pool2_tx_pcs_test_cfg0_register::SIZE);
    bzero(&rx_pcs_test_cfg0, mac_pool2_rx_pcs_test_cfg0_register::SIZE);
...
la_status
pacific_mac_pool::configure_pma_test_mode()
{
    mac_pool2_tx_pma_test_cfg0_register tx_pma_test_cfg0;
    mac_pool2_rx_pma_test_cfg0_register rx_pma_test_cfg0;

    bzero(&tx_pma_test_cfg0, mac_pool2_tx_pma_test_cfg0_register::SIZE);
    bzero(&rx_pma_test_cfg0, mac_pool2_rx_pma_test_cfg0_register::SIZE);
...
la_status
pacific_mac_pool::toggle_pdif_reset()
{
    la_device_revision_e revision = m_device->m_pacific_tree->get_revision();
    if ((revision != la_device_revision_e::PACIFIC_B0) && (revision != la_device_revision_e::PACIFIC_B1)) {
        return LA_STATUS_SUCCESS;
    ...
    la_status status;
    // PDIF reset register
    bit_vector pdif_reset_reg;

    if ((m_serdes_base_id >= 16) || (m_serdes_base_id % 2 == 1)) {
        // No toggling of pdif for macpool2 ports or odd numbered ports
        // See issue "Reset PDIF on MAC port creation" #1139
        return LA_STATUS_SUCCESS;
    }

    size_t bit_idx = m_serdes_base_id / 2 + m_ifg_id * 8;

    status
        = m_device->m_ll_device->read_register(m_device->m_pacific_tree->slice[m_slice_id]->pdoq->fdoq->spare_reg, pdif_reset_reg);
    return_on_error(status);

    // Assert PDIF reset (set to 0)
    pdif_reset_reg.set_bit(bit_idx, 0);

    status
        = m_device->m_ll_device->write_register(m_device->m_pacific_tree->slice[m_slice_id]->pdoq->fdoq->spare_reg, pdif_reset_reg);
    return_on_error(status);

    // Deassert PDIF reset (set to 1)
    pdif_reset_reg.set_bit(bit_idx, 1);
    ...
    log_debug(
        MAC_PORT, "%s %s: toggled PDIF reset, bit %d in FDOQ spare register.", __func__, this->to_string().c_str(), (int)bit_idx);

    return LA_STATUS_SUCCESS;
}

la_status
pacific_mac_pool::read_mac_status(la_mac_port::mac_status& out_mac_status) const
{
...
la_status
pacific_mac_pool::read_mac_status_simulated(la_mac_port::mac_status& out_mac_status) const
{
...
la_status
pacific_mac_pool::read_mac_status_hw(la_mac_port::mac_status& out_mac_status) const
{
    mac_pool_rx_status_register_register reg[8];
    ...
    // RxLinkFaultFsmStatus doesn't work on Pacific.
    // If no link, but pcs is good, there is a remote fault.
    if (!out_mac_status.link_state && out_mac_status.pcs_status) {
        out_mac_status.link_fault_status = la_mac_port::fault_state_e::REMOTE_FAULT;
    } else if (!out_mac_status.link_state && !out_mac_status.pcs_status) {
        out_mac_status.link_fault_status = la_mac_port::fault_state_e::LOCAL_FAULT;
    } else {
        out_mac_status.link_fault_status = la_mac_port::fault_state_e::NO_FAULT;
    }
    ...
    if (m_fec_mode == la_mac_port::fec_mode_e::KR) {
        ...
        mac_pool_rx_krf_status_register kr_reg;
...
la_status
pacific_mac_pool::read_mac_link_down_interrupt(link_down_interrupt_info& val_out) const
{
    if (m_device->is_simulated_device()) {
...
la_status
pacific_mac_pool::read_mac_link_down_interrupt_simulated(link_down_interrupt_info& val_out) const
{
...
la_status
pacific_mac_pool::read_mac_link_down_interrupt_hw(link_down_interrupt_info& val_out) const
{
    ...
    if (val_out.rx_link_status_down && val_out.rx_pcs_link_status_down) {
        val_out.rx_remote_link_status_down = false;
    } else if (val_out.rx_link_status_down && !val_out.rx_pcs_link_status_down) {
        val_out.rx_remote_link_status_down = true;
    }
...
la_status
pacific_mac_pool::clear_mac_link_down_interrupt() const
{
    uint64_t mask = get_mac_pool_interrupt_mask();
...
la_status
pacific_mac_pool::set_mac_link_down_interrupt_mask(bool enable_interrupt) const
{
...
la_status
pacific_mac_pool::clear_rx_deskew_fifo_overflow_interrupt() const
{
    la_status rc;
    ll_device_sptr ldev = m_device->m_ll_device;
    bit_vector pcs_bv(0);
...
void
pacific_mac_pool::populate_link_error_info(const interrupt_tree::cause_bits& link_error_bits,
                                           link_error_interrupt_info& val_out) const
{
    std::map<lld_register_scptr, bool*> reg_vals{
        ...
        {m_mac_pool_interrupt_regs.rx_oob_invert_crc_err_interrupt_register, &val_out.rx_oob_invert_crc_error},
...
la_status
pacific_mac_pool::set_mac_link_error_interrupt_mask(bool enable_interrupt) const
{
...
la_status
pacific_mac_pool::set_delayed_mac_link_error_interrupt_mask(bool enable_interrupt) const
{
    std::vector<lld_register_scptr> regs = {
...
la_status
pacific_mac_pool::read_mac_pcs_lane_mapping(la_mac_port::mac_pcs_lane_mapping& out_mac_pcs_lane_mapping) const
{
    mac_pool_rx_status_lane_mapping_register reg;
    bit_vector reg_bv;
...
la_status
pacific_mac_pool::read_rs_fec_symbol_errors_counters(la_mac_port::rs_fec_sym_err_counters& out_sym_err_counters) const
{
    return read_rs_fec_symbol_errors_counters(true, out_sym_err_counters);
}

la_status
pacific_mac_pool::read_rs_fec_symbol_errors_counters(bool clear, la_mac_port::rs_fec_sym_err_counters& out_sym_err_counters) const
{
    ...
    for (size_t fec_engines_index = 0; fec_engines_index < fec_engines_count; fec_engines_index++) {
        for (size_t fec_lane = 0; fec_lane < fec_lanes_per_fec_engine; fec_lane++) {
            ...
            mac_pool_rx_symb_err_lane_reg_register reg;
            la_status status;
            if (clear) {
                status = m_device->m_ll_device->read_register(
...
la_status
pacific_mac_pool::read_rs_fec_debug_counters(la_mac_port::rs_fec_debug_counters& out_debug_counters) const
{
    return read_rs_fec_debug_counters(true, out_debug_counters);
}

la_status
pacific_mac_pool::read_rs_fec_debug_counters(bool clear, la_mac_port::rs_fec_debug_counters& out_debug_counters) const
{
    // Check if debug is enabled for this port
    bool debug_enabled;
    la_status status = get_rs_fec_debug_enabled(debug_enabled);
    return_on_error(status);
    if (!debug_enabled) {
        return LA_STATUS_EINVAL;
    }
    ...
    mac_pool_rx_rsf_dbg_cntrs_reg_register reg;

    if (clear) {
        status = m_device->m_ll_device->read_register((*m_mac_pool_counters.rsf_debug), reg);
    } else {
        status = m_device->m_ll_device->peek_register((*m_mac_pool_counters.rsf_debug), reg);
    }
    return_on_error(status);
...
la_status
pacific_mac_pool::get_fec_counter_reg(la_mac_port::counter_e counter_type, lld_register_scptr& out_counter_reg) const
{
    switch (m_fec_mode) {
...
la_status
pacific_mac_pool::read_counter(la_mac_port::counter_e counter_type, size_t& out_counter) const
{
    return read_counter(true, counter_type, out_counter);
}

la_status
pacific_mac_pool::read_counter(bool clear, la_mac_port::counter_e counter_type, size_t& out_counter) const
{
...
la_status
pacific_mac_pool::read_counter(la_mac_port::serdes_counter_e counter_type, la_uint_t serdes_idx, size_t& out_counter) const
{
    lld_register_scptr counter_reg = nullptr;
...
la_status
pacific_mac_pool::clear_counters() const
{
    ...
    la_status status = get_rs_fec_debug_enabled(debug_enabled);
    return_on_error(status);
    // clear rs fec errors if enabled for this mac port
    if (debug_enabled) {
        mac_pool_rx_rsf_dbg_cntrs_reg_register reg;
    ...
    if (debug_enabled && m_fec_mode != la_mac_port::fec_mode_e::NONE && m_fec_mode != la_mac_port::fec_mode_e::KR) {
...
la_status
pacific_mac_pool::read_pma_test_ber(la_mac_port::mac_pma_ber& out_mac_pma_ber) const
{
    ...
    for (size_t serdes_lane = 0; serdes_lane < m_serdes_count; serdes_lane++) {
        mac_pool_rx_pma_test_counter_register error_counter;
        mac_pool_rx_pma_rd_cnt_reg_register read_counter;
...
la_status
pacific_mac_pool::configure_ber_fsm()
{
    mac_pool_rx_ber_fsm_cfg_register ber_fsm;

    // Below is the PCS High BER FSM configurations. The values are from HW team and depends on Pacific clock.
    // There are two parts:
...
la_status
pacific_mac_pool::configure_degraded_ser()
{
    mac_pool_rsf_degraded_ser_cfg0_register rsf_degraded_ser_cfg0;
    mac_pool_rx_high_ser_fsm_cfg_register rx_high_ser_fsm_cfg;
    ...
    // Workaround for B0 ifg OOB interleaving
    // Running OOB interleaving mode and generating large amount of uncorrectable errors causes garbage to go into the device
    // Using the high SER FSM for each uncorrectable error FEC corrupts all 64/66 PCS words for 200ns (about 2 frames more)
    // This makes sure that the word after the uncorrectable error gets corrupted as well and the first word that is not corrupted
    // is already after descrambler is synced
    bool pacific_oobi_en;
    m_device->get_bool_property(la_device_property_e::ENABLE_PACIFIC_OOB_INTERLEAVING, pacific_oobi_en);
    if ((m_device->m_pacific_tree->get_revision() != la_device_revision_e::PACIFIC_A0) && (!is_network_slice(m_port_slice_mode))
        && (pacific_oobi_en)) {
        rx_high_ser_fsm_cfg.fields.rx_high_ser_k_port0 = 16;
        rx_high_ser_fsm_cfg.fields.rx_high_ser_time_ms_port0 = 2;
        rx_high_ser_fsm_cfg.fields.rx_high_ser_words_wind0 = 0;
    }
...
la_status
pacific_mac_pool::calculate_pma_max_burst(uint32_t& pma_max_burst)
{
    ...
    if ((m_loopback_mode == la_mac_port::loopback_mode_e::PMA_CORE_CLK)
        ...
        } else if (m_serdes_speed == la_mac_port::port_speed_e::E_25G) {
            if ((m_speed == la_mac_port::port_speed_e::E_40G) && (m_serdes_count == 2)) {
                port_serdes_rate = 20.625; // (66/64) * 20Gbps
            } else if (m_fec_mode == la_mac_port::fec_mode_e::RS_KP4) {
                port_serdes_rate = 26.5625; // (68/64) * 25Gbps
            } else {
                port_serdes_rate = 25.78125; // (66/64) * 25Gbps
            }
        } else {                        // m_serdes_speed == la_mac_port::port_speed_e::E_10G
            port_serdes_rate = 10.3125; // (66/64) * 10Gbps
        }
        ...
        // For the supported device frequencies of 1.0 GHz - 1.4 GHz
        // Shaper factor is calculated as pma_max_burst / pma_max_burst + 1
        // Max Value = 53.125 / 60*1.0 = 0.885 ; Shaper Factor: 9/10 (0.9 > 0.885)
        // Min Value = 10.3125 / 60*1.4 = 0.240625 ; Shaper Factor: 1/2 (0.5 > 0.240625)
        // Shaper factor must be greater than the target rate, so possible values will be between 1/2 (0.5 > 0.240625) and
        // 9/10 (0.9 > 0.885), meaning 1 <= pma_max_burst <= 9
        // However, min value of pma_max_burst has to be 2. Therefore, 2 <= pma_max_burst <= 9
...
la_status
pacific_mac_pool::setup_counter_timer(bool enable, size_t clock_cycles) const
{
    la_status status;
    mac_pool_counter_timer_register counter_timer_reg;
    ...
    if (enable) {
        mac_pool_counter_timer_trigger_reg_register trigger_reg;
...
la_status
pacific_mac_pool::wait_counter_timer() const
{
    if (m_device->is_simulated_device()) {
        return LA_STATUS_SUCCESS;
    }

    mac_pool_counter_timer_trigger_reg_register trigger_reg{{0}};
    size_t retry = 0;
    for (; retry < COUNTER_TIMER_MAX_POLL; ++retry) {
        ...
        if (!trigger_reg.fields.counter_timer_trigger) {
            log_err(MAC_PORT, "%s: ready after %ld retries", __func__, retry);
            return LA_STATUS_SUCCESS;
        }
    }
...
bool
pacific_mac_pool::is_loopback_mode_supported(la_mac_port::loopback_mode_e mode)
{
    ...
    if (mode == la_mac_port::loopback_mode_e::SERDES) {
...
la_status
pacific_mac_pool::set_control_tx_mac_src(la_mac_addr_t mac_addr)
{
    for (size_t serdes = m_serdes_index_in_mac_pool; serdes < m_serdes_index_in_mac_pool + m_serdes_count; serdes++) {
        mac_pool2_tx_mac_ctrl_sa_register reg;
...
la_status
pacific_mac_pool::get_control_tx_mac_src(la_mac_addr_t& out_mac_addr) const
{
    mac_pool2_tx_mac_ctrl_sa_register reg;
