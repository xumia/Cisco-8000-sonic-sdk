...
public:
    la_output_queue_scheduler_impl(const la_device_impl_wptr& device,
    ...
    la_vsc_voq_map_t get_attached_vscs_voqs() const;
...
private:
    ...
    void get_dev_voq_map_info(la_vsc_gid_t vsc,
    ...
    la_status populate_oqse_cfg(scheduling_mode_e mode, sch_oqse_cfg_memory* out_oqse_cfg);
    ...
    lld_memory_scptr m_sch_vsc_map_cfg;
    lld_memory_scptr m_sch_vsc_token_bucket;
    lld_memory_scptr m_sch_vsc_token_bucket_cfg;
    lld_memory_scptr m_sch_vsc_token_bucket_empty;
