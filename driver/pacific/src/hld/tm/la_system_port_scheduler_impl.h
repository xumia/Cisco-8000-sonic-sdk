...
private:
    ...
    lld_register_scptr m_sch_tpse_general_configuration;
    lld_register_scptr m_sch_tpse_oqpg_mapping_configuration;
    lld_memory_scptr m_sch_oqpg_cir_token_bucket;
    lld_memory_scptr m_sch_oqpg_cir_token_bucket_cfg;
    lld_memory_scptr m_sch_oq_pir_token_bucket;
    lld_memory_scptr m_sch_oq_pir_token_bucket_cfg;
    lld_memory_scptr m_sch_tpse_wfq_cfg;
