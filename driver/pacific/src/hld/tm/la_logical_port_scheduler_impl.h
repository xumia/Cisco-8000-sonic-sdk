...
private:
    ...
    lld_memory_scptr m_sch_oqse_map_cfg;
    lld_memory_scptr m_sch_oqse_cfg;
    lld_memory_scptr m_sch_lpse_wfq_weight_map;
    lld_memory_scptr m_sch_oqse_cir_token_bucket;
    lld_memory_scptr m_sch_oqse_cir_token_bucket_cfg;
    lld_memory_scptr m_sch_oqse_cir_token_bucket_empty;
    lld_memory_scptr m_sch_oqse_eir_token_bucket;
    lld_memory_scptr m_sch_oqse_eir_token_bucket_cfg;
    lld_memory_scptr m_sch_oqse_eir_token_bucket_empty;
    lld_register_scptr m_sch_oqse_eir_pir_token_bucket_cfg;

    template <class _sch>
    void initialize_sch_references(_sch& sch)
    {
        m_sch_oqse_map_cfg = sch->oqse_map_cfg;
        m_sch_oqse_cfg = sch->oqse_cfg;
        m_sch_lpse_wfq_weight_map = sch->lpse_wfq_weight_map;
        m_sch_oqse_cir_token_bucket = sch->oqse_cir_token_bucket;
        m_sch_oqse_cir_token_bucket_cfg = sch->oqse_cir_token_bucket_cfg;
        m_sch_oqse_cir_token_bucket_empty = sch->oqse_cir_token_bucket_empty;
        m_sch_oqse_eir_token_bucket = sch->oqse_eir_token_bucket;
        m_sch_oqse_eir_token_bucket_cfg = sch->oqse_eir_token_bucket_cfg;
        m_sch_oqse_eir_token_bucket_empty = sch->oqse_eir_token_bucket_empty;
        m_sch_oqse_eir_pir_token_bucket_cfg = sch->oqse_eir_pir_token_bucket_cfg;
    }
