...
private:
    ...
    // Object ID
    la_object_id_t m_oid = LA_OBJECT_ID_INVALID; // Protection monitor ID
    la_protection_monitor_gid_t m_gid;

    // Address of table entry
    npl_native_protection_table_entry_wptr_t m_native_table_entry;
    npl_path_protection_table_entry_wptr_t m_path_table_entry;
