...
#ifndef __LA_GUE_PORT_IMPL_H__
#define __LA_GUE_PORT_IMPL_H__
...
class la_gue_port_impl : public la_gue_port
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS
public:
    explicit la_gue_port_impl(const la_device_impl_wptr& device);
    ~la_gue_port_impl() override;
...
private:
    ...
    la_ipv4_prefix_t m_local_prefix;

    /// Attached overlay VRF object
