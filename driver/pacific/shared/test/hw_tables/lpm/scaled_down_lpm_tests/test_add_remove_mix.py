...
class add_remove_mix(lpm_scaled_down_test):
    ...
    def test_add_remove_mix(self):
        self.perform_test_add_remove_many_lpm_instances("shared/test/hw_tables/lpm/inputs/ip_mix_huge.txt.gz", "OLD_FORMAT",
                                                        30000, 5)
