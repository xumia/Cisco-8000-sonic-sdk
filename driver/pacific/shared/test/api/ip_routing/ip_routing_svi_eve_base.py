...
class ip_routing_svi_eve_base(ip_routing_base):
    l3_port_impl_class = T.ip_svi_base

    FIRST_SERDES_SPA = T.get_device_first_serdes(6)
    LAST_SERDES_SPA = T.get_device_last_serdes(7)
    SVI_VLAN = 20
    SVI1_VLAN = 30
    SVI2_VLAN = 40
    ...
    SERDES8 = T.get_device_out_first_serdes(8)
    SERDES9 = T.get_device_out_last_serdes(9)
    SERDES10 = T.get_device_next2_first_serdes(10)
    SERDES11 = T.get_device_next2_last_serdes(11)
    SERDES12 = T.get_device_next4_first_serdes(12)
    SERDES13 = T.get_device_next4_last_serdes(13)
    ...
    def set_svi_tag(self, svi_port, vlan):
        ...
        self.assertEqual(vlan, tag1.tci.fields.vid)
    ...
    def setup_ip_routing_svi_eve(self):
        # 1. provision rx_svi
        self.set_svi_tag(self.topology.rx_svi, self.SVI_VLAN)
        ...
        eve.tag0.tci.fields.vid = self.SVI_VLAN
        ...
        eve.num_tags_to_pop = 0
        eve.tag0.tpid = Ethertype.Dot1Q.value
        eve.tag0.tci.fields.vid = self.SVI1_VLAN
    ...
    def setup_ip_routing_svi_eve_spa(self):
        ...
        first_serdes_spa1 = T.get_device_next_first_serdes(self.FIRST_SERDES_SPA)
        last_serdes_spa1 = T.get_device_next_last_serdes(self.LAST_SERDES_SPA)
        self.spa_mac_port11 = T.mac_port(self, self.device, T.TX_SLICE_DEF, T.TX_IFG_DEF,
                                         first_serdes_spa1, last_serdes_spa1, None)
        ...
        first_serdes_port_21 = T.get_device_out_next_first_serdes(self.SERDES8)
        last_serdes_port_21 = T.get_device_out_next_last_serdes(self.SERDES9)

        self.spa_mac_port21 = T.mac_port(self, self.device, T.TX_SLICE_DEF, T.TX_IFG_DEF,
                                         first_serdes_port_21, last_serdes_port_21, None)
        ...
        first_serdes_port31 = T.get_device_next3_first_serdes(self.SERDES10)
        last_serdes_port31 = T.get_device_next3_last_serdes(self.SERDES11)
        self.spa_mac_port31 = T.mac_port(self, self.device, T.TX_SLICE_REG, T.TX_IFG_REG,
                                         first_serdes_port31, last_serdes_port31, None)
        ...
        first_serdes_port41 = T.get_device_next5_first_serdes(14)
        last_serdes_port41 = T.get_device_next5_last_serdes(15)
        self.spa_mac_port41 = T.mac_port(self, self.device, T.TX_SLICE_DEF, T.TX_IFG_DEF,
                                         first_serdes_port41, last_serdes_port41, None)
    ...
    def create_non_native_vlan(self):
        ...
        self.set_svi_tag(self.rx_svi2, self.SVI2_VLAN)
    ...
    def create_non_native_l2_ac_port(self):
        ...
        eve.num_tags_to_pop = 0
        eve.tag0.tpid = Ethertype.Dot1Q.value
        eve.tag0.tci.fields.vid = self.SVI2_VLAN
    ...
    def move_nh_mac_from_access_to_trunk(self, access_port, trunk_port):
        ...
        eve.num_tags_to_pop = 0
        eve.tag0.tpid = Ethertype.Dot1Q.value
        eve.tag0.tci.fields.vid = self.SVI1_VLAN + 1
        trunk_port.set_egress_vlan_edit_command(eve)
