...
class ipv4_svi_routing_base(ip_routing_base):
    ...
    INPUT_PACKET_BASE_HSRP_V1_IPV4_VMAC = \
        S.Ether(dst=T.RX_HSRP_V1_IPV4_VMAC1.addr_str, src=ip_routing_base.SA.addr_str, type=U.Ethertype.Dot1Q.value) / \
        S.Dot1Q(vlan=T.RX_L2_AC_PORT_VID1) / \
        S.IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=ip_routing_base.TTL)

    INPUT_PACKET_BASE_HSRP_V2_IPV4_VMAC = \
        S.Ether(dst=T.RX_HSRP_V2_IPV4_VMAC1.addr_str, src=ip_routing_base.SA.addr_str, type=U.Ethertype.Dot1Q.value) / \
        S.Dot1Q(vlan=T.RX_L2_AC_PORT_VID1) / \
        S.IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=ip_routing_base.TTL)

    INPUT_PACKET_BASE_VRRP_IPV4_VMAC = \
        S.Ether(dst=T.RX_VRRP_IPV4_VMAC1.addr_str, src=ip_routing_base.SA.addr_str, type=U.Ethertype.Dot1Q.value) / \
        S.Dot1Q(vlan=T.RX_L2_AC_PORT_VID1) / \
        S.IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=ip_routing_base.TTL)
    ...
    SNOOP_PACKET_BASE = \
        ...
        IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=ip_routing_base.TTL)
    ...
    INPUT_PACKET_HSRP_V1_IPV4_VMAC, PAYLOAD_SIZE = U.enlarge_packet_to_min_length(INPUT_PACKET_BASE_HSRP_V1_IPV4_VMAC)
    INPUT_PACKET_HSRP_V2_IPV4_VMAC, PAYLOAD_SIZE = U.enlarge_packet_to_min_length(INPUT_PACKET_BASE_HSRP_V2_IPV4_VMAC)
    INPUT_PACKET_VRRP_IPV4_VMAC, PAYLOAD_SIZE = U.enlarge_packet_to_min_length(INPUT_PACKET_BASE_VRRP_IPV4_VMAC)
