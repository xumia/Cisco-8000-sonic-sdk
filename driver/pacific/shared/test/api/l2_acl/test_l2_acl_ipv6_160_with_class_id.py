...
class test_l2_acl_ipv6_160_with_class_id(test_l2_acl_ipv_base):
    ...
    @classmethod
    def setUpClass(cls):
        super(test_l2_acl_ipv6_160_with_class_id, cls).setUpClass(
            device_config_func=test_l2_acl_ipv6_160_with_class_id.device_config_func)
    ...
    def create_ipv6_class_id_unified_acl(self):
        ...
        tcam_pool_id = 0
        test_l2_acl_ipv6_160_with_class_id.acl_profile_ipv6_160_class_id = self.device.create_acl_key_profile(
            key_type, direction, ipv6_udk, tcam_pool_id)

        acl1 = self.device.create_acl(
            test_l2_acl_ipv6_160_with_class_id.acl_profile_ipv6_160_class_id,
        ...
        f2.val.class_id = test_l2_acl_ipv6_160_with_class_id.CLASS_ID
