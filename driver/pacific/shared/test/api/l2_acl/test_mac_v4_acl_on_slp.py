...
class test_mac_v4_acl_on_slp(test_l2_acl_ipv_base):

    CLASS_ID = 0xaf
    acl_profile_mac_160 = None
    ...
    def device_config_func(device, state):
        if state == sdk.la_device.init_phase_e_DEVICE:
            ...
            tcam_pool_id = 0
            test_mac_v4_acl_on_slp.acl_profile_mac_160 = device.create_acl_key_profile(
            ...
            direction = sdk.la_acl_direction_e_INGRESS
            tcam_pool_id = 0
            test_mac_v4_acl_on_slp.acl_profile_ipv4_160_class_id = device.create_acl_key_profile(
                key_type, direction, ipv4_udk, tcam_pool_id)

    @classmethod
    def setUpClass(cls):
        super(test_mac_v4_acl_on_slp, cls).setUpClass(
            device_config_func=test_mac_v4_acl_on_slp.device_config_func)
    ...
    def create_mac_acl1(self):
        acl1 = self.device.create_acl(
            test_mac_v4_acl_on_slp.acl_profile_mac_160,
    ...
    def create_mac_acl2(self):
        ...
        action3.data.counter_type = sdk.la_acl_counter_type_e_NONE
    ...
    def create_ipv4_class_id_unified_acl(self):
        ...
        acl1 = self.device.create_acl(
            test_mac_v4_acl_on_slp.acl_profile_ipv4_160_class_id,
            self.topology.acl_command_profile_def)
        self.assertNotEqual(acl1, None)
        ...
        f2.val.class_id = test_mac_v4_acl_on_slp.CLASS_ID
    ...
    @unittest.skipUnless(decor.is_gibraltar(), "Class ID tests supported only on GB")
    def test_acl(self):
        acl1 = self.create_mac_acl1()
        acl2 = self.create_mac_acl2()
