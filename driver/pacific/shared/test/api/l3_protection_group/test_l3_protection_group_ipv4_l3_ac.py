...
class ipv4_l3_ac(l3_protection_group_base):
    ...
    def test_create_l3_protection_group(self):
        self._test_create_l3_protection_group()
    ...
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_global_prefix_ecmp_p_nh_to_mpls(self):
        self._test_global_prefix_ecmp_p_nh_to_mpls()
    ...
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_prefix_p_nh_to_ip_seq1(self):
        self._test_prefix_p_nh_to_ip_seq1()

    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_prefix_p_nh_to_ip_seq2(self):
        self._test_prefix_p_nh_to_ip_seq2()
    ...
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_l3_protection_group_getters(self):
        self._test_l3_protection_group_getters()

    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_l3_protection_group_scale(self):
        self._test_l3_protection_group_scale()
    ...
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_update_l3_protection_group_destination(self):
        self._test_update_l3_protection_group_destination()
