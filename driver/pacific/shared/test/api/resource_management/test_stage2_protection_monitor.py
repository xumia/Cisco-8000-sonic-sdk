...
class stage2_protection_monitor(resource_handler_base):
    ...
    def test_stage2_protection_monitor(self):
        rd_def = sdk.la_resource_descriptor()
        rd_def.m_resource_type = sdk.la_resource_descriptor.type_e_STAGE2_PROTECTION_MONITOR
