...
class tcam_tcam_egress_usage(ipv4_egress_acl_base):
    ...
    def test_tcam_egress_narrow_usage(self):
        self.resource_type = sdk.la_resource_descriptor.type_e_TCAM_EGRESS_NARROW_POOL_0
        self.packet_format = sdk.la_acl_packet_format_e_IPV4
        if args.verbose:
            self.resource_str = 'TCAM_EGRESS_NARROW_POOL_0'
        self.base_test_tcam_egress_usage(is_ipv4=1)
