...
class ipv4_l3_ac_test(cbf_base):
    ...
    INPUT_PACKET_BASE = \
        ...
        IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=cbf_base.IP_TTL)
    ...
    INPUT_PACKET_IP_EXP_BASE = \
        ...
        Dot1Q(vlan=T.RX_L3_AC_PORT_VID1, type=U.Ethertype.Dot1Q.value) / \
        Dot1Q(vlan=T.RX_L3_AC_PORT_VID2) / \
        IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=cbf_base.IP_TTL, tos=8)
    ...
    EXPECTED_OUTPUT_IP_PACKET_BASE = \
        ...
        IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=cbf_base.IP_TTL - 1)
    ...
    EXPECTED_OUTPUT_IP_PACKET_BASE_EXP = \
        ...
        IP(src=SIP.addr_str, dst=DIP.addr_str, ttl=cbf_base.IP_TTL - 1, tos=8)
    ...
    def test_profile_usage(self):
        self.prefix_object_class = T.prefix_object
        self._test_profile_usage_locks()
