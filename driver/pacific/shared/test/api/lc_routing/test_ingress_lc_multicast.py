...
class ingress_lc_multicast(lc_multicast_base):
    ...
    def test_ingress_lc_multicast(self):
        ...
        self.in_l3_ac.hld_obj.set_protocol_enabled(sdk.la_l3_protocol_e_IPV4_MC, True)
        ...
        remote_l3_ac.hld_obj.set_protocol_enabled(sdk.la_l3_protocol_e_IPV4_MC, True)
        ...
        self.device.get_ip_multicast_group(MC_GROUP_ID)
...
#            sdk.LA_IPV4_ANY_IP, self.mc_group_addr.hld_obj, self.mc_group, None, False, False, None)
        ...
        # change it to ingress replication
