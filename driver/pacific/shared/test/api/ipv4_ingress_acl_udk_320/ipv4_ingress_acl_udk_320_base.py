...
class ipv4_ingress_acl_udk_320_base(sdk_test_case_base):
    ...
    def device_config_func(device, state):
        if state == sdk.la_device.init_phase_e_DEVICE:
            ...
            tcam_pool_id = 0
            ipv4_ingress_acl_udk_320_base.acl_key_profile_ipv4_320_udk = device.create_acl_key_profile(
                key_type, direction, udk, tcam_pool_id)

    @classmethod
    def setUpClass(cls):
        super(
            ipv4_ingress_acl_udk_320_base,
            cls).setUpClass(
            device_config_func=ipv4_ingress_acl_udk_320_base.device_config_func)
    ...
    def create_empty_acl(self):
        ...
        acl0 = self.device.create_acl(
            ipv4_ingress_acl_udk_320_base.acl_key_profile_ipv4_320_udk,
