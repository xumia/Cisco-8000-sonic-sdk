...
class ipv4_ingress_acl_class_id_320_base(sdk_test_case_base):
    l3_port_impl_class = T.ip_l3_ac_base
    ip_impl = ip_test_base.ipv4_test_base
    acl_key_profile_ipv4_320_class_id = None
    ...
    def device_config_func(device, state):
        if state == sdk.la_device.init_phase_e_DEVICE:
            ...
            udk.append(udf3)
            # udf4 for TTL from ipv4_ingress_acl_udk_320_base replaced with TOS
            ...
            udf13.udf_desc.protocol_layer = 0
            udf13.udf_desc.header = 0
            udf13.udf_desc.offset = 20
            ...
            tcam_pool_id = 0
            ipv4_ingress_acl_class_id_320_base.acl_key_profile_ipv4_320_class_id = device.create_acl_key_profile(
                key_type, direction, udk, tcam_pool_id)

    @classmethod
    def setUpClass(cls):
        super(ipv4_ingress_acl_class_id_320_base, cls).setUpClass(
            device_config_func=ipv4_ingress_acl_class_id_320_base.device_config_func)
    ...
    def create_lpm_class_id_unified_acl(self):
        ...
        acl1 = self.device.create_acl(
            ipv4_ingress_acl_class_id_320_base.acl_key_profile_ipv4_320_class_id,
        ...
        f2.val.class_id = ipv4_ingress_acl_class_id_320_base.CLASS_ID
    ...
    def create_host_class_id_unified_acl(self):
        ...
        f2 = sdk.la_acl_field()
        f2.type = sdk.la_acl_field_type_e_CLASS_ID
        f2.val.class_id = ipv4_ingress_acl_class_id_320_base.CLASS_ID_HOST
