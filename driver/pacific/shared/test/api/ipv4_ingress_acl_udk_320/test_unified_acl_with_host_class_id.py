...
class unified_acl(ipv4_ingress_acl_class_id_320_base):
    ...
    def test_unified_acl_with_host_class_id(self):
        ...
        expected_output_packet = EXPECTED_OUTPUT_HOST_PACKET.copy()
        expected_output_packet[IP].tos = QOS_MARK_DSCP << 2
        run_and_compare_inner_fields(self, self.device,
                                     INPUT_PACKET_HOST, T.RX_SLICE, T.RX_IFG, T.FIRST_SERDES,
        ...
        assertPacketLengthIngress(self, INPUT_PACKET_HOST, T.RX_SLICE, byte_count)
