...
class sda_encap(vxlan_l2_single_port):
    ...
    def test_vxlan_sda_encap_ucast(self):
    ...
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_vxlan_sda_encap_ucast_encap_decap(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_vxlan_sda_encap_ucast_encap_only(self):
        self.create_recycle_ac_port()
    ...
    def test_vxlan_sda_mcast_encap_her_encap_decap(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_sda_mcast_encap_her_encap_decap_with_ir(self):
        self.create_recycle_ac_port()
        self.single_port_setup(tunnel_mode.ENCAP_DECAP, True)
        self.sda_setup()
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_sda_mcast_encap_her_encap_only(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_matilda(), "Test is not yet enabled on Matilda")
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_sda_mcast_encap_her_encap_only_with_ir(self):
        self.create_recycle_ac_port()
        self.single_port_setup(tunnel_mode.ENCAP_ONLY, True)
        self.sda_setup()
        self.set_ingress_rep(True)
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_sda_mcast_encap_ulay_encap_only(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_matilda(), "Test is not yet enabled on Matilda")
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_sda_mcast_encap_ulay_encap_only_with_ir(self):
        self.create_recycle_ac_port()
        self.set_vxlan_dip(self.UND_MC_GROUP_ADDR.addr_str)
        self.single_port_setup(tunnel_mode.ENCAP_ONLY, True)
        self.sda_setup()
