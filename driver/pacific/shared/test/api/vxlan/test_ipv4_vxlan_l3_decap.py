...
class vxlan_l3_decap(vxlan_l2_single_port):
    ...
    def test_vxlan_l3_decap(self):
        self.create_recycle_ac_port()
        self.single_port_setup()
        self.l3vxlan_setup()
        self._test_vxlan_l3_decap()
    ...
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_vxlan_l3_decap_ucast_encap_decap(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
    def test_vxlan_l3_decap_ucast_decap_only(self):
        self.create_recycle_ac_port()
    ...
    def test_vxlan_l3_decap_mcast_her_encap_decap(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_l3_decap_mcast_her_encap_decap_with_ir(self):
        self.create_recycle_ac_port()
        self.single_port_setup(tunnel_mode.ENCAP_DECAP, True)
        self.l3vxlan_setup()
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_l3_decap_mcast_her_decap_only(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_matilda(), "Test is not yet enabled on Matilda")
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_l3_decap_mcast_her_decap_only_with_ir(self):
        self.create_recycle_ac_port()
        self.single_port_setup(tunnel_mode.DECAP_ONLY, True)
        self.l3vxlan_setup()
        self.set_ingress_rep(True)
    ...
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_l3_mcast_decap_ulay_decap_only(self):
        self.create_recycle_ac_port()
    ...
    @unittest.skipIf(decor.is_matilda(), "Test is not yet enabled on Matilda")
    @unittest.skipIf(not (decor.is_gibraltar() or decor.is_asic4()), "Run only on GB and PL")
    def test_vxlan_l3_mcast_decap_ulay_decap_only_with_ir(self):
        self.create_recycle_ac_port()
        self.set_vxlan_sip_prefix(self.L3MC_GROUP_ADDR.addr_str, 32)
        self.single_port_setup(tunnel_mode.DECAP_ONLY, True)
        self.l3vxlan_setup()
