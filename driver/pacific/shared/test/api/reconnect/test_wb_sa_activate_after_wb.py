...
class test_wb_sa(test_wb_sa_base):
    def test_wb_sa_activate_after_wb(self):
        '''
        check port activation after warmboot, no traffic testing
        '''
        print("checking port activate after wb")
        self.setup_ports()
