...
class ipv4_fields_acl(ipv4_ingress_acl_udk_160_base):
    ...
    def test_ipv4_fields_acl(self):
        ...
        # SVI port
        self._test_ipv4_fields_acl(True)

    def _test_ipv4_fields_acl(self, is_svi=False):
        acl1 = self.create_simple_sec_acl(is_svi)
        ...
        k0.append(f0)
        in_packet = INPUT_PACKET_SVI.copy() if is_svi else INPUT_PACKET.copy()
        ...
        in_packet = INPUT_PACKET_TCP_SVI.copy() if is_svi else INPUT_PACKET_TCP.copy()
