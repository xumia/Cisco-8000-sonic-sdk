...
class test_l3_vxlan_encap_ipv6_security_group_acl_monitor(vxlan_l2_single_port):
    ...
    def test_l3_vxlan_encap_ipv6_security_group_acl_monitor(self):
        self.create_recycle_ac_port()
        self.single_port_setup()
        self.sda_setup()
        self.set_l3_sgacl(True, True, False, True)  # monitor, drop, is_ipv4, is_encap
