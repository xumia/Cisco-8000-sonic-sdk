...
from warm_boot_upgrade_rollback_l2_switch_base import warm_boot_upgrade_rollback_l2_switch_base
...
class warm_boot_upgrade_l2_switch(warm_boot_upgrade_rollback_l2_switch_base):

    def test_warm_boot_upgrade_l2_switch(self):
        self._test_warm_boot_l2_switch(change_config_after_wb=False)
