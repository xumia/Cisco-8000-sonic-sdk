...
class test_mac_port_mii_srds_clk_loopback(mac_port_loopback_base):
    def test_mii_srds_clk_loopback(self):
        self.parallel_loopback_test(sdk.la_mac_port.loopback_mode_e_MII_SRDS_CLK, do_warm_boot=True)
