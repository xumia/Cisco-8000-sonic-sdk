...
class test_mac_port_mii_core_clk_loopback(mac_port_loopback_base):
    def test_mii_core_clk_loopback(self):
        self.parallel_loopback_test(sdk.la_mac_port.loopback_mode_e_MII_CORE_CLK, do_warm_boot=True)
