...
from gre_ipv6_base import *
import decor


@unittest.skipIf(decor.is_hw_asic3(), "Test is not yet enabled on GR-HW")
class test_gre_ipv6(gre_ipv6_base):
    ...
    @unittest.skip("Test is failing for IPv6. Skip for now")
    @unittest.skipIf(decor.is_asic5(), "RTF is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "RTF is not yet enabled on GR")
    @unittest.skipIf(decor.is_asic4(), "RTF is not yet enabled on PL")
    ...
    @unittest.skip("Test to be enabled after P4 changes")
    ...
    @unittest.skip("Test is not needed on IPv6")
    @unittest.skipIf(decor.is_asic5(), "RTF is not yet enabled on AR")
    @unittest.skipIf(decor.is_asic3(), "RTF is not yet enabled on GR")
    @unittest.skipIf(decor.is_asic4(), "RTF is not yet enabled on PL")
    ...
    @unittest.skipIf(decor.is_pacific(), "Test is not supported on PAC")
    @unittest.skipIf(decor.is_asic5(), "Test is not yet enabled on GR")
    @unittest.skipIf(decor.is_asic3(), "Test is not yet enabled on GR")
