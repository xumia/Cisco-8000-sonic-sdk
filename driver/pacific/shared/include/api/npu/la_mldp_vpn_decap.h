...
#ifndef __LA_MLDP_VPN_DECAP_H__
#define __LA_MLDP_VPN_DECAP_H__
...
/// @file
/// @brief Leaba MLDP Tunnel Decapsulator API-s.
///
/// Defines API-s for managing MLDP tunnel decapsulators.

namespace silicon_one
{

class la_mldp_vpn_decap : public la_object
{
public:
    ...
    /// @brief Set the MLDP decap counter.
    ///
    ...
    /// @brief Get the MLDP decap counter.
    ///
...
protected:
    ~la_mldp_vpn_decap() override = default;
};

} // namespace silicon_one

#endif // __LA_MLDP_VPN_DECAP_H__
