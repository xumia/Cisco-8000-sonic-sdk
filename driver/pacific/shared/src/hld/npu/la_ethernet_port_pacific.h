...
#ifndef __LA_ETHERNET_PORT_PACIFIC_H__
#define __LA_ETHERNET_PORT_PACIFIC_H__
...
class la_ethernet_port_pacific : public la_ethernet_port_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_ethernet_port_pacific() = default;
    //////////////////////////////
public:
    explicit la_ethernet_port_pacific(const la_device_impl_wptr& device);
    ~la_ethernet_port_pacific() override;
...
#endif // __LA_ETHERNET_PORT_PACIFIC_H__
