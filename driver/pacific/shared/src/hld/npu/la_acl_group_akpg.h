...
#ifndef __LA_ACL_GROUP_AKPG_H__
#define __LA_ACL_GROUP_AKPG_H__
...
class la_acl_group_akpg : public la_acl_group_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS

public:
    explicit la_acl_group_akpg(const la_device_impl_wptr& device);
    ~la_acl_group_akpg() override;

private:
    // For serialziation
    la_acl_group_akpg() = default;
