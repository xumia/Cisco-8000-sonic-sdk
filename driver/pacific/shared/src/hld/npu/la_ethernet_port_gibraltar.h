...
#ifndef __LA_ETHERNET_PORT_GIBRALTAR_H__
#define __LA_ETHERNET_PORT_GIBRALTAR_H__
...
class la_ethernet_port_gibraltar : public la_ethernet_port_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_ethernet_port_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_ethernet_port_gibraltar(const la_device_impl_wptr& device);
    ~la_ethernet_port_gibraltar() override;
...
#endif // __LA_ETHERNET_PORT_GIBRALTAR_H__
