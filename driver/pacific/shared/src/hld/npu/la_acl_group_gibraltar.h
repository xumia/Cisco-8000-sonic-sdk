...
#ifndef __LA_ACL_GROUP_GIBRALTAR_H__
#define __LA_ACL_GROUP_GIBRALTAR_H__
...
class la_acl_group_gibraltar : public la_acl_group_base
{
    CEREAL_SUPPORT_PRIVATE_MEMBERS

public:
    explicit la_acl_group_gibraltar(const la_device_impl_wptr& device);
    ~la_acl_group_gibraltar() override;

private:
    // For serialization
    la_acl_group_gibraltar() = default;
...
#endif // __LA_ACL_GROUP_GIBRALTAR_H__
