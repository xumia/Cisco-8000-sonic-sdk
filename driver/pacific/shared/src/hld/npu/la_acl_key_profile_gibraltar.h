...
#ifndef __LA_ACL_KEY_PROFILE_GIBRALTAR_H__
#define __LA_ACL_KEY_PROFILE_GIBRALTAR_H__
...
class la_acl_key_profile_gibraltar : public la_acl_key_profile_base
{
    ////////// Serialization ///////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_acl_key_profile_gibraltar() = default;
    ////////////////////////////////////
public:
    explicit la_acl_key_profile_gibraltar(const la_device_impl_wptr& device);
    ~la_acl_key_profile_gibraltar() override;
...
#endif //  __LA_ACL_KEY_PROFILE_GIBRALTAR_H__
