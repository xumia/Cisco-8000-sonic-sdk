...
#ifndef __LA_SVI_PORT_AKPG_H__
#define __LA_SVI_PORT_AKPG_H__
...
class la_svi_port_akpg : public la_svi_port_base
{
public:
    explicit la_svi_port_akpg(const la_device_impl_wptr& device);
    ~la_svi_port_akpg() override;
