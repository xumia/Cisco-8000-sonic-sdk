...
#include "la_vxlan_next_hop_gibraltar.h"
...
la_vxlan_next_hop_gibraltar::la_vxlan_next_hop_gibraltar(const la_device_impl_wptr& device) : la_vxlan_next_hop_base(device)
{
}

la_vxlan_next_hop_gibraltar::~la_vxlan_next_hop_gibraltar()
{
}

resolution_step_e
la_vxlan_next_hop_gibraltar::get_next_resolution_step(resolution_step_e prev_step) const
{
...
lpm_destination_id
la_vxlan_next_hop_gibraltar::get_lpm_destination_id(resolution_step_e prev_step) const
{
...
destination_id
la_vxlan_next_hop_gibraltar::get_destination_id(resolution_step_e prev_step) const
{
    resolution_step_e cur_step = get_next_resolution_step(prev_step);
