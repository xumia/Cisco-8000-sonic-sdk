...
#ifndef __LA_ACL_KEY_PROFILE_AKPG_H__
#define __LA_ACL_KEY_PROFILE_AKPG_H__
...
class la_acl_key_profile_akpg : public la_acl_key_profile_base
{
    ////////// Serialization ///////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_acl_key_profile_akpg() = default;
    ////////////////////////////////////
public:
    explicit la_acl_key_profile_akpg(const la_device_impl_wptr& device);
    ~la_acl_key_profile_akpg() override;
...
#endif //  __LA_ACL_KEY_PROFILE_AKPG_H__
