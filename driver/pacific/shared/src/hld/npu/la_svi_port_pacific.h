...
#ifndef __LA_SVI_PORT_PACIFIC_H__
#define __LA_SVI_PORT_PACIFIC_H__
...
class la_svi_port_pacific : public la_svi_port_base
{
public:
    explicit la_svi_port_pacific(const la_device_impl_wptr& device);
    la_svi_port_pacific() = default; // Needed for cereal
    ~la_svi_port_pacific() override;
...
private:
    // SVI egress flood
    la_status populate_recycled_inject_up_info_table(const la_l2_service_port_base_wptr& inject_up_port) override;
...
#endif // __LA_SVI_PORT_PACIFIC_H__
