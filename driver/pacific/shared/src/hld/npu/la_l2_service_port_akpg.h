...
#ifndef __LEABA_LA_L2_SERVICE_PORT_AKPG_H__
#define __LEABA_LA_L2_SERVICE_PORT_AKPG_H__
...
{
class la_l2_service_port_akpg : public la_l2_service_port_base
{
public:
    explicit la_l2_service_port_akpg(const la_device_impl_wptr& device);
    ~la_l2_service_port_akpg() override;
