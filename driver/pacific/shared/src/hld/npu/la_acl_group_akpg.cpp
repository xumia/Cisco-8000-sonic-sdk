...
#include "npu/la_acl_group_akpg.h"
...
la_acl_group_akpg::la_acl_group_akpg(const la_device_impl_wptr& device) : la_acl_group_base(device)
{
}

la_acl_group_akpg::~la_acl_group_akpg()
{
}

npl_rtf_stage_and_type_e
la_acl_group_akpg::get_next_rtf_stage(la_acl_packet_format_e packet_format, const la_acl_wptr_vec_t& acls, uint16_t acl_index) const
{
...
npl_rtf_stage_and_type_e
la_acl_group_akpg::get_init_eth_rtf_stage(la_acl_packet_format_e packet_format, const la_acl_wptr_vec_t& acls) const
{
    if (packet_format == la_acl_packet_format_e::ETHERNET) {
...
la_status
la_acl_group_akpg::get_post_fwd_rtf_stage(la_acl_packet_format_e packet_format,
