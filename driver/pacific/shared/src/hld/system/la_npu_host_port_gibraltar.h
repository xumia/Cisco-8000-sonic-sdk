...
#ifndef __LA_NPU_HOST_PORT_GIBRALTAR_H__
#define __LA_NPU_HOST_PORT_GIBRALTAR_H__
...
class la_npu_host_port_gibraltar : public la_npu_host_port_base
{
    /////// Cereal ///////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_npu_host_port_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_npu_host_port_gibraltar(const la_device_impl_wptr& device);
    ~la_npu_host_port_gibraltar() override;
...
#endif // __LA_NPU_HOST_PORT_GIBRALTAR_H__
