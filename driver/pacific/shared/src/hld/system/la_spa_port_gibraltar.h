...
#ifndef __LA_SPA_PORT_GIBRALTAR_H__
#define __LA_SPA_PORT_GIBRALTAR_H__
...
class la_spa_port_gibraltar : public la_spa_port_pacgb
{
    ////////// Cereal ////////////
    CEREAL_SUPPORT_PRIVATE_MEMBERS
    la_spa_port_gibraltar() = default;
    //////////////////////////////
public:
    explicit la_spa_port_gibraltar(const la_device_impl_wptr& device);
    ~la_spa_port_gibraltar() override;
    ...
    la_status update_dsp_sgt_attributes(bool security_group_policy_enforcement);
    la_status update_npp_sgt_attributes(la_sgt_t security_group_tag);
...
private:
    ...
    /// @brief Erases the resolution configuration for the last SPA member.
    ///
    /// Tears-down the last member's resolution configuration
    ///
    /// @retval     LA_STATUS_SUCCESS   Operation completed successfully.
    /// @retval     LA_STATUS_EUNKNOWN  An unknown error occurred.
