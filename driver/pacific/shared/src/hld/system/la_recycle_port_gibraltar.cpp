...
la_recycle_port_gibraltar::la_recycle_port_gibraltar(const la_device_impl_wptr& device) : la_recycle_port_base(device)
{
}

la_recycle_port_gibraltar::~la_recycle_port_gibraltar()
{
}

la_status
la_recycle_port_gibraltar::initialize(la_object_id_t oid, la_slice_id_t slice, la_ifg_id_t ifg)
{
    m_oid = oid;
    m_slice = slice;
    m_ifg = ifg;
...
la_status
la_recycle_port_gibraltar::set_slice_source_pif_entry()
{
...
la_status
la_recycle_port_gibraltar::erase_slice_source_pif_entry()
{
