...
#ifndef __LA_L2_MIRROR_COMMAND_AKPG_H__
#define __LA_L2_MIRROR_COMMAND_AKPG_H__
...
class la_l2_mirror_command_akpg : public la_l2_mirror_command_base
{
public:
    explicit la_l2_mirror_command_akpg(const la_device_impl_wptr& device);
    ~la_l2_mirror_command_akpg() override;
...
private:
    ...
    virtual la_status set_slice_truncate(la_slice_id_t slice, bool truncate) const = 0;
...
#endif // __LA_L2_MIRROR_COMMAND_AKPG_H__
