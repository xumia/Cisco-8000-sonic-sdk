...
#ifndef __LA_PCI_PORT_AKPG_H__
#define __LA_PCI_PORT_AKPG_H__
...
{
class la_pci_port_akpg : public la_pci_port_base
{
public:
    explicit la_pci_port_akpg(const la_device_impl_wptr& device, bool skip_kernel_driver);
    ~la_pci_port_akpg() override;
