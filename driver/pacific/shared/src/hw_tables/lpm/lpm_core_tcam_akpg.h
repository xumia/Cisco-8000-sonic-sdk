...
#ifndef __LEABA_LPM_CORE_TCAM_AKPG_H__
#define __LEABA_LPM_CORE_TCAM_AKPG_H__
...
class lpm_core_tcam_akpg : public lpm_core_tcam
{

    CEREAL_SUPPORT_PRIVATE_MEMBERS

public:
    /// @brief Construct a LPM Core TCAM AKPG object.
    ///
    ...
    lpm_core_tcam_akpg(std::string name,
                       size_t num_banksets,
...
protected:
    ...
    lpm_core_tcam_akpg() = default;
};

} // namespace silicon_one

#endif // __LEABA_LPM_CORE_TCAM_AKPG_H__
