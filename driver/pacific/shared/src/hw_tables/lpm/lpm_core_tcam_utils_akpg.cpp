...
logical_tcam_type_e
lpm_core_tcam_utils_akpg::get_logical_tcam_type_of_key(const lpm_key_t& key) const
{
    const map_alloc<size_t, logical_tcam_type_e> ipv4_ranges{{40, logical_tcam_type_e::SINGLE}};
    const map_alloc<size_t, logical_tcam_type_e> ipv6_ranges{
        {39, logical_tcam_type_e::SINGLE}, {76, logical_tcam_type_e::DOUBLE}, {151, logical_tcam_type_e::QUAD},
    };
