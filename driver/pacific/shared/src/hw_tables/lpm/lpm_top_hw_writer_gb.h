...
#ifndef __LPM_TOP_HW_WRITER_GB_H__
#define __LPM_TOP_HW_WRITER_GB_H__
...
class lpm_top_hw_writer_gb : public lpm_top_hw_writer
{
...
public:
    ...
    explicit lpm_top_hw_writer_gb(const ll_device_sptr& ldevice);
...
private:
    ...
    size_t m_entries;           ///< Number of entries per type. Will be changed later
};
